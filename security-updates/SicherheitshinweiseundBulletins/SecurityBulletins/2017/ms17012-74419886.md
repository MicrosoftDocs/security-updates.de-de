...
<tr class="even">
<td style="border:1px solid black;"><p>Sicherheitsanfälligkeit in Device Guard durch Umgehung von Sicherheitsfunktionen</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Sicherheitsanfälligkeit in SMBv2/SMBv3 für Denial-of-Service-Angriffe (NULL-Dereferenzierung)</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Sicherheitsanfälligkeit im Windows DNS-Client bezüglich Offenlegung von Informationen</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Sicherheitsanfälligkeit in Windows COM bezüglich Rechteerweiterungen</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Sicherheitsrisiko im iSNS-Server bezüglich Speicherbeschädigung</p></td>
