...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=73b3d681-26bb-49c1-849e-1f72484cb978) | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0478](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0478).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/980858">Microsoft Knowledge Base-Artikel 980858</a>.</td>
</tr>
<tr class="even">
...
-   Fabien Perigaud von [CERT-LEXSI](http://cert.lexsi.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Media-Diensten durch stapelbasierten Pufferüberlauf (CVE-2010-0478).

Microsoft [dankt](http://www.microsoft.com/germany/technet/sicherheit/bulletins/policy.mspx) folgender Person und folgenden Unternehmen, dass sie mit uns zusammengearbeitet haben und Einzelheiten zu einem Qualitätsproblem im ursprünglichen Sicherheitsupdate bereitgestellt haben:

-   Fabien Perigaud von [CERT-LEXSI](http://cert.lexsi.com/)
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/)
-   Dem Vulnerability Research Team, [TELUS Security Labs](http://telussecuritylabs.com/)
