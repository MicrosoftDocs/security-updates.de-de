...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=ad843b97-2f6e-4406-a17a-627b7db8a926)                                                                             | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=0b0a06e7-0ae5-41f4-9ff5-d524fc0afbfa)                                                                 | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=7c0c2850-e81d-4347-aeb3-47036caa7c1b)                                                       | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=6793f75b-cdf4-42ef-a53e-a1acb5b662d1)\*             | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=85add876-ca5a-4a92-984e-188a72e349fc)\* | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=d7307afd-84a0-434e-9658-bf9f8ae4b938)\*                                                              | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2742](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742).
...
Das Netlogon Remote-Protokoll ist eine RPC-Schnittstelle (Remoteprozeduraufruf), die für Benutzer- und Computerauthentifizierung in domänenbasierten Netzwerken verwendet wird. Weitere Informationen zu Netlogon RPC finden Sie im MSDN-Artikel [Netlogon Remote Protocol Specification](http://msdn.microsoft.com/en-us/library/cc237009(v=prot.10).aspx).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2207559">Microsoft Knowledge Base-Artikel 2207559</a>.</td>
</tr>
<tr class="even">
