---
TOCTitle: 'MS10-027'
Title: 'Microsoft Security Bulletin MS10-027 - Kritisch'
ms:assetid: 'ms10-027'
ms:contentKeyID: 61224640
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-027(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für die Windows Media Player 9-Reihe bei Installation unter allen unterstützten Editionen von Microsoft Windows 2000 und Windows XP als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie das ActiveX-Steuerelement von Windows Media Player speziell gestaltete Medieninhalte verarbeitet, die auf einer schädlichen Website gehostet werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [Windows Media Player 9-Reihe](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043) | Remotecodeausführung           | Kritisch                         | [MS07-047](http://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 2             | [Windows Media Player 9-Reihe](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5) | Remotecodeausführung           | Kritisch                         | [MS07-047](http://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 3             | [Windows Media Player 9-Reihe](http://www.microsoft.com/downloads/details.aspx?displaylang=de&familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721) | Remotecodeausführung           | Kritisch                         | Keine                                                    |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung – CVE-2010-0268</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9-Reihe bei Installation unter Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 9-Reihe unter Windows XP Service Pack 2</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9-Reihe unter Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
...
Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung – CVE-2010-0268  
--------------------------------------------------------------------------------------
  
Im ActiveX-Steuerelement von Windows Media Player liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren oder mit sämtlichen Benutzerrechten Daten anzeigen, ändern oder löschen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0268](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung – CVE-2010-0268
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.  
-   In einem webbasierten Angriffsszenario muss ein Angreifer eine Website mit einer Seite einrichten, die diese Sicherheitsanfälligkeit ausnutzt. Ein Angreifer kann Benutzer nicht zum Besuch einer Website zwingen. Er muss den Benutzer zu einem Besuch dieser Website verleiten. Zu diesem Zweck wird der Benutzer normalerweise aufgefordert, auf einen Link zur Website des Angreifers zu klicken.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung – CVE-2010-0268
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Um zu verhindern, dass das ActiveX-Steuerelement von Windows Media Player in Internet Explorer ausgeführt wird**
  
    Sie können Versuche, eine Instanz des ActiveX-Steuerelements von Windows Media Player in Internet Explorer zu erstellen, deaktivieren, indem Sie das Kill Bit für das Steuerelement in der Registrierung setzen.
    ...
    **Hinweis:** Sie sollten eine Sicherungskopie der Registrierung erstellen, bevor Sie diese bearbeiten.
    ...
    Führen Sie folgende Schritte aus, um das Ausführen des ActiveX-Steuerelements in Internet Explorer zu verhindern:
  
    1.  Speichern Sie Folgendes in einer Datei mit der Erweiterung .REG, z. B. Disable\_WMP.reg:  
        ...
        `"Compatibility Flags"=dword:00000400`  
    2.  Führen Sie mit einer der folgenden Methoden das oben stehende Registrierungsskript auf dem Zielcomputer aus:  
        Für die interaktive Methode doppelklicken Sie als Administrator auf die Datei **Disable\_WMP.reg**.  
        Für die verwaltete Bereitstellungsmethode führen Sie folgenden Befehl aus:  
        `Regedit.exe /s Disable_WMP.reg `  
        Sie können die Registrierungsänderungen mithilfe von Gruppenrichtlinien auch domänenübergreifend installieren. Weitere Informationen zu Gruppenrichtlinien finden Sie auf den folgenden Websites:  
    ...
    **Auswirkung der Problemumgehung:** Benutzer können das ActiveX-Steuerelement von Windows Media Player nicht mehr in Webseiten starten. Demzufolge wird Windows Media Player-Inhalt nicht auf einer Webseite dargestellt.
  
    **So machen Sie die Problemumgehung rückgängig:**
  
    1.  Speichern Sie anschließend Folgendes in einer Datei mit der Erweiterung .REG, z. B. Enable\_WMP.reg:  
        `Windows Registrierungs-Editor Version 5.00 `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
    2.  Führen Sie mit einer der folgenden Methoden das oben stehende Registrierungsskript auf dem Zielcomputer aus:  
        Für die interaktive Methode doppelklicken Sie als Administrator auf die Datei **Enable\_WMP.reg**.  
        Für die verwaltete Bereitstellungsmethode führen Sie folgenden Befehl aus:  
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung – CVE-2010-0268
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann eine Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren oder mit sämtlichen Benutzerrechten Daten anzeigen, ändern oder löschen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit ist vorhanden, weil das ActiveX-Steuerelement von Windows Media Player speziell gestaltete Medieninhalte falsch verarbeitet, die auf einer schädlichen Website gehostet werden.
...
Anweisungen zum Ermitteln der Version von Windows Media Player auf Ihrem System finden Sie im [Microsoft Knowledge Base-Artikel 190990](http://support.microsoft.com/kb/190990).
...
Ein Angreifer kann eine schädliche Website hosten, die speziell gestaltete Medieninhalte hostet, mit denen diese Sicherheitsanfälligkeit durch Internet Explorer ausgenutzt werden kann. Anschließend kann er einen Benutzer dazu verleiten, die Website anzuzeigen und die speziell gestalteten Medieninhalte zu öffnen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Es sind hauptsächlich Systeme gefährdet, auf denen die betroffene Software ausgeführt wird.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie das ActiveX-Steuerelement von Windows Media Player speziell gestaltete Medieninhalte verarbeitet, die auf einer schädlichen Website gehostet werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\$NTUninstallKB979402_WM9L$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/979402">Microsoft Knowledge Base-Artikel 979402</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Unter Windows 2000 Service Pack 2:<br />
WindowsXP-SP2-WindowsMedia-KB979402-x86-ENU /quiet<br />
<br />
Für Windows XP Service Pack 3:<br />
...
<br />
Unter Windows 2000 Service Pack 2:<br />
%Windir%\$NTUninstallKB979402_WM9L$\Spuninst folder<br />
<br />
Für Windows XP Service Pack 3:<br />
%Windir%\$NTUninstallKB979402_WM9$\Spuninst folder</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/979402">Microsoft Knowledge Base-Artikel 979402</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Windows XP Service Pack 2 werden die beiden folgenden Schlüssel erstellt:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\SP0\KB979402_WM9L\Filelist<br />
<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\KB979402_WM9L<br />
<br />
Für Windows XP Service Pack 3 werden die beiden folgenden Schlüssel erstellt:<br />
...
-   Einer Person, die mit [Zero Day Initiative](http://www.zerodayinitiative.com/) von [TippingPoint](http://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung (CVE-2010-0268).
