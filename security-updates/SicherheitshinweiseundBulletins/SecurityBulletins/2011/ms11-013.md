---
TOCTitle: 'MS11-013'
Title: 'Microsoft Security Bulletin MS11-013 - Kritisch'
ms:assetid: 'ms11-013'
ms:contentKeyID: 61224732
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-013(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-013 - Kritisch
===============================================
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=486d1969-6814-4556-8dc0-5bfbaee528b0">Windows XP Service Pack 3</a><br />
(KB2478971)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=8a1e2675-0bf0-4d94-b48a-6e846dd6d9f5">Windows Server 2003 Service Pack 2</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">Erhöhung von Berechtigungen</td>
<td style="border:1px solid black;">Hoch</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=e79bbbd4-8d5a-4c4c-8427-21c14400f041">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">Erhöhung von Berechtigungen</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=856fbcc2-ead9-4ec1-92dd-988e6d22dae9">Windows Server 2003 mit SP2 für Itanium-basierte Systeme</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">Erhöhung von Berechtigungen</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=ffed7c76-0b75-4f57-9b63-3961a8b449f6">Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1</a><br />
(KB2425227)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=c26cebcf-683f-4a51-be75-76535fb979a7">Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=46bb3ef1-24c3-41cb-8141-0fdbd85093f7">Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1</a>*<br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965">Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
**Weshalb wurde dieses Bulletin am 16. März 2011 überarbeitet?**  
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in nicht verschlüsselten Kerberos-Prüfsummen - CVE-2011-0043</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Kerberos bzgl. Spoofing - CVE-2011-0091</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091).
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2478971$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2478971">Microsoft Knowledge Base-Artikel 2478971</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2425227">Microsoft Knowledge Base-Artikel 2425227</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
-   [Das MIT Kerberos Team](http://web.mit.edu/kerberos) für den Hinweis auf die Sicherheitsanfälligkeit in nicht verschlüsselten Kerberos-Prüfsummen (CVE-2011-0043)  
-   Scott Stender von [iSEC Partners](http://www.isecpartners.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Kerberos bzgl. Spoofing (CVE-2011-0091)
