...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Microsoft Forefront Threat Management Gateway 2010 Client](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=d1c85acd-a6df-4634-9cd4-c562ad92097e) | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
<th>Sicherheitsanfälligkeit in TMG-Firewallclient bezüglich Speicherbeschädigung – CVE-2011-1889</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1889](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1889).
...
Weitere Informationen zu Forefront TMG Client finden Sie in dem TechNet-Artikel [Grundlagen zum Firewallclient: Einführung in ISA Server-Firewallclient und Forefront TMG Client](http://technet.microsoft.com/en-us/library/ee291341.aspx).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 2520426](http://support.microsoft.com/kb/2520426).                                                                                                   |  
