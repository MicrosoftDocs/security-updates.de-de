---
TOCTitle: 'MS11-093'
Title: 'Microsoft Security Bulletin MS11-093 - Hoch'
ms:assetid: 'ms11-093'
ms:contentKeyID: 61224812
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-093(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-093 - Hoch
===========================================
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=73531165-f299-4b62-b738-52fca410eaae)                                | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a98bb7cf-9939-4927-8d21-ccb3845e7cb7)       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6b555040-1117-4b06-a48c-02f0e1b686d8)                       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eb17782c-f754-42ab-905b-6f141df008c3)           | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=4cdde8a9-6d44-41fa-82c0-a25404cdfbb5) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in OLE-Eigenschaft – CVE-2011-3400</th>
...
Sicherheitsanfälligkeit in OLE-Eigenschaft – CVE-2011-3400  
----------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-3400](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3400).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in OLE-Eigenschaft – CVE-2011-3400
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in OLE-Eigenschaft – CVE-2011-3400
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in OLE-Eigenschaft – CVE-2011-3400
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2624667$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2624667">Microsoft Knowledge Base-Artikel 2624667</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2624667$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2624667](http://support.microsoft.com/kb/2624667).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Luigi Auriemma](http://aluigi.org/), die mit [VeriSign iDefense Labs](http://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in OLE-Eigenschaft (CVE-2011-3400)
