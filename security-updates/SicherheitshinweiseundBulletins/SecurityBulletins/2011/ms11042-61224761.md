...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                            | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                   | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                   | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                       | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                             | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                        | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                                | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                   | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                         | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                   | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                    | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                  | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
...
Das Distributed File System (DFS) ermöglicht Administratoren, freigegebene Ordner zu gruppieren, die sich auf verschiedenen Servern befinden, indem sie sie transparent mit einem oder mehreren DFS-Namespaces verbinden. Ein DFS-Namespace ist eine virtuelle Ansicht von freigegebenen Ordnern in einem Unternehmen. Mithilfe der DFS-Tools wählt ein Administrator aus, welche freigegebenen Ordner im Namespace präsentiert werden; er entwirft die Hierarchie, in der die Ordner angezeigt werden, und bestimmt die Namen, die die freigegebenen Ordner im Namespace zeigen. Wenn ein Endbenutzer den Namespace anzeigt, erscheint es so, als befänden sich die Ordner auf einer einzelnen Festplatte hoher Kapazität. Endbenutzer können die Ordner im Namespace navigieren, ohne die Servernamen oder freigegebenen Ordner zu kennen, in denen die Daten gehostet werden. Weitere Informationen finden Sie in [DFS: Technische Referenz](http://technet.microsoft.com/de-de/library/cc757042(ws.10).aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2535512">Microsoft Knowledge Base-Artikel 2535512</a>.</td>
</tr>
<tr class="even">
...
-   Laurent Gaffié von [NGS Software](http://www.ngssoftware.com/) für den Hinweis auf die Sicherheitsanfälligkeit in DFS-Verweisantwort (CVE-2011-1869)
