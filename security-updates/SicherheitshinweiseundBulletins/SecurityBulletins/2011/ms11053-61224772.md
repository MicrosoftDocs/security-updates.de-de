...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2566220](http://support.microsoft.com/kb/2566220) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=6bff74ac-45f3-4585-92da-316921b458fa">Windows Vista Service Pack 1</a>[1]<br />
(KB2561109)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=a1e5aa7d-5f38-4ce2-9575-4b4cb7520160">Windows Vista Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=849d2694-c8b3-4670-8203-912661bccabf">Windows Vista x64 Edition Service Pack 1</a>[1]<br />
(KB2561109)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=4287eeb4-ab29-4727-83f2-260d838b44d4">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01">Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
Windows Vista Service Pack 1 ist nur auf Systemen mit Unterstützung für Bluetooth 2.1-Technologie betroffen. Endbenutzer von Windows Vista Service Pack 1, die das [Windows Vista Feature Pack für Wireless](http://support.microsoft.com/kb/942567) installiert haben, haben Unterstützung für Bluetooth 2.1-Technologie und sind deshalb von dieser Sicherheitsanfälligkeit betroffen. Diese Endbenutzer müssen das Sicherheitsupdate KB2561109 installieren. Endbenutzer, die das Windows Vista Feature Pack für Wireless nicht installiert haben, haben keine Unterstützung für Bluetooth 2.1 und sind deshalb nicht von dieser Sicherheitsanfälligkeit betroffen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 2566220](http://support.microsoft.com/kb/2566220).
...
Endbenutzer von Windows Vista Service Pack 1, die das [Windows Vista Feature Pack für Wireless](http://support.microsoft.com/kb/942567) für Windows Vista Service Pack 1 aktiviert haben, und die erfolgreich auf Windows Vista Service Pack 2 aktualisiert haben, müssen das Sicherheitsupdate KB2532531 installieren. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 2566220](http://support.microsoft.com/kb/2566220).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265).
...
**Was ist Bluetooth?**    
Bluetooth ist ein dem Branchenstandard entsprechendes Protokoll, das drahtlose Verbindungen für Computer, Handheld-Geräte, Mobiltelefone und andere Geräte ermöglicht. Weitere Informationen finden Sie in dem MSDN-Artikel [Bluetooth](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx).
...
Ja. Windows Vista und Windows 7 unterstützen eine große Auswahl an Bluetooth-Funkgeräten und installieren den Bluetooth-Treiber, wenn dem System ein austauschbares Bluetooth-Gerät hinzugefügt wird. Deshalb sind alle unterstützten Versionen von Windows Vista und Windows 7 betroffen. Weitere Informationen finden Sie in dem MSDN-Artikel [Bluetooth Wireless-Technologie FAQ – 2010](http://msdn.microsoft.com/en-us/windows/hardware/gg487349.aspx).
...
Siehe <a href="http://support.microsoft.com/kb/2561109">Microsoft Knowledge Base-Artikel 2561109</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Windows Vista Service Pack 2<br />
Siehe <a href="http://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-Artikel 2532531</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-Artikel 2532531</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;"><strong>Hinweis:</strong> Es ist kein Registrierungsschlüssel vorhanden, um die Anwesenheit dieses Updates zu belegen.</td>
