...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Weitere Software</strong></p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a32e78a8-7f20-4dd5-888b-c6de40b1b5ea">Windows Media Center TV Pack für Windows Vista (32-Bit-Editionen)</a>[2]<br />
(2978742)</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1797e7d1-85d1-4e59-8df7-2941db987c84">Windows Media Center TV Pack für Windows Vista (64-Bit-Editionen)</a>[2]<br />
(2978742)</p></td>
<td style="border:1px solid black;"><p>Remotecodeausführung</p></td>
<td style="border:1px solid black;"><p>Kritisch</p></td>
<td style="border:1px solid black;"><p>Keine</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p>Windows 7 für 32-Bit-Systeme Service Pack 1<br />
(nur Starter und Home Basic Edition)</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p>Windows 7 für x64-basierte Systeme Service Pack 1<br />
(nur Starter und Home Basic Edition)</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><p>Windows 8 für 32-Bit-Systeme<br />
(ausgenommen Professional Edition)</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p>Windows 8 für x64-basierte Systeme<br />
(nur Professional Edition ausgenommen)</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p>Windows 8.1 für 32-Bit-Systeme<br />
(ausgenommen Professional Edition)</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p>Windows 8.1 für x64-basierte Systeme<br />
(ausgenommen Professional Edition)</p></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><p>Für Windows Media Center TV Pack für Windows Vista (32-Bit-Editionen):<br />
<strong>MCETVPack-Windows6.0-KB2978742-x86.msu</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Für Windows Media Center TV Pack für Windows Vista (64-Bit-Editionen):<br />
...
<td style="border:1px solid black;"><p>Siehe <a href="https://support.microsoft.com/kb/2978742">Microsoft Knowledge Base-Artikel 2978742</a>.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Dateiname des Sicherheitsupdates</strong></p></td>
<td style="border:1px solid black;"><p>Für Windows Media Center unter allen unterstützten 32-Bit-Editionen von Windows 8:<br />
<strong>Windows8-RT-KB2978742-x86.msu</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Für Windows Media Center unter allen unterstützten x64-basierten Editionen von Windows 8:<br />
<strong>Windows8-RT-KB2978742-x64.msu</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Für Windows Media Center unter allen unterstützten 32-Bit-Editionen von Windows 8.1 Professional:<br />
<strong>Windows8.1-KB2978742-x86.msu</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Für Windows Media Center unter allen unterstützten x64-basierten Editionen von Windows 8.1 Professional:<br />
