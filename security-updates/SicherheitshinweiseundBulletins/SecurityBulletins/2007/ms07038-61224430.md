...
**Bekannte Probleme:** Im [Microsoft Knowledge Base-Artikel 935807](http://support.microsoft.com/kb/935807) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?displaylang=de&amp;familyid=e9b64746-6afa-4a30-833d-e058e000c821)             | Offenlegung von Informationen  | Mittel                           | Keine                                             |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?displaylang=de&amp;familyid=0df5d190-3ad7-42d5-8629-43c47ec450cb) | Offenlegung von Informationen  | Mittel                           | Keine                                             |
...
Microsoft hat dieses Bulletin und die zugehörigen Sicherheitsupdates aktualisiert, um die in [Microsoft Knowledge Base-Artikel 935807](http://support.microsoft.com/kb/935807) beschriebenen Probleme in Zusammenhang mit Windows Vista zu beheben. Diese können einen Fehlschlag bei der Installation der Updates verursachen, wenn der Ordner Protokolldateien\\Firewall fehlt oder beschädigt ist.
...
<th>Sicherheitsanfälligkeit in der Windows Vista Firewall bzgl. Offenlegung von Informationen durch Blockierungsregel – CVE-2007-3038</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-3038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3038).
...
Jim Hoagland und Ollie Whitehouse von [Symantec](http://www.symantec.com/index.jsp) für den Hinweis auf die Sicherheitsanfälligkeit in der Windows Vista Firewall bzgl. Offenlegung von Informationen durch Blockierungsregel – CVE-2007-3038
...
-   V2.0 (14. August 2007): Das Update wurde überarbeitet und erneut veröffentlicht, um die in [Microsoft Knowledge Base-Artikel 935807](http://support.microsoft.com/kb/935807) beschriebenen Probleme zu beheben.
