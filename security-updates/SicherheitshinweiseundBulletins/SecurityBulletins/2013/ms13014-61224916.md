---
TOCTitle: 'MS13-014'
Title: 'Microsoft Security Bulletin MS13-014 - Hoch'
ms:assetid: 'ms13-014'
ms:contentKeyID: 61224916
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms13-014(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-014 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der NFS-Server einen Dateivorgang verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2790978](https://support.microsoft.com/kb/2790978).
...
<th colspan="2">
Sicherheitsanfälligkeit durch NULL-Dereferenzierung – CVE-2013-1281
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch NULL-Dereferenzierung – CVE-2013-1281

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer muss Zugriff auf die Dateifreigabe haben, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht von anonymen Benutzern ausgenutzt werden.
-   Diese Sicherheitsanfälligkeit betrifft nur Windows-Server, auf denen die NFS-Rolle aktiviert ist.

#### Problemumgehungen für die Sicherheitsanfälligkeit durch NULL-Dereferenzierung – CVE-2013-1281

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch NULL-Dereferenzierung – CVE-2013-1281

**Worin genau besteht diese Sicherheitsanfälligkeit?**
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**
Diese Sicherheitsanfälligkeit wird verursacht, wenn der Microsoft NFS-Server einen Dateivorgang nicht richtig verarbeitet.

**Was ist** **NFS?**
Network File System (NFS) ist ein Protokoll nach Branchenstandard, das in [RFC 1094](http://www.ietf.org/rfc/rfc1094.txt?number=1094) definiert ist und transparenten Remotezugriff auf freigegebene Dateien über Netzwerke bereitstellt. Die Dienste für das Network File System (NFS) stellen eine Dateifreigabelösung für Unternehmen bereit, die über eine gemischte Windows- und UNIX-Umgebung verfügen. Durch die Dienste für NFS können Benutzer mithilfe des NFS-Protokolls Dateien zwischen Computern übertragen, auf denen das Windows-Betriebssystem ausgeführt wird bzw. die auf UNIX basieren.

**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**
Ein Angreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann bewirken, dass das betroffene System nicht mehr reagiert und dann neu startet.

**Wie gehen Angreifer vor, um diese** **Sicherheitsanfälligkeit** **auszunutzen?**
Ein Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er versucht, auf einer schreibgeschützten Freigabe eine Datei oder einen Ordner umzubenennen.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**
Server, auf denen die Rolle „NFS-Server“ aktiviert ist, sind durch diese Sicherheitsanfälligkeit gefährdet.

**Was bewirkt das Update?**
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der NFS-Server einen Dateivorgang verarbeitet.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2790978">Microsoft Knowledge Base-Artikel 2790978</a>.</td>
</tr>
<tr class="odd">
