---
TOCTitle: 'MS13-018'
Title: 'Microsoft Security Bulletin MS13-018 - Hoch'
ms:assetid: 'ms13-018'
ms:contentKeyID: 61224920
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms13-018(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-018 - Hoch
===========================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Server 2008, Windows Server 2008 R2 und Windows Server 2012 als Hoch eingestuft; für alle unterstützten Editionen von Windows Vista, Windows 7, Windows 8 und Windows RT wird es als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows TCP/IP-Stapel Sequenzen zum Beenden von Verbindungen verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2790655](http://support.microsoft.com/kb/2790655) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2688338 in [MS12-032](http://technet.microsoft.com/de-de/security/bulletin/ms12-032)
</td>
</tr>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2790655](https://support.microsoft.com/kb/2790655).
...
<th>
Sicherheitsanfälligkeit in TCP-FIN-Wartezeit – CVE-2013-0075
</th>
<th>
Bewertung des Gesamtschweregrads
</th>
...
<span></span>
Im Windows TCP/IP-Stapel liegt eine Sicherheitsanfälligkeit bezüglich Denial-of-Service vor, die bewirken kann, dass das Zielsystem nicht mehr reagiert und automatisch neu startet. Die Sicherheitsanfälligkeit dadurch verursacht, dass der TCP/IP-Stapel eine Sequenz zum Beenden einer Verbindung falsch verarbeitet.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in TCP-FIN-Wartezeit – CVE-2013-0075

Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.

#### Problemumgehungen für die Sicherheitsanfälligkeit in TCP-FIN-Wartezeit – CVE-2013-0075

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in TCP-FIN-Wartezeit – CVE-2013-0075

**Worin genau besteht diese Sicherheitsanfälligkeit?**
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**
Die Sicherheitsanfälligkeit dadurch verursacht, dass der Windows TCP/IP-Stapel eine Sequenz zum Beenden einer Verbindung falsch verarbeitet.
...
Ein nicht authentifizierter Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er ein speziell gestaltetes Paket zum Beenden der Verbindung an den Server sendet.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**
Server sind hauptsächlich durch diese Sicherheitsanfälligkeit gefährdet.

**Was bewirkt das Update?**
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows TCP/IP-Stapel Sequenzen zum Beenden von Verbindungen verarbeitet.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2790655">Microsoft Knowledge Base-Artikel 2790655</a>.</td>
</tr>
<tr class="odd">
...
| **Dateiinformationen**                   | Siehe [Microsoft Knowledge Base-Artikel 2790655](http://support.microsoft.com/kb/2790655).                                                                                                                                         |
...
-   V1.1 (12. Februar 2013): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2790655 hinzugefügt.
