...
<p>Grundlegendes Installationsbeispiel:<br />
SQLWMSDE-KB960082-x86-ENU.exe SAPWD=”(Administratorkennwort)” INSTANCENAME=UDDI</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installieren ohne neu zu starten</td>
<td style="border:1px solid black;">Für alle unterstützten 32-Bit Editionen von Microsoft SQL Server 2000 Desktop Engine (WMSDE):<br />
...
<p><strong>Hinweis:</strong> Es ist weder ein Installationsassistent noch ein -dialogfeld verfügbar.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Neustartanforderung</strong></td>
<td style="border:1px solid black;"></td>
...
<p><strong>Hinweis:</strong> Durch das Entfernen dieses Sicherheitsupdates für WMSDE wird die Instanz von WMSDE ebenfalls vollständig vom System entfernt.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/959420">Microsoft Knowledge Base-Artikel 959420</a>.</td>
...
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung.
<p><strong>Hinweis:</strong> Durch das Entfernen dieses Sicherheitsupdates für WYukon wird die Instanz von WYukon ebenfalls vollständig vom System entfernt. WYukon wird in <strong>Software</strong> als „Windows Internal Database“ angezeigt.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/959420">Microsoft Knowledge Base-Artikel 959420</a>.</td>
