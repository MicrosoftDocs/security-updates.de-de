...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 955218](http://support.microsoft.com/kb/955218) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
[MS07-042](http://go.microsoft.com/fwlink/?linkid=88350&clcid=0x407)
</td>
</tr>
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 955218](http://support.microsoft.com/kb/955218).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-0099](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0099).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2007-0099](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0099) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4029).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4033](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4033).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/955218">Microsoft Knowledge Base-Artikel 955218</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/954430">Microsoft Knowledge Base-Artikel 954430</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<p>Weitere Informationen zu Funktionen, die Sie selektiv installieren können, finden Sie im Unterbereich <strong>Office-Funktionen</strong> in diesem Abschnitt.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Neustartanforderung:</strong></td>
<td style="border:1px solid black;"></td>
...
-   Stefano Di Paola von [Minded Security](http://www.mindedsecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in MSXML bezüglich Headeranforderung (CVE-2008-4033).  
-   Robert Hansen von [SecTheory](http://www.sectheory.com/) für den Hinweis auf das zusätzliche Tiefenverteidigungsproblem bezüglich nur-HTTP.
