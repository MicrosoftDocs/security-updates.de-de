...
-   Microsoft Office 2000 Service Pack 3 – [Update herunterladen (KB923093)](http://www.microsoft.com/downloads/details.aspx?familyid=14a61fda-bfe2-47ca-8313-40b772359994&amp;displaylang=de)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 – [Update herunterladen (KB923092)](http://www.microsoft.com/downloads/details.aspx?familyid=0fbd66fb-28bb-4587-9425-ad4a3f10651d&amp;displaylang=de)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 oder Service Pack 2 – [Update herunterladen (KB923091)](http://www.microsoft.com/downloads/details.aspx?familyid=d0e30f77-b48f-4b8b-a6fa-105a354b1a4e&amp;displaylang=de)
    -   Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 für Mac
    -   Microsoft PowerPoint 2004 für Mac – [Update herunterladen (KB924999)](http://www.microsoft.com/mac/)
-   Microsoft Office X für Mac
    -   Microsoft PowerPoint X für Mac – [Update herunterladen (KB924998)](http://www.microsoft.com/mac/)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------------|----------------------------------|-------------------------------------------------------------|
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – [CVE-2006- 3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435)                         | Remotecodeausführung                   | Keine                     | Keine                     | Hoch                             | Keine                                                       |
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876)                            | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                             | Hoch                                                        |
...
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-4694](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4694)                            | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                             | Hoch                                                        |
...
|---------------------------------------------------------------------------------------------|---------------------------|---------------------------|----------------------------------|-------------------------------------------------------------|
| [**MS06-028**](http://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-028.mspx) | Ersetzt                   | Ersetzt                   | Ersetzt                          | Ersetzt                                                     |
...
1.  [Laden Sie dieses Sicherheitsupdate für PowerPoint 2000 herunter](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
1.  [Laden Sie dieses Sicherheitsupdate für](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe) PowerPoint 2002 herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie dieses Sicherheitsupdate für PowerPoint 2002 herunter](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält. Klicken Sie auf **Start** und danach auf **Ausführen**, geben Sie den folgenden Befehl zum Extrahieren der MSP-Datei ein, und klicken Sie danach auf **OK**:
    **\[Pfad\\Name der EXE-Datei\] /c /t:C:\\AdminUpdate**
...
1.  [Laden Sie das Sicherheitsupdate](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) für PowerPoint 2003 herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie das Sicherheitsupdate für PowerPoint 2003 herunter.](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält. Klicken Sie auf **Start** und danach auf **Ausführen**, geben Sie den folgenden Befehl zum Extrahieren der MSP-Datei ein, und klicken Sie danach auf **OK**:
    **\[Pfad\\Name der EXE-Datei\] /c /t:C:\\AdminUpdate**
...
-   Arnaud Dovi in Zusammenarbeit mit [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) und [TippingPoint](http://tippingpoint.com) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – [CVE-2006- 3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435).
-   Dejun Meng von [Fortinet Inc.](http://www.fortinet.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876).
-   Chris Ries von [VigilantMinds Inc.](http://www.vigilantminds.com) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint durch Speicherbeschädigung aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877).
