...
Sicherheitsanfälligkeit durch Pufferüberlauf im DHCP-Client-Dienst – [CVE-2006-2372](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2372)
</td>
...
* Fordern Sie von Ihrem Netzwerkadministrator eine statische IP-Adresse an.
* Klicken Sie auf **Start**, **Systemsteuerung** und anschließend auf **Netzwerk- und Internetverbindungen.**  
* Klicken Sie mit der rechten Maustaste auf die Verbindung, für die eine statische IP-Adresse verwendet werden soll, und klicken Sie dann auf **Eigenschaften.**  
* Wählen Sie **Internetprotokoll (TCP/IP)** aus, und klicken Sie auf **Eigenschaften.**  
* Klicken Sie auf der Registerkarte **Allgemein** auf die Optionsfelder **Folgende IP-Adresse verwenden** und **Folgende DNS-Serveradressen verwenden.**  
* Geben Sie die statische IP-Adresse, die Subnetzmaske, das Standardgateway und die DNS-Server ein.
* Klicken Sie zweimal auf **OK.**  
* Wiederholen Sie die Schritte 3 bis 7 für jeden einzelnen Netzwerkadapter.
...
* Doppelklicken Sie auf **DHCP-Client.**  
