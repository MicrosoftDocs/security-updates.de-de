...
<td style="border:1px solid black;">
KB2709162 in [MS12-041](http://go.microsoft.com/fwlink/?linkid=251707) wird durch KB2718523 ersetzt
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2718523](http://support.microsoft.com/kb/2718523).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2718523">Microsoft Knowledge Base-Artikel 2718523</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2718523](http://support.microsoft.com/kb/2718523).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Nicolas Economou von [Core Security Technologies](http://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Tastaturlayout (CVE-2012-1890).  
-   [Qihoo 360 Security Center](http://www.360.cn/) für den Hinweis auf die Sicherheitsanfälligkeit im Tastaturlayout (CVE-2012-1890).  
-   Lufeng Li von Neusoft Corporation in Zusammenarbeit mit [Secunia Research](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung (CVE-2012-1893).
