...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2722913](http://support.microsoft.com/kb/2722913) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2699988 in [MS12-037](http://go.microsoft.com/fwlink/?linkid=249045) wird durch KB2722913 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2719177 in [MS12-044](http://go.microsoft.com/fwlink/?linkid=254377) wird durch KB2722913 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2722913](http://support.microsoft.com/kb/2722913).
...
Die in diesem Bulletin beschriebene Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript (CVE-2012-2523) wird auch von [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) behoben.

Benutzer, die Internet Explorer 8 auf ihren Systemen installiert haben, müssen das in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 installieren, um vor der in CVE-2012-2523 beschriebenen Sicherheitsanfälligkeit geschützt zu sein.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1526](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2521](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2522](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523).
...
**Hinweis:** Dieses Update behebt diese Sicherheitsanfälligkeit nicht für Internet Explorer 8. Für Internet Explorer 8 ist das in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 verfügbar.

**Internet Explorer 8 ist auf meinem System installiert. Wo finde ich das Update, mit dem CVE-2012-2523 behoben wird?**
Benutzer, die Internet Explorer 8 auf ihren Systemen installiert haben, können die in CVE-2012-2523 beschriebene Sicherheitsanfälligkeit beheben, indem Sie das in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 installieren.
...
<p>Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\$NTUninstallKB2722913$\Spuninst.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 für alle unterstützten Editionen von Windows XP:<br />
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2722913">Microsoft Knowledge Base-Artikel 2722913</a>.</td>
</tr>
<tr class="even">
...
-   GWSlabs in Zusammenarbeit mit [VeriSign iDefense Labs](http://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout (CVE-2012-1526).  
-   Derek Soeder in Zusammenarbeit mit dem Programm [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt (CVE-2012-2521).  
-   Sung-ting Tsai und Ming-Chieh Pan von [Trend Micro](http://www.trendmicro.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle (CVE-2012-2522).  
-   Cris Neckar vom [Google's Chrome Security Team](http://chrome.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript (CVE-2012-2523).
