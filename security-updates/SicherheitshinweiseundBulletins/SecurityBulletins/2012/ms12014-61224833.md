...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2661637](http://support.microsoft.com/kb/2661637) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|----------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).
...
Mit dem Indeo-Codec werden digitale Mediendateien zur Verwendung in Anwendungen wie Windows Media Player dekomprimiert. Weitere Informationen zu Codecs finden Sie unter [Codecs: Häufig gestellte Fragen (FAQs)](http://windows.microsoft.com/en-us/windows7/codecs-frequently-asked-questions).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2661637">Microsoft Knowledge Base-Artikel 2661637</a>.</td>
</tr>
<tr class="even">
