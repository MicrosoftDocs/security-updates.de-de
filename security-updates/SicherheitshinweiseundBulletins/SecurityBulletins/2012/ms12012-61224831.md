...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f6f89b3-3bc8-4325-b8d8-9a5a398b99c6)\*\*                                                                  | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=35e6bd04-594f-42ef-97f8-abcf578b4f10)\*\*                                                            | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d1d51b26-2d01-42a9-9bb1-9fb82c1fb914)                                                            | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c51e09b-51c3-4860-836e-6bcffde75f04)\*\*     | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fba58a1b-9d9f-4a10-b1df-08a0ebfa2358) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082).
...
-   **Installieren von Desktopdarstellung unter Windows Server 2008 und Windows Server 2008 R2**
    ...
    Weitere Informationen einschließlich Anweisungen zum Installieren und Entfernen der Desktopdarstellung finden Sie im TechNet-Artikel [Desktopdarstellung: Überblick](http://technet.microsoft.com/de-de/library/cc772567.aspx).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2643719">Microsoft Knowledge Base-Artikel 2643719</a>.</td>
</tr>
<tr class="odd">
