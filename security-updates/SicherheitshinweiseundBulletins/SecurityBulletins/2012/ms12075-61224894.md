---
TOCTitle: 'MS12-075'
Title: 'Microsoft Security Bulletin MS12-075 - Kritisch'
ms:assetid: 'ms12-075'
ms:contentKeyID: 61224894
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-075(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 13. November 2012 | Aktualisiert: Dienstag, 13. November 2012
...
<td style="border:1px solid black;">
KB2731847 in [MS12-055](http://go.microsoft.com/fwlink/?linkid=257907) wird ersetzt durch KB2761226
</td>
</tr>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2761226](https://support.microsoft.com/kb/2761226).
...
Ja. Das Update KB2761226 ist für Windows 8 Release Preview und Windows Server 2012 Release Candidate verfügbar. Benutzer mit Windows 8 Release Preview und Windows Server 2012 Release Candidate sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](http://update.microsoft.com/windowsupdate/) verfügbar.
...
<th>
Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2530
</th>
<th>
Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2553
</th>
<th>
Sicherheitsanfälligkeit in Windows bei Schriftartanalyse – CVE-2012-2897
</th>
<th>
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530).

#### Schadensbegrenzende Faktoren für die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2530
...
#### Problemumgehungen für die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2530

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2530
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553).

#### Schadensbegrenzende Faktoren für die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2553

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2553

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung – CVE-2012-2553
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Windows bei Schriftartanalyse – CVE-2012-2897
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Windows bei Schriftartanalyse – CVE-2012-2897

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Windows bei Schriftartanalyse – CVE-2012-2897

**Worin genau besteht diese Sicherheitsanfälligkeit?**
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**
Die Sicherheitsanfälligkeit wird verursacht, wenn Windows speziell gestaltete TrueType-Schriftarten (TTF) nicht richtig verarbeitet.
...
**Was bewirkt das Update?**
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows TrueType-Schriftartendateien verarbeitet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe in den folgenden Ordnern: %Windir%\$NTUninstallKB2761226$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2761226">Microsoft Knowledge Base-Artikel 2761226</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe in den folgenden Ordnern: %Windir%\\$NTUninstallKB2761226$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2761226](http://support.microsoft.com/kb/2761226).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **Dateiinformationen:**                  | Siehe [Microsoft Knowledge Base-Artikel 2761226](http://support.microsoft.com/kb/2761226).                                                                                                                                                  |
...
-   Matthew Jurczyk von [Google Inc](http://www.google.de) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Windows Kernel win32k.sys (CVE-2012-2553).  
-   Eetu Luodemaa und Joni Vähämäki von [Documill](http://www.documill.com) in Zusammenarbeit mit dem Chromium Security Rewards Program für den Hinweis auf die Sicherheitsanfälligkeit durch TrueType-Schriftartanalyse (CVE-2012-2897).
...
-   V1.1 (13. November 2012): Der Titel der Sicherheitsanfälligkeit sowie die Einträge in den Häufig gestellten Fragen für CVE-2012-2897 wurden korrigiert. Dies ist lediglich eine Informationsänderung.
