...
Windows Technical Preview und Windows Server Technical Preview sind betroffen. Benutzern, die diese Betriebssysteme verwenden, wird empfohlen, das Update über [Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=de-de) zu installieren.
