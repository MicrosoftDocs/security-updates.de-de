...
Nicht definiert (standardmäßig kein Registrierungswert vorhanden)
...
Interaktive Anmeldung: Domänencontrollerauthentifizierung zum Aufheben der Sperrung der Arbeitsstation erforderlich (Desktopcomputer)
...
Interaktive Anmeldung: Domänencontrollerauthentifizierung zum Aufheben der Sperrung der Arbeitsstation erforderlich (Laptopcomputer)
...
Multicast, Broadcast und ISAKMP sind ausgenommen (beste Einstellung für Windows XP)
...
IPSec wird zunehmend für die grundlegende Hostfirewall-Paketfilterung verwendet, insbesondere in Szenarien mit einer Gefährdung durch Internetverbindungen. Die Auswirkungen dieser Standardausnahmen werden jedoch nicht immer richtig verstanden. Einige IPSec-Administratoren erstellen daher u. U. vermeintlich sichere IPSec-Richtlinien, die jedoch nicht vor eingehenden Angriffen schützen, bei denen die Standardausnahmen verwendet werden. Microsoft empfiehlt, für die beiden in diesem Handbuch behandelten Umgebungen die Standardeinstellung in Windows XP mit SP2, **Multicast****,****Broadcast****und ISAKMP sind ausgenommen**, zu verwenden.
...
NTLMv2-Sitzungssicherheit erfordern, 128-Bit-Verschlüsselung erfordern
...
Herunterfahren: Auslagerungsdatei des virtuellen Arbeitsspeichers löschen (Desktopcomputer)
...
Herunterfahren: Auslagerungsdatei des virtuellen Arbeitsspeichers löschen (Laptopcomputer)
...
Nicht zutreffend (Standard = Bei Bedarf überschreiben)
...
Internetzone\Auf Datenquellen über Domänengrenzen hinweg zugreifen
...
Internetzone\Ziehen und Ablegen oder Kopieren und Einfügen von Dateien zulassen
...
Internetzone\Schriftartdownloads zulassen
...
Internetzone\Installation von Desktopelementen zulassen
...
Internetzone\Allow cut, copy, or paste operations from the clipboard via script (Von Skripts durchgeführtes Ausschneiden, Kopieren oder Einfügen aus der Zwischenablage zulassen)
...
Internetzone\Skript initiierte Fenster ohne Größen- bzw. Positionseinschränkungen zulassen
...
§ Internetzone\Statuszeilenaktualisierung über Skript zulassen
...
Internetzone\Automatische Eingabeaufforderung für Dateidownloads
...
Internetzone\Download von signierten ActiveX-Steuerelementen
...
Internetzone\Download von unsignierten ActiveX-Steuerelementen
...
Internetzone\ActiveX-Steuerelemente initialisieren und ausführen, die nicht sicher sind
...
Internetzone\Java-Einstellungen
...
Internetzone\Programme und Dateien in einem IFRAME starten
...
Aktiviert:Nach Benutzername und Kennwort fragen
...
Internetzone\Subframes zwischen verschiedenen Domänen bewegen
...
Internetzone\Dateien basierend auf dem Inhalt und nicht der Dateierweiterung öffnen
...
Internetzone\Zugriffsrechte für Softwarechannel
...
Internetzone\Popupblocker verwenden
...
Internetzone\Websites, die sich in Webinhaltzonen niedriger Berechtigung befinden, können in diese Zone navigieren
...
Zone eingeschränkter Sites\Auf Datenquellen über Domänengrenzen hinweg zugreifen
...
Zone eingeschränkter Sites\Active Scripting zulassen
...
Zone eingeschränkter Sites\Binär- und Skriptverhalten zulassen
...
Zone eingeschränkter Sites\Allow cut, copy, or paste operations from the clipboard via script (Von Skripts durchgeführtes Ausschneiden, Kopieren oder Einfügen aus der Zwischenablage zulassen)
...
Zone eingeschränkter Sites\Ziehen und Ablegen oder Kopieren und Einfügen von Dateien zulassen
...
Zone eingeschränkter Sites\Dateidownloads zulassen
...
Zone eingeschränkter Sites\Schriftartdownloads zulassen
...
Zone eingeschränkter Sites\Installation von Desktopelementen zulassen
...
Zone eingeschränkter Sites\META REFRESH zulassen
...
Zone eingeschränkter Sites\Skript initiierte Fenster ohne Größen- bzw. Positionseinschränkungen zulassen
...
§ Zone eingeschränkter Sites\Statuszeilenaktualisierung über Skript zulassen
...
Zone eingeschränkter Sites\Automatische Eingabeaufforderung für Dateidownloads
...
Zone eingeschränkter Sites\Download von signierten ActiveX-Steuerelementen
...
Zone eingeschränkter Sites\Download von unsignierten ActiveX-Steuerelementen
...
Zone eingeschränkter Sites\ActiveX-Steuerelemente initialisieren und ausführen, die nicht sicher sind
...
Zone eingeschränkter Sites\Java-Einstellungen
...
Zone eingeschränkter Sites\Programme und Dateien in einem IFRAME starten
...
Zone eingeschränkter Sites\Anmeldeoptionen
...
Zone eingeschränkter Sites\Subframes zwischen verschiedenen Domänen bewegen
...
Zone eingeschränkter Sites\Dateien basierend auf dem Inhalt und nicht der Dateierweiterung öffnen
...
Zone eingeschränkter Sites\Nicht mit Authenticode signierte Komponenten ausführen, die.NET Framework erfordern
...
Zone eingeschränkter Sites\Mit Authenticode signierte Komponenten ausführen, die.NET Framework erfordern
...
Zone eingeschränkter Sites\ActiveX-Steuerelemente und Plug-Ins ausführen
...
Zone eingeschränkter Sites\ActiveX-Steuerelemente ausführen, die für Scripting sicher sind
...
Zone eingeschränkter Sites\Scripting von Java-Applets
...
Zone eingeschränkter Sites\Zugriffsrechte für Softwarechannel
...
Zone eingeschränkter Sites\Popupblocker verwenden
...
Zone eingeschränkter Sites\Websites, die sich in Webinhaltzonen niedriger Berechtigung befinden, können in diese Zone navigieren
...
Die Einstellung **Dateien basierend auf dem Inhalt****und nicht der Dateierweiterung öffnen** ist für die Hochsicherheitsumgebung auf **Aktiviert:Deaktivieren** und für die Unternehmensclient-Umgebung auf **Nicht konfiguriert** gesetzt. Dies gilt für die **Internetzone** ebenso wie für die **Zone eingeschränkter Sites.**  
...
[![](https://technet.microsoft.com/de-de/Dd443743.pageLeft(de-de,TechNet.10).gif "Dd443743.pageLeft(de-de,TechNet.10).gif")](http://www.microsoft.com/germany/technet/prodtechnol/windowsvista/secprot/sicherheitshandbuch/specialized_security.mspx)
7 von 7
</td>
