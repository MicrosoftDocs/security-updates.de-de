...
* Stellen Sie sicher, dass die ermittelten Serverrollen auf Ihre Umgebung zutreffen, wie z. B. die Rollen der DHCP-Server und WINS-Server.
...
* Schließen Sie die entsprechende Sicherheitsvorlage mit ein (z. B. „Unternehmensclient - Infrastrukturserver.inf“).

* Speichern Sie die Richtlinie unter einem geeigneten Namen (z. B. Infrastrukturserver.xml).
...
<CodeSnippet Language="" ContainsMarkup="false" DisplayLanguage="">scwcmd transform /p:"C:\Windows\Security\msscw\Policies\Infrastructure.xml"/g:"Infrastructure Policy"</CodeSnippet>  
