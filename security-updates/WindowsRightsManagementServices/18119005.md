...
Vor der Bereitstellung müssen Sie den RMS-Client unter [https://go.microsoft.com/fwlink/?linkId=67736](https://go.microsoft.com/fwlink/?linkid=67736) downloaden.
...
Wenn Sie ein Programm mit der Gruppenrichtlinie verteilen, können Sie das Programm den gewünschten Computern zuweisen. Das Programm wird installiert, sobald der Computer gestartet wird, und steht für alle Benutzer zur Verfügung, die sich beim Computer anmelden. Weitere Informationen zur Gruppenrichtlinie erhalten Sie unter „Entwerfen einer Gruppenrichtlinieninfrastruktur“ (<https://go.microsoft.com/fwlink/?linkid=24328>). Bei diesem Verfahren wird vorausgesetzt, dass Sie die GPMC (Group Policy Management Console, Gruppenrichtlinien-Verwaltungskonsole) verwenden. Um GPMC zu downloaden, informieren Sie sich im Abschnitt zur GPMC mit Service Pack 1 (<https://go.microsoft.com/fwlink/?linkid=21813>).
