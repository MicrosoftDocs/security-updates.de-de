...
-   Microsoft Windows XP und Microsoft Windows XP Service Pack 1 – [Update downloaden](https://www.microsoft.com/download/details.aspx?familyid=6b70ba00-56d1-4314-8f53-f8355a6861d3&displaylang=de).
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 – [Update downloaden](https://www.microsoft.com/download/details.aspx?familyid=3f6896f3-f055-438d-93ce-cd15f37264cb&displaylang=en).
-   Microsoft Windows XP 64-Bit Edition Version 2003 – [Update downloaden](https://www.microsoft.com/download/details.aspx?familyid=4b63ef24-d0e4-4005-8e23-2f5ec24be63f&displaylang=de).
-   Microsoft Windows Server 2003 – [Update downloaden](https://www.microsoft.com/download/details.aspx?familyid=0903569e-7f3d-4846-a1dc-78734e77d3a9&displaylang=de)
-   Microsoft Windows Server 2003 64-Bit Edition – [Update downloaden](https://www.microsoft.com/download/details.aspx?familyid=4b63ef24-d0e4-4005-8e23-2f5ec24be63f&displaylang=de).
...
|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|-----------------------|
| Sicherheitsanfälligkeit in komprimierten Ordnern (ZIP) – [CAN-2004-0575](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0575) | Codeausführung von Remotestandorten aus | Kritisch     | Kritisch              |
...
|------------------------------------------------------------|------------|-----------------------|
| [**MS02-054**](https://go.microsoft.com/fwlink?linkid=8139) | Ersetzt    | Nicht anwendbar       |
...
-   **Installieren Sie das** [**Outlook-E-Mail-Sicherheitsupdate**,](https://go.microsoft.com/fwlink/?linkid=33334) **wenn Sie Outlook 2000 SP1 oder eine frühere Version verwenden, um sich vor Angriffen über HTML-E-Mail-Nachrichten zu schützen.**
...
Wenn das Laufwerk mit NTFS formatiert ist, bietet Windows außerdem eine andere Möglichkeit zum Komprimieren von Ordnern: die [NTFS-Dateikomprimierung](https://support.microsoft.com/default.aspx?scid=kb;en-us;307987). Die NTFS-Dateikomprimierung unterscheidet sich allerdings erheblich von der Komprimierung von Dateien als komprimierte Ordner (ZIP).
...
**Voraussetzungen**
Dieses Sicherheitsupdate erfordert eine veröffentlichte Version von Windows XP oder Windows XP Service Pack 1 (SP1). Weitere Informationen finden Sie im Microsoft Knowledge Base-Artikel [322389](https://support.microsoft.com/default.aspx?scid=kb;en-us;322389).
...
-   [eEye Digital Security](https://www.eeye.com/html/) für den Hinweis auf die Sicherheitsanfälligkeit in komprimierten Ordnern (ZIP) (CAN-2004-0575)
...
-   Das [Microsoft Security Portal](https://go.microsoft.com/fwlink/?linkid=21132) bietet weitere Informationen zur Sicherheit von Microsoft-Produkten.
-   [Microsoft Software Update Services: /germany/technet/datenbank/overview.asp?siteid=600220](https://go.microsoft.com/fwlink/?linkid=21133)
-   Microsoft Baseline Security Analyzer (MBSA): [/germany/ms/technetdatenbank/ showArticle.asp?siteid=600189](https://go.microsoft.com/fwlink/?linkid=21134). Unter https://support.microsoft.com/default.aspx?scid=kb;DE;306460 steht Ihnen eine Liste mit Sicherheitspatches zur Verfügung, die mit dem MBSA nur eingeschränkt überprüft werden können.
-   [Windows Update: https://windowsupdate.microsoft.com](https://go.microsoft.com/fwlink/?linkid=21130)
-   [Windows Update:](https://support.microsoft.com/default.aspx?scid=kb;en-us;323166)https://v4.windowsupdate.microsoft.com/de/default.asp
