...
**Bekannte Probleme.**  Im [Microsoft Knowledge Base-Artikel 961501](https://support.microsoft.com/kb/961501) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=86378753-db24-44c2-a27d-cc0239f40ab8)                                                                                | Remotecodeausführung           | Kritisch                         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0228](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0228).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0229](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0229).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0230).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 961501](https://support.microsoft.com/kb/961501).                                                               |  
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/961501">Microsoft Knowledge Base-Artikel 961501</a>.</td>
</tr>
<tr class="even">
...
-   Jun Mao von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Pufferüberlaufs in der Druckwarteschlange (CVE-2009-0228)
