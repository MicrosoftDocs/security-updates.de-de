...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 977981](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/977981.mspx) beschrieben wurde.
...
Ja. Dieses Sicherheitsupdate (976325) beinhaltet die in [Microsoft Knowledge Base-Artikel 976749](https://support.microsoft.com/kb/976749) beschriebene Problembehebung, mit der bekannte Probleme mit dem Sicherheitsupdate 974455 im Microsoft Security Bulletin [MS09-054](https://go.microsoft.com/fwlink/?linkid=163979) behoben werden.

**In welcher Beziehung steht dieses Security Bulletin zu dem in MS09-035 beschriebenen ATL-Problem?**  
Im Microsoft Security Bulletin [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) werden Sicherheitsanfälligkeiten in denjenigen Komponenten und Steuerelementen beschrieben, die unter Verwendung anfälliger öffentlicher Versionen der Active Template Library (ATL) entwickelt wurden. Dieses Sicherheitsupdate (976325) hilft, bekannte Angriffsmethoden in Internet Explorer für jene Komponenten und Steuerelemente abzuschwächen, die mit den in der [Microsoft-Sicherheitsempfehlung 973882](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/973882.mspx) und in MS09-035 beschriebenen Versionen von ATL entwickelt wurden. Weitere Informationen dazu finden Sie auch in der Sicherheitsanfälligkeit bezüglich der COM-Initialisierung in ATL, [CVE-2009-2493](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493), im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
In der [Microsoft-Sicherheitsempfehlung 973882](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/973882.mspx) werden Sicherheitsanfälligkeiten in öffentlichen und privaten Versionen der Active Template Library (ATL) beschrieben. Dieses Sicherheitsupdate (976325) aktualisiert ein Steuerelement, das mit den in der Microsoft-Sicherheitsempfehlung 973882 und in [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) beschriebenen ATL-Versionen entwickelt wurde. Weitere Informationen finden Sie auch in der Sicherheitsanfälligkeit bezüglich der COM-Initialisierung in ATL, [CVE-2009-2493](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493), im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
Weitere Informationen zu Sicherheitsanfälligkeiten in Active Template Library (ATL) finden Sie in der [Microsoft-Sicherheitsempfehlung 973882](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/973882.mspx).
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 976325](https://support.microsoft.com/kb/976325).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2493](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3671).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3672](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672).
...
-   **Aktivieren Sie DEP für Internet Explorer 6 oder Internet Explorer 7 mithilfe der automatisierten Microsoft Fix it-Lösung**
    ...
    Im [Microsoft Knowledge Base-Artikel 976325](https://support.microsoft.com/kb/976325) finden Sie Informationen zur Aktivierung und Deaktivierung dieser Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung.
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-3672](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3673](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3673).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3674](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3674).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/976325">Microsoft Knowledge Base-Artikel 976325</a>.</td>
</tr>
<tr class="even">
...
-   Ryan Smith von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich der COM-Initialisierung in ATL (CVE-2009-2493).  
-   Sam Thomas (https://eshu.co.uk/) in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-3671).  
-   [team509](https://www.team509.com/) in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Objekten (CVE-2009-3672).  
-   Einer Person, die mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-3673).  
-   Einer Person, die mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-3674).
