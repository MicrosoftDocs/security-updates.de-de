...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 969693](https://support.microsoft.com/kb/969693) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=d4b0665d-5744-49c7-a3c0-f231fd08d3b8">Microsoft Office Publisher 2007 Service Pack 1</a><br />
(KB969693)</td>
...
Im [Microsoft Knowledge Base-Artikel 969693](https://support.microsoft.com/kb/969693) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
  
**Enthält dieses Update zusätzliche sicherheitsbezogene oder nicht sicherheitsbezogene Änderungen?**    
Ja, als Bestandteil des Wartungsmodells für Microsoft Office 2007. Wenn Benutzer von Microsoft Office 2007 Service Pack 1 dieses Update installieren, werden ihre Systeme mit Sicherheitsfunktionen aktualisiert, die ursprünglich mit [Microsoft Office 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b444bf18-79ea-46c6-8a81-9db49b4ab6e5&displaylang=en) veröffentlicht wurden. Alle Updates, die nach Februar 2009 veröffentlicht wurden, enthalten die Updates, die in [Microsoft Knowledge Base-Artikel 953195](https://support.microsoft.com/kb/953195) „Überblick über Service Pack 2-Verbesserungen“ aufgeführt werden. Wir haben dieses Update eingehend getestet, doch wie bei allen Updates empfehlen wir den Benutzern, ihrer Umgebung und der Konfigurationen ihres Systems gemäße Tests durchzuführen. Weitere Informationen dazu, wie Microsoft die Microsoft Office 2007-Produkte aktualisiert, finden Sie im [Microsoft Knowledge Base-Artikel 949370](https://support.microsoft.com/kb/949370).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0566](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0566).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969693">Microsoft Knowledge Base-Artikel 969693</a>.</td>
</tr>
<tr class="even">
...
-   Lionel d'Hauenens von [Labo Skopia](https://www.laboskopia.com/), der mit [VersiSign iDefense Labs](https://www.idefense.com/) zusammenarbeitet, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Zeigerdereferenzierung (CVE-2009-0566).
