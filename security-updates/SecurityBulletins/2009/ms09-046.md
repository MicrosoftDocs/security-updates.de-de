...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2519](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/956844">Microsoft Knowledge Base-Artikel 956844</a>.</td>
</tr>
<tr class="even">
...
-   Tavis Ormandy von [Google Inc.](https://www.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit im ActiveX-Steuerelement der DHTML-Bearbeitungskomponente (CVE-2009-2519).
