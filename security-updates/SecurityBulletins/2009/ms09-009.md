---
TOCTitle: 'MS09-009'
Title: 'Microsoft Security Bulletin MS09-009 - Kritisch'
ms:assetid: 'ms09-009'
ms:contentKeyID: 61224548
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-009(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Microsoft Office Excel 2000 als Kritisch eingestuft. Für alle unterstützten Editionen von Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office 2004 für Mac und Microsoft Office 2008 für Mac sowie für alle unterstützten Versionen von Microsoft Office Excel Viewer und Microsoft Office Compatibility Pack Service Pack 1 wird dieses Sicherheitsupdate als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.
...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 968272](https://technet.microsoft.com/security/advisory/968272) beschrieben wurde.
...
\*Für Microsoft Office Excel 2007 Service Pack 1 müssen Benutzer zusätzlich zum Sicherheitsupdatepaket KB959997 auch das Sicherheitsupdate für [Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf) Service Pack 1 (KB960003) installieren, um vor den in diesem Bulletin beschriebenen Sicherheitsanfälligkeiten geschützt zu sein.
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 968557](https://support.microsoft.com/kb/968557).
...
**Weshalb wird dieses Update für Excel 2000 als Kritisch eingestuft, aber nur Hoch für alle anderen betroffenen Versionen von Excel?**  
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0100
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0238
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung in Microsoft Office Excel vor, die Remotecodeausführung ermöglichen kann, wenn ein Benutzer eine speziell gestaltete Excel-Datei öffnet, die ein fehlerhaftes Objekt enthält. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0100](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0100).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0100
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0100
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0100
...
Dieses Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office Excel speziell gestaltete Excel-Dateien öffnet.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0238
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0238
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung – CVE-2009-0238

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Es liegt eine Sicherheitsanfälligkeit in Microsoft Office Excel vor, die Remotecodeausführung ermöglichen kann, wenn ein speziell gestaltetes Excel-Arbeitsblatt geöffnet wird. Die spezifische Sicherheitsanfälligkeit wird durch die Art und Weise verursacht, wie Microsoft Office Excel das Dateiformat des Excel-Arbeitsblatts analysiert.
...
**Was bewirkt das Update?**  
Dieses Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Excel speziell gestaltete Excel-Dateien öffnet.

**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238) zugewiesen. Diese Sicherheitsanfälligkeit wurde erstmals in der [Microsoft-Sicherheitsempfehlung 968272](https://technet.microsoft.com/security/advisory/968272) beschrieben.
...
Im Fall von SMS 2.0 und SMS 2003 kann das SMS SUS Feature Pack, das das Sicherheitsupdate-Inventurprogramm (SUIT) enthält, von SMS zum Auffinden von Sicherheitsupdates verwendet werden. Siehe auch [Downloads für Systems Management Server 2.0.](https://technet.microsoft.com/de-de/security/cc184922.aspx)
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/968557">Microsoft Knowledge Base-Artikel 968557</a>.</td>
</tr>
<tr class="even">
...
<br />
Für Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 1:<br />
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.5.4 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=52271140-89be-4b9c-baa2-cea09097d703) herunter, und installieren Sie sie.
...
-   Öffnen Sie die Datei des Microsoft Office 2004-Updates für Mac 11.5.4 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Microsoft Office 2004-Updates für Mac 11.5.4 auf die Anwendung des Microsoft Office 2004-Updates für Mac 11.5.4, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
...
Wird die Versionsnummer **11.5.4** angezeigt, wurde das Update erfolgreich installiert.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.1.7 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f6e407eb-11a5-433f-8006-4b822953ca98) herunter, und installieren Sie sie.
  
-   Beenden Sie alle ausgeführten Anwendungen, da sie die Installation beeinträchtigen könnten. Dies betrifft auch Antivirenprogramme, alle Microsoft Office-Anwendungen, Microsoft Messenger für Mac sowie Office Notifications.  
-   Öffnen Sie die Datei des Microsoft Office 2008-Updates für Mac 12.1.7 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Microsoft Office 2008-Updates für Mac 12.1.7 auf die Anwendung des Microsoft Office 2008-Updates für Mac 12.1.7, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
-   Wenn die Installation erfolgreich abgeschlossen wurde, können Sie das Update-Installationsprogramm von Ihrer Festplatte entfernen. Weitere Informationen dazu, wie Sie den erfolgreichen Abschluss der Installation überprüfen können, finden Sie im Unterabschnitt „Überprüfen der Updateinstallation“. Um das Update-Installationsprogramm zu entfernen, ziehen Sie zuerst die Datei des Microsoft Office 2008-Updates für Mac 12.1.7 in den Papierkorb. Ziehen Sie anschließend die heruntergeladene Datei in den Papierkorb.
...
Wird die Versionsnummer **12.1.7** angezeigt, wurde das Update erfolgreich installiert.
...
-   Haifei Li von Fortinets [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung (CVE-2009-0100).
...
-   V1.1 (22. April 2009): Excel Viewer 2003 Service Pack 3 wurde den MBSA- und SMS-Tabellen im Abschnitt „Tools und Anleitungen zur Erkennung und Bereitstellung“ hinzugefügt. Dies ist lediglich eine Informationsänderung. An den Binärdateien des Sicherheitsupdates oder der Erkennungslogik wurden keine Änderungen vorgenommen.
