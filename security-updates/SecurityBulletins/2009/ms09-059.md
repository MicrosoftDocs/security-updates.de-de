...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 975467](https://support.microsoft.com/kb/975467) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
&#42;Dieses Betriebssystem ist nur betroffen, wenn KB968389, „Erweiterter Authentifizierungsschutz“ (siehe [Microsoft-Sicherheitsempfehlung 973811](https://support.microsoft.com/kb/973811)), installiert wurde. Weitere Informationen finden Sie in dem Eintrag in **Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate**.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524).
...
-   **Deinstallieren von KB968389 von Computern unter Windows XP oder Windows Server 2003**
    ...
    **So machen Sie die Problemumgehung rückgängig:** Installieren Sie KB968389, indem Sie das für Ihr Betriebssystem geeignete Installationspaket von [Microsoft Knowledge Base-Artikel 936389](https://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0) herunterladen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/975467">Microsoft Knowledge Base-Artikel 975467</a>.</td>
</tr>
<tr class="even">
