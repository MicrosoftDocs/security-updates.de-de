...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 960803](https://support.microsoft.com/kb/960803) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Dieses Bulletin wurde überarbeitet, um mitzuteilen, dass der Abschnitt **Bekannte Probleme mit diesem Sicherheitsupdate** im zugehörigen [Microsoft Knowledge Base-Artikel 960803](https://support.microsoft.com/kb/960803) aktualisiert wurde, um ein Kompatibilitätsproblem bei der Anwendung von diesem Update und Systemen zu beschreiben, auf denen der Websense Logon Agent ausgeführt wird und dieser auf die Verwendung der Windows-Authentifizierung mit Herausforderung und Antwort (NTLM) konfiguriert ist.

**Wo befinden sich die Dateiinformationen?**  
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 960803](https://support.microsoft.com/kb/960803).
...
Sicherheitsupdates sind unter [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) und [Windows-Update](https://go.microsoft.com/fwlink/?linkid=21130) verfügbar.

**In welcher Beziehung steht dieses Sicherheitsupdate zu MS09-014?**  
Die Sicherheitsanfälligkeit in den Windows HTTP-Diensten bezüglich Reflektion von Anmeldeinformationen, [CVE-2009-0550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550), die in diesem Security Bulletin beschrieben wird, betrifft auch Internet Explorer und die Windows Internet-API. Microsoft empfiehlt Benutzern von Internet Explorer, auch das von [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), Kumulatives Sicherheitsupdate für Internet Explorer (963027), bereitgestellte Sicherheitsupdate zu installieren.

**Welches sind die bekannten Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können?**  
Im [Microsoft Knowledge Base-Artikel 960803](https://support.microsoft.com/kb/960803) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0086).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0089).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550).
...
Außerdem betrifft dieses Problem auch Internet Explorer und die Windows Internet-API. Microsoft empfiehlt Benutzern von Internet Explorer, das von [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), Kumulatives Sicherheitsupdate für Internet Explorer (963027), bereitgestellte Sicherheitsupdate zu installieren.
...
CVE-2009-0550 betrifft sowohl WinINet, das von Internet Explorer verwendet wird, als auch Windows HTTP-Dienste, eine Komponente des Windows-Betriebssystems. Microsoft empfiehlt Benutzern von Internet Explorer, auch das von [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), Kumulatives Sicherheitsupdate für Internet Explorer (963027), bereitgestellte Sicherheitsupdate zu installieren.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-0550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/960803">Microsoft Knowledge Base-Artikel 960803</a>.</td>
</tr>
<tr class="even">
...
-   Greg MacManus von [iSIGHT Partners Labs](https://www.isightpartners.com/) für den Hinweis auf die Sicherheitsanfälligkeit in den Windows HTTP-Diensten durch Ganzzahlunterlauf (CVE-2009-0086)  
-   WanTeh Chang und Cem Paya von [Google](https://www.google.com/corporate) für den Hinweis auf die Sicherheitsanfälligkeit in den Windows HTTP-Diensten durch Zertifikatsnamenkonflikt (CVE-2009-0089)
