...
Dieses Update beinhaltet eine Tiefenverteidigungsänderung, die WinINET die Verwendung des erweiterten Authentifizierungsschutzes ermöglicht. Weitere Informationen finden Sie in der [Microsoft-Sicherheitsempfehlung 973811](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/973811.mspx).
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 974455](https://support.microsoft.com/kb/974455).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1547](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1547).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2530).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2531](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2531).
...
\*SMS 2.0 und SMS 2003 unterstützen alle betroffenen Versionen von Internet Explorer mit Ausnahme von Internet Explorer 7 und Internet Explorer 8. Weitere Informationen dazu finden Sie im [Microsoft Knowledge Base-Artikel 924178](https://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/974455">Microsoft Knowledge Base-Artikel 974455</a>.</td>
</tr>
<tr class="even">
...
-   SkyLined von [Google Inc.](https://www.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit bzgl. Beschädigung von Datenstromheadern (CVE-2009-1547)  
-   Mark Dowd von [IBM ISS X-Force](https://www.iss.net/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Verarbeitung von HTML-Komponenten (CVE-2009-2529)  
-   [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-2530).  
-   Sam Thomas (https://eshu.co.uk/) in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-2531).
