...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 975191](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/975191.mspx) beschrieben wurde.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 975254](https://support.microsoft.com/kb/975254) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
-   [Microsoft-FTP-Dienst 7.5 für IIS 7.0 (x86)](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=b7f5b652-8c5c-447a-88b8-8cfc5c13f571)
-   [Microsoft-FTP-Dienst 7.5 für IIS 7.0 (x64)](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=ffb7c167-279e-48d3-8169-dea85784c4d1)
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023).
...
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer mit Zugriff auf den FTP-Dienst kann mit dieser Sicherheitsanfälligkeit einen stapelbasierten Überlauf verursachen, der die Ausführung beliebigen Codes im Kontext des LocalSystem-Kontos auf Systemen ermöglichen kann, auf denen IIS 5.0 ausgeführt wird, oder aber Denial-of-Service auf betroffenen Systemen, auf denen IIS 5.1 oder IIS 6.0 ausgeführt wird. In Konfigurationen des FTP-Dienstes, bei denen anonyme Authentifizierung möglich ist, muss der Angreifer sich nicht authentifizieren, damit die Sicherheitsanfälligkeit ausgenutzt werden kann. Weitere Informationen zu dem LocalSystem-Konto finden Sie in dem MSDN-Artikel [LocalSystem-Konto](https://msdn.microsoft.com/en-us/library/ms684190(vs.85).aspx).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023) zugewiesen.

**Lagen Microsoft zum Zeitpunkt der Veröffentlichung dieses Security Bulletins Informationen vor, dass diese Sicherheitsanfälligkeit bereits ausgenutzt wurde?**  
Ja. Microsoft ist sich gezielter Angriffe bewusst, bei denen versucht wird, die Sicherheitsanfälligkeit auszunutzen.

**Trägt die Installation dieses Sicherheitsupdates zum Schutz der Benutzer vor dem veröffentlichten Code bei, mit dem versucht wird, diese Sicherheitsanfälligkeit auszunutzen?**  
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023) zugewiesen.
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 975254](https://support.microsoft.com/kb/975254).                                                                 |
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/975254">Microsoft Knowledge Base-Artikel 975254</a>.</td>
</tr>
<tr class="even">
