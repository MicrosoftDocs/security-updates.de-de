...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523).
...
-   **Deaktivieren des Lizenzprotokollierdiensts**
    ...
    **Auswirkung der Problemumgehung:** Wird der Lizenzprotokollierdienst deaktiviert, können Dienste, die explizit vom Lizenzprotokollierdienst abhängen, u. U. eine Fehlermeldung im Systemereignisprotokoll aufzeichnen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 316631](https://support.microsoft.com/kb/316631).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 974783](https://support.microsoft.com/kb/974783).                                                               |  
...
-   Cody Pierce von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs im Lizenzprotokollierserver (CVE-2009-2523).
