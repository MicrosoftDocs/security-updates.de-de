...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 963093](https://support.microsoft.com/kb/963093) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/963093">Microsoft Knowledge Base-Artikel 963093</a>.</td>
</tr>
<tr class="even">
...
-   Yair Amit von [IBM Rational Application Security](https://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) für den Hinweis auf die Sicherheitsanfälligkeit bei Skriptausführung in der Windows-Suche (CVE-2009-0239)
