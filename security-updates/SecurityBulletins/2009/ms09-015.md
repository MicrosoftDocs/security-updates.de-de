...
Für Administratoren und für Installationen in Unternehmen bzw. für Endbenutzer, die dieses Sicherheitsupdate manuell installieren möchten, empfiehlt Microsoft, das Update mit Updateverwaltungssoftware zu installieren bzw. mithilfe des Diensts [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) auf Updates zu prüfen.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c4e408d7-6716-4a12-ad3a-8029667f5c84)                                                                                 | Keine                          | Keine                            | Keine                                                    |
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3de0684d-605c-489b-bdc7-08bce9b2d4f6)                                                               | Erhöhung von Berechtigungen    | Mittel                           | [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b743a7fe-7bf4-420d-a72e-39471e5659fa)                                           | Erhöhung von Berechtigungen    | Mittel                           | [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=992bb0cd-fbc7-4a7c-9088-f7f9d9a3ead0)                                             | Erhöhung von Berechtigungen    | Mittel                           | [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Server 2003 x64 Edition und Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f0a58e8c-7d63-4d7d-ba95-b3787cf408f0)                                    | Erhöhung von Berechtigungen    | Mittel                           | [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Server 2003 mit SP1 für Itanium-basierte Systeme und Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=00c6479d-f81f-445d-b8e4-7b71d77d540a) | Erhöhung von Berechtigungen    | Mittel                           | [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Vista und Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2b672d45-f33b-4edc-9f22-2f2c8c726a8b)                                                                        | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                    |
| [Windows Vista x64 Edition und Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7576e7d5-5bb1-4a53-b568-1ee0500ce721)                                                | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                    |
| [Windows Server 2008 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6b73cf5e-66fe-4b7d-95fc-91a1c262c1e5)\*                                                                              | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                    |
| [Windows Server 2008 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7e60847c-b341-4c38-bc25-2e3cf2d4ae14)\*                                                                        | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                    |
| [Windows Server 2008 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=de1c2b4b-af47-4b9a-8363-720e5527573c)                                                                      | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                    |
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 959426](https://support.microsoft.com/kb/959426).

**In welcher Beziehung steht dieses Sicherheitsupdate zu MS09-014?**  
Die Sicherheitsanfälligkeit bezüglich Erhöhung von Berechtigungen durch komplexe Bedrohung, [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540), die in diesem Security Bulletin beschrieben wird, betrifft auch Internet Explorer. Microsoft empfiehlt Benutzern, auch das in [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), Kumulatives Sicherheitsupdate für Internet Explorer (963027), bereitgestellte Sicherheitsupdate zu installieren.
...
Nein, Sie müssen außerdem den Tiefenverteidigungsschutz separat aktivieren, der durch das Kumulative Sicherheitsupdate für Internet Explorer, [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), bereitgestellt wird. Sie müssen jedoch überprüfen, ob die Aktivierung dieses Tiefenverteidigungsschutzes gegen das komplexe Bedrohungsproblem für Ihre Umgebung geeignet ist.

Um den Tiefenverteidigungsschutz in Internet Explorer zu aktivieren, aktivieren Sie den SearchPath-Funktionssteuerungsschlüssel, der im Abschnitt „Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate“ in [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659) beschrieben wurde. Weitere Informationen zum komplexen Bedrohungsproblem finden Sie unter der Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540).
...
Aufgrund dieser architektonischen Änderungen von Microsoft Windows 2000 müssen Sie die für Microsoft Windows 2000 spezifische Tiefenverteidigungsänderung mithilfe des Registrierungsschlüssels HKLM\\System\\CCS\\control\\Session Manager\\SafeDLLSearchMode aktivieren. Anweisungen hierzu finden Sie im [Microsoft Knowledge Base-Artikel 959426](https://support.microsoft.com/kb/959426). Weitere Informationen finden Sie im MSDN-Artikel [DLL-Suchreihenfolge](https://msdn.microsoft.com/en-us/library/ms682586.aspx).

**Was ist die SearchPath-Funktion?**  
Die SearchPath-Funktion wird verwendet, um eine bestimmte Datei in einem angegebenen Pfad zu suchen. Weitere Informationen finden Sie in dem MSDN-Artikel [SearchPath-Funktion](https://msdn.microsoft.com/en-us/library/aa365527.aspx).

**Was ist die LoadLibrary-Funktion?**  
Die LoadLibrary-Funktion lädt das angegebene Modul in den Adressbereich des aufrufenden Prozesses. Das angegebene Modul kann das Laden anderer Module verursachen. Weitere Informationen finden Sie in dem MSDN-Artikel [LoadLibrary-Funktion](https://msdn.microsoft.com/en-us/library/ms684175(vs.85).aspx).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich Erhöhung von Berechtigungen durch komplexe Bedrohung – CVE-2008-2540</th>
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/959426">Microsoft Knowledge Base-Artikel 959426</a>.</td>
</tr>
<tr class="even">
...
-   [Aviv Raff](https://aviv.raffon.net/) für den Hinweis auf die Sicherheitsanfälligkeitserhöhung bezüglich Erhöhung von Berechtigungen durch komplexe Bedrohung (CVE-2008-2540)
