...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cb2c9b76-0c65-4754-9941-d45a7c74a29a">Active Directory Application Mode (ADAM)</a> <br />
(KB970437)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2ef3aaf0-a2a9-4c17-99ab-a0dc3d3f7e86">Active Directory Application Mode (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f6f99957-f74f-4446-8734-a468283eebae">Active Directory Application Mode (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a2badc7-c0a5-4032-a009-73ebe9d76313">Active Directory Application Mode (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1138](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138).
...
-   **Blockieren Sie die TCP-Ports 389, 636, 3268 und 3269 an der Firewall**
    ...
    Microsoft empfiehlt das Blockieren der gesamten unerwünschten eingehenden Kommunikation aus dem Internet. So können Sie Angriffe verhindern, bei denen möglicherweise andere Ports verwendet werden. Weitere Informationen zu den Ports finden Sie unter [TCP- und UDP-Portzuweisungen](https://go.microsoft.com/fwlink/?linkid=21312). Weitere Informationen zur Windows-Firewall finden Sie unter [So konfigurieren Sie eine Windows-Firewall auf einem einzelnen Computer](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
-   **Deaktivieren Sie den anonymen LDAP-Zugriff auf Microsoft Windows 2000-Servern**
  
    Durch Deaktivieren des anonymen LDAP-Zugriffs auf Microsoft Windows 2000-Servern wird die Ausnutzung dieser Sicherheitsanfälligkeit auf authentifizierte Benutzer beschränkt. Weitere Informationen zu anonymen LDAP-Verbindungen (Basis NULL) einschließlich einer Beschreibung der Auswirkungen ihrer Deaktivierung finden Sie im [Microsoft Knowledge Base-Artikel 837964](https://support.microsoft.com/kb/837964).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1139](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 969805](https://support.microsoft.com/kb/969805).                                                               |  
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/970437">Microsoft Knowledge Base-Artikel 970437</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969805">Microsoft Knowledge Base-Artikel 969805</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
-   Joshua J. Drake von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Active Directory bezüglich ungültiger Speicherfreigabe (CVE-2009-1138)
-   Justin Wyatt vom [Beaverton School District](https://www.beaverton.k12.or.us/home/) für den Hinweis auf die Sicherheitsanfälligkeit in Active Directory bezüglich Speicherverlusts (CVE-2009-1139)
