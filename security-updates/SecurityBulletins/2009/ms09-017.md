...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 969136](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/969136.mspx) beschrieben wurde.

**Empfehlung.** Microsoft empfiehlt Benutzern die sofortige Installation des Updates.

**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 967340](https://support.microsoft.com/kb/967340) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Wenn die derzeit bekannten Probleme und empfohlenen Lösungen nur auf bestimmte Veröffentlichungen dieser Software zutreffen, werden in diesem Artikel Verknüpfungen zu weiteren Artikeln bereitgestellt.
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834)  
(KB957789)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834)  
(KB957789)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
Mit den Sicherheitsupdatepaketen für Microsoft Works 8.5 (KB967043) und Microsoft Works 9 (KB967044) in diesem Bulletin, MS09-017, werden auch die in [MS09-024](https://go.microsoft.com/fwlink/?linkid=128104) beschriebenen Sicherheitsanfälligkeiten behoben. Benutzer mit Microsoft Works 8.5 bzw. Microsoft Works 9 müssen die Updatepakete nur einmal installieren.

**Wo befinden sich die Dateiinformationen?**  
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 967340](https://support.microsoft.com/kb/967340).

**Müssen Benutzer bestimmte Maßnahmen hinsichtlich der PowerPoint 4.0-Dateiformate treffen?**  
Mit diesem Update wird die Möglichkeit, PowerPoint 4.0-Dateiformate zu öffnen, in Microsoft Office PowerPoint 2000 und Microsoft Office PowerPoint 2002 standardmäßig deaktiviert. Diese Funktionalität wurde in Microsoft Office PowerPoint 2003 Service Pack 3 bereits standardmäßig deaktiviert. Diese Funktionalität existiert in Microsoft Office PowerPoint 2007 ebenfalls nicht mehr. Weitere Informationen bezüglich dieser Änderung finden Sie im [Microsoft Knowledge Base-Artikel 970980](https://support.microsoft.com/kb/970980).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0220](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0220).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0221](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0221).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0222](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0222).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0223](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0223).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0224).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0225](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0225).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0226](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0226).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0227).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-0556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556) zugewiesen. Diese Sicherheitsanfälligkeit wurde erstmals in der [Microsoft-Sicherheitsempfehlung 969136](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/969136.mspx) beschrieben.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1128).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1129).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1130).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1131).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1137](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1137).
...
**Hinweis**: Für Benutzer, die ältere Software verwenden, die nicht von MBSA 2.1, Microsoft Update und Windows Server Update Services unterstützt wird: Besuchen Sie die Website [Microsoft Baseline Security Analyzer](https://technet.microsoft.com/de-de/security/cc184924.aspx) und sehen Sie im Abschnitt Support für ältere Produkte nach, wie Sie mit älteren Tools eine umfassende Erkennung von Sicherheitsupdates erstellen können.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/967340">Microsoft Knowledge Base-Artikel 967340</a>.</td>
</tr>
<tr class="even">
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.5.5 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=5557bfb7-ebb4-4c42-8042-41e830c4e550) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.1.9 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=58326da2-eb75-4b42-b1bc-e70319defb58) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateikonverter-Updates für Mac 1.0.3 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=9d6d9eaa-8442-4184-8886-faab2803bde6) herunter, und installieren Sie sie.
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Works 8.5:<br />
Siehe <a href="https://support.microsoft.com/kb/967043">Microsoft Knowledge Base-Artikel 967043</a>.<br />
<br />
Für Microsoft Works 9:<br />
Siehe <a href="https://support.microsoft.com/kb/967044">Microsoft Knowledge Base-Artikel 967044</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-0220).  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs (CVE-2009-0221).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-0222).  
-   Marsu Pilami von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-0223).  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung (CVE-2009-0224).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PP7 bezüglich Speicherbeschädigung (CVE-2009-0225).  
-   Marsu Pilami von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-0226).  
-   Marsu Pilami von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-0227).  
-   Marsu Pilami in Zusammenarbeit mit [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung (CVE-2009-0556).  
-   Marsu Pilami von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PP7 bezüglich Speicherbeschädigung (CVE-2009-1128).  
-   Marsu Pilami von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PP7 bezüglich Speicherbeschädigung (CVE-2009-1129).  
-   Ling and Wushi von [team509](https://www.team509.com/) in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) und Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heap-Beschädigung (CVE-2009-1130).  
-   Carsten H. Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich ungebundener Daten (CVE-2009-1131).  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich des Legacy-Dateiformats (CVE-2009-1137).
