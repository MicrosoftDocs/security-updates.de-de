...
<td style="border:1px solid black;">
[Microsoft Office Word 2000 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4bf95806-3d32-411b-9779-a81aebad45e9)  
(KB957838)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office Word 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b0ba8c9e-75ee-46bd-9e92-d4e6599309ad)  
(KB957646)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Word 2003 Service Pack 3 mit dem Microsoft Works 6–9-Dateikonverter](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=a7ba3ea7-d06a-4c14-9107-9b92ef68fcae)\*  
(KB968326)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bd47e1e5-cd2e-4c08-9864-471e97f38ca3)  
(KB969559)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Mit den Sicherheitsupdatepaketen für Microsoft Works 8.5 (KB967043) und Microsoft Works 9 (KB967044) in diesem Bulletin, MS09-024, werden auch die in [MS09-017](https://go.microsoft.com/fwlink/?linkid=141704) beschriebenen Sicherheitsanfälligkeiten behoben. Benutzer mit Microsoft Works 8.5 bzw. Microsoft Works 9 müssen die Updatepakete nur einmal installieren.

**Was ist der Microsoft Works 6-9-Dateikonverter?**  
Der Microsoft Works 6-9-Konverter ermöglicht Microsoft Office Word 2003 das Öffnen, Bearbeiten und Speichern von Dateien im Works Word Processor-Dateiformat, das von den Works-Versionen 6, 7, 8 und 9 unterstützt wird. Weitere Informationen finden Sie unter [Microsoft Works 6–9-Dateikonverter](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1533](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533).
...
-   Microsoft Office Word 2003 ist nur betroffen, wenn der Works-Konverter installiert ist. Weitere Informationen finden Sie unter [Microsoft Works 6–9-Dateikonverter](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297).
...
-   **Deaktivieren Sie in Word 2003 mit dem** [**Microsoft Works 6-9-Dateikonverter**](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297) **und in Word 2007 den Works 6-9-Konverter durch Einschränken des Zugriffs**
    ...
    **Für Windows** **Vista** **und Windows Server 2008:**
    ...
    takeown /f "%ProgramFiles(x86)%\Common Files\Microsoft Shared\TextConv\works632.cnv"icacls "%ProgramFiles(x86)%\Common Files\Microsoft Shared\TextConv\works632.cnv" /save works632_ACL.TXTicacls "%ProgramFiles(x86)%\Common Files\Microsoft Shared\TextConv\works632.cnv" /deny everyone:(F)
    ```
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/957838">Microsoft Knowledge Base-Artikel 957838</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/957646">Microsoft Knowledge Base-Artikel 957646</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/968326">Microsoft Knowledge Base-Artikel 968326</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969559">Microsoft Knowledge Base-Artikel 969559</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Shaun Colley von [NGS Software](https://www.ngssoftware.com/) und Yuji Ukai von [Fourteenforty Research Institute, Inc.](https://www.fourteenforty.jp/) für den Hinweis auf die Sicherheitsanfälligkeit im Dateikonverter bezüglich Pufferüberlaufs (CVE-2009-1533).
