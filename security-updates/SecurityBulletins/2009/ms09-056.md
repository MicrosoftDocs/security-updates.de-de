---
TOCTitle: 'MS09-056'
Title: 'Microsoft Security Bulletin MS09-056 - Kritisch'
ms:assetid: 'ms09-056'
ms:contentKeyID: 61224595
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-056(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-056 - Kritisch
===============================================
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=52b9198d-b65f-467a-a5ab-141e23d64a86)                                                                                | Spoofing                       | Hoch                             | [MS04-007](https://go.microsoft.com/fwlink/?linkid=20067) |
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9c5ab624-e37b-418a-a919-d8f652b15679)                                                              | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ad29696d-4611-4a12-9dfa-74fa6866b759)                                                                                  | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=49e9cc53-cf17-4bc7-aaaa-92213167e1a9)                                                                                   | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d170cef9-f5d2-4fcd-997b-e778ad5a6797)                                                                       | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2ede1eb9-7f5f-411d-bbc3-5db46d80e0bb)                                                             | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Vista, Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8b5a9a95-9439-40c8-acef-000b919daa04)                                         | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4a60f789-1a4a-49a8-8d13-fda989ed40be)     | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f9b487af-fe73-42a8-b240-d59c4321f95b)\*                   | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=0d8a2a3e-d7d4-47fb-8364-16fce28e4d38)\*       | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8962f0b6-f346-4e88-9d83-4d15b699dd9d) | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ad6f06d5-27db-445d-a8b2-c42adc90afc0)                                                                                         | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=70cd0270-77e9-492a-82d9-798364640c10)                                                                                   | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ce78c019-ec08-4ec6-abec-334f5ec5cb76)\*                                                                    | Spoofing                       | Hoch                             | Keine                                                    |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6442a77a-3c0d-4beb-b2d2-2885376c2135)                                                                  | Spoofing                       | Hoch                             | Keine                                                    |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch Nullabschneidung im gemeinsamen Namen von X.509 – CVE-2009-2510</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch Ganzzahlüberlauf in Objektbezeichnern von X.509 – CVE-2009-2511</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2510](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510).
...
Weitere Informationen zu ASN.1 finden Sie im [Microsoft Knowledge Base-Artikel 252648](https://support.microsoft.com/kb/252648).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-2510](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2511](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2009-2511](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511) zugewiesen.
...
| **Bereitstellung:**                          |                                                                                                                                                        |  
| Installieren ohne Benutzereingriff           | Windows2000-kb974571-x86-enu /quiet                                                                                                                    |  
| Installieren ohne neu zu starten             | Windows2000-kb974571-x86-enu /norestart                                                                                                                |  
| Protokolldatei aktualisieren                 | kb974571.log                                                                                                                                           |  
...
| **Informationen zur Deinstallation:**        | Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB974571$\\Spuninst. |  
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 974571](https://support.microsoft.com/kb/974571).                                                               |  
| **Überprüfung des Registrierungsschlüssels** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974571\\Filelist                                                              |
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB974571$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/974571">Microsoft Knowledge Base-Artikel 974571</a>.</td>
</tr>
<tr class="even">
...
<br />
Für alle x64-basierten Editionen von Windows 7:<br />
...
-   Ian Wright und Jean-Luc Giraud von [Citrix](https://www.citrix.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit durch Nullabschneidung im gemeinsamen Namen von X.509 (CVE-2009-2510).  
-   Dan Kaminsky von [IOActive](https://www.ioactive.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Nullabschneidung im gemeinsamen Namen von X.509 (CVE-2009-2510) und die Sicherheitsanfälligkeit durch Ganzzahlüberlauf in Objektbezeichnern von X.509 (CVE-2009-2511).
