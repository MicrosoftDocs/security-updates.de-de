---
TOCTitle: 'MS09-052'
Title: 'Microsoft Security Bulletin MS09-052 - Kritisch'
ms:assetid: 'ms09-052'
ms:contentKeyID: 61224591
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-052(v=Security.10)'
---
...
|---------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                   | [Microsoft Windows Media Player 6.4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=13035ef7-7e47-487c-8b7c-7795d33ce7de) | Remotecodeausführung           | Kritisch                         | Keine                                                     |
| Windows XP Service Pack 2 und Windows XP Service Pack 3 | [Microsoft Windows Media Player 6.4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b2efe1ac-d8d7-41bb-b87d-fc5e22afef0f) | Remotecodeausführung           | Kritisch                         | [MS08-076](https://go.microsoft.com/fwlink/?linkid=125419) |
| Windows XP Professional x64 Edition Service Pack 2      | [Microsoft Windows Media Player 6.4](https://www.microsoft.com/download/details.aspx?familyid=a9e7dfd8-7ba1-4f14-8e60-92ef00d91467)                | Remotecodeausführung           | Kritisch                         | [MS08-076](https://go.microsoft.com/fwlink/?linkid=125419) |
| Windows Server 2003 Service Pack 2                      | [Microsoft Windows Media Player 6.4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5f82d01c-573e-425e-b9f2-86a54f377b19) | Remotecodeausführung           | Kritisch                         | [MS08-076](https://go.microsoft.com/fwlink/?linkid=125419) |
| Windows Server 2003 x64 Edition Service Pack 2          | [Microsoft Windows Media Player 6.4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=65e9036e-2e1b-40ff-a84b-c507107bcce8) | Remotecodeausführung           | Kritisch                         | [MS08-076](https://go.microsoft.com/fwlink/?linkid=125419) |
...
| Windows Vista, Windows Vista Service Pack 1 und Windows Vista Service Pack 2                                         | Nicht anwendbar |
| Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2     | Nicht anwendbar |
| Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2                     | Nicht anwendbar |
| Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2         | Nicht anwendbar |
...
**Ich habe Windows Media Player 6.4 nicht auf meinem System installiert. Warum wird mir dieses Update angeboten?**  
Beim Aktualisieren von Microsoft Windows Media Player 6.4 auf eine höhere Version von Windows Media Player werden bestimmte Komponenten von Microsoft Windows Media Player 6.4 nicht vollständig vom System entfernt, um Abwärtskompatibilität sicherzustellen. Diese Komponenten werden durch dieses Bulletin aktualisiert. Obwohl höhere Versionen von Windows Media Player von dieser Sicherheitsanfälligkeit nicht betroffen sind, besteht weiterhin die Gefahr einer Ausnutzung, wenn ein Programm explizit diese älteren Komponenten bei der Medienwiedergabe aufruft. Wenn Sie dieses Update nach dem Aktualisieren von Microsoft Windows Media Player 6.4 nicht installieren, erkennen automatisierte Scan-Tools wie z. B. MBSA, dass Ihr System anfällig ist, obwohl Microsoft Windows Media Player 6.4 nicht der standardmäßige Media Player auf dem System ist. Microsoft Windows Media Player 6.4 ist die einzige Version von Windows Media Player, die von dem Problem betroffen ist, das in diesem Bulletin behoben wird. Alle Benutzer, denen das Update automatisch angeboten wird, sollten es jedoch installieren, um sicherzustellen, dass sie vor dieser Sicherheitsanfälligkeit geschützt sind.

**Wo befinden sich die Dateiinformationen?**  
Informationen zum Speicherort der Dateiinformationen finden Sie in den Referenztabellen im Abschnitt **Bereitstellung von Sicherheitsupdates**.

**Inwieweit bezieht sich dieses Bulletin auf MS09-051: Sicherheitsanfälligkeit in Windows Media Runtime kann Remotecodeausführung ermöglichen?**  
Dieses Bulletin hat keinen Bezug zu [MS09-051](https://go.microsoft.com/fwlink/?linkid=125438): Sicherheitsanfälligkeit in Windows Media Runtime kann Remotecodeausführung ermöglichen. Benutzer sollten beide Updates installieren, um sicherzustellen, dass sie vollständig geschützt sind.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs – CVE-2009-2527</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 unter Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 unter Windows XP Service Pack 2 und Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 unter Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 unter Windows 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 unter Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Kritisch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Kritisch</strong></td>
</tr>
...
Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs – CVE-2009-2527  
----------------------------------------------------------------------
  
In Windows Media Player 6.4 liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor. Ein Angreifer kann die Sicherheitsanfälligkeit durch Erstellen einer speziell gestalteten ASF-Datei ausnutzen, die Remotecodeausführung ermöglichen kann, wenn sie mit Windows Media Player 6.4 wiedergegeben wird. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2527).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs – CVE-2009-2527
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.  
-   Die Sicherheitsanfälligkeit kann nicht automatisch über E-Mail ausgenutzt werden. Ein Benutzer muss eine zusammen mit einer E-Mail-Nachricht gesendete Dateianlage öffnen, damit ein E-Mail-Angriff erfolgreich ist.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs – CVE-2009-2527
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Ändern der Zugriffssteuerungsliste (ACL) für strmdll.dll**
  
    Führen Sie zum Beschränken der Zugriffssteuerungsliste (ACL) für strmdll.dll in Windows XP und Windows Server 2003 die folgenden Befehle an einer Eingabeaufforderung mit Administratorrechten aus:
    ...
    **Auswirkung der Problemumgehung:** Windows Media Player 6.4 kann keine Mediendateien wiedergeben.
  
    **So machen Sie die Problemumgehung rückgängig:**
  
    Führen Sie in Windows XP und Windows Server 2003 folgende Befehle an einer Eingabeaufforderung mit Administratorrechten aus:
...
-   **Für Nichtmultimedia-Ordnertypen kann die Windows-Shell-Angriffsmethode mithilfe der herkömmlichen Windows-Ordner verringert werden**
    ...
    Führen Sie die folgenden Schritte durch, um Ordneroptionen zu ändern:
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs – CVE-2009-2527
...
Windows Media Player 6.4 verarbeitet speziell gestaltete ASF-Dateien falsch.
...
Wenn eine schädliche ASF-Datei auf einem Computer mit der betroffenen Software gehostet wird, wird nur durch das Navigieren zu dem Ordner in Windows Explorer die Datei weit genug analysiert, um die Sicherheitsanfälligkeit auszulösen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Jedes System, auf dem Windows Media Player 6.4 verwendet wird, z. B. Arbeitsstationen oder Terminalserver, ist durch diese Sicherheitsanfälligkeit gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Media Player 6.4 speziell gestaltete ASF-Dateien verarbeitet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB974112_WM41$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/974112">Microsoft Knowledge Base-Artikel 974112</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation:</strong></td>
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB974112$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/974112">Microsoft Knowledge Base-Artikel 974112</a>.</td>
...
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in WMP bezüglich Heapüberlaufs (CVE-2009-2527).
...
-   V1.1 (29. Oktober 2009): Eine Problemumgehung wurde entfernt. Außerdem wurde ein Eintrag im Abschnitt **Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate** hinzugefügt, um zu erklären, warum einigen Benutzern möglicherweise dieses Update angeboten wird, obwohl sie Windows Media Player 6.4 nicht auf ihren Systemen installiert haben.
-   V1.2 (12. Januar 2010): Registrierungsschlüssel für Windows Media Player 6.4 unter Microsoft Windows 2000 Service Pack 4 wurden korrigiert. Dies ist lediglich ein Informationsupdate.
