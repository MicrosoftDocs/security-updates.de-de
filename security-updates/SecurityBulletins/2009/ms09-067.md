...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1 und Microsoft Office Excel 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693)\*  
(KB973593)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
\*Für Microsoft Office Excel 2007 Service Pack 1 und Microsoft Office Excel 2007 Service Pack 2 müssen Benutzer zusätzlich zum Sicherheitsupdatepaket KB973593 auch das Sicherheitsupdate für [Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 1 und Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) (KB973704) installieren, um vor den in diesem Bulletin beschriebenen Sicherheitsanfälligkeiten geschützt zu sein.
...
Im [Microsoft Knowledge Base-Artikel 972652](https://support.microsoft.com/kb/972652) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für November](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms09-nov.mspx). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/en-us/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3127](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3132](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3133](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-3134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134).
...
Die aktuelle Version von MBSA wurde veröffentlicht: [Microsoft Baseline Security Analyzer 2.1.1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b1e76bbe-71df-41e8-8b52-c871d012ba78). Weitere Informationen finden Sie unter [Microsoft Baseline Security Analyzer 2.1](https://technet.microsoft.com/en-us/security/cc184923.aspx).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/973471">Microsoft Knowledge Base-Artikel 973471</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Excel 2003:<br />
Siehe <a href="https://support.microsoft.com/kb/973475">Microsoft Knowledge Base-Artikel 973475</a>.<br />
<br />
Für Excel Viewer 2003:<br />
Siehe <a href="https://support.microsoft.com/kb/973484">Microsoft Knowledge Base-Artikel 973484</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Excel 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/973593">Microsoft Knowledge Base-Artikel 973593</a>.<br />
<br />
Für Excel Viewer:<br />
Siehe <a href="https://support.microsoft.com/kb/973707">Microsoft Knowledge Base-Artikel 973707</a>.<br />
<br />
Für Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/973704">Microsoft Knowledge Base-Artikel 973704</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.5.6 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.2.3 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.1.3 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6) herunter, und installieren Sie sie.
...
-   Bing Liu von [Fortinets FortiGuard Labs](https://www.fortiguard.com) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Beschädigung des Cachespeichers in Excel (CVE-2009-3127).  
-   [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Beschädigung des Cachespeichers in Excel (CVE-2009-3127).  
-   Bing Liu von [Fortinets FortiGuard Labs](https://www.fortiguard.com) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Excel SxView (CVE-2009-3128).  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung im Featheader-Datensatz von Excel (CVE-2009-3129).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs beim Analysieren von Excel-Dokumenten (CVE-2009-3130).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung beim Analysieren von Excel-Formeln (CVE-2009-3131).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel beim Analysieren des Index (CVE-2009-3132).  
-   Nicolas Joly von [VUPEN Security](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung beim Analysieren von Excel-Dokumenten (CVE-2009-3133).  
-   Bing Liu von [Fortinets FortiGuard Labs](https://www.fortiguard.com) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bei Feldbereinigung (CVE-2009-3134).
