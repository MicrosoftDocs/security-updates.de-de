...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 969462](https://support.microsoft.com/kb/969462) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0558](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0559](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0560](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0561](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969683">Microsoft Knowledge Base-Artikel 969683</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969680">Microsoft Knowledge Base-Artikel 969680</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Excel 2003:<br />
Siehe <a href="https://support.microsoft.com/kb/969681">Microsoft Knowledge Base-Artikel 969681</a>.<br />
<br />
Für Excel Viewer 2003:<br />
Siehe <a href="https://support.microsoft.com/kb/969685">Microsoft Knowledge Base-Artikel 969685</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Excel 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/969682">Microsoft Knowledge Base-Artikel 969682</a>.<br />
<br />
Für Excel Viewer:<br />
Siehe <a href="https://support.microsoft.com/kb/969686">Microsoft Knowledge Base-Artikel 969686</a>.<br />
<br />
Für Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/969679">Microsoft Knowledge Base-Artikel 969679</a>.<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/969737">Microsoft Knowledge Base-Artikel 969737</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Bing Liu von Fortinets [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Zeigerbeschädigung bei Datensatz (CVE-2009-0549)  
-   Bing Liu von Fortinets [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Beschädigung von Objektdatensatz (CVE-2009-0557)  
-   Carsten H. Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Arrayindizierung (CVE-2009-0558)  
-   [TELUS Security Labs Vulnerability Research Team](https://telussecuritylabs.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich stapelbasierten Überlaufs bei Zeichenfolgenkopiervorgang (CVE-2009-0559)  
-   Bing Liu von Fortinets [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Feldbereinigung (CVE-2009-0560)  
-   Sean Larsson und Joshua Drake von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs bei Datensatz (CVE-2009-0561)  
-   Carsten H. Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs bei Datensatz (CVE-2009-0561)  
-   [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Zeigerbeschädigung bei Datensatz (CVE-2009-1134)
