...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 972260](https://support.microsoft.com/kb/972260) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Weitere Informationen zu Sicherheitsanfälligkeiten in Active Template Library (ATL) finden Sie in der [Microsoft-Sicherheitsempfehlung (973882)](https://technet.microsoft.com/security/advisory/973882).

Informationen zum Herunterladen dieses Updates für ATL finden Sie im Microsoft Security Bulletin [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131).

**Wenn ich das Update in MS09-035 installiert habe, muss ich dann trotzdem dieses Update installieren?**  
Ja. [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) richtet sich speziell an Entwickler, die die Active Template Library (ATL) mit Microsoft Visual Studio verwenden. Entwickler, die Komponenten und Steuerelemente weiterverteilen, die mit ATL erstellt wurden, sollten das in MS09-035 bereitgestellte Update installieren, um sicherzustellen, dass ihre Komponenten und Steuerelemente nicht die in diesem Bulletin beschriebenen Sicherheitsanfälligkeiten enthalten.
...
Die erste Tiefenverteidigungsmaßnahme ist standardmäßig aktiviert und verändert die Art und Weise, wie ATL-basierte ActiveX-Steuerelemente beständige Daten lesen. Die erste schadensbegrenzende Maßnahme ist eine Änderung der Art und Weise, wie ATL-basierte Steuerelemente beständige Daten lesen, wobei spezifische Rufmuster erkannt werden, die möglicherweise problematisch sind. Ein solches Beispiel ist das Rufmuster, das zu einem Angriff auf MSVidCtl.dll führt, der durch [MS09-032](https://go.microsoft.com/fwlink/?linkid=157386) behoben wird, einem der Sicherheitsupdates, die am 14. Juliveröffentlicht wurden. Die schadensbegrenzende Maßnahme behebt die Sicherheitsanfälligkeiten in ATL, die in der [Microsoft-Sicherheitsempfehlung (973882)](https://technet.microsoft.com/security/advisory/973882) und in [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) beschrieben werden. Die Änderung wird standardmäßig für alle betroffenen Plattformen aktiviert und hilft, Sicherheitsanfälligkeiten in ATL für Steuerelemente zu blockieren, die in Internet Explorer geladen werden, einschließlich solcher Steuerelemente, die nicht von Microsoft erstellt wurden.

Die zweite Tiefenverteidigungsmaßnahme ist verwandt mit der ersten, bietet aber einen noch stärkeren Schutz und hat ein höheres Risiko hinsichtlich der Anwendungskompatibilität. Diese Tiefenverteidigungsmaßnahme ist standardmäßig deaktiviert und bietet die Möglichkeit, die Verwendung der Schnittstellenimplementierungen IPersistStream\* und IPersistStorage innerhalb einzelner Steuerelemente zu regulieren. Anwendungsentwickler und Endbenutzer können diese schadensbegrenzende Maßnahme optional für eine beliebige Anwendung mit [WebOC](https://msdn.microsoft.com/en-us/library/aa752040(vs.85).aspx) und unter Verwendung des neuen Funktionssteuerungsschlüssels **FEATURE\_RESTRICT\_OBJECT\_DATA\_ATTRIBUTE** aktivieren:
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 972260](https://support.microsoft.com/kb/972260).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1917](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1917).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1918](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1918).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1919](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1919).
...
\*SMS 2.0 und SMS 2003 mit SUSFP unterstützen alle betroffenen Versionen von Internet Explorer mit Ausnahme von Internet Explorer 7 und Internet Explorer 8. Weitere Informationen dazu finden Sie im [Microsoft Knowledge Base-Artikel 924178](https://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/972260">Microsoft Knowledge Base-Artikel 972260</a>.</td>
</tr>
<tr class="even">
...
-   Peter Vreugdenhil von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung (CVE-2009-1917).  
-   Wushi und Ling von [team509](https://www.team509.com/) in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Objekten (CVE-2009-1918).  
-   Peter Vreugdenhil in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Speicherbeschädigung aufgrund von Nichtinitialisierung - (CVE-2009-1919).
