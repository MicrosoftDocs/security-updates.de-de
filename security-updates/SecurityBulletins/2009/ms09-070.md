---
TOCTitle: 'MS09-070'
Title: 'Microsoft Security Bulletin MS09-070 - Kritisch'
ms:assetid: 'ms09-070'
ms:contentKeyID: 61224609
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-070(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-070 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für betroffene Versionen von Windows Server 2003, Windows Server 2003 x64 Edition, Windows Server 2008 und Windows Server 2008 x64 Edition als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie ADFS-fähige Webserver Anforderungsheader überprüfen, die von einem Webclient übermittelt werden. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 971726](https://support.microsoft.com/kb/971726) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=31351b9e-b5bb-4618-990b-1089ea5a3bc2)<sup>[1]</sup>                                                                      | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://technet.microsoft.com/de-DE/library///www.microsoft.com/downloads/details.aspx?displaylang=de%26familyid=b6eb9d9b-1a43-4b30-a033-19a1db786244(v=Security.10))<sup>[2]</sup>  | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f6715abb-fd93-44ba-9854-2ecc672622da)\*             | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7d1f5e9e-a7de-4f96-89c8-510fd51f16e7)\* | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<sup>[1]</sup>Nur betroffen, wenn mit Windows Server 2003 R2 aktualisiert wurde, worin Active Directory-Verbunddienste bereitgestellt werden.

<sup>[2]</sup>Nur betroffen, wenn mit Windows Server 2003 R2 x64 Edition aktualisiert wurde, worin Active Directory-Verbunddienste bereitgestellt werden.
...
Im [Microsoft Knowledge Base-Artikel 971726](https://support.microsoft.com/kb/971726) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.

**Warum behandelt dieses Update mehrere gemeldete Sicherheitsanfälligkeiten?**  
Dieses Update bietet Unterstützung für mehrere Sicherheitsanfälligkeiten, da die Änderungen, die zum Beheben dieser Probleme erforderlich sind, in zueinander in Beziehung stehenden Dateien enthalten sind. Auf diese Weise müssen Benutzer nicht mehrere Updates installieren, die nahezu identisch sind, sondern nur dieses eine Update.

**Was sind Active Directory-Verbunddienste?**  
Active Directory-Verbunddienste (ADFS) basieren auf der aufkommenden, von der Industrie unterstützten Webdienstearchitektur, die in WS-\*-Spezifikationen definiert ist. ADFS unterstützt Sie bei der Verwendung einer einmaligen Anmeldung (Single Sign-on, SSO) zum Authentifizieren von Benutzern für mehrere in Beziehung stehende Webanwendungen innerhalb der Gültigkeitsdauer einer einzelnen Online-Sitzung. Dies wird durch die sichere Freigabe der digitalen Identität und der Zugriffsrechte über Sicherheits- und Unternehmensgrenzen hinweg erreicht.

**Wie kann ich überprüfen, ob ADFS auf meinem Server installiert ist?**  
Um zu überprüfen, ob ADFS auf Ihrem Server installiert ist, klicken Sie auf **Start**, dann auf **Systemsteuerung** und anschließend auf **Software**. Doppelkicken Sie auf **Windows-Komponenten** und suchen Sie nach **Verbunddienste** als installierte Komponente.

**Was ist Windows Server 2003 R2?**  
Windows Server 2003 R2 erweitert das Betriebssystem Windows Server 2003 und stellt dadurch eine effizientere Möglichkeit zum Verwalten und Steuern von Zugriff auf lokale und Remoteressourcen bereit, während es sich problemlos in Ihre vorhandene Windows Server 2003-Umgebung integriert. Windows Server 2003 R2 stellt eine skalierbare Internet-Plattform mit erhöhter Sicherheit mit nahtloser Interoperabilität mit UNIX-basierten Systemen bereit und befähigt neue Szenarien einschließlich vereinfachter Teilstrukturserververwaltung, verbesserter Identitäts- und Zugriffsverwaltung und effizienterer Speicherverwaltung. Windows Server 2003 R2 Datacenter Edition und Windows Server 2003 R2 Enterprise Edition liefern auch eine dynamische neue Lizenzierung, mit der Benutzer mehr Wert aus Servervirtualisierungen schöpfen können.

Weitere Informationen zu Windows Server 2003 R2 finden Sie auf der Website [Windows Server 2003 R2](https://www.microsoft.com/germany/windowsserver2003/default.mspx).

**Was sind WS-\*-Internetspezifikationen?**  

Die Spezifikationen für eine Webdienstearchitektur, die auf Branchenstandards basiert, z. B. Simple Object Access Protocol (SOAP); XML; Web Service Description Language (WSDL) und Universal Description, Discovery, and Integration (UDDI). WS-\* bietet eine Grundlage für vollständige, interoperable Geschäftslösungen für das erweiterte Unternehmen, einschließlich der Möglichkeit, Identitätsverbund und Sicherheit zu verwalten.

Das Webdienstemodell basiert auf der Idee, dass Unternehmenssysteme in unterschiedlichen Sprachen und mit verschiedenen Programmiermodellen geschrieben sind, die auf vielen verschiedenartigen Geräten ausgeführt werden bzw. die darauf zugreifen. Webdienste sind eine Möglichkeit, verteilte Systeme zu erstellen, die problemlos und effizient über das Internet miteinander in Verbindung treten und interagieren können, unabhängig davon, in welcher Sprache sie in geschrieben sind oder auf welcher Plattform sie ausgeführt werden.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in ADFS bzgl. Spoofing der einmaligen Anmeldung – CVE-2009-2508</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in ADFS bzgl. Remotecodeausführung – CVE-2009-2509</th>
...
Sicherheitsanfälligkeit in ADFS bzgl. Spoofing der einmaligen Anmeldung – CVE-2009-2508  
---------------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2508).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in ADFS bzgl. Spoofing der einmaligen Anmeldung – CVE-2009-2508
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer kann nicht auswählen, wen er nachahmen möchte. Ein Angreifer kann nur jemanden nachahmen, dessen Authentifizierungstoken er erhalten konnte, z. B. von einem Internetkiosk.  
-   Ein Angriff ist nur möglich, bevor die Sitzung auf dem Server abläuft. Standardmäßig bleiben Sitzungen für 600 Minuten auf dem Server geöffnet. Wenn ein Angreifer versucht, das Authentifizierungstoken eines Opfers wiederzuverwenden, nachdem jenes Zeitlimit abgelaufen ist, schlägt der Angriff fehl.  
-   Ein Angreifer muss Zugriff auf das Authentifizierungstoken haben, das vom vorherigen Benutzer auf jenem Terminal verwendet wurde. Im Falle eines HTTPS-fähigen Servers ist dieses Authentifizierungstoken während der Übertragung geschützt. Ein Angreifer muss Zugriff auf den Computer des Opfers haben (z. B. ein Internetkiosk), um die Sicherheitsanfälligkeit auszunutzen. In einem Internetkiosk kann der Benutzer sich u. U. bei einer ADFS-Webanwendung mit einmaliger Anmeldung (Single Sign-on, SSO) anmelden und sich dann abmelden. Ein Angreifer kann dann mit jenem Computer als der vorherige Benutzer auf die Webanwendung zugreifen, obwohl der Benutzer sich abgemeldet hat.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in ADFS bzgl. Spoofing der einmaligen Anmeldung – CVE-2009-2508
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in ADFS bzgl. Spoofing der einmaligen Anmeldung – CVE-2009-2508
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Dies ist eine Sicherheitsanfälligkeit durch Spoofing. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann einen anderen Benutzer nachahmen. Dadurch kann der Angreifer als der Zielbenutzer Zugriff auf eine Website erhalten, auf der die einmalige Anmeldung der von Active Directory-Verbunddienste (ADFS) verwendet wird.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit ist vorhanden, weil ADFS die Sitzungsverwaltung nicht ausreichend überprüft.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**    
Auf Systemen mit gemeinsamem Zugriff wie Internetkiosken kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, auf Ressourcen zugreifen, die einem anderen, zuvor authentifizierten Benutzer gehören. Dieser Angriff kann nur in dem vom ADFS-Administrator konfigurierten Sitzungstimeout ausgeführt werden, das standardmäßig auf 600 Minuten konfiguriert ist.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er auf bestimmte Daten im Cache des Browsers zugreift und diese wiederverwendet, um sich bei der Webanwendung zu authentifizieren, die die einmalige Anmeldung (Single Sign-on, SSO) von ADFS implementiert. Nachdem das Zeitlimit für die Sitzung auf dem Server abgelaufen ist, deaktiviert ADFS die authentifizierte Sitzung auf dem Server und ermöglicht dem Angreifer nicht mehr, diese Anmeldeinformationen wiederzuverwenden.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Von dieser Sicherheitsanfälligkeit sind Webserver betroffen, die ADFS für die einmalige Anmeldung verwenden. Diese Sicherheitsanfälligkeit betrifft Clientsysteme nicht direkt.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem Anmeldeinformationen für die Authentifizierung ordnungsgemäß verworfen werden, wenn der Benutzer sich vom Netzwerk abmeldet.
...
Sicherheitsanfälligkeit in ADFS bzgl. Remotecodeausführung – CVE-2009-2509  
--------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-2509](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2509).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in ADFS bzgl. Remotecodeausführung – CVE-2009-2509
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Der Angreifer muss gültige Anmeldeinformationen für den anfälligen Server haben. Ein Angriff kann nur nach erfolgreicher Authentifizierung bei dem Server ausgeführt werden, der ADFS unterstützt.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in ADFS bzgl. Remotecodeausführung – CVE-2009-2509
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in ADFS bzgl. Remotecodeausführung – CVE-2009-2509
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit liegt vor, weil ADFS Anforderungsheader nicht richtig überprüft, die von authentifizierten Clients übermittelt werden.
...
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann versuchen, die Sicherheitsanfälligkeit auszunutzen, indem er eine speziell gestaltete HTTP-Anforderung an einen ADFS-fähigen Webserver sendet. Ein Angreifer muss ein authentifizierter Benutzer sein, um diese Sicherheitsanfälligkeit auszunutzen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
ADFS-fähige Webserver sind gefährdet. Clientsysteme sind von dieser Sicherheitsanfälligkeit nicht betroffen.
  
**Was bewirkt das Update?**    
Dieses Update korrigiert die Überprüfung, die ADFS-fähige Webserver auf Anforderungsheader anwenden, die von einem Webclient gesendet werden.
...
<td style="border:1px solid black;">Für alle unterstützten 32-Bit-Editionen von Windows Server 2003 R2 mit ADFS:<br />
WindowsServer2003-KB971726-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für alle unterstützten x64-basierten-Editionen von Windows Server 2003 R2 mit ADFS:<br />
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB971726$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/971726">Microsoft Knowledge Base-Artikel 971726</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für alle unterstützten 32-Bit-Editionen von Windows Server 2008 mit ADFS:<br />
Windows6.0-KB971726-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für alle unterstützten x64-basierten Editionen von Windows Server 2008 mit ADFS:<br />
...
-   V1.1 (9. Dezember 2009): Die Einträge für **SMS 2.0** und **SMS 2003 mit SUIT** für Windows Server 2003 x64 Edition Service Pack 2 in der SMS-Tabelle wurden korrigiert. Dies ist lediglich eine Informationsänderung.
