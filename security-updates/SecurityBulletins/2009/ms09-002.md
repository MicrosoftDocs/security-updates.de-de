---
TOCTitle: 'MS09-002'
Title: 'Microsoft Security Bulletin MS09-002 - Kritisch'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61224541
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-002(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 10. Februar 2009 | Aktualisiert: Montag, 16. Februar 2009
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 961260](https://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2009-0075
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei CSS – CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2009-0075
...
-   Diese Sicherheitsanfälligkeit betrifft nur Windows Internet Explorer 7. Sie betrifft keine unterstützten Versionen von Microsoft Internet Explorer 5 und Microsoft Internet Explorer 6.

#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2009-0075
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2009-0075
...
Es liegt eine Sicherheitsanfälligkeit vor, die eine Remotecodeausführung ermöglicht und dadurch verursacht wird, wie Internet Explorer Cascading Style Sheets (CSS) verarbeitet. Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Website erstellt. Wenn ein Benutzer die Website anzeigt, kann die Sicherheitsanfälligkeit die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der angemeldete Benutzer erlangen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-0076](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei CSS – CVE-2009-0076
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei CSS – CVE-2009-0076
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei CSS – CVE-2009-0076
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Wenn Internet Explorer eine Webseite anzeigt, die bestimmte CSS-Stile enthält, kann der Speicher so beschädigt werden, dass ein Angreifer im Kontext des angemeldeten Benutzers beliebigen Code ausführen kann.
...
**Was ist CSS?**  
CSS oder Cascading Style Sheets ist eine Formatierungsmethode für Websites, bei denen HTML verwendet wird. Weitere Informationen zu CSS finden Sie auf der [Microsoft TechNet Website](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true).

**Was bewirkt das Update?**  
Das Update behebt die Art und Weise, in der Internet Explorer Cascading Style Sheets verarbeitet.
...
| Windows Server 2003 Service Pack 1 und Microsoft Windows Server 2003 Service Pack 2                                   | Nein    | Nein               | Ja                                                                        | Ja                         |
...
<td style="border:1px solid black;">Internet Explorer 7 für alle unterstützten Editionen von Windows XP:<br />
Verwenden Sie die Option „Software“ in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie7updates\KB961260-IE7\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/961260">Microsoft Knowledge Base-Artikel 961260</a>.</td>
</tr>
<tr class="even">
...
-   [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2009-0075).  
-   Sam Thomas ([https://eshu.co.uk](https://eshu.co.uk/)/) in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei CSS (CVE-2009-0076).
...
-   V1.1 (16. Februar 2009): Dem Abschnitt „Bekannte Probleme“ in der **Kurzzusammenfassung** wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 961260 hinzugefügt.
