---
TOCTitle: 'MS09-041'
Title: 'Microsoft Security Bulletin MS09-041 - Kritisch'
ms:assetid: 'ms09-041'
ms:contentKeyID: 61224580
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms09-041(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-041 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP und Windows Server 2003 als Hoch und für alle unterstützten Editionen von Windows Vista und Windows Server 2008 als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Arbeitsstationsdienst Speicher zuweist und freigibt. Weitere Informationen zu der Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9c0e5bff-c248-4e87-a83b-82ba52f5299d)                                                              | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7b64a454-d383-47e3-b469-b87e2b3c1a9f)                                                                                  | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9cb0477f-0656-47f5-bd35-5716e0572fbd)                                                                                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=96fbf65f-1db2-432d-92a0-6669d8abaeb0)                                                                       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=11321f48-8997-4b99-982a-3ba4ad3f5992)                                                             | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Vista, Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=979ac9da-940f-49e7-91a2-b12db3708076)                                         | DoS (Denial of Service)        | Mittel                           | Keine                                             |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b9aa04cc-a5c5-47ae-bf0f-250cff275d26)     | DoS (Denial of Service)        | Mittel                           | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=24c77c27-0b7d-4a35-a871-b453f90e5913)\*                   | DoS (Denial of Service)        | Mittel                           | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=48d0432e-704a-4bbb-b0a1-cd14069a8e93)\*       | DoS (Denial of Service)        | Mittel                           | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c119223c-f4e0-449b-8e7b-a6bf11c98f94) | DoS (Denial of Service)        | Mittel                           | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung – CVE-2009-1544</th>
...
Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung – CVE-2009-1544  
-------------------------------------------------------------------------------------------
  
Im Windows-Arbeitsstationsdienst liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die durch eine mögliche „Double Free“-Bedingung im Dienst verursacht wird. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code mit erhöhten Berechtigungen ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2009-1544](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung – CVE-2009-1544
...
-   Ein Angreifer muss über gültige Anmeldeinformationen für ein betroffenes System verfügen, um diese Sicherheitsanfälligkeit ausnutzen zu können. Die Sicherheitsanfälligkeit kann nicht von anonymen Benutzern ausgenutzt werden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung – CVE-2009-1544
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung – CVE-2009-1544
...
Der Windows-Arbeitsstationsdienst führt keine richtige Zuweisung und Freigabe von Speicher durch, wenn speziell gestaltete RPC-Nachrichten empfangen werden.
  
**Was ist der Arbeitsstationsdienst?**    
Der Arbeitsstationsdienst ist eine Windows-Komponente, die das Weiterleiten von Ressourcenanforderungen für Remotedateien und Netzwerkdruck unterstützt. Sowohl Anforderungen des lokalen Dateisystems als auch Remotedatei- oder Druckanforderungen über das Netzwerk werden durch den Arbeitsstationsdienst weitergeleitet. Der Dienst stellt fest, wo sich die Ressource befindet, und leitet die Anforderung dann an das lokale Dateisystem oder die Netzwerkkomponenten weiter. Wenn der Arbeitsstationsdienst beendet wird, wird bei allen Anforderungen davon ausgegangen, dass es sich um lokale Anforderungen handelt
...
Diese Dienste sind für den Zugriff auf Ressourcen in einem Netzwerk sowie zum Durchführen der Domänenauthentifizierung erforderlich. Die Internetverbindung und die Browserfunktionen für eigenständige Systeme, z. B. im Falle von Benutzern mit DFÜ-, DSL- oder Kabelmodemverbindungen, sollten nicht betroffen sein, wenn diese Dienste deaktiviert werden.
  
**Hinweis:** Der Microsoft Baseline Security Analyzer funktioniert nicht, wenn der Arbeitsstationsdienst deaktiviert ist.
...
Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete RPC-Nachricht erstellt und an ein betroffenes System sendet. Die Nachricht kann dann dem authentifizierten Client ermöglichen, beliebige Daten in den Speicher im Adressbereich des Arbeitsstationsdiensts zu schreiben.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Alle Systeme mit aktiviertem Arbeitsstationsdienst sind gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Arbeitsstationsdienst Speicher zuweist und freigibt.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB971657$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/971657">Microsoft Knowledge Base-Artikel 971657</a>.</td>
</tr>
<tr class="even">
...
-   Cody Pierce von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Arbeitsstationsdienst durch Speicherbeschädigung (CVE-2009-1544)
