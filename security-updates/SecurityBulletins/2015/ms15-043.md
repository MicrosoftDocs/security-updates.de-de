...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Bewertung des Schweregrads und Sicherheitsauswirkung</th>
...
Windows-Server:<br />
<strong>Niedrig/EoP</strong><sup>[1]</sup></td>
<td style="border:1px solid black;">Windows-Clients:<br />
<strong>Hoch/EoP<br />
</strong><br />
Windows-Server:<br />
