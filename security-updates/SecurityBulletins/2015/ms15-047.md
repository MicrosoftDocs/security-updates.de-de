...
<td style="border:1px solid black;">
[**Sicherheitsanfälligkeit in SharePoint bezüglich Seiteninhalten – CVE-2015-1700**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1700)
</td>
<td style="border:1px solid black;">
**Bewertung des Gesamtschweregrads**
</td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2015-1700](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1700).
