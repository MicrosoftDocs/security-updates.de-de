...
<td style="border:1px solid black;">
[Microsoft .NET Framework 1.1 Service Pack 1](https://www.microsoft.com/de-de/download/details.aspx?id=46531)  
(3037572)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/de-de/download/details.aspx?id=46534)  
(3037577)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4](https://www.microsoft.com/de-de/download/details.aspx?id=46532)<sup>[1]</sup>
(3037578)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/de-de/download/details.aspx?id=46542)  
(3037573)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.5/4.5.1/4.5.2](https://www.microsoft.com/de-de/download/details.aspx?id=46529)  
(3037581)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/de-de/download/details.aspx?id=46528)  
(3037574)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5](https://www.microsoft.com/de-de/download/details.aspx?id=46530)  
(3037575)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.5/4.5.1/4.5.2](https://www.microsoft.com/de-de/download/details.aspx?id=46488)  
(3037580)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5](https://www.microsoft.com/de-de/download/details.aspx?id=46533)  
(3037576)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.5.1/4.5.2](https://www.microsoft.com/de-de/download/details.aspx?id=46485)  
(3037579)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<td style="border:1px solid black;">
[**Sicherheitsanfälligkeit in ASP.NET bezüglich Offenlegung von Informationen – CVE-2015-1648**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1648)
</td>
<td style="border:1px solid black;">
**Bewertung des Gesamtschweregrads**
</td>
...
Die Standardeinstellung in der Datei "web.config" lautet wie folgt:

```
    <customErrors mode="remoteOnly" />  
```

In einer Produktionsumgebung empfiehlt es sich, diesen Eintrag wie folgt zu ändern:

```
    <customErrors mode="On" defaultRedirect="ErrorPage.htm" />   
```
    
Im Allgemeinen sollten Entwickler in Produktionsumgebungen nie Folgendes verwenden:
...
-   V2.0 (12. Mai 2015): Dieses Bulletin wurde erneut veröffentlicht, um Probleme mit dem Update 3037580 für Microsoft .NET Framework 4.5/4.5.1/4.5.2 unter betroffenen Editionen von Microsoft Windows zu beheben. Benutzern, die diese Versionen von .NET Framework ausführen, wird empfohlen, die [neue Version des Updates 3037580](https://www.microsoft.com/de-de/download/details.aspx?id=46488) zu installieren, um vor der in diesem Bulletin erörterten Sicherheitsanfälligkeit geschützt zu sein. Weitere Informationen hierzu finden Sie im [Microsoft Knowledge Base-Artikel 3037580](https://support.microsoft.com/de-de/kb/3037580).
