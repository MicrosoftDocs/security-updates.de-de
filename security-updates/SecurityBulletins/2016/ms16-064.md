---
TOCTitle: 'MS16-064'
Title: 'Microsoft-Sicherheitsbulletin MS16-064 – Kritisch'
ms:assetid: 'ms16-064'
ms:contentKeyID: 72963766
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms16-064(v=Security.10)'
---

Microsoft-Sicherheitsbulletin MS16-064 – Kritisch
=================================================

Sicherheitsupdate für Adobe Flash Player (3157993)
--------------------------------------------------
...
Weitere Informationen zu diesem Update finden Sie im [Microsoft Knowledge Base-Artikel 3163207](https://support.microsoft.com/de-de/kb/3163207).

Informationen zu Sicherheitsanfälligkeiten
------------------------------------------

Dieses Sicherheitsupdate behebt die folgenden in Adobe Security Bulletin [APSB16-15](https://helpx.adobe.com/de/security/products/flash-player/apsb16-15.html) beschriebenen Sicherheitsanfälligkeiten:
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/de-de/download/details.aspx?id=52273)  
(3163207)
</td>
<td style="border:1px solid black;">
**Kritisch**  
...
<td style="border:1px solid black;">
3157993, vormals in diesem Bulletin.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   V1.1 (10.05.16): Das Bulletin wurde überarbeitet, um vorübergehend einen inaktiven Link für das Adobe Security Bulletin APSB16-15 auf die Version des Adobe Security Advisory APSA16-02 vom Mai 2016 umzuleiten. Die Umleitung erfolgt in der Zeit vor der Veröffentlichung der Version des Adobe Security Bulletins für Mai 2016. Diese Änderung dient lediglich zur Information.
-   V2.0 (13.05.16): Bulletin wurde überarbeitet, um die Veröffentlichung des Updates 3163207 anzukündigen, das sich mit den im Adobe Security Bulletin APSB16-15 enthaltenen Schwachstellen befasst. Beachten Sie, dass das Update 3163207 das zuvor in diesem Bulletin (Update 3157993) veröffentlichte Update ersetzt. Microsoft empfiehlt allen Kunden dringend, das Update3163207 zu installieren, um sich vor den im Adobe Adobe Security Bulletin APSB16-15 beschriebenen Schwachstellen zu schützen.

*Seite generiert am 12.05.16 um 15:12:00-07:00.*