...
<td style="border:1px solid black;">
[**Sicherheitsanfälligkeit in Windows-SMB-Server durch Erhöhung von Berechtigungen – CVE-2016-3225**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3225)
</td>
<td style="border:1px solid black;">
**Ersetzte Updates**\*
</td>
...
**Hinweis** Windows Server Technical Preview 5 ist betroffen. Kunden, die dieses Betriebssystem ausführen, sind angehalten, das Update zu installieren, das über [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) verfügbar ist.
