...
Microsoft bietet die in [Microsoft Security Bulletin MS08-030 – Sicherheitsanfälligkeit im Bluetooth-Stack kann Remotecodeausführung ermöglichen (951376)](http://go.microsoft.com/fwlink/?linkid=119619) behandelten Updates aufgrund von Problemen erneut an, die die Updates für Windows XP Service Pack 2 und Windows XP Service Pack 3 betreffen. Die in [Microsoft Security Bulletin MS08-030](http://go.microsoft.com/fwlink/?linkid=119619) für Windows XP Service Pack 2 und Windows XP Service Pack 3 angebotenen Updates haben die im Security Bulletin erörterte Sicherheitsanfälligkeit nicht vollständig behoben. Alle anderen Versionen des Sicherheitsupdates bieten Schutz gegen die im Security Bulletin diskutierten Probleme.
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 951376](http://support.microsoft.com/kb/951376).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1453](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1453).
...
**Was ist Bluetooth?**    
Bluetooth ist ein dem Branchenstandard entsprechendes Protokoll, das drahtlose Verbindungen für Computer, Handheld-Geräte, Mobiltelefone und andere Geräte ermöglicht. Weitere Informationen finden Sie im [MSDN Bluetooth-Artikel](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/951376">Microsoft Knowledge Base-Artikel 951376</a>.</td>
</tr>
<tr class="even">
...
-   Tombkeeper von [NSFocus](http://www.nsfocus.com/) und Sowhat von [Nevis Labs](http://www.nevisnetworks.com/) für die Hilfe bei der erneuten Veröffentlichung des Updates für die Sicherheitsanfälligkeit in Bluetooth – (CVE-2008-1453).
