...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista und Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3f21a8a2-9861-4fef-9d1e-caf5f7822c1a)                         | Offenlegung von Informationen  | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition und Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=aa04a754-fbfb-42a7-89d2-14373e3f4742) | Offenlegung von Informationen  | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c3363df6-39dc-4910-9ce5-66553155378e)\*                               | Offenlegung von Informationen  | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=39dd1722-412b-469d-a475-b6513764838c)\*                         | Offenlegung von Informationen  | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e9c6cd46-30ad-46ee-9c8b-d0b446e660c4)                       | Offenlegung von Informationen  | Hoch                             | Keine                                             |
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 953733](https://support.microsoft.com/kb/953733).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in IPSec-Richtlinie durch Offenlegung von Informationen – CVE-2008-2246</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-2246](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2246).
...
-   Aktivieren Sie die „Standardantwortregel“ nicht, wenn Sie eine IPSec-Richtlinie erstellen, oder deaktivieren Sie diese Regel in vorhandenen Richtlinien. Diese Regel gilt unter Windows Vista und Windows Server 2008 nicht mehr und ist nur unter früheren Versionen von Windows anwendbar. Weitere Informationen zum Emulieren dieser Regel in Windows Vista und Windows Server 2008 finden Sie im [Microsoft Knowledge Base-Artikel 942964](https://support.microsoft.com/kb/942964/).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/953733">Microsoft Knowledge Base-Artikel 953733</a>.</td>
</tr>
<tr class="odd">
