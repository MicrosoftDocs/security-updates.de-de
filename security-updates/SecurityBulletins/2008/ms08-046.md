---
TOCTitle: 'MS08-046'
Title: 'Microsoft Security Bulletin MS08-046 - Kritisch'
ms:assetid: 'ms08-046'
ms:contentKeyID: 61224507
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms08-046(v=Security.10)'
---
...
Sicherheitsanfälligkeit im Microsoft Windows-Farbverwaltungssystem kann Remotecodeausführung ermöglichen (952954)
-----------------------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=db455d17-435f-46d7-b2dd-5babb5a1eeb3)                                                                                 | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d313f42c-f43f-48ea-82ef-3bc33077c7fa)                                                               | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3150c6b8-f50b-4b84-a7ce-c8daf77c080c)                                           | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=828d8fdc-8534-4621-85a5-08aec255496f)                                             | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 x64 Edition und Microsoft Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=0a13776f-d543-41df-b904-d51e368c81cc)                          | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 mit SP1 für Itanium-basierte Systeme und Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9566493f-4260-4072-947a-527887d2cd63) | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 952954](https://support.microsoft.com/kb/952954).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem – CVE-2008-2245</th>
...
Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem – CVE-2008-2245  
--------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit vor, die eine Remotecodeausführung ermöglicht und durch die Art und Weise verursacht wird, wie das Microsoft-Farbverwaltungssystem-Modul (MSCMS) der ICM-Komponente von Microsoft die Speicherzuordnung verarbeitet. Die Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen, wenn ein Benutzer eine speziell gestaltete Bilddatei öffnet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Berechtigungen erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-2245](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2245).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem – CVE-2008-2245
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem – CVE-2008-2245
...
-   **Deaktivieren Sie die Metafile-Verarbeitung, indem Sie die Registrierung ändern**  
    Kunden, die MS07-017 installiert haben, können die Metafile-Verarbeitung deaktivieren, indem sie die Registrierung ändern. Durch diese Einstellung wird das betroffene System vor Versuchen geschützt, diese Sicherheitsanfälligkeit auszunutzen.  
...
-   Einige Szenarios, bei denen OLE-Darstellung verwendet wird, werden gestört. Dies geschieht meistens, wenn der Objektserver nicht aktiv ist.
    ...
    **So machen Sie die Problemumgehung rückgängig:**
    ...
    2.  Suchen Sie den folgenden Registrierungsunterschlüssel, und klicken Sie darauf:  
        HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\GRE\_Initialize  
    3.  Löschen Sie den Wert „DisableMetaFiles“.
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem – CVE-2008-2245
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann eine Remotecodeausführung ermöglichen. Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit wird durch einen Heapüberlauf verursacht, wenn das Microsoft-Farbverwaltungssystem-Modul (MSCMS) der ICM-Komponente von Microsoft einer speziell gestalteten Bilddatei auf falsche Weise Speicher zuweist.
  
**Was ist ICM?**    
Image Color Management (ICM) ist ein Farbverwaltungssystem, das Daten in ICC-Profilen analysiert und verwendet, um Farbkonvertierungsvorgänge durchzuführen. Gleichmäßige Farbe über verschiedene Bildschirme und Ausgabearten kann für Inhaltsherausgeber problematisch sein. In der Verlagsindustrie beispielsweise kann gleichmäßige Farbe im gesamten kommerziellen Veröffentlichungsprozess sowohl Zeit als auch Geld sparen. Designer möchten sicherstellen, dass das gedruckte Material ihrer Kunden die gleichen Ergebnisse erzielt, wenn der Auftrag an ein Dienstleistungsunternehmen, ein Geschäft oder einen Drucker übergeben wird, und dass es auch dann toll aussieht, wenn es im Internet zur Verfügung gestellt wird. Unterschiede im Farbraum, im Farbskalabereich und in der Farbskalakurve sind in den meisten Fällen aufgrund der Einschränkungen der entsprechenden Geräte oder der Medien unvermeidlich. Es kann jedoch auf diese Unterschiede getestet werden, die dann mit einem der vielen Software- und Hardwareprodukte, die derzeit auf dem Markt verfügbar sind, in einem ICC-Profil aufgezeichnet werden. Diese ICC-Profile werden dann an das restliche ICM-System weitergegeben, um sicherzustellen, dass Farben den Benutzern genau präsentiert werden, unabhängig von dem verwendeten Gerät. Weitere Informationen zu ICM finden Sie auf dieser [Microsoft-Website](https://www.microsoft.com/whdc/archive/icmwp.mspx).
  
**Was ist das ICC (International Color Consortium)?**    
Das ICC (Internationales Farbkonsortium) ist eine Organisation, die einen Standard bereitstellt, anhand dessen Anbieter die Farbverwaltung implementieren können, um die Kompatibilität zwischen den Anbietern sicherzustellen. Weitere Informationen zum ICC finden Sie auf folgender [Website.](https://www.color.org/)
...
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Bilddatei oder ein Office-Dokument, in die eine speziell gestaltete Bilddatei eingebettet ist, an den Benutzer sendet und ihn dazu verleitet, das Dokument zu öffnen oder die E-Mail anzuzeigen, in der die speziell gestaltete Bilddatei enthalten ist.
  
In einem webbasierten Angriffsszenario muss ein Angreifer eine Website mit einer Bilddatei einrichten, mit der versucht wird, diese Sicherheitsanfälligkeit auszunutzen. Außerdem können manipulierte Websites und Websites, die von Benutzern bereitgestellte Inhalte akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden kann. Ein Angreifer kann Benutzer nicht zum Besuch einer speziell gestalteten Website zwingen. Der Angreifer müsste stattdessen den Benutzer zum Besuch dieser Webseite verleiten. Zu diesem Zweck wird der Benutzer meist dazu gebracht, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zur Website des Angreifers zu klicken.
...
Das Sicherheitsupdate behebt diese Sicherheitsanfälligkeit, indem geändert wird, wie das Microsoft-Farbverwaltungssystem (MSCMS) beim Verarbeiten von Bilddateien Speicher zuweist.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Verwenden Sie die Option „Software“ in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallkb952954$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/952954">Microsoft Knowledge Base-Artikel 952954</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation</strong></td>
<td style="border:1px solid black;">Verwenden Sie die Option Software in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallkb952954$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/952954">Microsoft Knowledge Base-Artikel 952954</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation</strong></td>
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallkb952954$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/952954">Microsoft Knowledge Base-Artikel 952954</a>.</td>
...
-   Jun Mao von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Microsoft-Farbverwaltungssystem (CVE-2008-2245).
...
-   V1.0 (10. August 2008): Bulletin veröffentlicht.
