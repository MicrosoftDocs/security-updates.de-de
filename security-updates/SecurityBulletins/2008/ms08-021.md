...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 948590](https://support.microsoft.com/kb/948590) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=caac000a-22b6-48cb-aa00-1a0bfe886de2)                                                                                 | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c2763dd8-a03e-4a48-aa86-a7ec00250a7a)                                                                                             | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=166f2ab5-913c-47a9-86fe-b814797b751e)                                           | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bee91d80-d49a-4d3d-82d6-d5aa63f54979)                                             | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows Server 2003 x64 Edition und Microsoft Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e3dde449-e062-4ce0-a9f4-433bff23e224)                          | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows Server 2003 mit SP1 für Itanium-basierte Systeme und Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7886a802-f2b5-489c-b14b-631f4c4c0742) | Remotecodeausführung           | Kritisch                         | [MS07-046](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-046.mspx) |
| [Windows Vista und Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9b51deb8-3873-4146-977f-7e3d0840a4c5)                                                                        | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| [Windows Vista x64 Edition und Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4ad6dcd1-6ea5-43bf-8bee-a5f507beadc6)                                                | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| [Windows Server 2008 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=006d5c47-53e6-4ee1-932c-497611804938)                                                                                | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| [Windows Server 2008 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8909f144-655b-4f07-916f-fd967f1efb2b)                                                                          | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| [Windows Server 2008 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b7771a4a-4e4f-48d1-8551-bb8b778ca5a7)                                                                      | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |

Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate
---------------------------------------------------------------------------

**Welches sind die bekannten Probleme, die bei der Deinstallation dieses Sicherheitsupdates auftreten können?**  
Im [Microsoft Knowledge Base-Artikel 948590](https://support.microsoft.com/kb/948590) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Es gibt Binärdateien, die von den in MS08-025 (Kernel) und MS08-021 (GDI) angebotenen Sicherheitsupdates gemeinsam verwendet werden. Wenn Sie die von MS08-025 (Kernel) angebotenen Sicherheitsupdates gefolgt von MS08-021 (GDI) installieren und dann das von MS08-025 (Kernel) angebotene Update deinstallieren, kann das von MS08-021 (GDI) angebotene Update wieder zu der anfälligen Version zurückkehren. Dies führt dazu, dass das Update MS08-021 (GDI) dem anfälligen System wieder angeboten wird.

**Wo befinden sich die Dateiinformationen?**  
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 948590](https://support.microsoft.com/kb/948590).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1083).
...
Weitere Informationen zu Bildtypen und -formaten finden Sie im [Microsoft Knowledge Base-Artikel 320314](https://support.microsoft.com/kb/320314/de). Weitere Informationen zu diesen Dateiformaten sind auch auf der [Website der MSDN-Bibliothek](https://msdn2.microsoft.com/en-us/library/ms536391.aspx) verfügbar.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1087).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/948590">Microsoft Knowledge Base-Artikel 948590</a>.</td>
</tr>
<tr class="even">
...
-   Jun Mao von [iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in GDI bezüglich Heapüberlaufs (CVE-2008-1083).  
-   Sebastian Apelt von [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in GDI bezüglich Heapüberlaufs (CVE-2008-1083).  
-   Thomas Garnier von [SkyRecon](https://www.skyrecon.com/) für den Hinweis auf die Sicherheitsanfälligkeit in GDI bezüglich Heapüberlaufs (CVE-2008-1083).  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeiten in GDI bezüglich Stapel- und Heapüberlaufs (CVE-2008-1087 und CVE-2008-1083).
