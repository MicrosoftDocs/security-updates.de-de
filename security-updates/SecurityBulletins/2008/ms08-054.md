...
|--------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| Windows XP Service Pack 2 und Windows XP Service Pack 3                                    | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d5891180-5dd1-49ec-bcc6-3030a544202c) | Remotecodeausführung           | Kritisch                         | Keine                                             |
| Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2 | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c)                | Remotecodeausführung           | Kritisch                         | Keine                                             |
| Windows Vista und Windows Vista Service Pack 1                                             | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e) | Remotecodeausführung           | Kritisch                         | Keine                                             |
| Windows Vista x64 Edition und Windows Vista x64 Edition Service Pack 1                     | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=334352e7-d41f-494f-866d-f1f1745ffd17) | Remotecodeausführung           | Kritisch                         | Keine                                             |
| Windows Server 2008 für 32-Bit-Systeme\*                                                   | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc) | Remotecodeausführung           | Kritisch                         | Keine                                             |
| Windows Server 2008 für x64-basierte Systeme\*                                             | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3906512b-26db-473e-b522-3883ff34a21c) | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 954154](https://support.microsoft.com/kb/954154).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-2253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253).
...
Eine serverseitige Wiedergabeliste (SSPL) ist eine Liste, anhand der identifiziert wird, welcher Inhalt für einen Client wiedergegeben wird, der Zeitpunkt, zu dem der Inhalt wiedergegeben wird, sowie die Reihenfolge, in der der Inhalt wiedergegeben wird. Die SSPL für einen Windows Media Server ist ein XML-Dokument. Weitere Informationen zu SSPL finden Sie in [Serverseitige Wiedergabelisten](https://msdn.microsoft.com/en-us/library/ms753585(vs.85).aspx).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/954154">Microsoft Knowledge Base-Artikel 954154</a>.</td>
</tr>
<tr class="even">
