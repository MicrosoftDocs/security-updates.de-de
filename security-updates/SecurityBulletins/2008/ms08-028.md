...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 950627](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/950627.mspx) beschrieben wurde. Zusätzlich zur Installation dieses Updates wird empfohlen, dass Benutzer mit Microsoft Word auch die Updates installieren, die im [Microsoft Security Bulletin MS08-026: Sicherheitsanfälligkeiten in Microsoft Word können Remotecodeausführung ermöglichen (951207)](https://go.microsoft.com/fwlink/?linkid=117295) bereitgestellt werden, um den Schutz gegen die Angriffsmethode dieser Art von Angriffen auf dem neuesten Stand zu halten.
...
|----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                    | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=0de12d09-e675-4cf0-bc6f-e42eeb4784a1)\* | Remotecodeausführung           | Kritisch                         | [MS04-014](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms04-014.mspx) |
| Windows XP Service Pack 2                                | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3247433f-0aa9-49b8-9e40-c5463a95bcff)\* | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| Windows XP Professional x64 Edition                      | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?familyid=4915ebc4-5e7b-493e-b8c4-321d40d9a701)\*                | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| Windows Server 2003 Service Pack 1                       | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=86e3ed62-98f7-46ec-96ab-5e8c123b1288)\* | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| Windows Server 2003 x64 Edition                          | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?familyid=5dfc867b-74b7-4818-9fc2-d71e7c9d2e38)\*                | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
| Windows Server 2003 mit SP1 für Itanium-basierte Systeme | [Microsoft Jet 4.0-Datenbankengine](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3452119b-ba4c-4272-82ec-97396b2c2c3d)\* | Remotecodeausführung           | Kritisch                         | Keine                                                                                   |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026).
...
-   **Blockieren Sie die Verarbeitung von MDB-Dateien durch Ihre E-Mail-Infrastruktur.**
    ...
    **Hinweis**: Alle Jet-Datenbankdateien sollten als unsichere Dateitypen für gemeinsame Benutzer behandelt werden. Microsoft empfiehlt, per E-Mail übertragene Datenbankdateien als verdächtig zu behandeln.
    ...
    Weitere Informationen zu Konfigurationen, die für Benutzer von Microsoft Exchange spezifisch sind, die Forefront-Technologien (früher Antigen) verwenden, finden Sie in [Microsoft Forefront Server Security: Filtern nach Dateien](https://technet.microsoft.com/en-us/library/bb795068.aspx).
  
    Diese Informationen wurden Mitgliedern der [Microsoft Security Response Alliance](https://www.microsoft.com/security/msra/default.mspx)zur Verfügung gestellt. Wenn Sie die MSRA-Tools zum Erkennen von MDB-Dateien verwenden möchten, wenden Sie sich an die auf der MSRA-Homepage aufgeführten Anbieter.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit  [CVE-2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026)zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/950749">Microsoft Knowledge Base-Artikel 950749</a>.</td>
</tr>
<tr class="even">
...
-   [CERT/CC](https://www.cert.org/) für den Hinweis auf das Problem – CVE-2007-6026
-   [ISC/SANS](https://isc.sans.org/) für den Hinweis auf das Problem – CVE-2007-6026
-   Aaron Portnoy von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf das Problem – CVE-2007-6026
