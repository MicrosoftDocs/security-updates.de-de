...
|-----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| Windows XP Professional Service Pack 2                                                                                | [Microsoft Internet-Informationsdienste 5.1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2b498065-d682-4227-b23e-d234d7d6a3fe)  | Remotecodeausführung           | Hoch                             | [MS06-034](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-034.mspx) |
| Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2                            | [Microsoft Internet Information Services 6.0](https://www.microsoft.com/download/details.aspx?familyid=df9875f7-04d6-486e-bdb5-35e9e305fa1d)                | Remotecodeausführung           | Hoch                             | [MS06-034](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-034.mspx) |
| Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2                                             | [Microsoft Internet Information Services 6.0](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6583e798-d16d-419c-aee1-30c3e6c635b3) | Remotecodeausführung           | Hoch                             | [MS06-034](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-034.mspx) |
| Windows Server 2003 x64 Edition und Windows Server 2003 x64 Edition Service Pack 2                                    | [Microsoft Internet Information Services 6.0](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e8286174-8209-409f-8805-e534715a741c) | Remotecodeausführung           | Hoch                             | [MS06-034](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-034.mspx) |
| Windows Server 2003 mit SP1 für Itanium-basierte Systeme und Windows Server 2003 mit SP2 für Itanium-basierte Systeme | [Microsoft Internet Information Services 6.0](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=29faa70d-f1ac-4da4-b72a-faf1973cd845) | Remotecodeausführung           | Hoch                             | [MS06-034](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-034.mspx) |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0075).
...
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann dann auf dem IIS-Server jede Aktion mit den gleichen Rechten wie die Arbeitsprozessidentität (Worker Process Identity, WPI) ausführen, die standardmäßig mit Netzwerkdienst-Kontoberechtigungen konfiguriert ist. Dienste, die mit Netzwerkdienst-Kontenberechtigungen konfiguriert sind, erhalten Zugriff auf der Ebene authentifizierter Benutzer, aber keinen Zugriff auf administrativer Ebene. Weitere Informationen finden Sie unter [NetworkService-Konto](https://msdn2.microsoft.com/en-us/library/ms684272(vs.85).aspx). IIS-Server, deren Anwendungspool mit einer WPI konfiguriert ist, die ein Konto mit Administratorrechten verwendet, können stärker betroffen sein als IIS Server, deren Anwendungspool mit den Standard-WPI-Einstellungen konfiguriert ist.
  
Das Netzwerkdienstkonto verwendet die Anmeldeinformationen des Computers, wenn es sich von einem Remotestandort aus authentifiziert, verfügt aber auf dem Server selbst über eine deutlich geringere Berechtigungsebene und besitzt deshalb keine lokalen Administratorrechte. Weitere Informationen finden Sie unter [NetworkService-Konto](https://msdn2.microsoft.com/en-us/library/ms684272(vs.85).aspx), [IIS und integrierte Konten (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/3648346f-e4f5-474b-86c7-5a86e85fa1ff.mspx), [Konfigurieren von Arbeitsprozessidentitäten (IIS 6.0)](https://technet2.microsoft.com/windowsserver/de/library/ee6c6b61-9048-460b-b94c-5f69498b07441031.mspx?mfr=true)und [Konfigurieren von Anwendungspools in IIS 6.0 (IIS 6.0)](https://technet2.microsoft.com/windowsserver/de/library/c7f09f1c-b238-42a4-9d57-c5732485eba91031.mspx?mfr=true).
...
Arbeitsprozesse sind Prozesse, die die serverseitigen Verarbeitungstasks für einen Webserver ausführen **.**Informationen zu Arbeitsprozessen sowie zu ihrer Implementierung in IIS 6.0 finden Sie unter [Arbeitsprozesse (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/29f53968-0115-451f-b26d-5ad58d87b5d1.mspx). Zusätzliche Informationen zu Arbeitsprozessen sowie dazu, wie sie webbasierte Anwendungen isoliert ausführen, finden Sie unter [Arbeitsprozess-Isolationsmodus (IIS 6.0)](https://technet2.microsoft.com/windowsserver/de/library/36ce175c-181a-44ad-988a-395798af4d951031.mspx?mfr=true).
