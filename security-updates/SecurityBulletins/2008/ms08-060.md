...
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| Microsoft Windows 2000 Server Service Pack 4 | [Active Directory](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8ed7bb9a-4b26-49d7-8c14-60226d2bc20d) | Remotecodeausführung           | Kritisch                         | [MS08-035](https://go.microsoft.com/fwlink/?linkid=111953) |
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 957280](https://support.microsoft.com/kb/957280).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4023).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/957280">Microsoft Knowledge Base-Artikel 957280</a>.</td>
</tr>
<tr class="even">
...
-   Paul Miseiko von [nCircle](https://www.ncircle.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Active Directory durch Überlauf (CVE-2008-4023).
