...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-003.mspx">MS07-003</a></td>
</tr>
<tr class="even">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-0110](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110).
...
-   Greg MacManus von [iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Outlook bezüglich URI (CVE-2008-0110)
