...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1437](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1437).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1438](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1438).
...
Anweisungen zum Konfigurieren von Microsoft Antigen finden Sie auf der folgenden [Microsoft-Website](https://technet.microsoft.com/library/bb914029.aspx).
...
Anweisungen zum Konfigurieren der Forefront Server Security für Exchange Server-Module finden Sie auf der folgenden [Microsoft-Website](https://technet.microsoft.com/library/bb795069.aspx).
...
Anweisungen zum Konfigurieren der Forefront Server Security für SharePoint-Module finden Sie auf der folgenden [Microsoft-Website](https://technet.microsoft.com/library/bb795181.aspx).
...
-   SoWhat von [Nevis Labs](https://www.nevisnetworks.com) für den Hinweis auf die Sicherheitsanfälligkeit im Microsoft-Modul zum Schutz vor schädlicher Software – (CVE-2008-1437).
-   SoWhat von [Nevis Labs](https://www.nevisnetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Microsoft-Modul zum Schutz vor schädlicher Software – (CVE-2008-1438).
