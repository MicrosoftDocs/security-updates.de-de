...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 955179](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/955179.mspx) beschrieben wurde.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms03-038.mspx">MS03-038</a></td>
</tr>
<tr class="even">
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 955617](https://support.microsoft.com/kb/955617).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-2463](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463).
...
Ja. Diese Sicherheitsanfälligkeit wurde öffentlich gemeldet und wurde allgemein als „Sicherheitsanfälligkeit durch Racebedingung im Microsoft Office ActiveX-Steuerelement Snapshot Viewer“ bezeichnet. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2008-2463](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit [CVE-2008-2463](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2463) zugewiesen.
...
-   Unterstützte Versionen des 2007 Microsoft Office-Systems finden Sie unter [Erstellen eines Netzwerkinstallationspunkts im 2007 Office-System](https://technet.microsoft.com/en-us/library/cc179063(technet.10).aspx). 
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/955617">Microsoft Knowledge Base-Artikel 955617</a>.</td>
</tr>
<tr class="even">
