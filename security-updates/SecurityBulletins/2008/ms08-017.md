...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=806c654a-35e3-4385-855a-4b803249bfcf)  
(KB931660)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f54d2a5e-c0ed-4f70-9746-38dd61c8e9d7)  
(KB932031)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d71b23fa-a873-406d-bad7-e38e565dee39)  
(KB933367)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2fe10ccd-40cb-4090-b83d-eae3d4eca174)  
(KB933369)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=5fddd54f-7a33-4ea3-b68d-b96a9bae509d)  
(KB939714)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=71de76ba-b62c-4a7a-a78a-9317f5255b13)  
(KB941305)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=526d87bd-c3da-412e-8765-c15987ae9b01)  
(KB948257)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2006-4695](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4695).
...
Das Kill Bit ist eine Methode, mit der verhindert werden kann, dass ein ActiveX-Steuerelement je über Internet Explorer aufgerufen wird, selbst wenn es auf dem System vorhanden ist. (Weitere Informationen zu dem Kill Bit finden Sie im [Microsoft Knowledge Base-Artikel 240797](https://support.microsoft.com/kb/240797/de)). Wenn eine Sicherheitsanfälligkeit ein ActiveX-Steuerelement betrifft, stellt das Sicherheitsupdate in der Regel ein neues Steuerelement zur Verfügung und setzt das Kill Bit für das anfällige Steuerelement.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-1201](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1201).
...
**Was bewirkt das Update?**    
Dieses Update behebt die bekannte Sicherheitsanfälligkeit und setzt das Kill Bit für eine Liste von Klassenkennungen (CLSIDs) für Office Web Components. Zum Schutz unserer Kunden verhindert dieses Update, dass diese CLSIDs in Internet Explorer instanziiert werden. Weitere Informationen zu Kill Bits finden Sie im [Microsoft Knowledge Base-Artikel 240797](https://support.microsoft.com/kb/240797/de).
...
m – Informationen betreffend zuwenig Arbeitsspeicher oder schwerwiegendem Abbruch<br/>
...
-   Chris Ries von [VigilantMinds Inc.](https://www.vigilantminds.com) für den Hinweis auf die Sicherheitsanfälligkeit in Office Web Components beim Analysieren von URLs – (CVE-2006-4695).  
-   Xiaohui von [NCNIPC](https://www.nipc.org.cn) für den Hinweis auf die Sicherheitsanfälligkeit in Office Web Components beim Analysieren von URLs – (CVE-2006-4695).  
-   Golan Yosef von [Finjan](https://www.finjan.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Office Web Components beim Analysieren von URLs – (CVE-2006-4695).  
-   Yuval Ben-Itzhak von [Finjan](https://www.finjan.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Office Web Components bezüglich DataSource – (CVE-2007-1201).
