...
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-024.mspx">MS07-024</a></td>
</tr>
<tr class="even">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-0109](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109).
...
-   Rubén Santamarta von [Reversemode.com](https://reversemode.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Word (CVE-2008-0109).
