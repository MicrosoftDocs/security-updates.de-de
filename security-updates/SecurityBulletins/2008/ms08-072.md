...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 957173](https://support.microsoft.com/kb/957173) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Word Viewer 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=70de7c3c-519f-4f4a-a03f-027f80b5415c)  
(KB956366)
</td>
<td style="border:1px solid black;">
Nicht anwendbar 
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Word Viewer](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=70de7c3c-519f-4f4a-a03f-027f80b5415c)  
(KB956366)
</td>
<td style="border:1px solid black;">
Nicht anwendbar 
...
Microsoft hat Benutzern von Works 8.0 eine kostenlose Aktualisierung auf Works 8.5 bereitgestellt. Demzufolge sollten alle Benutzer, die Microsoft Works 8.0, Works Suite 2005 oder Works Suite 2004 verwenden, auf das sicherheitsverbesserte Works 8.5 aktualisieren. Weitere Informationen finden Sie unter [Microsoft Works Update](https://www.microsoft.com/products/works/international/update_1001.mspx).
...
Ja, als Bestandteil des Wartungsmodells für Microsoft Office 2007. Wenn Benutzer von Microsoft Office 2007 RTM dieses Update installieren, werden deren Systeme mit Sicherheitsfunktionen aktualisiert, die ursprünglich mit Microsoft Office 2007 Service Pack 1 veröffentlicht wurden. Alle Updates, die nach 8. Dezember 2007 für Microsoft Office 2007 veröffentlicht werden, enthalten diese Sicherheitsfunktionen, die in [Microsoft Office 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9ec51594-992c-4165-a997-25da01f388f5) eingeführt wurden. Wir haben dieses Update eingehend getestet, aber wie bei allen Updates empfehlen wir den Benutzern, ihrer Umgebung und der Konfiguration ihres Systems gemäße Tests durchzuführen.
...
----------------------------------------------------------------------
d maximale Sicherheitsauswirkung nach betroffener Software
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4024).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4025).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4026).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4027).
...
-   **Verhindern Sie, dass Word RTF-Dateien lädt**
    ...
    **Für Word 2003 Interaktiv**
    ...
    Wenn Sie [Sicherheitsupdate 934181](https://www.microsoft.com/download/details.aspx?familyid=6870245d-4618-4504-bffc-878635267059&displaylang=en) installiert haben, können Sie verhindern, dass diese Art von Datei in Word 2003 geladen wird.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4030).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4028).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4031).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4837](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4837).
...
Weitere Informationen zu MBSA 2.1 finden Sie unter „Häufig gestellte Fragen zu [MBSA 2.](https://www.microsoft.com/germany/technet/sicherheit/tools/mbsa/2_0_qa.mspx)1“.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/957173">Microsoft Knowledge Base-Artikel 957173</a>.</td>
</tr>
<tr class="even">
...
-   Ricardo Narvaja von [Core Security Technologies](https://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Word (CVE-2008-4024).  
-   Dyon Balding von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der RTF-Objektanalyse in Word (CVE-2008-4025).  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Word (CVE-2008-4026).  
-   Wushi in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der RTF-Objektanalyse in Word (CVE-2008-4027).  
-   Aaron Portnoy von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der RTF-Objektanalyse in Word (CVE-2008-4030).  
-   Wushi von [team509](https://www.team509.com/) in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der RTF-Objektanalyse in Word (CVE-2008-4028).  
-   Aaron Portnoy von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der RTF-Objektanalyse in Word (CVE-2008-4031).  
-   Wushi und Ling in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Word (CVE-2008-4837).
