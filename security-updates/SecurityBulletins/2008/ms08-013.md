---
TOCTitle: 'MS08-013'
Title: 'Microsoft Security Bulletin MS08-013 - Kritisch'
ms:assetid: 'ms08-013'
ms:contentKeyID: 61224474
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms08-013(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 12. Februar 2008 | Aktualisiert: Dienstag, 12. Januar 2010
...
Dies ist ein kritisches Sicherheitsupdate für alle unterstützten Editionen von Microsoft Office 2000 und ein wichtiges Sicherheitsupdate für Microsoft Office XP, Microsoft Office 2003 und Microsoft Office 2004 für Mac. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Dieses Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office Dokumente mit eingefügten Objekten lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=5fb74e24-d9ee-4951-9c46-e1c84617f097">Microsoft Office 2000 Service Pack 3</a><br />
(KB944425)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=3e147b1a-f3be-465f-8587-7f3a33d6a6e5">Microsoft Office XP Service Pack 3</a><br />
(KB944423)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=f4ac0f34-4604-4bbe-9669-01db645041ca">Microsoft Office 2003 Service Pack 2</a><br />
(KB945185)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=36b00c58-192d-488c-a069-730c69f0b6b0">Microsoft Office 2004 für Mac</a><br />
(KB948056)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-060.mspx">MS07-060</a></td>
</tr>
</tbody>
</table>
...
**Warum kann ich dieses Update nach dem Installieren nicht entfernen?**  
In Microsoft Office XP und Office 2003 liegt ein Problem vor, durch das Office teilweise deinstalliert wird, wenn Updates für bestimmte Komponenten installiert oder deinstalliert werden. Dieses Problem wird durch dieses Update behoben. Wenn dieses Update jedoch deinstalliert wird, besteht dieses Problem erneut und Office wird teilweise deinstalliert. Um dieses Verhalten zu verhindern, hat Microsoft dieses Update als nicht deinstallierbar markiert.
...
**Ich habe nicht die vollständige Microsoft Office Suite, die in der Tabelle „Betroffene Software“ aufgeführt ist, sondern nur eine Anwendung, z. B. Word. Wird meinem System das Sicherheitsupdate angeboten?**    
Die Sicherheitsanfälligkeit, die dieses Security Bulletin zum Thema hat, betrifft nur die vollständige Microsoft Office Suite, die im Abschnitt „Betroffene Software“ aufgeführt ist. In bestimmten Microsoft Office-Anwendungen jedoch werden einige der gleichen Dateien verwendet wie in der vollständigen Microsoft Office Suite, für die das Sicherheitsupdate vorgesehen ist. Wir empfehlen die Installation des Updates, um zu vermeiden, dass das Sicherheitsupdate erneut angeboten wird.
...
**Stellt das Angebot für die Aktualisierung des Microsoft Office 2003 Service Pack 3 eine Schwachstelle im Microsoft Updatemechanismus dar?**    
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs – CVE-2008-0103</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs – CVE-2008-0103  
----------------------------------------------------------------------------------------
  
Die Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen, wenn ein Benutzer ein speziell gestaltetes Microsoft Office-Dokument mit einem fehlerhaften Objekt öffnet, das in das Dokument eingefügt wurde. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0103).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs – CVE-2008-0103
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs – CVE-2008-0103
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   Schränken Sie den Zugriff auf VBE6.dll ein
  
    Um den Zugriff auf VBE6.dll einzuschränken, geben Sie Folgendes an der Eingabeaufforderung ein:
    ...
    **Auswirkung der Problemumgehung:** Die Auswirkung dieser Problemumgehung besteht darin, dass Microsoft Office-Dateien mit VBA-Inhalten (z. B. Makros) nicht mehr geladen werden.
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs – CVE-2008-0103
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung In Microsoft Office. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird durch eine Speicherbeschädigung in Microsoft Office verursacht, wenn ein Benutzer eine speziell gestaltete Office-Datei öffnet, in die fehlerhafte Objekte eingefügt wurden. Durch den Fehler kann der Systemspeicher in einer solchen Weise beschädigt werden, dass ein Angreifer einen beliebigen Code ausführen kann.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Diese Sicherheitsanfälligkeit erfordert, dass ein Benutzer eine speziell gestaltete Office-Datei mit einer betroffenen Edition von Microsoft Office öffnet.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Office Speicherzuordnungen beim Öffnen von Office-Dokumenten verwaltet, in die Objektinformationen eingefügt wurden.
...
**Hinweis:** Für Benutzer, die ältere Software verwenden, die nicht von MBSA 2.0.1, Microsoft Update und Windows Server Update Services unterstützt wird: besuchen Sie die Site [Microsoft Baseline Security Analyzer](https://technet.microsoft.com/de-de/security/cc184924.aspx) und sehen Sie im Abschnitt **Support für ältere Produkte** nach, wie Sie mit älteren Tools eine umfassende Erkennung von Sicherheitsupdates erstellen können.
...
| Microsoft Office 2004 für Mac        | Nein    | Nein               | Nein              | Ja        |
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.4.0 zur Installation von der [Microsoft Mactopia Website](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer) herunter.
...
-   Shaun Colley von [NGSSoftware](https://www.ngssoftware.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Office bezüglich Ausführungssprungs (CVE-2008-0103).
...
-   V1.1 (13. Februar 2008): Aktualisierung des Bulletins, um darauf hinzuweisen, dass es beim Installieren dieses Sicherheitsupdates keine bekannten Probleme gibt.  
-   V1.2 (27. Februar 2008): Aktualisierung des Bulletins, um auf den Grund dafür hinzuweisen, dass dieses Update für Office XP und Office 2003 nicht deinstalliert werden kann.  
-   V1.3 (16. April 2008): Aktualisierung des Bulletins: Den Häufig gestellten Fragen zum Update wurde ein Eintrag hinzugefügt, um zusätzliche Sicherheitsfunktionen zu beschreiben, die für Microsoft Office 2003 Service Pack 2 hinzugefügt wurden.  
-   V1.4 (12. Januar 2010): Aktualisierung des Bulletins: Die Informationen zu den Bulletins, die durch dieses Update ersetzt werden, wurden für Microsoft Office 2003 Service Pack 2 korrigiert.
