...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 953635](http://technet.microsoft.com/security/advisory/953635) beschrieben wurde.
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 955048](http://support.microsoft.com/kb/955048).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244).
...
Ja. Zum Zeitpunkt der Erstveröffentlichung dieses Bulletins war diese Sicherheitsanfälligkeit öffentlich bekannt. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) zugewiesen. Diese Sicherheitsanfälligkeit wurde erstmals in der [Microsoft-Sicherheitsempfehlung 953635](http://technet.microsoft.com/security/advisory/953635) beschrieben.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/955048">Microsoft Knowledge Base-Artikel 955048</a>.</td>
</tr>
<tr class="even">
...
-   [ISC/SANS](http://isc.sans.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bei der Datensatzanalyse (CVE-2008-2244).
