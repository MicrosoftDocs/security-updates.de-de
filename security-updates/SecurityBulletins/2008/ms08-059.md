...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 956695](https://support.microsoft.com/kb/956695).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-3466](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3466).
...
<br />
<strong>Hinweis:</strong> Beim Entfernen des Updates werden Sie möglicherweise aufgefordert, die Microsoft Host Integration Server 2000-CD einzulegen. Außerdem wird Ihnen in der Systemsteuerung unter „Software“ möglicherweise nicht die Option zum Deinstallieren des Updates angeboten. Das kann verschiedene Gründe haben. Das kann verschiedene Gründe haben. Weitere Informationen zum Entfernen des Updates finden Sie im <a href="https://support.microsoft.com/kb/268800/">Microsoft Knowledge Base-Artikel 268800</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/956695">Microsoft Knowledge Base-Artikel 956695</a>.</td>
</tr>
<tr class="odd">
...
-   Stephen Fewer von [Harmony Security](https://www.harmonysecurity.com/) in Zusammenarbeit mit [iDefense VCP](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in HIS bei Befehlsausführung (CVE-2008-3466).
