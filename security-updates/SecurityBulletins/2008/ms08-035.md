...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms08-003.mspx">MS08-003</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=0a983ffb-4f5a-4b78-9bf5-813dcc5df8d3">ADAM</a><br />
(KB949269)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Mittel</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms08-003.mspx">MS08-003</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition und Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=334252db-4a7a-4161-bb71-2a20c0b5bd93">ADAM</a><br />
(KB949269)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Mittel</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms08-003.mspx">MS08-003</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 für 32-Bit-Systeme*</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=2981156e-2e2f-469e-91be-da127d50f3fc">AD LDS</a><br />
(KB949014)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Mittel</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 für x64-basierte Systeme*</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=b5cfe6f4-c5ba-4be9-a6b8-9381c40c85aa">AD LDS</a><br />
(KB949014)</td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Mittel</td>
<td style="border:1px solid black;">Keine</td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-1445](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1445).
...
[ADAM](https://technet2.microsoft.com/windowsserver/de/library/29fb059e-544c-4577-bf7c-ba4b08df48431031.mspx?mfr=true) ist ein LDAP-Verzeichnisdienst (Lightweight Directory Access Protocol), der als Benutzerdienst für Windows XP und Windows Server 2003 ausgeführt wird und nicht als Systemdienst.
  
**Was ist Active Directory Lightweight Directory Service (AD LDS)?**  
[AD LDS](https://technet2.microsoft.com/windowsserver2008/en/library/6a3bedf7-9c5b-4ada-9a51-6b794adc9ab81033.mspx?mfr=true) ist ein LDAP-Verzeichnisdienst (Lightweight Directory Access Protocol), der als Benutzerdienst für Windows Server 2008 ausgeführt wird und nicht als Systemdienst.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/953235">Microsoft Knowledge Base-Artikel 953235</a>.</td>
</tr>
<tr class="even">
...
-   Alex Matthews und John Guzik von [Securify](https://www.securify.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Active Directory – (CVE-2008-1445).
