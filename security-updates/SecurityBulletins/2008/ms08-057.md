...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 956416](http://support.microsoft.com/kb/956416).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-3477](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3477).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-3471](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3471).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4019).
...
-   Unterstützte Versionen des 2007 Microsoft Office-Systems finden Sie unter [Erstellen eines Netzwerkinstallationspunkts im 2007 Office-System](http://technet.microsoft.com/en-us/library/cc179063.aspx).  
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/956416">Microsoft Knowledge Base-Artikel 956416</a>.</td>
</tr>
<tr class="even">
...
-   Wushi in Zusammenarbeit mit [TippingPoint](http://www.tippingpoint.com/) und der [Zero Day Initiative](http://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich der Analyse von Dateiformaten (CVE-2008-3471).  
-   Lionel d'Hauenens von [Labo Skopia](http://www.laboskopia.com/), der mit [iDefense VCP](http://labs.idefense.com/) zusammenarbeitet, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Kalenderobjektüberprüfung (CVE-2008-3477).  
-   Joshua J. Drake von [iDefense](http://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Kalenderobjektüberprüfung (CVE-2008-3477).
