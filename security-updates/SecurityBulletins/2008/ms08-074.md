...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 959070](https://support.microsoft.com/kb/959070) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 959070](https://support.microsoft.com/kb/959070).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2008-4266](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/959070">Microsoft Knowledge Base-Artikel 959070</a>.</td>
</tr>
<tr class="even">
...
-   Joshua J. Drake von [Verisign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich der Analyse von Dateiformaten (CVE-2008-4265).  
-   Claes M Nyberg von [signedness.org](https://www.signedness.org/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich der Analyse von Dateiformaten (CVE-2008-4264)  
-   Dyon Balding von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung im globalen Array von Excel (CVE-2008-4266)
