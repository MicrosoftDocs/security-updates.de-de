---
TOCTitle: 'MS11-062'
Title: 'Microsoft Security Bulletin MS11-062 - Kritisch'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61224781
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-062(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-062 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der NDISTAPI-Treiber Benutzermoduseingaben überprüft, bevor diese an den Windows Kernel gesendet werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b)             | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)           | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d) | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen – CVE-2011-1974</th>
...
Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen – CVE-2011-1974  
---------------------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1974](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen – CVE-2011-1974
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen – CVE-2011-1974
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen – CVE-2011-1974
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der NDISTAPI-Treiber benutzerdefinierte Eingaben falsch überprüft, wenn Daten vom Benutzermodus an den Windows Kernel übergeben werden.
  
**Welche Komponente ist von der Sicherheitsanfälligkeit betroffen?**    
NDISTAPI.sys ist die von dieser Sicherheitsanfälligkeit betroffene Komponente.
  
**Was ist der Remote Access Service (RAS)?**    
Mit dem Remote Access Service (RAS) können Benutzer über Telefonleitungen, das Internet oder andere Netzwerkverbindungen eine Verbindung zu einem Remotecomputer herstellen, um so zu arbeiten, als wäre ihr System physisch mit dem Remotenetzwerk verbunden. Mithilfe von RAS können Benutzer von einem Remotestandort aus Aktivitäten wie das Senden und Empfangen von E-Mails, das Faxen von Dokumenten, das Abrufen von Dateien und das Drucken von Dokumenten auf einem Bürodrucker ausführen. Weitere Informationen finden Sie im MSDN-Artikel, [RAS-](https://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx)Architektur: Überblick (NDIS 5.1).
  
RAS ist ein systemeigener Dienst in Windows XP und Windows Server 2003 und wurde in neueren Betriebssystemen durch Routing- und RAS-Dienst (RRAS) ersetzt. RRAS ermöglicht die Verwendung eines Computers als Netzwerk-Router. RRAS stellt auch die nächste Generation der RAS-Serverfunktionalität für Windows bereit. Die RRAS-Serverfunktionalität basiert auf der RAS-Funktion, die Bestandteil früherer Betriebssysteme war.
  
**Was ist der NDISTAPI-Treiber?**    
Der NDISTAPI-Treiber ist Teil der RAS-Architektur und bildet eine Schnittstelle zwischen den Diensten NDISWAN und TAPI. Telefonienanwendungen implementieren die TAPI-Dienste und können TAPI-Anforderungen zum Einrichten, Überwachen und Unterbrechen von Leitungen sowie zum Durchführen von Anrufen erstellen. Der NDISTAPI-Treiber übergibt diese TAPI-Anforderungen an NDISWAN. Weitere Informationen finden Sie im MSDN-Artikel [NDISTAPI: Überblick (NDIS 5.1)](https://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx).
  
**Was ist NDISWAN?**    
Das Netzwerktreiber-Schnittstellenstandard Wide Area Network (NDISWAN) ist ein vom System bereitgestellter vorläufiger NDIS-Treiber, der Funktionen wie Datenkomprimierung, Verschlüsselung, Loopback und einfaches PPP-Framing bereitstellt, die von WAN-Miniport-Treibern verwendet werden. WAN-Miniport-Treiber sind daher erforderlich, um nur jene Funktionen zu implementieren, die für das Medium spezifisch sind (z. B. ist Q931-Signalisierung für ISDN erforderlich). Weitere Informationen finden Sie im MSDN-Artikel [NDISWAN: Überblick](https://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx).
  
**Was ist der TAPI-Dienst?**    
Der TAPI-Dienst (Telephony Application Programming Interface) ist eine Programmierschnittstelle, die Tefefoniedienste für Anwendungen bereitstellt, die über die Telefonie kommunizieren können.
  
**Was ist NDIS?**    
Der Netzwerktreiber-Schnittstellenstandard (NDIS) ist Teil des Windows Driver Kits. Dies ist ein vollständig integriertes Treiberentwicklungssystem, welches das Windows Driver Device Kit und Tests für die Stabilität und Zuverlässigkeit von Windows-Treibern enthält. Die NDIS-Bibliothek abstrahiert die Netzwerkhardware von Netzwerktreibern. NDIS gibt auch eine Standardschnittstelle zwischen geschichteten Netzwerktreibern an, wodurch Treiber unterer Ebenen abstrahiert werden, die Hardware von Treibern höherer Ebenen verwalten, z. B. Netzwerktransporte. NDIS pflegt auch Statusinformationen und Parameter für Netzwerktreiber, einschließlich Zeiger auf Funktionen, Handles und Parameterblöcke für Verknüpfungen sowie weitere Systemwerte.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der NDISTAPI-Treiber Benutzermoduseingaben überprüft, bevor diese an den Windows Kernel gesendet werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2566454$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2566454">Microsoft Knowledge Base-Artikel 2566454</a>.</td>
</tr>
<tr class="even">
...
-   Lufeng Li von der für den Hinweis auf die Sicherheitsanfälligkeit in NDISTAPI bezüglich der Erhöhung von Berechtigungen (CVE-2011-1974)
