---
TOCTitle: 'MS11-084'
Title: 'Microsoft Security Bulletin MS11-084 - Mittel'
ms:assetid: 'ms11-084'
ms:contentKeyID: 61224803
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-084(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows 7 und Windows Server 2008 R2 als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem sichergestellt wird, dass die Windows-Kernelmodustreiber beim Laden von TrueType-Schriftartdateien Arrayindizes richtig überprüfen. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=156c1bd9-55bc-482c-874b-61998d1ef153)                                               | DoS (Denial of Service)        | Mittel                           | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5c7db930-5495-43f0-928c-d586ac9e80d0)                                   | DoS (Denial of Service)        | Mittel                           | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5d810dae-5c52-4155-b5c2-163d27be6e78)\*\*\*   | DoS (Denial of Service)        | Mittel                           | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=395819e2-1028-44b7-ace4-ca754b1a7543) | DoS (Denial of Service)        | Mittel                           | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten – CVE-2011-2004</th>
...
Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten – CVE-2011-2004  
---------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2004](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2004).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten – CVE-2011-2004
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Damit ein Angriff erfolgreich ist, muss ein Benutzer den nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen, die eine speziell gestaltete TrueType-Schriftartdatei enthält, oder die Datei als E-Mail-Anlage öffnen. Ein Angreifer kann Endbenutzer jedoch nicht zum Ausführen solcher Aktionen zwingen. Stattdessen muss ein Angreifer einen Benutzer dazu verleiten, die Website oder Netzwerkfreigabe zu besuchen. Zu diesem Zweck wird der Benutzer meist dazu gebracht, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zu klicken.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten – CVE-2011-2004
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten – CVE-2011-2004
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass die Windows-Kernelmodustreiber keine ausreichende Überprüfung an einem Arrayindex durchführen, wenn eine TrueType-Schriftartdatei geladen wird.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2617657">Microsoft Knowledge Base-Artikel 2617657</a>.</td>
</tr>
<tr class="odd">
...
-   Will Dorman von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten (CVE-2011-2004)
