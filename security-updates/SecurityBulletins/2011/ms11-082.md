---
TOCTitle: 'MS11-082'
Title: 'Microsoft Security Bulletin MS11-082 - Hoch'
ms:assetid: 'ms11-082'
ms:contentKeyID: 61224801
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-082(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-082 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie Host Integration Server speziell gestaltete UDP- und TCP-Pakete verarbeitet. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich DoS durch Endlosschleife in snabase.exe – CVE-2011-2007</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich DoS durch Zugriff auf nicht zugewiesenen Speicher – CVE-2011-2008</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit bezüglich DoS durch Endlosschleife in snabase.exe – CVE-2011-2007  
-----------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich nicht authentifizierten Denial-of-Services vor, die dadurch verursacht wird, wie Host Integration Server UDP- und TCP-Netzwerkverkehr verarbeitet. Die Sicherheitsanfälligkeit kann einem Remotebenutzer ermöglichen, zu bewirken, dass „snabase.exe“, „snaserver.exe“, „snalink.exe“ oder „mngagent.exe“ nicht mehr auf neue Anforderungen reagieren.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2007).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich DoS durch Endlosschleife in snabase.exe – CVE-2011-2007
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich DoS durch Endlosschleife in snabase.exe – CVE-2011-2007
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Blockieren der TCP-Ports1477** **und** **1478sowie UDP-Port** **1478** **an der Firewall**
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich DoS durch Endlosschleife in snabase.exe – CVE-2011-2007
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff. Ein anonymer Remoteangreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann bewirken, dass der betroffene SNA-Serverdienst und alle abhängigen Dienste nicht mehr reagieren. Diese Sicherheitsanfälligkeit ermöglicht einem Angreifer keine Codeausführung oder Erhöhung von Berechtigungen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit wird von fehlerhafter Eingabeüberprüfung verursacht, wenn Host Integration Server speziell gestalteten Netzwerkverkehr verarbeitet.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein anonymer Remoteangreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann bewirken, dass das System des betroffenen SNA-Serverdienstes und alle abhängigen Dienste nicht mehr auf neue Anforderungen reagieren.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Ein Remoteangreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er speziell gestaltete Netzwerkpakete an Host Integration Server sendet, die den UDP-Port 1478 oder die TCP-Ports 1477 und 1478 abhören.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Server, auf denen Host Integration Server (HIS) ausgeführt wird.
  
**Was bewirkt das Update?**  
Dieses Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Host Integration Server speziell gestaltete UDP- und TCP-Pakete verarbeitet.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-2007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2007) zugewiesen.
  
**Lagen Microsoft zum Zeitpunkt der Veröffentlichung dieses Security Bulletins Informationen vor, dass diese Sicherheitsanfälligkeit bereits ausgenutzt wurde?**  
Nein. Microsoft lagen zum Zeitpunkt der Erstveröffentlichung dieses Security Bulletins keine Informationen vor, dass diese Sicherheitsanfälligkeit öffentlich für Angriffe auf Benutzer ausgenutzt wurde.
  
Sicherheitsanfälligkeit bezüglich DoS durch Zugriff auf nicht zugewiesenen Speicher – CVE-2011-2008  
---------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich nicht authentifizierten Denial-of-Services vor, die dadurch verursacht wird, wie Host Integration Server UDP- und TCP-Netzwerkverkehr verarbeitet. Die Sicherheitsanfälligkeit kann einem Remotebenutzer ermöglichen, zu bewirken, dass „snabase.exe“, „snaserver.exe“, „snalink.exe“ oder „mngagent.exe“ nicht mehr auf neue Anforderungen reagieren.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2008).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich DoS durch Zugriff auf nicht zugewiesenen Speicher – CVE-2011-2008
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Mithilfe empfohlener Vorgehensweisen für die Firewall und standardisierten Firewallkonfigurationen können Netzwerke vor Remoteangriffen von außerhalb des Unternehmens geschützt werden. Eine bewährte Methode besteht darin, für Systeme, die mit dem Internet verbunden sind, nur eine minimale Anzahl von Ports zu öffnen. In diesem Fall sollten die Host Integration Server-Ports vom Internet blockiert werden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich DoS durch Zugriff auf nicht zugewiesenen Speicher – CVE-2011-2008
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Blockieren der TCP-Ports 1477 und 1478 sowie UDP-Port 1478 an der Firewall**
  
    Diese Ports werden dazu verwendet, eine Verbindung mit der betroffenen Komponente zu initiieren. Das Blockieren dieser Ports an der Unternehmensfirewall (sowohl in eingehender als auch ausgehender Richtung) schützt Systeme hinter dieser Firewall vor Angriffen, die diese Sicherheitsanfälligkeit auszunutzen versuchen. Wir empfehlen das Blockieren der gesamten unerwünschten eingehenden Kommunikation aus dem Internet. So können Sie Angriffe verhindern, bei denen möglicherweise andere Ports verwendet werden. Weitere Informationen zu den Ports finden Sie in dem TechNet-Artikel [TCP- und UDP-Portzuweisungen](https://go.microsoft.com/fwlink/?linkid=21312). Weitere Informationen zur Windows-Firewall finden Sie in dem TechNet-Artikel [So konfigurieren Sie eine Windows-Firewall auf einem einzelnen Computer](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich DoS durch Zugriff auf nicht zugewiesenen Speicher – CVE-2011-2008
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff. Ein anonymer Remoteangreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann bewirken, dass der betroffene SNA-Serverdienst und alle abhängigen Dienste nicht mehr reagieren.
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-2008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2008) zugewiesen.
...
#### Microsoft Host Integration Server (alle Editionen)
...
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2004 Service Pack 1:<br />
HIS2004-SP1-KB2578757-x86-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2006 Service Pack 1:<br />
HIS2006-SP1-KB2579597-ENU.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2009:<br />
HIS2009-RTM-KB2579598-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2010:<br />
...
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2004 Service Pack 1:<br />
Siehe <a href="https://support.microsoft.com/kb/2578757">Microsoft Knowledge Base-Artikel 2578757</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2006 Service Pack 1:<br />
Siehe <a href="https://support.microsoft.com/kb/2579597">Microsoft Knowledge Base-Artikel 2579597</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2009:<br />
Siehe <a href="https://support.microsoft.com/kb/2579598">Microsoft Knowledge Base-Artikel 2579598</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2010:<br />
Siehe <a href="https://support.microsoft.com/kb/2579599">Microsoft Knowledge Base-Artikel 2579599</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2004 Service Pack 1:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2004 SP1 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2578757.]GDR</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2004 Service Pack 1 (nur Japan):<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2006 Service Pack 1 (32-Bit-Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2006 SP1 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579597.]LDR</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2006 Service Pack 1 (x64-basierte Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2006 SP1 Hotfix [See KB article 2579597 for details]LDR</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2009 (32-Bit-Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2009 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579598.]GDR oder HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2009 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579598.]LDR</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2009 (x64-basierte Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2009 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579598.]GDR oder HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2009 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579598.]LDR</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2010 (32-Bit-Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2010 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579599.]GDR oder HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2010 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579599.]LDR</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Host Integration Server 2010 (x64-basierte Systeme):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2010 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579599.]GDR oder HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Host Integration Server 2010 Hotfix [Weitere Informationen finden Sie im KB-Artikel 2579599.]LDR</td>
</tr>
</tbody>
</table>
