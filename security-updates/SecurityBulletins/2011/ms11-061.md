...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2546250](https://support.microsoft.com/kb/2546250) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=777f3bbe-094c-411d-879d-34a5a20ae7f3)\*\* | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
Ja. Microsoft empfiehlt Benutzern, die ihre ASP-Seiten für die Webregistrierung bearbeitet haben, den [Microsoft Knowledge Base-Artikel 2546250](https://support.microsoft.com/kb/2546250) zu lesen. Dort erhalten sie wichtige Informationen zu bekannten Problemen, die auf ihre Systeme zutreffen können.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Web Access für Remotedesktop – CVE-2011-1263</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1263).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2546250">Microsoft Knowledge Base-Artikel 2546250</a>.</td>
</tr>
<tr class="odd">
