---
TOCTitle: 'MS11-055'
Title: 'Microsoft Security Bulletin MS11-055 - Kritisch'
ms:assetid: 'ms11-055'
ms:contentKeyID: 61224774
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-055(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-055 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für Microsoft Visio 2003 Service Pack 3 als Hoch eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Microsoft Visio externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=1c7b2a5b-4aa6-4006-90bf-89f8b2b7becd">Microsoft Visio 2003 Service Pack 3</a><br />
(KB2493523)</td>
...
| Microsoft Visio 2010 (32-Bit-Editionen) und Microsoft Visio 2010 (32-Bit-Editionen) Service Pack 1 |  
| Microsoft Visio 2010 (64-Bit-Editionen) und Microsoft Visio 2010 (64-Bit-Editionen) Service Pack 1 |  
...
**Ich habe eine nicht anfällige Version von Microsoft Office 2003 installiert, warum wird mir dieses Update angeboten?**    
Obwohl die Angriffsmethode zum Ausnutzen der Sicherheitsanfälligkeit, die in CVE-2010-3148 beschrieben wird, durch Microsoft Visio 2003 erfolgt, ist der anfällige Code in einer freigegebenen Komponente von Microsoft Office vorhanden. Einige nicht betroffene Software, etwa Microsoft Office 2003 Suite und eigenständige Microsoft Office 2003-Programme, enthalten zwar die anfällige gemeinsam genutzte Komponente von Microsoft Office, doch da sie nicht auf den anfälligen Code zugreifen, sind sie nicht von dieser Sicherheitsanfälligkeit betroffen. Da jedoch der anfällige Code vorhanden ist, wird dieses Update angeboten.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Microsoft Visio durch nicht sicheres Laden von Bibliotheken – CVE-2010-3148</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit in Microsoft Visio durch nicht sicheres Laden von Bibliotheken – CVE-2010-3148  
------------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung in der Art und Weise vor, in der Microsoft Visio das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3148](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Microsoft Visio durch nicht sicheres Laden von Bibliotheken – CVE-2010-3148
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Damit ein Angriff erfolgreich ist, muss ein Benutzer einen nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen und dort eine Office-bezogene Datei (z. B. eine VSD-, VDX-, VST- oder VTX-Datei) öffnen.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Microsoft Visio durch nicht sicheres Laden von Bibliotheken – CVE-2010-3148
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Microsoft Visio durch nicht sicheres Laden von Bibliotheken – CVE-2010-3148
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass die Microsoft Visio-Komponente den für das Laden externer Bibliotheken verwendeten Pfad falsch einschränkt.
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige, Visio-bezogene Datei (z. B. eine VSD-, VDX-, VST- oder VTX-Datei) zu öffnen, die sich in dem gleichen Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Wenn dann die legitime Datei geöffnet wird, kann Microsoft Visio versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er einem Benutzer eine gültige, Visio-bezogene Dateianlage (z. B. eine VSD-, VDX-, VST- oder VTX-Datei) sendet und ihn dazu verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und des Weiteren die gültige Datei zu öffnen. Wenn dann die legitime Datei geöffnet wird, kann Microsoft Visio versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem Netzwerkangriffsszenario kann ein Angreifer eine gültige, Visio-bezogene Datei und eine speziell gestaltete DLL-Datei auf einer Netzwerkfreigabe, einem UNC- oder WebDAV-Speicherort ablegen und den Benutzer anschließend dazu verleiten, die Datei zu öffnen.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Microsoft Visio externe Bibliotheken lädt.
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3148](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2493523">Microsoft Knowledge Base-Artikel 2493523</a>.</td>
</tr>
<tr class="even">
