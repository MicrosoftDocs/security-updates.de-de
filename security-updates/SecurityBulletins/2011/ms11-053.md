---
TOCTitle: 'MS11-053'
Title: 'Microsoft Security Bulletin MS11-053 - Kritisch'
ms:assetid: 'ms11-053'
ms:contentKeyID: 61224772
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-053(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-053 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Vista und Windows 7 als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der Windows Bluetooth-Stack Objekte im Speicher verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2566220](https://support.microsoft.com/kb/2566220) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=6bff74ac-45f3-4585-92da-316921b458fa">Windows Vista Service Pack 1</a>[1]<br />
(KB2561109)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=a1e5aa7d-5f38-4ce2-9575-4b4cb7520160">Windows Vista Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=849d2694-c8b3-4670-8203-912661bccabf">Windows Vista x64 Edition Service Pack 1</a>[1]<br />
(KB2561109)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=4287eeb4-ab29-4727-83f2-260d838b44d4">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01">Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<sup>[1]</sup>Windows Vista Service Pack 1 ist nur betroffen, wenn das optionale Windows Vista Feature Pack für Wireless installiert wurde. Weitere Informationen finden Sie in den häufig gestellten Fragen (FAQs) zu diesem Update.
...
**Ich führe Windows Vista Service Pack 1 aus.Ist mein System von dieser Sicherheitsanfälligkeit betroffen?**    
Windows Vista Service Pack 1 ist nur auf Systemen mit Unterstützung für Bluetooth 2.1-Technologie betroffen. Endbenutzer von Windows Vista Service Pack 1, die das [Windows Vista Feature Pack für Wireless](https://support.microsoft.com/kb/942567) installiert haben, haben Unterstützung für Bluetooth 2.1-Technologie und sind deshalb von dieser Sicherheitsanfälligkeit betroffen. Diese Endbenutzer müssen das Sicherheitsupdate KB2561109 installieren. Endbenutzer, die das Windows Vista Feature Pack für Wireless nicht installiert haben, haben keine Unterstützung für Bluetooth 2.1 und sind deshalb nicht von dieser Sicherheitsanfälligkeit betroffen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 2566220](https://support.microsoft.com/kb/2566220).
  
**Ich habe das Windows Vista Feature Pack für Wireless für Windows Vista Service Pack 1 installiert, habe aber auf Windows Vista Service Pack 2 aktualisiert. Welche Updates muss ich installieren?**    
Endbenutzer von Windows Vista Service Pack 1, die das [Windows Vista Feature Pack für Wireless](https://support.microsoft.com/kb/942567) für Windows Vista Service Pack 1 aktiviert haben, und die erfolgreich auf Windows Vista Service Pack 2 aktualisiert haben, müssen das Sicherheitsupdate KB2532531 installieren. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 2566220](https://support.microsoft.com/kb/2566220).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Bluetooth-Stack – CVE-2011-1265</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit im Bluetooth-Stack – CVE-2011-1265  
----------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Bluetooth-Stack – CVE-2011-1265
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Diese Sicherheitsanfälligkeit betrifft nur Systeme, auf denen Bluetooth-Fähigkeit installiert ist.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit im Bluetooth-Stack – CVE-2011-1265
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Beenden und Deaktivieren des Bluetooth-Treibers**
  
    Sie können den Treiber beenden und deaktivieren, indem Sie an der Eingabeaufforderung folgenden Befehl eingeben:
  
    `sc config bthport start= disabled`
  
    **So machen Sie die Problemumgehung rückgängig.**
  
    Sie können den Bluetooth-Treiber wieder aktivieren, indem Sie an der Eingabeaufforderung folgenden Befehl eingeben:
  
    `sc config bthport start= demand`
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Bluetooth-Stack – CVE-2011-1265
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit wird dadurch verursacht, wie der Windows Bluetooth-Stack auf Speicher zugreift, der nicht richtig initialisiert oder gelöscht wurde.
  
**Was ist Bluetooth?**    
Bluetooth ist ein dem Branchenstandard entsprechendes Protokoll, das drahtlose Verbindungen für Computer, Handheld-Geräte, Mobiltelefone und andere Geräte ermöglicht. Weitere Informationen finden Sie in dem MSDN-Artikel [Bluetooth](https://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx).
...
Um diese Sicherheitsanfälligkeit auszunutzen, muss der Angreifer sich in der Nähe des Zielcomputers befinden, um Funkübertragungen innerhalb des Bluetooth-Frequenzspektrums zu senden und zu empfangen. Der Angreifer kann die Sicherheitsanfälligkeit dann ausnutzen, indem er eine Reihe speziell gestalteter Bluetooth-Pakete erstellt und an den Zielcomputer sendet.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Von dieser Sicherheitsanfälligkeit sind in erster Linie Arbeitsstationen betroffen.
  
**Meine Windows Vista- bzw. Windows 7-Arbeitsstation hat keine Bluetooth-Technologie. Bin ich betroffen?**    
Ja. Windows Vista und Windows 7 unterstützen eine große Auswahl an Bluetooth-Funkgeräten und installieren den Bluetooth-Treiber, wenn dem System ein austauschbares Bluetooth-Gerät hinzugefügt wird. Deshalb sind alle unterstützten Versionen von Windows Vista und Windows 7 betroffen. Weitere Informationen finden Sie in dem MSDN-Artikel [Bluetooth Wireless-Technologie FAQ – 2010](https://msdn.microsoft.com/en-us/windows/hardware/gg487349.aspx).
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der Windows Bluetooth 2.1-Stack Objekte in Speicher verarbeitet.
...
<td style="border:1px solid black;">Für 32-Bit-Editionen von Windows Vista Service Pack 1, auf denen Windows Vista Feature Pack für Wireless aktiviert ist:<br />
Windows6.0-KB2561109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für alle unterstützten 32-Bit-Editionen von Windows Vista Service Pack 2:<br />
Windows6.0-KB2532531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für x64-basierte Editionen von Windows Vista Service Pack 1, auf denen Windows Vista Feature Pack für Wireless aktiviert ist:<br />
Windows6.0-KB2561109-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für alle unterstützten x64-basierten Editionen von Windows Vista Service Pack 2:<br />
...
<td style="border:1px solid black;">Für Windows Vista Service Pack 1, auf dem Windows Vista Feature Pack für Wireless aktiviert ist:<br />
Siehe <a href="https://support.microsoft.com/kb/2561109">Microsoft Knowledge Base-Artikel 2561109</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Windows Vista Service Pack 2<br />
Siehe <a href="https://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-Artikel 2532531</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-Artikel 2532531</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;"><strong>Hinweis:</strong> Es ist kein Registrierungsschlüssel vorhanden, um die Anwesenheit dieses Updates zu belegen.</td>
