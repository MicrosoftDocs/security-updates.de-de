---
TOCTitle: 'MS11-001'
Title: 'Microsoft Security Bulletin MS11-001 - Kritisch'
ms:assetid: 'ms11-001'
ms:contentKeyID: 61224720
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-001(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-001 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Vista als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Backup Manager externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4eeaad20-729c-4594-8853-e4ae55e9d491)                         | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b2839cd0-1958-4a22-9aac-0e0aa8f2b52c) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Backup Manager durch nicht sicheres Laden von Bibliotheken – CVE-2010-3145</th>
...
Sicherheitsanfälligkeit in Backup Manager durch nicht sicheres Laden von Bibliotheken – CVE-2010-3145  
-----------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Windows Backup Manager das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3145](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Backup Manager durch nicht sicheres Laden von Bibliotheken – CVE-2010-3145
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Damit ein Angriff erfolgreich ist, muss ein Benutzer einen nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen und dort eine WBCAT-Datei öffnen (Windows Backup Catalog).  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Backup Manager durch nicht sicheres Laden von Bibliotheken – CVE-2010-3145
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in Backup Manager durch nicht sicheres Laden von Bibliotheken – CVE-2010-3145
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Windows Backup Manager den für das Laden externer Bibliotheken verwendeten Pfad falsch einschränkt.
  
**Was ist Windows Backup Manager?**    
Windows Backup Manager (sdclt.exe) ermöglicht Benutzern, die Systemdateien eines Computers zu einem früheren Zeitpunkt wiederherzustellen. Die Systemwiederherstellung verwendet eine Funktion namens „Computerschutz“, um regelmäßig Wiederherstellungspunkte auf dem Computer zu erstellen und zu speichern. Diese Wiederherstellungspunkte enthalten Informationen zu Registrierungseinstellungen und anderen Systeminformationen, die von Windows verwendet werden. Diese Wiederherstellungspunkte können auch manuell erstellt werden.
...
Die Sicherheitsanfälligkeit erfordert, dass ein Benutzer eine gültige WBCAT-Datei öffnet, die sich in demselben Verzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Wenn die WBCAT-Datei geöffnet wird, kann die Anwendung Windows Backup Manager versuchen, die speziell gestaltete DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem Netzwerkangriffsszenario kann ein Angreifer eine gültige WBCAT-Datei und eine speziell gestaltete DLL auf einer Netzwerkfreigabe wie einem UNC- oder WebDAV-Speicherort ablegen und den Benutzer anschließend dazu verleiten, die WBCAT-Datei zu öffnen. Wenn der Benutzer die WBCAT-Datei öffnet, wird die speziell gestaltete DLL-Datei geladen, die sich in demselben Verzeichnis befindet. Ein Angreifer kann Benutzer jedoch nicht zum Öffnen einer WBCAT-Datei von einer Netzwerkfreigabe zwingen. Stattdessen muss ein Angreifer Benutzer dazu verleiten, die Datei zu öffnen. Zu diesem Zweck werden die Benutzer normalerweise dazu gebracht, auf einen Link in einer E-Mail-Nachricht oder Instant Messenger-Nachricht zu klicken, die die Benutzer zur Netzwerkfreigabe des Angreifers führt. Dort werden die Benutzer dazu verleitet, die WBCAT-Datei zu öffnen.
  
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine gültige WBCAT-Dateianlage an einen Benutzer sendet und diesen dazu verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und danach die WBCAT-Datei zu öffnen. Wenn der Benutzer die WBCAT-Datei öffnet, wird die speziell gestaltete DLL-Datei geladen, die sich in demselben Verzeichnis befindet. Klickt ein Benutzer auf einen Link in einer E-Mail, besteht weiterhin die Gefahr einer Ausnutzung dieser Sicherheitsanfälligkeit wie im oben beschriebenen netzwerkbasierten Angriffsszenario.
...
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Backup Manager externe Bibliotheken lädt.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3145](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2478935">Microsoft Knowledge Base-Artikel 2478935</a>.</td>
</tr>
<tr class="odd">
