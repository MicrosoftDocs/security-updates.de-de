...
Microsoft Excel 2010 ist nur von der in diesem Bulletin beschriebenen CVE-2011-1273 betroffen. Die automatisierte **Microsoft Fix it-Lösung** „Bearbeiten in geschützter Ansicht für Excel 2010 deaktivieren“ in [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) blockiert die Angriffsmethoden zum Ausnutzen von CVE-2011-1273. Endbenutzer können die Fix it-Lösung als Problemumgehung übernehmen, wenn das Sicherheitsupdate für Excel 2010 erst zu einem späteren Zeitpunkt installiert werden soll.
...
Die Sicherheitsupdatepakete für Microsoft Office 2004 für Mac (KB2555786), Microsoft Office 2008 für Mac (KB2555785) und Open XML-Dateiformatkonverter für Mac (KB2555784) in diesem Bulletin beheben auch die Sicherheitsanfälligkeiten, die im Security Bulletin [MS11-036](https://go.microsoft.com/fwlink/?linkid=217670) beschrieben werden.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1272](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1272).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1273](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1274](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1275](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1276](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1277](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279).
...
-   **Einstellen der Überprüfung von Office-Dateien, das Öffnen von Dateien zu deaktivieren, die der Überprüfung in Excel 2003 nicht standhalten**
    ...
    **Hinweis:** Bevor Sie diese Problemumgehung übernehmen, muss die Überprüfung von Office-Dateien für Ihre Version von Microsoft Office aktiviert werden. Weitere Informationen zum Aktivieren der Überprüfung von Office-Dateien in Microsoft Office 2003 finden Sie in dem TechNet-Artikel [Überprüfung von Office-Dateien für Office 2003 und Office 2007](https://technet.microsoft.com/en-us/library/gg985445(office.12).aspx).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2541003">Microsoft Knowledge Base-Artikel 2541003</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2541025">Microsoft Knowledge Base-Artikel 2541025</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel 2007 finden Sie im <a href="https://support.microsoft.com/kb/2541007">Microsoft Knowledge Base-Artikel 2541007</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel Viewer finden Sie im <a href="https://support.microsoft.com/kb/2541015">Microsoft Knowledge Base-Artikel 2541015</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zum Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 finden Sie im <a href="https://support.microsoft.com/kb/2541012">Microsoft Knowledge Base-Artikel 2541012</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2523021">Microsoft Knowledge Base-Artikel 2523021</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.6.4 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=d12d0868-4f28-4c0a-ab61-338878064b70) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.3.0 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=9e2d348b-c753-4eab-838c-370cd5af5e14) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office für Mac 2011-Updates 14.1.2 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=3c58555c-1eba-42fe-a10f-b30af9031e44) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.2.0 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=6118d5f5-b6fd-4584-be25-209534772379) herunter, und installieren Sie sie.
...
-   Bing Liu von [Fortinets FortiGuard Labs](https://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel durch unzureichende Datensatzüberprüfung (CVE-2011-1272)  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchten, für den Hinweis auf die Sicherheitsanfälligkeit in Excel durch fehlerhafte Datensatzanalyse (CVE-2011-1273)  
-   Omair in Zusammenarbeit mit den [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs (CVE-2011-1274)  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchten, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Heapüberschreibung im Speicher (CVE-2011-1275)  
-   Nicolas Gregoire von [Agarri](https://www.agarri.fr/) in Zusammenarbeit mit den [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Pufferüberlaufs (CVE-2011-1276)  
-   Omair für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2011-1277)  
-   Will Dormann von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel in WriteAV (CVE-2011-1278)  
-   Will Dormann von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen WriteAVs (CVE-2011-1279)
