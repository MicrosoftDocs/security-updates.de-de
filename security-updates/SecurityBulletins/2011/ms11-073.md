...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981)  
(KB2584066)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981)  
(KB2584066)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f)  
(KB2584066)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f)  
(KB2584066)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für September](https://technet.microsoft.com/security/bulletin/ms11-sep). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/security/cc998259).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1980).
...
Die Überprüfung von Office-Dateien ist ein Sicherheits-Add-In für Office 2003 und 2007. Anhand der Überprüfung von Office-Dateien wird geprüft, ob das binäre Dateiformat dem Dateiformat von Microsoft Office entspricht. Der Benutzer wird über mögliche Sicherheitsrisiken benachrichtigt, wenn Dateien nicht dem Format entsprechen. Weitere Informationen zu diesem Add-In finden Sie im [Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1982](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1982).
...
Verwalten Sie die Software und die Sicherheitsupdates, die Sie den Servern, Desktops und mobilen Computern in Ihrer Organisation bereitstellen müssen. Weitere Informationen finden Sie im [TechNet Update Management Center](https://go.microsoft.com/fwlink/?linkid=69903). Die Website [TechNet Sicherheit](https://go.microsoft.com/fwlink/?linkid=21132) bietet weitere Informationen zur Sicherheit von Microsoft-Produkten.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2584052">Microsoft Knowledge Base-Artikel 2584052</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2584063">Microsoft Knowledge Base-Artikel 2584063</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2584066">Microsoft Knowledge Base-Artikel 2584066</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Parvez Anwar in Zusammenarbeit mit [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in einer Office-Komponente aufgrund des nicht sicheren Ladens von Bibliotheken (CVE-2011-1980)  
-   David Warren von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Office aufgrund nicht initialisierten Objektzeigers (CVE-2011-1982)
