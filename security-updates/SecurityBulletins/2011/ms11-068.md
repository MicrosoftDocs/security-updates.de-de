---
TOCTitle: 'MS11-068'
Title: 'Microsoft Security Bulletin MS11-068 - Mittel'
ms:assetid: 'ms11-068'
ms:contentKeyID: 61224787
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-068(v=Security.10)'
---
...
Dieses Sicherheitsupdates wird für alle unterstützten Editionen von Windows Vista, Windows Server 2008, Windows 7 und Windows Server 2008 R2 als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows Kernel Metadateninformationen in Dateien analysiert. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9713b7b8-f260-440d-a994-845f17683fe9)                                         | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4d67ec00-e86a-49b6-a9a2-85b2520fa4bb)                             | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=da219735-b8b7-4f97-b8a8-7c253838de6b)\*\*\*          | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e077af5-5823-4377-a997-44b022a694d8)\*\*\*    | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=560efa6f-c956-47cb-a2f4-a1f45278b7cd)      | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?familyid=6c8dd72b-abf8-4e1f-aafc-777c1a3ef3db)                                         | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 für 32-Bit-Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6c8dd72b-abf8-4e1f-aafc-777c1a3ef3db)                          | DoS (Denial of Service)        | Mittel                           | Keine                                                     |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=d90c07c1-3c07-4989-825c-fb8453541a0e)                                   | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d90c07c1-3c07-4989-825c-fb8453541a0e)                    | DoS (Denial of Service)        | Mittel                           | Keine                                                     |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=67cccd09-5b82-4546-884a-d2a9e2400820)\*\*\*                | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=67cccd09-5b82-4546-884a-d2a9e2400820)\*\*\* | DoS (Denial of Service)        | Mittel                           | Keine                                                     |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)                  | DoS (Denial of Service)        | Mittel                           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)   | DoS (Denial of Service)        | Mittel                           | Keine                                                     |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bei Metadatenanalyse in Windows Kernel bezüglich Denial of Service (DOS) - CVE-2011-1971</th>
...
Sicherheitsanfälligkeit bei Metadatenanalyse in Windows Kernel bezüglich Denial of Service (DOS) - CVE-2011-1971  
----------------------------------------------------------------------------------------------------------------
  
In Windows liegt eine Sicherheitsanfälligkeit bezüglich Denial of Service vor, die dadurch verursacht wird, wie der Kernel beim Navigieren zu einem Ordner Dateimetadaten analysiert. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass das betroffene System zusammenbricht.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1971).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bei der Metadatenanalyse in Windows Kernel bezüglich Denial of Service - CVE-2011-1971
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   In einem webbasierten Angriffsszenario kann ein Angreifer eine Website mit einer Webseite einrichten, die diese Sicherheitsanfälligkeit ausnutzt. Außerdem können manipulierte Websites und Websites, die von Endbenutzern bereitgestellte Inhalte oder Werbemitteilungen akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden könnte. In einem auf einer Netzwerkfreigabe basierenden Angriffsszenario kann ein Angreifer eine speziell gestaltete Datei auf einer Netzwerkfreigabe hosten, mit der diese Sicherheitsanfälligkeit ausgenutzt wird. Ein Angreifer kann Benutzer jedoch nicht zum Besuch einer solchen Website oder Netzwerkfreigabe zwingen. Stattdessen muss ein Angreifer einen Benutzer dazu verleiten, die Website oder Netzwerkfreigabe zu besuchen. Zu diesem Zweck wird der Benutzer meist dazu gebracht, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zu klicken.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit bei der Metadatenanalyse in Windows Kernel bezüglich Denial of Service - CVE-2011-1971
...
-   **Blockieren Sie die TCP-Ports 139 und 445 an der Firewall:**
    ...
    **So machen Sie die Problemumgehung rückgängig.** Aufheben der Blockierung der TCP-Ports 139 und 445 an der Firewall. Weitere Informationen zu den Ports finden Sie im TechNet-Artikel [TCP- und UDP-Portzuweisungen](https://go.microsoft.com/fwlink/?linkid=21312).
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bei der Metadatenanalyse in Windows Kernel bezüglich Denial of Service -CVE-2011-1971
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows Kernel Metadateninformationen in Dateien falsch analysiert.
  
**Was ist der Windows-Kernel?**  
^Der Windows-Kernel ist der Kern des Betriebssystems. Der Kernel stellt Dienste auf Systemebene wie Geräte- und Speicherverwaltung zur Verfügung, weist Prozessen Prozessorzeit zu und verwaltet die Fehlerbehandlung.
...
In einem webbasierten Angriffsszenario muss ein Angreifer eine Website hosten, die auf eine speziell gestaltete Datei auf einer Netzwerkfreigabe zeigt. Wenn dann der Benutzer zu der Website navigiert, wird der betroffene Steuerpfad über das Detail- und Vorschaufenster in Windows Explorer ausgelöst. Die speziell gestaltete Datei kann dann die Sicherheitsanfälligkeit ausnutzen und bewirken, dass das betroffene System neu startet. Ein Angreifer kann Benutzer nicht zum Besuch einer speziell gestalteten Website zwingen. Stattdessen muss er den Benutzer zu einem Besuch dieser Website verleiten. Zu diesem Zweck wird der Benutzer normalerweise dazu gebracht, auf einen Link zur Site des Angreifers zu klicken.
  
In einem auf einer Netzwerkfreigabe basierenden Angriffsszenario kann ein Angreifer eine speziell gestaltete Datei auf einer Netzwerkfreigabe hosten. Wenn dann der Benutzer in Windows Explorer zu der Freigabe navigiert, wird der betroffene Steuerpfad über das Detail- und das Vorschaufenster ausgelöst. Die speziell gestaltete Datei kann dann die Sicherheitsanfälligkeit ausnutzen und bewirken, dass das betroffene System neu startet.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows Kernel Metadateninformationen in Dateien analysiert.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2556532">Microsoft Knowledge Base-Artikel 2556532</a>.</td>
</tr>
<tr class="odd">
...
-   Zheng Wenbin von [Qihoo 360 Security Center](https://www.360.cn/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Metadatenanalyse in Windows Kernel bezüglich Denial of Service (CVE-2011-1971)
...
-   V1.1 (10. August 2011): Der Hinweis **Die Server Core-Installation ist nicht betroffen.** für Windows Server 2008 und Windows Server 2008 R2 wurde überarbeitet, um zu erklären, dass das Update immer noch Systemen angeboten wird, auf denen die Server Core-Installationsoption verwendet wird.
