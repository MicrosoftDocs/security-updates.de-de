---
TOCTitle: 'MS11-085'
Title: 'Microsoft Security Bulletin MS11-085 - Hoch'
ms:assetid: 'ms11-085'
ms:contentKeyID: 61224804
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-085(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-085 - Hoch
===========================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Vista als Hoch eingestuft, für alle unterstützten Editionen von Windows Server 2008 als Mittel und ist für alle unterstützten Editionen von Windows 7 und Windows Server 2008 R2 als Niedrig. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Mail und Windows-Teamarbeit externe Bibliotheken laden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524)                                                                                               | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38)                                                                                   | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc)\*\*                                                                  | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9)\*\*                                                            | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                            | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9)                                               | Remotecodeausführung           | Niedrig                          | Keine                                             |
| [Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960)                                   | Remotecodeausführung           | Niedrig                          | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5)\*\*     | Remotecodeausführung           | Niedrig                          | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1) | Remotecodeausführung           | Niedrig                          | Keine                                             |
...
Es gibt einige Desktopfunktionen, z. B. Windows Mail, die nicht standardmäßig unter Windows Server 2008 installiert sind. Stattdessen können Sie sie alle zusammen mit der Desktopdarstellung unter Windows Server 2008 installieren. Weitere Informationen finden Sie in dem TechNet-Artikel [Windows Mail, Windows Media Player und weitere Funktionen in der Desktopdarstellung in Windows Server 2008](https://technet.microsoft.com/de-de/library/cc771519(ws.10).aspx).

**Warum wird dieses Update für Systeme mit Windows Server 2008 angeboten, ungeachtet dessen, ob die Desktopdarstellung installiert ist?**  
Der anfällige Code liegt in Installationen von Windows Server 2008 vor, unabhängig davon, ob die Desktopdarstellung installiert ist. Da der anfällige Code vorhanden ist, wird dieses Update angeboten.

Andererseits erfolgen die Angriffe zum Ausnutzen der Sicherheitsanfälligkeit durch Windows Mail und Windows-Teamarbeit. Windows-Teamarbeit und Windows Mail sind nicht standardmäßig unter Windows Server 2008 installiert. Auf Systemen, auf denen Windows-Teamarbeit und Windows Mail nicht installiert sind, wird nicht auf den anfälligen Code zugegriffen.

Windows Mail kann zusammen mit der Desktopdarstellung unter Windows Server 2008 installiert werden. Microsoft empfiehlt Benutzern von Windows Server 2008, das Update zu installieren, um die mögliche Angriffsmethode zu beseitigen.

**Weshalb ist die Bewertung des Schweregrads für Systeme mit Windows 7 und Windows Server 2008 R2 niedriger?** 
Obwohl der anfällige Code in Windows 7 und Windows Server 2008 R2 vorhanden ist, ist Microsoft sich keinerlei Angriffsmethoden bewusst, welche die Ausnutzung der Sicherheitsanfälligkeit auf diesen Betriebssystemen ermöglicht. Benutzern dieser Betriebssysteme wird dennoch empfohlen, das Update als Tiefenverteidigungsmaßnahme zu übernehmen.
...
**Sind andere E-Mail-Clients, z. B. Windows Live Mail oder Outlook Express von diesem Problem betroffen?**
Nein. Diese Sicherheitsanfälligkeit betrifft nur Windows Mail-Clients auf den Betriebssystemen, die in der Tabelle „Betroffene Software“ aufgeführt sind. Andere E-Mail-Clients sind nicht betroffen.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich nicht sicheren Ladens von Bibliotheken durch Windows Mail – CVE-2011-2016
</th>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Windows Mail und Windows-Teamarbeit das Laden von DLL-Dateien verarbeiten. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2016](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich nicht sicheren Ladens von Bibliotheken durch Windows Mail – CVE-2011-2016

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Damit ein Angriff erfolgreich ist, muss ein Benutzer einen nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen und an diesem Ort eine gültige Datei (z. B. eine EML- oder WCINV-Datei) öffnen, die dann von einer anfälligen Anwendung geladen wird.
...
-   Unter Windows Server 2008 sind Windows Mail und Windows-Teamarbeit standardmäßig nicht installiert. Windows Mail wird nur installiert, wenn auch die Desktopdarstellung installiert wird.
-   Obwohl der anfällige Code in Windows 7 und Windows Server 2008 R2 vorhanden ist, ist Microsoft sich keinerlei Angriffsmethoden bewusst, welche die Ausnutzung der Sicherheitsanfälligkeit auf diesen Betriebssystemen ermöglicht.

#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich nicht sicheren Ladens von Bibliotheken durch Windows Mail – CVE-2011-2016
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich nicht sicheren Ladens von Bibliotheken durch Windows Mail – CVE-2011-2016
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Windows Mail und Windows-Teamarbeit den Pfad falsch einschränken, wenn externe Bibliotheken geladen werden.
...
Mit Windows-Teamarbeit können Sie Dokumente, Programme oder Ihren Desktop mit anderen Personen gemeinsam nutzen, auf deren Computer Windows Vista ausgeführt wird. Windows-Teamarbeit verwendet Peer-to-Peer-Technologie und richtet automatisch ein Ad-hoc-Netzwerk ein, wenn es kein Netzwerk finden kann. Weitere Informationen finden Sie in den [Häufig gestellte Fragen zu Windows-Teamarbeit](https://windows.microsoft.com/de-de/windows-vista/windows-meeting-space-frequently-asked-questions).
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige Datei (z. B. eine EML- oder WCINV-Datei) zu öffnen, die sich in dem gleichen Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Beim Öffnen der gültigen Datei können Windows Mail oder Windows-Teamarbeit versuchen, die DLL-Datei zu laden und darin enthaltenen Code auszuführen.

In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine gültige Datei (z. B. eine EML- oder WCINV-Datei) an einen Benutzer sendet und diesen dazu verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und danach die gültige Datei zu öffnen. Beim Öffnen der gültigen Datei können Windows Mail oder Windows-Teamarbeit versuchen, die DLL-Datei zu laden und darin enthaltenen Code auszuführen.

In einem Netzwerkangriffsszenario kann ein Angreifer eine gültige Datei (z. B. eine EML- oder WCINV-Datei) und eine speziell gestaltete DLL-Datei auf einer Netzwerkfreigabe, einem UNC- oder WebDAV-Speicherort ablegen und den Benutzer anschließend dazu verleiten, die Datei zu öffnen.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Systeme, auf denen Windows Mail oder Windows-Teamarbeit verwendet werden, einschließlich Arbeitsstationen und Server, sind hauptsächlich gefährdet. Bei Servern ist das Risiko größer, wenn Administratoren Benutzern ermöglichen, sich bei Servern anzumelden und Programme auszuführen. Es wird jedoch dringend davon abgeraten, diese Erlaubnis zu erteilen.

**Was bewirkt das Update?**  
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Mail und Windows-Teamarbeit externe Bibliotheken laden.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2620704">Microsoft Knowledge Base-Artikel 2620704</a>.</td>
</tr>
<tr class="odd">
...
-   Ivan Sanchez von EvilCode für den Hinweis auf die Sicherheitsanfälligkeit bezüglich nicht sicheren Ladens von Bibliotheken durch Windows Mail (CVE-2011-2016)
