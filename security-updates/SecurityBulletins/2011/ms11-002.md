...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=7951fd7b-6b0a-4168-8519-312a62ff3289">Microsoft Data Access Components 2.8 Service Pack 1</a><br />
(KB2419632)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=d451ced7-c9c7-4c41-9d44-8f8929fca390">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=3f2c8cfa-819e-4fd9-93ba-b687eb2d46fe">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=8dbcbb91-464b-4eb3-b7e5-afe82febf8d7">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=13445e4a-099a-4edd-864e-c44f42940500">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=fd6b806e-50d4-4f4d-96e1-7c71fca4c543">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=3d0885ac-97b3-46b5-970d-cc810270fba3">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=8f33c57e-343c-4cdb-b667-af18a8779ad2">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=5ecc8180-6baa-4f4b-a392-4b45a30469fc">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=3dfd4f1c-e7a5-4686-8d2c-b7a5a53c5333">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=cf30e5c0-811b-4ecd-a6b2-874000d25074">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=cc9bac5a-3eaa-46fb-9ef4-c511b5f57996">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=ba2612ec-ffad-4cd3-85c6-ba07f70a0d24">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026).
...
-   Diese Sicherheitsanfälligkeit kann in der standardmäßigen Windows-Konfiguration nicht ausgenutzt werden. Um für das Problem anfällig zu sein, muss auf dem System eine Drittanbieteranwendung installiert sein, die bestimmte [ODBC](https://support.microsoft.com/kb/110093)-APIS (Open Database Connectivity) derart verwendet, dass die Sicherheitsanfälligkeit ausgenutzt werden kann.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027).
...
<td style="border:1px solid black;">Für Microsoft Data Access Components 2.8 Service Pack 1 unter Microsoft Windows XP Service Pack 3:<br />
Siehe <a href="https://support.microsoft.com/kb/2419632">Microsoft Knowledge Base-Artikel 2419632</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Data Access Components 2.8 Service Pack 2 unter Windows XP Professional x64 Edition Service Pack 2:<br />
Siehe <a href="https://support.microsoft.com/kb/2419635">Microsoft Knowledge Base-Artikel 2419635</a>.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2419635">Microsoft Knowledge Base-Artikel 2419635</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2419640">Microsoft Knowledge Base-Artikel 2419640</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
-   Abdul Aziz Hariri in Zusammenarbeit mit [TippingPoints](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Überlauf in DSN (CVE-2011-0026)  
-   Peter Vreugdenhil in Zusammenarbeit mit [TippingPoints](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit im ADO-Datensatzspeicher (CVE-2011-0027)
