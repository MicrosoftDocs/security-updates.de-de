...
[Microsoft Office XP Service Pack 3](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=6c87c2a9-3705-4680-8a9b-63b6ec83674d)  
(KB2509461)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2003 Service Pack 3](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=8b68cf68-1606-4649-b860-a64702c6cf33)  
(KB2509503)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2007 Service Pack 2](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=dbba0cd4-ab72-4e2b-9524-fd6be27f0b02)  
(KB2509488)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Das Sicherheitsupdatepaket für Microsoft Office XP (KB2509461) in diesem Bulletin behebt auch die Sicherheitsanfälligkeit, die im Security Bulletin [MS11-029](http://go.microsoft.com/fwlink/?linkid=208524) beschrieben wird. Benutzer mit Microsoft Office XP müssen nur eines der Sicherheitsupdatepakete installieren.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die Sicherheitsanfälligkeit behoben, die mithilfe der veröffentlichten Codebeispiele für ein Angriffskonzept ausgenutzt werden kann. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977).
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2509503">Microsoft Knowledge Base-Artikel 2509503</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2509488">Microsoft Knowledge Base-Artikel 2509488</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.6.3 im [Microsoft Download Center](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5) herunter, und installieren Sie sie.
...
Falls Sie technische Fragen oder Probleme beim Herunterladen bzw. Verwenden dieses Updates haben, finden Sie unter [Microsoft Support für Mac](http://www.microsoft.com/mac/support) die Supportoptionen, die Ihnen zur Verfügung stehen.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.2.9 im [Microsoft Download Center](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.1.9 im [Microsoft Download Center](http://www.microsoft.com/downloads/de-de/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14) herunter, und installieren Sie sie.
...
-   Haifei Li von [Fortinets FortiGuard Labs](http://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Office-Komponente durch das nicht sichere Laden von Bibliotheken (CVE-2011-0107)  
-   Einer Person, die mit der [Zero Day Initiative](http://www.zerodayinitiative.com/) von [TippingPoint](http://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Office bezüglich Grafikobjekt-Dereferenzierung (CVE-2011-0977)
