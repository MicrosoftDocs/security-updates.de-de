...
<td style="border:1px solid black;">
[Microsoft Excel 2002 Service Pack 3](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=db2c5cfe-588c-4646-b86a-3fb8248f7af4)  
(KB2466169)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Excel 2003 Service Pack 3](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=916a076d-d754-4092-b23d-c8826db7e397)  
(KB2502786)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2007 Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=5ae34fe0-03bd-48a9-a7ac-de8f7b1aff90)<sup>[1]</sup>
(KB2464583)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 (32-Bit-Editionen)](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=a427f0e2-b74d-4ef3-bec4-0a101d09bfa3)  
(KB2466146)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 (64-Bit-Editionen)](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=13dca35d-2209-4c5c-9150-d6db2bb3b496)  
(KB2466146)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Excel Viewer Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=2d75786a-2368-4ef2-970b-fa2e57d63ca9)  
(KB2466158)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=946cc611-4d75-4728-b9d3-1c8b557b02c2)  
(KB2466156)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0097](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0098](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0101](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0979](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten in Microsoft Excel aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** In Microsoft Office 2003 und Microsoft Office 2007 können Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](https://support.microsoft.com/kb/922848) erörtert ein gesondertes „Ausnahmeverzeichnis“ konfiguriert oder Dateien an einen vertrauenswürdigen Speicherort verschoben haben, Dateien im Format Office 2003 oder früheren Versionen nicht öffnen. In Microsoft Office 2010 werden Dateien aus Office 2003 oder früheren Versionen entweder nicht oder im geschütztem Modus geöffnet, je nach dem ausgewählten Öffnungsverhalten.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2466169">Microsoft Knowledge Base-Artikel 2466169</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2502786">Microsoft Knowledge Base-Artikel 2502786</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel 2007 finden Sie im <a href="https://support.microsoft.com/kb/2464583">Microsoft Knowledge Base-Artikel 2464583</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel Viewer finden Sie im <a href="https://support.microsoft.com/kb/2466158">Microsoft Knowledge Base-Artikel 2466158</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zum Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 finden Sie im <a href="https://support.microsoft.com/kb/2466156">Microsoft Knowledge Base-Artikel 2466156</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2466146">Microsoft Knowledge Base-Artikel 2466146</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Alin Rad Pop von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Ganzzahlüberlaufs (CVE-2011-0097)  
-   Alin Rad Pop von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Heapüberlaufs (CVE-2011-0098)  
-   Muhammad Junaid Bohio von [Telus Security Labs](https://www.telussecuritylabs.com) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bei Datensatzanalyse in WriteAV (CVE-2011-0101)  
-   Aniway in Zusammenarbeit mit [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bei Datensatzanalyse in WriteAV (CVE-2011-0101)  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchten, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2011-0103)  
-   Rodrigo Rubira Branco vom [Check Point Vulnerability Discovery Team](https://www.checkpoint.com/) (VDT) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Pufferüberschreibung (CVE-2011-0104)  
-   Aniway in Zusammenarbeit mit [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Dateninitialisierung (CVE-2011-0105)  
-   Aniway in Zusammenarbeit mit [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Arrayindizierung (CVE-2011-0978)  
-   Einer Person, die mit [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich beschädigter verknüpfter Liste (CVE-2011-0979)  
-   Ein Forscher, der mit [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbleibender Zeiger (CVE-2011-0980)
