...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d">Microsoft Office Publisher 2007 Service Pack 2</a><br />
(KB2596705)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=198156">MS10-103</a></td>
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Dezember](https://technet.microsoft.com/security/bulletin/ms11-dec). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/security/cc998259).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die Sicherheitsanfälligkeit behoben, die mithilfe der veröffentlichten Codebeispiele für ein Angriffskonzept ausgenutzt werden kann. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-3410](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3410).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-3411](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3411).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-3412](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3412).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2553084">Microsoft Knowledge Base-Artikel 2553084</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2596705">Microsoft Knowledge Base-Artikel 2596705</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Will Dormann von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Publisher bezüglich außerhalb des Bereichs liegenden Arrayindexes (CVE-2011-3410).  
-   Will Dormann von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Publisher aufgrund ungültigen Zeigers (CVE-2011-3411).  
-   Will Dormann von [CERT/CC](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Publisher durch Speicherbeschädigung (CVE-2011-3412).
