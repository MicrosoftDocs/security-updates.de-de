---
TOCTitle: 'MS11-075'
Title: 'Microsoft Security Bulletin MS11-075 - Hoch'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61224794
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-075(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-075 - Hoch
===========================================

Sicherheitsanfälligkeit in Microsoft Active Accessibility kann Remotecodeausführung ermöglichen (2623699)
---------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 11. Oktober 2011 | Aktualisiert: Dienstag, 25. Oktober 2011
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Microsoft Active Accessibility-Komponente externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Windows Server 2003 mit SP2 für Itanium-basierte Systeme</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5">Windows Server 2008 für 32-Bit-Systeme Service Pack 2</a>\*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca">Windows Server 2008 für x64-basierte Systeme Service Pack 2</a>\*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b">Windows Server 2008 für Itanium-basierte Systeme Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42">Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07">Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8">Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87">Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken – CVE-2011-1247</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken – CVE-2011-1247  
-----------------------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie die Microsoft Active Accessibility-Komponente das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1247](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken – CVE-2011-1247
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken – CVE-2011-1247
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken – CVE-2011-1247
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass die Microsoft-Active Accessibility-Komponente den Pfad zum Laden externer Bibliotheken falsch einschränkt.
  
**Was ist die Microsoft-Active Accessibility-Komponente?**  
Die Microsoft Active Accessibility-Komponente ist eine COM-basierte Technologie (Component Object Model), die die Zusammenarbeit von Eingabehilfen mit Anwendungen verbessert, die unter Microsoft Windows ausgeführt werden. Sie stellt DLLs (Dynamic Link Libraries) bereit, die in das Betriebssystem integriert werden, sowie eine COM-Schnittstelle und API-Elemente, die zuverlässige Methoden zum Offenlegen von Informationen zu UI-Elementen bereitstellen. Weitere Informationen finden Sie in dem MSDN-Artikel, [Microsoft Active Accessibility](https://msdn.microsoft.com/en-us/library/ms971350.aspx).
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige Datei zu öffnen, die sich im selben Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Beim Öffnen der gültigen Datei kann die Microsoft Active Accessibility-Komponente dann versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine gültige Dateianlage an einen Benutzer sendet und diesen verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und danach die gültige Datei zu öffnen. Beim Öffnen der gültigen Datei kann die Microsoft Active Accessibility-Komponente dann versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
...
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie die Microsoft Active Accessibility-Komponente externe Bibliotheken lädt.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2564958$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2564958">Microsoft Knowledge Base-Artikel 2564958</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Für alle unterstützten 32-Bit- und x64-basierten Editionen von Windows Server 2003:  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
Für alle unterstützten 32-Bit- und x64-basierten Editionen von Windows Server 2003:  
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2564958$\\Spuninst.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Für alle unterstützten Itanium-basierten Editionen von Windows Server 2003:  
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2605295$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Für alle unterstützten 32-Bit- und x64-basierten Editionen von Windows Server 2003:  
Siehe [Microsoft Knowledge Base-Artikel 2564958](https://support.microsoft.com/kb/2564958).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Für alle unterstützten Itanium-basierten Editionen von Windows Server 2003:  
Siehe [Microsoft Knowledge Base-Artikel 2605295](https://support.microsoft.com/kb/2605295).
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](https://contagiodump.com) in Zusammenarbeit mit Anshul Kothari und Nishant Kaushik von [Adobe Systems, Inc.](https://www.adobe.com) für den Hinweis auf die Sicherheitsanfälligkeit in aktiven Eingabehilfen bezüglich nicht sicheren Ladens von Bibliotheken (CVE-2011-1247).
...
-   V1.1 (12. Oktober 2011): Die Bulletin-Ersetzungsinformationen für alle unterstützten Editionen von Windows Vista, Windows Server 2008, Windows 7 und Windows Server 2008 R2 wurden korrigiert. Dies ist lediglich eine Informationsänderung. Es wurden keine Änderungen an der Erkennungslogik oder an den Updatedateien vorgenommen.  
-   V1.2 (25. Oktober 2011): Die Namen der Updatedateien für 32-Bit- und x64-basierte Editionen von Windows XP und Windows Server 2003 wurden gemäß dem Schema überarbeitet, das in Microsoft Knowledge Base-Artikel KB816915 dokumentiert ist. Dies ist lediglich eine Änderung der Dateinamen. Es wurden keine Änderungen an der Erkennungslogik oder an den Updateinhalten vorgenommen. Benutzer, die dieses Update bereits erfolgreich installiert haben, müssen keine Maßnahmen ergreifen.
