---
TOCTitle: 'MS11-083'
Title: 'Microsoft Security Bulletin MS11-083 - Kritisch'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61224802
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-083(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-083 - Kritisch
===============================================
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                                                               | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                                                                   | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                                                                    | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                                              | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                            | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 für 32-Bit Systeme und Windows 7 für 32-Bit Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7)                                               | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)                                   | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f)\*       | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad) | Kritisch                       | Remotecodeausführung             | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch Überlauf des Referenzzählers – CVE-2011-2013</th>
...
Sicherheitsanfälligkeit durch Überlauf des Referenzzählers – CVE-2011-2013  
--------------------------------------------------------------------------
  
Im Windows TCP/IP-Stapel liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die durch die Verarbeitung eines ununterbrochenen Flusses von speziell gestalteten UDP-Paketen verursacht wird. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2013](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Überlauf des Referenzzählers – CVE-2011-2013
  
Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit durch Überlauf des Referenzzählers – CVE-2011-2013
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Blockieren unbenutzter UDP-Ports an der Umkreisfirewall**
  
    Durch das Blockieren unbenutzter (geschlossener) UDP-Ports an der Umkreisfirewall werden die Systeme hinter jener Firewall gegen Angriffsversuche geschützt, bei denen diese Sicherheitsanfälligkeit ausgenutzt werden soll. Weitere Informationen zu den Ports finden Sie im TechNet-Artikel [TCP- und UDP-Portzuweisungen](https://go.microsoft.com/fwlink/?linkid=21312). Weitere Informationen zur Windows-Firewall finden Sie in dem TechNet-Artikel [So konfigurieren Sie eine Windows-Firewall auf einem einzelnen Computer](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Überlauf des Referenzzählers – CVE-2011-2013
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung im Kontext des Windows-Kernels.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows TCP/IP-Stapel einen ununterbrochenen Fluss speziell gestalteter UDP-Pakete bearbeitet, die zu einem Ganzzahlüberlauf führen.
...
**Was ist UDP?**  
Das User Datagram-Protokoll (UDP) ist ein in RFC 768 definierter TCP/IP-Standard, „User Datagram-Protokoll (UDP)“. UDP wird von einigen Programmen anstelle von TCP für schnellen, leichten, unzuverlässigen Transport von Daten zwischen TCP/IP-Hosts verwendet. UDP stellt einen verbindungslosen Datagrammdienst bereit, der Lieferung nach bestem Vermögen anbietet. Das bedeutet, dass UDP die Lieferung von Datagrammen nicht garantiert oder deren Sequenzierung überprüft. Ein Quellhost, der zuverlässige Kommunikation benötigt, muss entweder TCP oder ein Programm verwenden, das seine eigene Sequenzierung und eigene Anerkennungsdienste bereitstellt. Weitere Informationen finden Sie in dem TechNet-Artikel [User Datagram-Protokoll (UDP)](https://technet.microsoft.com/de-de/library/cc785220(ws.10).aspx).
...
Ein Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er einen ununterbrochenen Fluss speziell gestalteter UDP-Pakete an einen geschlossenen Port auf einem Zielsystem sendet.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Von dieser Sicherheitsanfälligkeit sind in erster Linie Arbeitsstationen und Server betroffen.
  
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der Windows TCP/IP-Stapel den Verlauf von UDP-Paketen innerhalb des Speichers verfolgt.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2588516">Microsoft Knowledge Base-Artikel 2588516</a>.</td>
</tr>
<tr class="odd">
