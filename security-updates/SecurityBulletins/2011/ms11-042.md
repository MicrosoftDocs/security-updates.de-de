---
TOCTitle: 'MS11-042'
Title: 'Microsoft Security Bulletin MS11-042 - Kritisch'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61224761
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-042(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-042 - Kritisch
===============================================

Sicherheitsanfälligkeiten in Distributed File System können Remotecodeausführung ermöglichen (2535512)
------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 14. Juni 2011 | Aktualisiert: Dienstag, 14. Juni 2011
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP und Windows Server 2003 als Kritisch eingestuft; für alle unterstützten Editionen von Windows Vista und Windows Server 2008 als Hoch und für Windows 7 für 32-Bit-Systeme, Windows 7 für x64-basierte Systeme, Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme ebenfalls als Hoch. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie der DFS-Client Felder in speziell gestalteten DFS-Verweisantworten überprüft, und indem korrigiert wird, wie der DFS-Dienst speziell gestaltete DFS-Verweisantworten verarbeitet. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                            | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                   | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                   | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                       | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                             | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                        | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                                | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                   | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                         | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                   | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                    | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                  | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in DFS bezüglich Speicherbeschädigung - CVE-2011-1868</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in DFS-Verweisantwort - CVE-2011-1869</th>
...
Sicherheitsanfälligkeit in DFS bezüglich Speicherbeschädigung - CVE-2011-1868  
-----------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in DFS bezüglich Speicherbeschädigung - CVE-2011-1868
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in DFS bezüglich Speicherbeschädigung - CVE-2011-1868
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in DFS bezüglich Speicherbeschädigung - CVE-2011-1868
...
Die Sicherheitsanfälligkeit wird verursacht, wenn die Implementierung des Microsoft Distributed File System (DFS) alle Felder innerhalb speziell gestalteter DFS-Antworten falsch überprüft.
  
**Was ist das Distributed File System (DFS)?**  
Das Distributed File System (DFS) ermöglicht Administratoren, freigegebene Ordner zu gruppieren, die sich auf verschiedenen Servern befinden, indem sie sie transparent mit einem oder mehreren DFS-Namespaces verbinden. Ein DFS-Namespace ist eine virtuelle Ansicht von freigegebenen Ordnern in einem Unternehmen. Mithilfe der DFS-Tools wählt ein Administrator aus, welche freigegebenen Ordner im Namespace präsentiert werden; er entwirft die Hierarchie, in der die Ordner angezeigt werden, und bestimmt die Namen, die die freigegebenen Ordner im Namespace zeigen. Wenn ein Endbenutzer den Namespace anzeigt, erscheint es so, als befänden sich die Ordner auf einer einzelnen Festplatte hoher Kapazität. Endbenutzer können die Ordner im Namespace navigieren, ohne die Servernamen oder freigegebenen Ordner zu kennen, in denen die Daten gehostet werden. Weitere Informationen finden Sie in [DFS: Technische Referenz](https://technet.microsoft.com/de-de/library/cc757042(ws.10).aspx).
...
Ein Angreifer kann einen speziell gestalteten Server hosten, der zum Ausnutzen dieser Sicherheitsanfälligkeit entwickelt wurde, und dann einen Benutzer dazu verleiten, eine DFS-Verbindung zu ihm zu initiieren. Außerdem kann ein Angreifer im lokalen Netzwerk einen Man-in-the-Middle-Angriff durchführen, um mit einer fehlerhaften DFS-Antwort auf eine legitime DFS-Anforderung zu antworten.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Alle unterstützten Editionen von Windows XP und Windows Server 2003 sind durch diese Sicherheitsanfälligkeit gefährdet.
  
**Was bewirkt das Update?**  
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der DFS-Client Felder in speziell gestalteten DFS-Antworten überprüft.
...
Sicherheitsanfälligkeit in DFS-Verweisantwort - CVE-2011-1869  
-------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1869](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in DFS-Verweisantwort - CVE-2011-1869
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in DFS-Verweisantwort - CVE-2011-1869
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in DFS-Verweisantwort - CVE-2011-1869
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass das betroffene System nicht mehr reagiert, bis es manuell neu gestartet wird. Beachten Sie, dass eine Sicherheitsanfälligkeit vom Typ Denial-of-Service einem Angreifer keine Codeausführung oder Erhöhung von Benutzerberechtigungen ermöglicht, sondern dazu führt, dass der betroffene Dienst keine Anforderungen mehr annimmt.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird verursacht, wenn die Implementierung des Distributed File Systems (DFS) speziell gestaltete DFS-Verweisantworten falsch verarbeitet.
...
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Alle unterstützten Versionen von Windows sind durch diese Sicherheitsanfälligkeit gefährdet.
  
**Was bewirkt das Update?**  
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der DFS-Dienst speziell gestaltete DFS-Verweisantworten verarbeitet.
...
| Windows 7 für 32-Bit-Systeme                                                                                         | Ja                | Ja                         |  
| Windows 7 für x64-basierte Systeme                                                                                   | Ja                | Ja                         |  
| Windows Server 2008 R2 für x64-basierte Systeme                                                                      | Ja                | Ja                         |  
| Windows Server 2008 R2 für Itanium-basierte Systeme                                                                  | Ja                | Ja                         |
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2535512$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2535512">Microsoft Knowledge Base-Artikel 2535512</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Windows 7 für 32-Bit-Systeme:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Windows 7 für x64-basierte Systeme:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für alle Windows 7 für x64-basierten Systeme:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Windows 2008 R2 für x64-basierte Systeme:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Windows 2008 R2 für Itanium-basierte Systeme:<br />
...
-   Laurent Gaffié von [NGS Software](https://www.ngssoftware.com/) für den Hinweis auf die Sicherheitsanfälligkeit in DFS-Verweisantwort (CVE-2011-1869)
...
-   V1.1 (14. Juni 2011): Windows 7 für 32-Bit-Systeme Service Pack 1, Windows 7 für x64-basierte Systeme Service Pack 1, Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1 und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1 wurden aus der Tabelle der betroffenen Software in die Tabelle der nicht betroffenen Software verschoben. Dies ist lediglich eine Informationsänderung. An den Dateien des Sicherheitsupdates oder der Erkennungslogik wurden keine Änderungen vorgenommen.
