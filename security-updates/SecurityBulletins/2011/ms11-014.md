---
TOCTitle: 'MS11-014'
Title: 'Microsoft Security Bulletin MS11-014 - Kritisch'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61224733
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-014(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-014 - Kritisch
===============================================
...
Veröffentlicht: Dienstag, 8. Februar 2011 | Aktualisiert: Donnerstag, 28. April 2011
...
Dieses Sicherheitsupdate behebt eine vertraulich gemeldete Sicherheitsanfälligkeit im LSASS-Dienst (Local Security Authority Subsystem Service, Subsystemdienst für die lokale Sicherheitsautorität) in Windows XP und Windows Server 2003. Dieses Sicherheitsupdate wird für alle unterstützten Editionen dieser Betriebssysteme als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie LSASS bestimmte Werte verarbeitet, die beim Authentifizierungsprozess verwendet werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2478960](https://support.microsoft.com/kb/2478960) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                                                                  |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)             | Erhöhung von Berechtigungen    | Hoch                             | [MS08-002](https://go.microsoft.com/germany/technet/sicherheit/bulletins/ms08-002.mspx) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                       | Erhöhung von Berechtigungen    | Hoch                             | [MS08-002](https://go.microsoft.com/germany/technet/sicherheit/bulletins/ms08-002.mspx) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)           | Erhöhung von Berechtigungen    | Hoch                             | [MS08-002](https://go.microsoft.com/germany/technet/sicherheit/bulletins/ms08-002.mspx) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Erhöhung von Berechtigungen    | Hoch                             | [MS08-002](https://go.microsoft.com/germany/technet/sicherheit/bulletins/ms08-002.mspx) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung - CVE-2011-0039</th>
...
Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung - CVE-2011-0039  
----------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie der Microsoft Windows LSASS-Dienst (Local Security Authority Subsystem Service, Subsystemdienst für die lokale Sicherheitsautorität) speziell gestaltete Authentifizierungsanforderungen verarbeitet. Diese Sicherheitsanfälligkeit kann einem Angreifer ermöglichen, Code mit erhöhten Berechtigungen auszuführen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen administrativen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung - CVE-2011-0039
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung - CVE-2011-0039
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung - CVE-2011-0039
...
Die Sicherheitsanfälligkeit wird verursacht, wenn Windows LSASS eine speziell gestaltete Authentifizierungsanforderung verarbeitet.
...
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie LSASS bestimmte Werte verarbeitet, die beim Authentifizierungsprozess verwendet werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2478960$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2478960">Microsoft Knowledge Base-Artikel 2478960</a>.</td>
</tr>
<tr class="even">
...
-   Sicherheitstester Jorge Moura von Primavera BSS für den Hinweis auf die Sicherheitsanfälligkeit in LSASS bezüglich Längenüberprüfung (CVE-2011-0039)
...
-   V1.1 (28. April 2011): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2478960 hinzugefügt.
