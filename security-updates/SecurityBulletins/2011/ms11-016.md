---
TOCTitle: 'MS11-016'
Title: 'Microsoft Security Bulletin MS11-016 - Kritisch'
ms:assetid: 'ms11-016'
ms:contentKeyID: 61224735
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-016(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-016 - Kritisch
===============================================

Sicherheitsanfälligkeit in Microsoft Groove kann Remotecodeausführung ermöglichen (2494047)
-------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 8. März 2011
...
Dieses Sicherheitsupdate wird für Microsoft Groove 2007 Service Pack 2 als Hoch eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Groove 2007 externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office-Programme</th>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/de-de/details.aspx?familyid=3981ab53-1082-4155-9000-11d8a976ff33">Microsoft Groove 2007 Service Pack 2</a><br />
(KB2494047)</td>
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken – CVE-2010-3146</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken – CVE-2010-3146  
---------------------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung in der Art und Weise vor, in der Microsoft Groove 2007 das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken – CVE-2010-3146
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Damit ein Angriff erfolgreich ist, muss ein Benutzer einen nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen und eine Groove-bezogene Datei (z. B. eine VCG- oder GTA-Datei) öffnen.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken – CVE-2010-3146
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken – CVE-2010-3146
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Microsoft Groove 2007 den Pfad zum Laden externer Bibliotheken falsch einschränkt.
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige, Groove-bezogene Datei (z. B. eine VCG- oder GTA-Datei) zu öffnen, die sich in dem gleichen Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Wenn dann die legitime Datei geöffnet wird, kann Microsoft Groove 2007 versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er einem Benutzer eine gültige, Groove-bezogene Dateianlage (z. B. eine VCG- oder GTA-Datei) sendet und ihn dazu verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und des Weiteren die gültige Datei zu öffnen. Wenn dann die legitime Datei geöffnet wird, kann Microsoft Groove 2007 versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem Netzwerkangriffsszenario kann ein Angreifer eine gültige, Groove-bezogene Datei und eine speziell gestaltete DLL auf einer Netzwerkfreigabe, einem UNC- oder WebDAV-Speicherort ablegen und den Benutzer anschließend dazu verleiten, die Datei zu öffnen.
  
**Was ist eine VCG-Datei (Microsoft Groove vCard)?**    
Das vCard-Format ist ein Dateiformatstandard für elektronische Visitenkarten. VCG-Dateien (Microsoft Groove vCard) werden für Kontakte verwendet, die im vCard-Format gespeichert werden.
  
**Was ist eine GTA-Datei (Microsoft Groove Tool Archive)?**    
GTA-Dateien (Microsoft Groove Tool Archive) werden für Groove-Tools verwendet. Das sind Minianwendungen, die auf der Groove zugrunde liegenden Möglichkeit beruhen, Inhalte mithilfe der Kopien des Groove-Arbeitsbereichs von anderen Mitgliedern zu synchronisieren und zu verbreiten.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Windows Groove 2007 externe Bibliotheken lädt.
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die Sicherheitsanfälligkeit behoben, die mithilfe der veröffentlichten Codebeispiele für ein Angriffskonzept ausgenutzt werden kann. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146) zugewiesen.
...
|--------------------------------------|---------|-------------------|-------------------|----------------------------|  
| Microsoft Groove 2007 Service Pack 2 | Nein    | Nein              | Ja                | Ja                         |
...
#### Microsoft Groove 2007 (alle Editionen)
...
<td style="border:1px solid black;">Für Microsoft Office Groove 2007 Service Pack 2:<br />
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2494047">Microsoft Knowledge Base-Artikel 2494047</a>.</td>
</tr>
<tr class="even">
...
-   HD Moore von [Rapid 7](http://www.rapid7.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Groove aufgrund des nicht sicheren Ladens von Bibliotheken (CVE-2010-3146)
