---
TOCTitle: 'MS11-005'
Title: 'Microsoft Security Bulletin MS11-005 - Kritisch'
ms:assetid: 'ms11-005'
ms:contentKeyID: 61224724
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-005(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-005 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für Active Directory unter allen unterstützten Editionen von Windows Server 2003 als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Active Directory-Server SPN-Aktualisierungsanforderungen (Service Principal Name, Dienstprinzipalname) verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=651c1f4f-4e69-4d17-8aa2-72681dfc5463">Active Directory</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=ec962b0e-e951-4e70-8d97-8c2afd360c28">Active Directory</a></td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=190509">MS10-068</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=201319">MS10-101</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/de-de/details.aspx?familyid=4ac66eae-e6d8-4e8b-b4ea-e7a77cc74db0">Active Directory</a></td>
<td style="border:1px solid black;">DoS (Denial of Service)</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=190509">MS10-068</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=201319">MS10-101</a></td>
...
<td style="border:1px solid black;">(ADAM, AD LDS und Active Directory sind keine Komponenten dieser Version von Microsoft Windows)</td>
</tr>
<tr class="even">
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Active Directory bezüglich SPN-Überprüfung – CVE-2011-0040</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit in Active Directory bezüglich SPN-Überprüfung – CVE-2011-0040  
-------------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Active Directory bezüglich SPN-Überprüfung – CVE-2011-0040
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Um diese Sicherheitsanfälligkeit bezüglich Denial-of-Service auszunutzen, muss der Angreifer Administrator eines Computers sein, der einer Domäne angehört.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in Active Directory bezüglich SPN-Überprüfung – CVE-2011-0040
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Active Directory bezüglich SPN-Überprüfung – CVE-2011-0040
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Dies ist sowohl eine Sicherheitsanfälligkeit bezüglich Herunterstufung der Authentifizierung als auch eine Sicherheitsanfälligkeit bezüglich Denial-of-Service. Ein Angreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann im betroffenen System eine Herunterstufung von Kerberos auf NTLM (NT LAN Manager) verursachen und im schlimmsten Fall bewirken, dass der Dienst nicht mehr reagiert. Diese Sicherheitsanfälligkeit ermöglicht einem Angreifer keine Codeausführung oder Erhöhung von Berechtigungen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Active Directory bearbeitet speziell gestaltete Anforderungen zur Aktualisierung des SPNs (Service Principal Name, Dienstprinzipalname) nicht richtig. Dies kann in der Domäne zu Namenskonflikten führen.
...
**Was ist SPN?**    
Ein SPN (Service Principal Name) ist der Name, anhand dessen ein Client eine Instanz eines Diensts eindeutig identifiziert. Weitere Informationen zur Verwendung des Dienstprinzipalnamens finden Sie im MSDN-Artikel [Dienstprinzipalnamen](https://msdn.microsoft.com/en-us/library/ms677949(vs.85).aspx).
...
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann Namenskonflikte in der Domäne verursachen. Dies bewirkt, dass die Authentifizierung der Dienste, die den SPN verwenden, auf NTLM heruntergestuft werden. In bestimmten Konfigurationen, in denen der Dienst nicht zum Verhandeln konfiguriert ist, steht der Dienst nicht mehr zur Verfügung.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann versuchen, diese Sicherheitsanfälligkeit auszunutzen, indem er speziell gestaltete Pakete an den Active Directory-Server sendet. Der Angreifer muss gültige lokale Administratorberechtigungen auf dem Computer haben, der einer Domäne angehört, um diese Sicherheitsanfälligkeit auszunutzen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Diese Sicherheitsanfälligkeit betrifft Umgebungen, in denen Active Directory unter Windows Server 2003 ausgeführt wird.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Active Directory-Server SPN-Aktualisierungsanforderungen (Service Principal Name, Dienstprinzipalname) verarbeitet.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2011-0040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040) zugewiesen.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2478953$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2478953">Microsoft Knowledge Base-Artikel 2478953</a>.</td>
</tr>
<tr class="even">
