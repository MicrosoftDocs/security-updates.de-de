---
TOCTitle: 'MS11-058'
Title: 'Microsoft Security Bulletin MS11-058 - Kritisch'
ms:assetid: 'ms11-058'
ms:contentKeyID: 61224777
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-058(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 9. August 2011 | Aktualisiert: Dienstag, 25. Oktober 2011
...
Dieses Sicherheitsupdate wird für 32-Bit und x64-basierte Editionen von Windows Server 2008 und x64-basierte Editionen von Windows Server 2008 R2 als Kritisch eingestuft; und für alle unterstützten Editionen von Windows Server 2003 wird es als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie der DNS-Server NAPTR-Abfragen im Speicher verarbeitet und wie er Objekte im Speicher vor der Verwendung initialisiert. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f)                                                                                   | DoS (Denial of Service)        | Hoch                             | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43)                                                                       | DoS (Denial of Service)        | Hoch                             | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a)                                                             | DoS (Denial of Service)        | Hoch                             | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ac2d5122-6f9b-46f5-9840-77aa7ff84308)\*                                                              | Remotecodeausführung           | Kritisch                         | Keine                                                     |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5f605f6f-3854-403d-878b-637626aef78f)\*                                                        | Remotecodeausführung           | Kritisch                         | Keine                                                     |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6a86e2cf-4e7d-4012-88c3-6957a3842dd3)\* | Remotecodeausführung           | Kritisch                         | Keine                                                     |
...
**Weshalb wurde dieses Bulletin am** **25.Oktober** **2011 überarbeitet?**  
Microsoft hat dieses Bulletin überarbeitet, um eine Änderung an der Erkennungslogik anzukündigen und Bulletin-Ersetzungsinformationen für alle unterstützten Editionen von Windows Server 2003 zu korrigieren. Es gab keine Änderungen an den Sicherheitsupdatedateien. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen – CVE-2011-1966</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in DNS bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2011-1970</th>
...
Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen – CVE-2011-1966  
----------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, dass der Windows DNS-Server eine speziell gestaltete NAPTR-Abfragezeichenfolge im Speicher falsch verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code im Kontext des Systems ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1966](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen – CVE-2011-1966
  
Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen – CVE-2011-1966
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Deaktivieren des DNS-Dienstes bei Nichtverwendung**
  
    **Interaktive Methode:**
  
    1.  Klicken Sie auf **Start** und dann auf **Ausführen**, geben Sie **regedit** ein, und klicken Sie dann auf **OK**.  
    2.  Erweitern Sie **HKEY\_LOCAL\_MACHINE**, erweitern Sie **System**, dann **CurrentControlSet** und schließlich **Dienste**.  
    3.  Klicken Sie auf **DNS**.  
    4.  Klicken Sie auf das Menü **Datei** und dann auf **Exportieren**.  
    5.  Geben Sie in das Dialogfeld „Registrierungsdatei exportieren“ den Namen **DNS\_configuration\_backup.reg** ein, und klicken Sie auf **Speichern**.  
    6.  Doppelklicken Sie auf den Wert **Start**, und ändern Sie dann das Datenfeld **Wert** in **4**.  
    7.  Klicken Sie auf **OK**.  
    8.  Führen Sie als Administrator folgenden Befehl an einer Eingabeaufforderung aus:  
    ...
    **Verwenden eines verwalteten Bereitstellungsskripts:**
    ...
    2.  Speichern Sie folgenden Text in einer Datei mit der Erweiterung .REG (z. B. Disable\_service\_DNSame.reg):  
        ...
        ```
    3.  Führen Sie mit folgendem Befehl das oben in Schritt 2 auf dem Zielcomputer erstellte Registrierungsskript aus:  
    ...
    **Interaktive Methode:**
    ...
    3.  Wählen Sie im Dialogfeld „Registrierungsdatei importieren“ **DNS\_configuration\_backup.reg** aus, und klicken Sie dann auf **Öffnen**.
  
    **Verwenden eines verwalteten Bereitstellungsskripts:**
  
    Stellen Sie den ursprünglichen Zustand der Registrierung wieder her, indem Sie als Administrator folgenden Befehl an einer Eingabeaufforderung ausführen:  
    `Regedit /s DNS_configuration_backup.reg`
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen – CVE-2011-1966
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass ein nicht autorisierender DNS-Server einen speziell gestalteten NAPTR-Datensatz im Speicher falsch verarbeitet, während er den Datensatz rekursiv vom autoritativen DNS-Server anfordert.
  
**Welche Komponente ist von dieser Sicherheitsanfälligkeit betroffen?**  
Dns.exe ist von dieser Sicherheitsanfälligkeit betroffen.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code im Kontext des Systems ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Ein nicht authentifizierter Remoteangreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er eine Domäne registriert, die einen NAPTR DNS-Ressourceneintrag erstellt und dann eine speziell gestaltete NAPTR-Abfrage an den Ziel-DNS-Server sendet.
...
**Was ist ein NAPTR DNS-Ressourceneintrag?**  
Ein Namensvergebungsstellen-Zeiger (NAPTR) DNS-Ressourceneintrag (RR) ermöglicht die Verwendung von DNS zum Nachschlagen von Diensten für eine Vielfalt von Ressourcennamen, einschließlich URIs, die nicht in der Namenssyntax der Domäne vorliegen. Weitere Informationen zu NAPTR finden Sie in [RFC-2915](https://www.ietf.org/rfc/rfc2915.txt).
  
**Was ist ein DNS-Ressourceneintrag?**  
Ein DNS-Ressourceneintrag (RR) kennzeichnet eine besondere Ressource innerhalb einer Domäne. Weitere Informationen finden Sie im TechNet-Artikel [Funktionsweise von DNS](https://technet.microsoft.com/de-de/library/dd197446(ws.10).aspx).
  
**Was ist eine URI?**  
Ein Uniform Resource Identifier (URI) ist eine Zeichenfolge, mit der Ressourcen im Internet oder über ein Netzwerk identifiziert werden bzw. auf diese eingewirkt wird. Eine URL ist ein typisches Beispiel für eine URI, die auf eine Ressource wie eine Website verweist. Weitere Informationen zu URIs finden Sie unter [RFC 2396](https://www.ietf.org/rfc/rfc2915.txt).
  
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der DNS-Server NAPTR-Abfragen im Speicher verarbeitet.
...
Sicherheitsanfälligkeit in DNS bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2011-1970  
---------------------------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Denial-of-Service vor, die dadurch verursacht wird, dass der DNS-Server ein Objekt im Speicher, das nicht initialisiert wurde, falsch verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass der DNS-Serverdienst auf dem Zielsystem nicht mehr antwortet.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in DNS bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2011-1970
  
Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in DNS bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2011-1970
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in DNS bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2011-1970
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der DNS-Server ein nicht initialisiertes Objekt im Speicher falsch verarbeitet, während er den Ressourceneintrag einer nicht vorhandenen Domäne nachschlägt.
  
**Welche Komponente ist von dieser Sicherheitsanfälligkeit betroffen?**  
Dns.exe ist von dieser Sicherheitsanfälligkeit betroffen.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass der DNS-Serverdienst dem Zielsystem nicht mehr antwortet.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Ein nicht authentifizierter Remoteangreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete DNS-Abfrage für den Ressourceneintrag einer nicht existierenden Domäne an den Ziel-DNS-Server sendet.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der DNS-Server Objekte im Speicher vor der Verwendung initialisiert.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2562485$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2562485">Microsoft Knowledge Base-Artikel 2562485</a>.</td>
</tr>
<tr class="even">
...
-   Grischa Zengel (Zengel Medizintechnik GmbH) für den Hinweis auf die Sicherheitsanfälligkeit durch DNS NAPTR-Abfragen (CVE-2011-1966)
...
-   V1.1 (21. September 2011): Die Tabelle „Betroffene Software“ wurde korrigiert, um das Bulletin MS11-046, das durch dieses Update ersetzt wird, aus allen betroffenen Editionen von Windows Server 2003 zu entfernen. Dies ist lediglich eine Erkennungsänderung. Die Dateien des Sicherheitsupdates wurden nicht verändert. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.  
-   V1.2 (25. Oktober 2011): Ankündigung einer Änderung an der Erkennungslogik und Korrektur von Bulletin-Ersetzungsinformationen für einige betroffene Konfigurationen. Die Dateien des Sicherheitsupdates wurden nicht verändert. Weitere Informationen finden Sie in den häufig gestellten Fragen (FAQs) zu diesem Update.
