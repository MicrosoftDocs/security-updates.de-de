...
Indem Sie die Überprüfung von Office-Dateien so einstellen, dass das Öffnen verdächtiger Dateien in Excel 2003 nicht zugelassen wird, blockiert die **Microsoft Fix it-Lösung** „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“ im [Microsoft Knowledge Base-Artikel 2501584](http://support.microsoft.com/kb/2501584) die Angriffsmethoden zum Ausnutzen der Sicherheitsanfälligkeiten, die in CVE-2011-1986 und CVE-2011-1987 beschrieben sind.
...
Indem Sie die Überprüfung von Office-Dateien so einstellen, dass das Öffnen verdächtiger Dateien in Excel 2007 nicht zugelassen wird, blockiert die **Microsoft Fix it-Lösung** „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“ im [Microsoft Knowledge Base-Artikel 2501584](http://support.microsoft.com/kb/2501584) die Angriffsmethoden zum Ausnutzen der Sicherheitsanfälligkeit, die in CVE-2011-1987 beschrieben ist.
...
Die automatisierte **Microsoft Fix it-Lösung** „Bearbeiten in geschützter Ansicht für Excel 2010 deaktivieren“ in [Microsoft Knowledge Base-Artikel 2501584](http://support.microsoft.com/kb/2501584) blockiert die Angriffsmethoden zum Ausnutzen von CVE-2011-1987. Endbenutzer können die Fix it-Lösung als Problemumgehung übernehmen, wenn das Sicherheitsupdate für Excel 2010 erst zu einem späteren Zeitpunkt installiert werden soll.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1986](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1986).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1987](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1987).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1988](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1988).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1989](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1989).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1990](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1990).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2553072">Microsoft Knowledge Base-Artikel 2553072</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Excel 2007 Service Pack 2:<br />
Siehe <a href="http://support.microsoft.com/kb/2553073">Microsoft Knowledge Base-Artikel 2553073</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office 2007 Service Pack 2:<br />
Siehe <a href="http://support.microsoft.com/kb/2553089">Microsoft Knowledge Base-Artikel 2553089</a>.<br />
Siehe <a href="http://support.microsoft.com/kb/2553090">Microsoft Knowledge Base-Artikel 2553090</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel Viewer Service Pack 2:<br />
Siehe <a href="http://support.microsoft.com/kb/2553075">Microsoft Knowledge Base-Artikel 2553075</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Siehe <a href="http://support.microsoft.com/kb/2553074">Microsoft Knowledge Base-Artikel 2553074</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (32-Bit-Editionen):<br />
Siehe <a href="http://support.microsoft.com/kb/2553070">Microsoft Knowledge Base-Artikel 2553070</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen):<br />
Siehe <a href="http://support.microsoft.com/kb/2553091">Microsoft Knowledge Base-Artikel 2553091</a>.<br />
Siehe <a href="http://support.microsoft.com/kb/2553096">Microsoft Knowledge Base-Artikel 2553096</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (64-Bit-Editionen):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Web App:<br />
Siehe <a href="http://support.microsoft.com/kb/2553095">Microsoft Knowledge Base-Artikel 2553095</a>.</td>
</tr>
<tr class="even">
...
Siehe <a href="http://support.microsoft.com/kb/2553093">Microsoft Knowledge Base-Artikel 2553093</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2553094">Microsoft Knowledge Base-Artikel 2553094</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Einer Person, die mit [VeriSign iDefense Labs](http://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV (CVE-2011-1986)  
-   Sean Larsson von [VeriSign iDefense Labs](http://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs (CVE-2011-1987)  
-   Einer Person, die mit [VeriSign iDefense Labs](http://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung (CVE-2011-1988)  
-   Einer Person, die mit der [Zero Day Initiative](http://www.zerodayinitiative.com/) von [TippingPoint](http://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke (CVE-2011-1989)  
-   Omair in Zusammenarbeit mit der [Zero Day Initiative](http://www.zerodayinitiative.com/) von [TippingPoint](http://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs (CVE-2011-1990)
