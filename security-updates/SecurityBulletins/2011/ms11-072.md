---
TOCTitle: 'MS11-072'
Title: 'Microsoft Security Bulletin MS11-072 - Hoch'
ms:assetid: 'ms11-072'
ms:contentKeyID: 61224791
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-072(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Office 2007, Microsoft Excel 2010, Microsoft Office 2010, Microsoft Office 2004 für Mac, Microsoft Office 2008 für Mac und Microsoft Office für Mac 2011 als Hoch eingestuft; ebenso für Open XML-Dateiformatkonverter für Mac und alle unterstützten Versionen von Microsoft Excel Viewer, den Microsoft Office Compatibility Packs, Microsoft Excel Services unter SharePoint Server 2007, Microsoft Excel Services unter SharePoint Server 2010 und Microsoft Excel Web App 2010. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Update behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie Microsoft Excel Objekte im Speicher verwaltet, ein Array von Speicherbereichen indiziert, bestimmte Datensätze in Excel-Dateien analysiert, einen besonderen Typ bedingter Ausdrücke verarbeitet und die Begrenzungsüberprüfung an Arrayindexwerten durchführt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=4612c6e4-ac29-4cc4-9da5-88779ea3643e)  
(KB2553070)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=4612c6e4-ac29-4cc4-9da5-88779ea3643e)  
(KB2553070)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=d40db27b-1318-4ca7-b44f-c90bb6342109)  
(KB2553070)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=d40db27b-1318-4ca7-b44f-c90bb6342109)  
(KB2553070)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="thead">
<th style="border:1px solid black;" >
Microsoft SharePoint Server und Microsoft Office Web Apps
</th>
<th style="border:1px solid black;" >
Komponente
</th>
...
Microsoft hat dieses Bulletin überarbeitet, um eine Änderung der Erkennungslogik für das Update KB2553094 für Excel Services anzukündigen, das unter Microsoft Office SharePoint Server 2010 und Microsoft Office SharePoint Server 2010 Service Pack 1 installiert wurde. Dies ist lediglich eine Änderung der Erkennungslogik. Damit wird ein Problem beim Anbieten des nicht sicherheitsrelevanten Updates KB2510639 für Microsoft SharePoint Server 2010 behoben.

Die Dateien des Sicherheitsupdates wurden nicht verändert. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.
...
Wenn die Funktion zum Überprüfen von Office-Dateien in Microsoft Excel 2003 aktiviert ist, werden speziell gestaltete Dateien, die in CVE-2011-1986 und CVE-2011-1987 beschrieben sind und mit denen die Sicherheitsanfälligkeiten ausgenutzt werden können, nicht automatisch geöffnet. Stattdessen wird der Benutzer standardmäßig aufgefordert, auszuwählen, ob eine solche Datei geöffnet werden soll. Ein Benutzer muss auf die Warnung klicken, um die Datei zu öffnen, bevor eine der Sicherheitsanfälligkeiten ausgenutzt werden kann. Weitere Informationen zur Überprüfung von Office-Dateien in Microsoft Excel 2003 finden Sie in der [Microsoft-Sicherheitsempfehlung 2501584](https://technet.microsoft.com/de-de/security/advisory/2501584).

Wenn die Überprüfungsfunktion für Office-Dateien in Microsoft Excel 2007 aktiviert ist, werden speziell gestaltete Dateien, die in CVE-2011-1987 beschrieben sind und mit denen die Sicherheitsanfälligkeit ausgenutzt werden kann, nicht automatisch geöffnet. Stattdessen wird der Benutzer standardmäßig aufgefordert, das Öffnen einer solchen Datei zu bestätigen. Ein Benutzer muss auf die Warnung klicken, um die Datei zu öffnen, bevor eine der Sicherheitsanfälligkeiten ausgenutzt werden kann. Weitere Informationen zur Überprüfung von Office-Dateien in Microsoft Excel 2007 finden Sie in der [Microsoft-Sicherheitsempfehlung 2501584](https://technet.microsoft.com/de-de/security/advisory/2501584).

Die Funktion zum Überprüfen von Office-Dateien ist in Microsoft Excel 2010 standardmäßig aktiviert. Speziell gestaltete Dateien, mit denen die in CVE-2011-1987 beschriebenen Sicherheitsanfälligkeiten ausgenutzt werden können, halten der Überprüfung nicht stand und werden in der [geschützten Ansicht](https://www.microsoft.com/security/pc-security/office2010.aspx) geöffnet. Der Benutzer muss sich dann durch mehrere Warnmeldungen klicken, bevor die Datei zum Bearbeiten geöffnet werden kann und die Sicherheitsanfälligkeiten ausgenutzt werden können.

**Welchen Vorteil hat es, das Öffnen von Dateien zu deaktivieren, die der Dateiüberprüfung in Excel 2003 nicht standhalten?**  
Indem Sie die Überprüfung von Office-Dateien so einstellen, dass das Öffnen verdächtiger Dateien in Excel 2003 nicht zugelassen wird, blockiert die **Microsoft Fix it-Lösung** „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“ im [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) die Angriffsmethoden zum Ausnutzen der Sicherheitsanfälligkeiten, die in CVE-2011-1986 und CVE-2011-1987 beschrieben sind.

Im [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) finden Sie Anweisungen zum Anwenden der automatisierten Fix it-Lösung „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“. In den Abschnitten „Problemumgehung“ für CVE-2011-1986 und CVE-2011-1987 im Abschnitt „Informationen zu Sicherheitsanfälligkeiten“ dieses Bulletins finden Sie Anweisungen zum manuellen Anwenden der Lösungen.

**Welchen Vorteil hat es, das Öffnen von Dateien zu deaktivieren, die der Dateiüberprüfung in Excel 2007 nicht standhalten?**  
Indem Sie die Überprüfung von Office-Dateien so einstellen, dass das Öffnen verdächtiger Dateien in Excel 2007 nicht zugelassen wird, blockiert die **Microsoft Fix it-Lösung** „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“ im [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) die Angriffsmethoden zum Ausnutzen der Sicherheitsanfälligkeit, die in CVE-2011-1987 beschrieben ist.

Im [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) finden Sie Anweisungen zum Anwenden der automatisierten Fix it-Lösung „Öffnen von Dokumenten für Excel 2003 und 2007 deaktivieren“. In den Abschnitten „Problemumgehung“ für CVE-2011-1987 im Abschnitt „Informationen zu Sicherheitsanfälligkeiten“ dieses Bulletins finden Sie Anweisungen zum manuellen Anwenden der Lösungen.

**Welchen Vorteil hat es, das Öffnen von Dateien zu deaktivieren, die der Dateiüberprüfung in Excel 2010 nicht standhalten?**  
Die automatisierte **Microsoft Fix it-Lösung** „Bearbeiten in geschützter Ansicht für Excel 2010 deaktivieren“ in [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584) blockiert die Angriffsmethoden zum Ausnutzen von CVE-2011-1987. Endbenutzer können die Fix it-Lösung als Problemumgehung übernehmen, wenn das Sicherheitsupdate für Excel 2010 erst zu einem späteren Zeitpunkt installiert werden soll.

Anweisungen zum Installieren der automatisierten Fix it-Lösung „Bearbeiten in geschützter Ansicht für Excel 2010 deaktivieren“ finden Sie im [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584). In den Abschnitten „Problemumgehung“ für CVE-2011-1987 im Abschnitt „Informationen zu Sicherheitsanfälligkeiten“ dieses Bulletins finden Sie Anweisungen zum manuellen Installieren der Lösung.

**Weshalb sind für Microsoft Office 2007 mehrere Updatepakete verfügbar?**  
Die Updates zum Beheben der Sicherheitsanfälligkeiten, die in diesem Bulletin beschrieben sind, werden wie in der Tabelle **Betroffene Software** gezeigt in verschiedenen Updatepaketen angeboten. Der Grund dafür ist das in Komponenten aufgeteilte Wartungsmodell für Microsoft Office 2007.

**Weshalb sind für Microsoft Office 2010 mehrere Updatepakete verfügbar?**  
Die Updates zum Beheben der Sicherheitsanfälligkeiten, die in diesem Bulletin beschrieben sind, werden wie in der Tabelle **Betroffene Software** gezeigt in verschiedenen Updatepaketen angeboten. Der Grund dafür ist das in Komponenten aufgeteilte Wartungsmodell für Microsoft Office 2010.

**Ich nutze Microsoft Excel 2007 oder Microsoft Excel 2010. Muss ich alle Updates installieren, die in der Tabelle „Betroffene Software“ für die Software aufgeführt werden?**  
Ja. Benutzer sollten alle Updatepakete installieren, die für die Software angeboten werden, die auf ihren Systemen installiert ist.

**Muss ich diese Sicherheitsupdates in einer bestimmten Reihenfolge installieren?**  
Nein, die Updates können in beliebiger Reihenfolge installiert werden.
...
**Weshalb werden mit die Updates KB2553089 und KB2553090 für Microsoft Office 2007 in einem Microsoft Excel Bulletin angeboten?**  
Die Updates KB2553089 und KB2553090 für Microsoft Office 2007 werden Ihnen angeboten, da die Updates für eine gemeinsam genutzte Komponente von Microsoft Office gelten, die den anfälligen Code enthält. Die Angriffsmethoden betreffen nur Microsoft Excel. Andere Microsoft Office-Produkte enthalten zwar die anfällige gemeinsam genutzte Komponente, greifen aber nicht auf den anfälligen Code zu.

**Weshalb werden mit die Updates KB2553091 und KB2553096 für Microsoft Office 2010 in einem Microsoft Excel Bulletin angeboten?**  
Die Updates KB2553091 und KB2553096 für Microsoft Excel 2010 werden Ihnen angeboten, da die Updates für eine gemeinsam genutzte Komponente von Microsoft Office gelten, die den anfälligen Code enthält. Die Angriffsmethoden betreffen nur Microsoft Excel. Andere Microsoft Office-Produkte enthalten zwar die anfällige gemeinsam genutzte Komponente, greifen aber nicht auf den anfälligen Code zu.
...
Nein, der Updatemechanismus funktioniert richtig, indem er Versionen der Dateien auf dem System erkennt, die älter sind als diejenigen im Updatepaket, und folglich das Update anbietet.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für September](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms11-sep.mspx). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/security/cc998259).
...
<th style="border:1px solid black;" >
Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV – CVE-2011-1986
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Excel bezüglich verbotener Arrayindizierung – CVE-2011-1987
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung - CVE-2011-1988
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke – CVE-2011-1989
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs – CVE-2011-1990
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen)<sup>[3]</sup>
</td>
<td style="border:1px solid black;">
Nicht anwendbar
</td>
...
<tr>
<td style="border:1px solid black;">
Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (64-Bit-Editionen)<sup>[3]</sup>
</td>
<td style="border:1px solid black;">
Nicht anwendbar
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Excel Services unter Microsoft Office SharePoint Server 2010 und Excel Services unter Microsoft Office SharePoint Server 2010 Service Pack 1
</td>
<td style="border:1px solid black;">
Nicht anwendbar
</td>
...
<sup>[3]</sup>Die Angriffsmethoden betreffen nur Microsoft Excel. Andere Microsoft Office-Produkte enthalten zwar die anfällige gemeinsam genutzte Komponente, greifen aber nicht auf den anfälligen Code zu.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1986](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1986).

#### Schadensbegrenzende Faktoren für die Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV – CVE-2011-1986
...
#### Problemumgehungen für die Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV – CVE-2011-1986
...
-   **Einstellen der Überprüfung von Office-Dateien, das Öffnen von Dateien zu deaktivieren, die der Überprüfung in Excel 2003 nicht standhalten**
    ...
    **Hinweis:** Bevor Sie diese Problemumgehung übernehmen, muss die Überprüfung von Office-Dateien für Ihre Version von Microsoft Office aktiviert werden. Weitere Informationen zum Aktivieren der Überprüfung von Office-Dateien in Microsoft Office 2003 und Microsoft Office 2007 finden Sie in dem TechNet-Artikel [Überprüfung von Office-Dateien für Office 2003 und Office 2007](https://technet.microsoft.com/en-us/library/gg985445(office.12).aspx).

    Die folgenden Registrierungsskripts können in Registrierungseintragsdateien (.reg) gespeichert werden. Mit diesen wird das Bearbeiten von Dateien deaktiviert, die der Dateiüberprüfung nicht standgehalten haben. Weitere Informationen zum Verwenden von Registrierungsskripts finden Sie im [Microsoft Knowledge Base-Artikel 310516](https://support.microsoft.com/kb/310516).

    **Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584), um diese Problemumgehung in der entsprechenden Office-Software mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
Die folgenden Registrierungsskripts können in Registrierungseintragsdateien (.reg) gespeichert werden, um die Dateiblockierungsrichtlinie festzulegen. Weitere Informationen zum Verwenden von Registrierungsskripts finden Sie im [Microsoft Knowledge Base-Artikel 310516](https://support.microsoft.com/kb/310516).
...
**Auswirkung der Problemumgehung:** In Microsoft Office 2003 können Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und ein gesondertes „Ausnahmeverzeichnis“ konfiguriert oder Dateien an einen vertrauenswürdigen Speicherort verschoben haben, Dateien im Format Office 2003 oder früheren Versionen nicht öffnen. Weitere Informationen zu den Auswirkungen der Dateiblockierungseinstellung in Microsoft Office-Software finden Sie im [Microsoft Knowledge Base-Artikel 922850](https://support.microsoft.com/kb/922850).
...
-   **Verwenden Sie die Microsoft Office Isolated Conversion Environment (MOICE), wenn Sie Dateien von unbekannten oder nicht vertrauenswürdigen Quellen öffnen.**
    ...
    **Hinweis:** Eine fehlerhafte Änderung der Registrierung kann unter Umständen ernste Probleme verursachen, die eine erneute Installation des Betriebssystems erfordern können. Microsoft kann nicht garantieren, dass Probleme, die aus einer fehlerhaften Änderung der Registrierung resultieren, gelöst werden können. Sie ändern die Registrierung auf eigene Gefahr.
    ...
    Für die Installation von MOICE benötigen Sie außerdem das Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007. Sie erhalten das Compatibility Pack als kostenlosen Download vom [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=941b3470-3ae9-4aee-8f43-c6bb74cd1466&amp;displaylang=en).

    Für MOICE sind sämtliche Updates erforderlich, die für alle Office-Programme empfohlen werden. Auf der [Microsoft Update](https://update.microsoft.com/microsoftupdate/v6/default.aspx)-Website finden Sie alle empfohlenen Updates.
...
#### Häufig gestellte Fragen (FAQs) zur Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV – CVE-2011-1986
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1987](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1987).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel bezüglich verbotener Arrayindizierung – CVE-2011-1987
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel bezüglich verbotener Arrayindizierung – CVE-2011-1987
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Excel bezüglich verbotener Arrayindizierung – CVE-2011-1987
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1988](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1988).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung - CVE-2011-1988
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung - CVE-2011-1988
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung - CVE-2011-1988
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1989](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1989).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke – CVE-2011-1989
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke – CVE-2011-1989
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke – CVE-2011-1989
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1990](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1990).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs – CVE-2011-1990
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs – CVE-2011-1990
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs – CVE-2011-1990
...
| Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (32-Bit-Editionen)                                                                  | Ja   |
| Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen)                                                                | Ja   |
| Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (64-Bit-Editionen)                                                                  | Ja   |
...
| Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen)                                                   | Ja   |
| Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen)                                                   | Ja   |
| Für Excel Services unter Microsoft Office SharePoint Server 2010 und Excel Services unter Microsoft Office SharePoint Server 2010 Service Pack 1 | Ja   |
| Microsoft Excel Web App 2010 und Microsoft Excel Web App 2010 Service Pack 1                                                                     | Ja   |
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2010 und Microsoft Excel
<div>
2010 Service Pack 1 (32-Bit-Editionen)
</div></td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen)</td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2010 und Microsoft Excel
<div>
2010 Service Pack 1 (64-Bit-Editionen)
</div></td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (64-Bit-Editionen)</td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2</td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen)</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen)</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2010 und Excel Services unter Microsoft Office SharePoint Server 2010 Service Pack 1</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
<td style="border:1px solid black;">Ja. Siehe <strong>Hinweis für Microsoft Office SharePoint Server 2007und Microsoft Office SharePoint Server 2010</strong> weiter unten.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Excel Web App 2010 und Microsoft Excel Web App 2010 Service Pack 1</td>
<td style="border:1px solid black;">Ja</td>
<td style="border:1px solid black;">Ja</td>
</tr>
</tbody>
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2553072">Microsoft Knowledge Base-Artikel 2553072</a>.</td>
</tr>
<tr class="even">
...
#### Excel 2007 (alle Editionen) und Office 2007 (alle Editionen)
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Microsoft Excel 2007 Service Pack 2:<br />
excel2007-kb2553073-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office 2007 Service Pack 2:<br />
Office2007-kb2553089-fullfile-x86-glb.exe /passive<br />
Office2007-kb2553090-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel Viewer Service Pack 2:<br />
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Excel 2007 Service Pack 2:<br />
Siehe <a href="https://support.microsoft.com/kb/2553073">Microsoft Knowledge Base-Artikel 2553073</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office 2007 Service Pack 2:<br />
Siehe <a href="https://support.microsoft.com/kb/2553089">Microsoft Knowledge Base-Artikel 2553089</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2553090">Microsoft Knowledge Base-Artikel 2553090</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel Viewer Service Pack 2:<br />
Siehe <a href="https://support.microsoft.com/kb/2553075">Microsoft Knowledge Base-Artikel 2553075</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Siehe <a href="https://support.microsoft.com/kb/2553074">Microsoft Knowledge Base-Artikel 2553074</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
#### Excel 2010 (alle Editionen), Microsoft Office 2010 (alle Editionen) und Microsoft Excel Web App (alle Versionen)
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (32-Bit-Editionen):<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (64-Bit-Editionen):<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Web App:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel Web App:<br />
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (32-Bit-Editionen):<br />
Siehe <a href="https://support.microsoft.com/kb/2553070">Microsoft Knowledge Base-Artikel 2553070</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office 2010 und Microsoft Office 2010 Service Pack 1 (32-Bit-Editionen):<br />
Siehe <a href="https://support.microsoft.com/kb/2553091">Microsoft Knowledge Base-Artikel 2553091</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2553096">Microsoft Knowledge Base-Artikel 2553096</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Excel 2010 und Microsoft Excel 2010 Service Pack 1 (64-Bit-Editionen):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Web App:<br />
Siehe <a href="https://support.microsoft.com/kb/2553095">Microsoft Knowledge Base-Artikel 2553095</a>.</td>
</tr>
<tr class="even">
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.6.5 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=868f4d9f-3498-4d59-a017-59204553889c) herunter, und installieren Sie sie.
...
-   Öffnen Sie die Datei des Microsoft Office 2004-Updates für Mac 11.6.5 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Microsoft Office 2004-Updates für Mac 11.6.5 auf die Anwendung des Microsoft Office 2004-Updates für Mac 11.6.5, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
...
Wird die Versionsnummer **11.6.5** angezeigt, wurde das Update erfolgreich installiert.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.3.1 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=afa79cfc-6e8a-4d0b-88aa-0d7e05031e44) herunter, und installieren Sie sie.
  
-   Beenden Sie alle ausgeführten Anwendungen, da sie die Installation beeinträchtigen könnten. Dies betrifft auch Antivirenprogramme, alle Microsoft Office-Anwendungen, Microsoft Messenger für Mac sowie Office Notifications.  
-   Öffnen Sie die Datei des Microsoft Office 2008-Updates für Mac 12.3.1 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Microsoft Office 2008-Updates für Mac 12.3.1 auf die Anwendung des Microsoft Office 2008-Updates für Mac 12.3.1, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
-   Wenn die Installation erfolgreich abgeschlossen wurde, können Sie das Update-Installationsprogramm von Ihrer Festplatte entfernen. Weitere Informationen dazu, wie Sie den erfolgreichen Abschluss der Installation überprüfen können, finden Sie im Unterabschnitt „Überprüfen der Updateinstallation“. Um das Update-Installationsprogramm zu entfernen, ziehen Sie zuerst die Datei des Microsoft Office 2008-Updates für Mac 12.3.1 in den Papierkorb. Ziehen Sie anschließend die heruntergeladene Datei in den Papierkorb.
...
Wird die Versionsnummer **12.3.1** angezeigt, wurde das Update erfolgreich installiert.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office für Mac 2011-Updates 14.1.3 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=535fcf4a-eeb2-44eb-b2a6-9c512509c49d) herunter, und installieren Sie sie.
...
-   Öffnen Sie die Datei des Microsoft Office für Mac 2011-Updates 14.1.3 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Microsoft Office für Mac 2011-Updates 14.1.3 auf die Anwendung des Microsoft Office für Mac 2011-Updates 14.1.3, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
-   Wenn die Installation erfolgreich abgeschlossen wurde, können Sie das Update-Installationsprogramm von Ihrer Festplatte entfernen. Weitere Informationen dazu, wie Sie den erfolgreichen Abschluss der Installation überprüfen können, finden Sie im Unterabschnitt „Überprüfen der Updateinstallation“. Um das Update-Installationsprogramm zu entfernen, ziehen Sie zuerst die Datei des Microsoft Office für Mac 2011-Updates 14.1.3 in den Papierkorb. Ziehen Sie anschließend die heruntergeladene Datei in den Papierkorb.
...
Wenn die Nummer der zuletzt installierten Updateversion **14.1.3** lautet, wurde das Update erfolgreich installiert.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.2.1 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=9796588d-238f-4694-9598-1aa8d2becb55) herunter, und installieren Sie sie.
  
-   Beenden Sie alle ausgeführten Anwendungen, da sie die Installation beeinträchtigen könnten. Dies betrifft auch Antivirenprogramme, alle Microsoft Office-Anwendungen, Microsoft Messenger für Mac sowie Office Notifications.  
-   Öffnen Sie das Open XML-Dateiformatkonverter-Update für Mac 1.2.1 auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.  
-   Doppelklicken Sie im Fenster des Open XML-Dateiformatkonverter-Updates für Mac 1.2.1 auf die Anwendung des Open XML-Dateiformatkonverter-Updates für Mac 1.2.1, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.  
-   Wenn die Installation erfolgreich abgeschlossen wurde, können Sie das Update-Installationsprogramm von Ihrer Festplatte entfernen. Weitere Informationen dazu, wie Sie den erfolgreichen Abschluss der Installation überprüfen können, finden Sie im Unterabschnitt „Überprüfen der Updateinstallation“. Um das Update-Installationsprogramm zu entfernen, ziehen Sie zuerst die Datei des Open XML-Dateiformatkonverter-Updates für Mac 1.2.1 in den Papierkorb. Ziehen Sie anschließend die heruntergeladene Datei in den Papierkorb.
...
Wird die Versionsnummer **1.2.1** angezeigt, wurde das Update erfolgreich installiert.
...
#### Excel Services unter SharePoint Server 2007 (alle Editionen)
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen):<br />
office2007-kb2553093-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen):<br />
Siehe <a href="https://support.microsoft.com/kb/2553093">Microsoft Knowledge Base-Artikel 2553093</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen):<br />
...
#### Excel Services unter SharePoint Server 2010 (alle Editionen)
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Excel Services unter Microsoft Office SharePoint Server 2010 und Excel Services unter Microsoft Office SharePoint Server 2010 Service Pack 1:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2553094">Microsoft Knowledge Base-Artikel 2553094</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in Excel bezüglich WriteAV (CVE-2011-1986)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs (CVE-2011-1987)  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Heap-Beschädigung (CVE-2011-1988)  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich der Analyse bedingter Ausdrücke (CVE-2011-1989)  
-   Omair in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich verbotenen Arrayzugriffs (CVE-2011-1990)
...
-   V1.1 (11. Oktober 2011): Ankündigung einer Änderung der Erkennungslogik für Update KB2553094. Die Sicherheitsupdatedateien wurden nicht verändert. Weitere Informationen finden Sie in den häufig gestellten Fragen (FAQs) zu diesem Update.
