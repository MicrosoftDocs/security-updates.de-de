---
TOCTitle: 'MS11-041'
Title: 'Microsoft Security Bulletin MS11-041 - Kritisch'
ms:assetid: 'ms11-041'
ms:contentKeyID: 61224760
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-041(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-041 - Kritisch
===============================================
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                         | Erhöhung von Berechtigungen    | Hoch                             | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393)                                                                             | Erhöhung von Berechtigungen    | Hoch                             | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                   | Erhöhung von Berechtigungen    | Hoch                             | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f)                                      | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715)\*             | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)       | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a)                                   | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c)\*       | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424) | Remotecodeausführung           | Kritisch                         | [MS11-034](https://go.microsoft.com/fwlink/?linkid=211826) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung - CVE-2011-1873</th>
...
Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung - CVE-2011-1873  
---------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, dass der Windows-Kernelmodustreiber speziell gestaltete OpenType-Schriftarten auf 64-Bit-Systemen und Itanium-basierten Systemen falsch analysiert. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen administrativen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1873](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1873).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung - CVE-2011-1873
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung - CVE-2011-1873
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung - CVE-2011-1873
...
Die Sicherheitsanfälligkeit wird verursacht, wenn der Windows-Kernelmodustreiber beim Analysieren von OTF Schriftarten Zeiger falsch überprüft.
...
In einem webbasierten Angriffsszenario muss ein Angreifer eine Website hosten, die auf eine speziell gestaltete OpenType-Schriftart auf einer Netzwerkfreigabe zeigt. Wenn dann der Benutzer zu der Website navigiert, wird der betroffene Steuerpfad über das Detail- und das Vorschaufenster in Windows Explorer ausgelöst. Die speziell gestaltete OpenType-Schriftart kann dann die Sicherheitsanfälligkeit ausnutzen und die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer hat keine Möglichkeit, einen Benutzer zu zwingen, eine speziell gestaltete Website zu besuchen. Stattdessen muss er den Benutzer zu einem Besuch dieser Website verleiten. Zu diesem Zweck wird der Benutzer meist dazu gebracht, auf einen Link zur Website des Angreifers zu klicken und anschließend die speziell gestaltete Excel-Datei zu öffnen.
  
In einem auf einer Netzwerkfreigabe basierenden Angriffsszenario kann ein Angreifer eine speziell gestaltete OpenType-Schriftart auf einer Netzwerkfreigabe hosten. Wenn dann der Benutzer in Windows Explorer zu der Freigabe navigiert, wird der betroffene Steuerpfad über das Detail- und das Vorschaufenster ausgelöst. Die speziell gestaltete OpenType-Schriftart kann dann die Sicherheitsanfälligkeit ausnutzen und die vollständige Kontrolle über ein betroffenes System erlangen.
...
**Welche Arten von Systemen sind von dieser Sicherheitsanfälligkeit betroffen?**  
Diese Sicherheitsanfälligkeit betrifft nur 64-Bit-Versionen und Itanium-basierte Versionen von Windows-Betriebssystemen; 32-Bit-Versionen von Windows-Betriebssystemen sind nicht betroffen.
  
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows-Kernelmodustreiber beim Analysieren von OpenType-Schriftarten Zeiger überprüft.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2525694$\Spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2525694">Microsoft Knowledge Base-Artikel 2525694</a>.</td>
</tr>
<tr class="odd">
...
Windows6.1-KB2525694-x64.msu /quiet Für alle unterstützten</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installieren ohne neu zu starten</td>
<td style="border:1px solid black;">Für alle unterstützten x64-basierten Editionen von Windows 7:<br />
...
-   Koro von [www.korosoft.net](https://www.korosoft.net/) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bei OTF-Überprüfung (CVE-2011-1873)
