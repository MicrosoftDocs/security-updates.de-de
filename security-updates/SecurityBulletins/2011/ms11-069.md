...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2567951](https://support.microsoft.com/kb/2567951) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978).
...
-   Endbenutzer, die [KB2562394](https://support.microsoft.com/kb/2562394) installiert haben, können nicht ohne Benutzereingriff ausgenutzt werden. Das durch [MS11-044](https://go.microsoft.com/fwlink/?linkid=216436) zur Verfügung gestellte Update verhindert, dass ClickOnce-Anwendungen in der Internetzone ohne Aufforderung des Benutzers ausgeführt werden. Endbenutzern, die [KB2562394](https://support.microsoft.com/kb/2562394) nicht installiert haben, wird kein Dialogfeld angezeigt, wenn die Anwendung nur die für das Internet geltenden Berechtigungen verwendet. Weitere Informationen zu dieser Funktion finden Sie in [KB2562394](https://support.microsoft.com/kb/2562394).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2567951">Microsoft Knowledge Base-Artikel 2567951</a>.</td>
</tr>
<tr class="odd">
