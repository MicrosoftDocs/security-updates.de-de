---
TOCTitle: 'MS11-028'
Title: 'Microsoft Security Bulletin MS11-028 - Kritisch'
ms:assetid: 'ms11-028'
ms:contentKeyID: 61224747
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-028(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-028 - Kritisch
===============================================

Sicherheitsanfälligkeit in .NET Framework kann Remotecodeausführung ermöglichen (2484015)
-----------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 12. April 2011 | Aktualisiert: Mittwoch, 30. November 2011
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie .NET Framework bestimmte Arten von Funktionsaufrufen verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2484015](https://support.microsoft.com/kb/2484015) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5](https://www.microsoft.com/download/details.aspx?familyid=1407aaec-b3e0-404c-b84f-0c8e808614c4) Service Pack 1  
(KB2449742)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Microsoft hat dieses Security Bulletin überarbeitet, um eine Erkennungsänderung im Windows-Update (WU) Paket für KB2446709 anzukündigen. In dem WU-Paket ist jetzt das richtige Bulletin aufgeführt, das durch dieses Update ersetzt wird. Dies ist lediglich eine Erkennungsänderung. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.

**Weshalb wurde dieses Bulletin am 10. Mai 2011 erneut veröffentlicht?**  
Microsoft hat dieses Bulletin erneut veröffentlicht, um Hotfix KB979744 mit den Sicherheitsupdates KB2446709 und KB2449742 erneut anzubieten und ein bekanntes Problem zu beheben, das sich auf SQL und Exchange Server auswirkte. Dieses Problem ist in [Microsoft Knowledge Base-Artikel 2540222](https://support.microsoft.com/kb/2540222) ausführlich beschrieben. Für Benutzer, die die ursprüngliche Version (V1) von Hotfix KB979744 installiert haben, bietet dieses Update sowohl das Sicherheitsupdate als auch die neue Version des Hotfixes KB979744 an und installiert beide automatisch. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert, aber Hotfix KB979744 nicht installiert haben, müssen dieses Update nicht erneut installieren.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für April](https://technet.microsoft.com/security/bulletin/ms11-apr). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherbeschädigung – CVE-2010-3958
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 mit SP2 für Itanium-basierte Systeme
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Vista Service Pack 1 und Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 unter Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 unter Windows Server 2003 mit SP2 für Itanium-basierte Systeme
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 unter Windows Vista Service Pack 1 und Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 unter Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 bei Installation unter Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch die Art und Weise vor, in der .NET Framework bestimmte Arten von Funktionsaufrufen verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3958](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherbeschädigung – CVE-2010-3958
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherbeschädigung – CVE-2010-3958
...
#### Häufig gestellte Fragen (FAQs) für die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherbeschädigung – CVE-2010-3958
...
Diese Sicherheitsanfälligkeit wird verursacht, wenn der x86 JIT-Compiler innerhalb von .NET Framework bestimmte Arten von Funktionsaufrufen falsch kompiliert.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie x86 JIT-Compiler innerhalb von .NET Framework bestimmte Arten von Funktionsaufrufen verarbeitet.

**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3958](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958) zugewiesen.
...
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows XP Service Pack 3:<br />
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2484015">Microsoft Knowledge Base-Artikel 2484015</a>.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1 unter Windows Server 2003 mit SP2 für Itanium-basierte Systeme:<br />
...
-   V2.0 (10. Mai 2011): Das Bulletin wurde erneut veröffentlicht, um die Updates KB2446709 und KB2449742 erneut anzubieten. Dadurch wird ein bekanntes Problem mit SQL und Exchange Servern behoben, auf denen Hotfix KB979744 installiert ist.  
-   V2.1 (14. Juni 2011): Diesem Update wurde eine häufig gestellte Frage (FAQ) hinzugefügt, um eine Erkennungsänderung anzukündigen, durch die das ersetzte Bulletin für Microsoft .NET Framework 3.5.1 unter unterstützten Editionen von Windows 7 und Windows Server 2008 R2 korrigiert wird. Dies ist lediglich eine Erkennungsänderung. Die Dateien des Sicherheitsupdates wurden nicht verändert. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.  
-   V2.2 (22. Juni 2011): Die Bulletin-Ersetzungsinformationen wurden korrigiert. Dies ist lediglich eine Bulletin-Änderung. An den Erkennungs- oder Sicherheitsupdatedateien wurden keine Änderungen vorgenommen.  
-   V2.3 (26. Oktober 2011): Die Bulletin-Ersetzungsinformationen für .NET Framework 4 unter 32-Bit-Editionen von Microsoft Windows wurden korrigiert. Dies ist lediglich eine Bulletin-Änderung. An den Erkennungs- oder Sicherheitsupdatedateien wurden keine Änderungen vorgenommen. Außerdem wurde die Anwendbarkeit der Server Core-Installation für .NET Framework 4 unter Windows Server 2008 R2 für x64-basierte Systeme korrigiert.  
-   V2.4 (30. November 2011): Die Bulletin-Ersetzungsinformationen für .NET Framework 4 unter Windows 7 für x64-basierte Systeme Service Pack 1, Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1 und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1 wurden korrigiert. Dies ist lediglich eine Bulletin-Änderung. An den Erkennungs- oder Sicherheitsupdatedateien wurden keine Änderungen vorgenommen.
