---
TOCTitle: 'MS11-051'
Title: 'Microsoft Security Bulletin MS11-051 - Kritisch'
ms:assetid: 'ms11-051'
ms:contentKeyID: 61224770
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-051(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-051 - Kritisch
===============================================
...
Veröffentlicht: Dienstag, 14. Juni 2011 | Aktualisiert: Mittwoch, 15. Juni 2011
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen (außer Itanium) von Windows Server 2003, Windows Server 2008 und Windows Server 2008 R2 als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Webregistrierungs-Site von Active Directory-Zertifikatsdiensten Eingabeparameter überprüft. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2518295](https://support.microsoft.com/kb/2518295) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ef90d6c1-ea7f-4c32-9c90-0303e04c7436)                                                                                     | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=62944095-33d6-4131-be32-a79d9ec4d4a9)                                                                         | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=46ade106-e0cb-4c71-8230-793a15062823)\*\*                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6141a1c5-ecaf-4553-9d27-dd6e5c4a13fd)\*\*       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1da04414-6210-43ea-8e0a-cf21cf144076)\*\* | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
Das Update wird nur Systemen angeboten, auf denen die betroffene Komponente sowohl installiert als auch aktiviert ist. Microsoft Windows Server-Systeme, die nicht für die Rolle der Webregistrierung von Active Directory-Zertifikatsdiensten konfiguriert sind, sind nicht betroffen und erhalten dieses Update nicht.

**Ich habe meine ASP-Seiten für die Webregistrierung angepasst. Muss ich wegen der bekannten Probleme, die in Microsoft Knowledge Base-Artikel 2518295 aufgeführt sind, besorgt sein?**  
Ja. Microsoft empfiehlt Benutzern, die ihre ASP-Seiten für die Webregistrierung bearbeitet haben, den [Microsoft Knowledge Base-Artikel 2518295](https://support.microsoft.com/kb/2518295) zu lesen. Dort erhalten sie wichtige Informationen zu bekannten Problemen, die auf ihre Systeme zutreffen können.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Active Directory bezüglich Zertifikatsdiensten - CVE-2011-1264</th>
...
Sicherheitsanfälligkeit in Active Directory bezüglich Zertifikatsdiensten - CVE-2011-1264  
-----------------------------------------------------------------------------------------
  
Es besteht eine mögliche XSS-Sicherheitsanfälligkeit in der Webregistrierung von Active Directory-Zertifikatsdiensten, durch die ein Angreifer ein clientseitiges Skript in die Benutzerinstanz von Internet Explorer injizieren kann. Das Skript kann im Namen des Zielbenutzers Inhalte vortäuschen, Informationen offen legen oder Aktionen ausführen, die der Benutzer auf der Website vornehmen kann.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Active Directory bezüglich Zertifikatsdiensten - CVE-2011-1264
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Active Directory bezüglich Zertifikatsdiensten - CVE-2011-1264
...
-   **Aktivieren des XSS-Filters für die Intranetzone für Internet Explorer 8 und Internet Explorer 9**
    ...
    5.  Ändern Sie den Standard **Deaktiviert** zu **Aktiviert**.  
    ...
    **So machen Sie die Problemumgehung rückgängig.**
    ...
    3.  Ziehen Sie den Gleitregler unter **Sicherheitsstufe dieser Zone** auf **Stufe anpassen...**.  
    4.  Blättern Sie nach unten zu **XSS-Filter aktivieren** (fast am Ende der Liste).  
    5.  Ändern Sie den Standard **Aktiviert** zu **Deaktiviert**.  
    6.  Klicken Sie im Dialogfeld **Möchten Sie die Einstellungen für diese Zone wirklich ändern?** auf **OK** und dann auf **Ja**.  
    7.  Klicken Sie im Dialogfeld **Internetoptionen** auf **OK**.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Active Directory bezüglich Zertifikatsdiensten - CVE-2011-1264
...
Die Sicherheitsanfälligkeit wird durch eine fehlerhafte Eingabeüberprüfung eines Anforderungsparameters auf einer Webregistrierungs-Site von Active Directory-Zertifikatsdiensten verursacht.
...
Die betroffene Komponente ist die Webregistrierung von Active Directory-Zertifikatsdiensten.
...
Server, die die Webregistrierungs-Rolle von Active Directory-Zertifikatsdiensten ausführen, sind hauptsächlich gefährdet. Server, die diese bestimmte Rolle nicht ausführen, sind nicht gefährdet.
  
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Webregistrierungs-Site von Active Directory-Zertifikatsdiensten Eingabeparameter überprüft.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2518295$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2518295">Microsoft Knowledge Base-Artikel 2518295</a>.</td>
</tr>
<tr class="even">
...
-   Ruggero Strabla, [Emaze Networks](https://www.emaze.net/); [Saipem Security Team](https://www.saipem.com/) für den Hinweis auf die Sicherheitsanfälligkeit von Active Directory-Zertifikatsdiensten (CVE-2011-1264)
...
-   V1.1 (15. Juni 2011): Die schadensbegrenzende Maßnahme für XSS-Filter wird erläutert.
