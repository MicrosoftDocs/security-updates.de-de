...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1976](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1976).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 2548826](https://support.microsoft.com/kb/2548826).                                                                                                                                                                                                                                                                                                                                                                                                       |  
...
| HotPatching                                  | Nicht anwendbar                                                                                          |  
| **Informationen zur Deinstallation**         | Verwenden Sie die Option „Software“ in der Systemsteuerung.                                              |  
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 2579115](https://support.microsoft.com/kb/2579115).               |  
| **Überprüfung des Registrierungsschlüssels** | **Hinweis** Es ist kein Registrierungsschlüssel vorhanden, um die Anwesenheit dieses Updates zu belegen. |
...
-   Adam Bixby von [Gotham Digital Science](https://www.gdssecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Report Viewer-Steuerelementen bezüglich XSS (CVE-2011-1976)
