---
TOCTitle: 'MS11-039'
Title: 'Microsoft Security Bulletin MS11-039 - Kritisch'
ms:assetid: 'ms11-039'
ms:contentKeyID: 61224758
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-039(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-039 - Kritisch
===============================================

Sicherheitsanfälligkeit in .NET Framework und Microsoft Silverlight kann Remotecodeausführung ermöglichen (2514842)
-------------------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 14. Juni 2011 | Aktualisiert: Mittwoch, 26. Oktober 2011
...
Dieses Sicherheitsupdate wird für alle betroffenen Versionen von Microsoft .NET Framework für Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 und Windows Server 2008 R2 und Microsoft Silverlight 4 als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie .NET Framework Werte überprüft, die an vertrauenswürdige APIs übergeben werden. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu** **Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2514842](https://support.microsoft.com/kb/2514842) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 1 und Microsoft .NET Framework 3.5](https://www.microsoft.com/download/details.aspx?familyid=2eabacce-394f-4b9a-8306-0875ca19a3a9)  
(KB2478657)  
[Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=55fd3254-7e59-4cf9-afa8-45ae66bc7390)  
(KB2478659)  
[Microsoft .NET Framework 4.0](https://www.microsoft.com/download/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 und Microsoft .NET Framework 3.5 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=afa11dda-a543-42a7-b997-5292fd869a8b)  
(KB2478660)  
[Microsoft .NET Framework 4.0](https://www.microsoft.com/download/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
**Steht dieses Sicherheitsupdate in Beziehung zu MS11-044, „Sicherheitsanfälligkeit in .NET Framework kann Remotecodeausführung ermöglichen“?**  
...
Microsoft Silverlight Build 4.0.60531.0, der aktuelle Build von Microsoft Silverlight bei der ersten Veröffentlichung dieses Bulletins, behebt die Sicherheitsanfälligkeit und ist nicht betroffen. Builds von Microsoft Silverlight vor 4.0.60531.0 sind betroffen.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Juni](https://technet.microsoft.com/security/bulletin/ms11-jun). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in .NET Framework bezüglich Array-Offset – CVE-2011-0664
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 unter Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Kritisch**  
Remotecodeausführung
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-0664](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in .NET Framework bezüglich Array-Offset – CVE-2011-0664
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in .NET Framework bezüglich Array-Offset – CVE-2011-0664
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in .NET Framework bezüglich Array-Offset – CVE-2011-0664
...
Die Sicherheitsanfälligkeit wird verursacht, wenn .NET Framework und Microsoft Silverlight Argumente falsch überprüfen, die an die eingebauten Netzwerkfunktionen übergeben werden.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie .NET Framework Werte überprüft, die an vertrauenswürdige APIs übergeben werden.
...
| Microsoft Silverlight 3 bei Installation unter Mac OS                                                                      | Ja   |
| Microsoft Silverlight 3 bei Installation unter allen Versionen von Microsoft Windows-Clients                               | Ja   |
| Microsoft Silverlight 3 bei Installation unter allen Versionen von Microsoft Windows-Servern                               | Ja   |
| Microsoft Silverlight 4 bei Installation unter Mac                                                                         | Ja   |
...
| Microsoft Silverlight 3 bei Installation unter Mac OS                                                                      | Ja                | Ja                         |
| Microsoft Silverlight 3 bei Installation unter allen Versionen von Microsoft Windows-Clients                               | Ja                | Ja                         |
| Microsoft Silverlight 3 bei Installation unter allen Versionen von Microsoft Windows-Servern                               | Ja                | Ja                         |
| Microsoft Silverlight 4 bei Installation unter Mac                                                                         | Ja                | Ja                         |
...
<td style="border:1px solid black;">Siehe den Unterabschnitt <strong>Tools und Anleitungen zur Erkennung</strong> <strong>und Bereitstellung.</strong></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2514842">Microsoft Knowledge Base-Artikel 2514842</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 3.5 unter Windows Server 2003 für Itanium-basierte Systeme:<br />
...
-   Michael J. Liu für den Hinweis auf die Sicherheitsanfälligkeit in .NET Framework bezüglich Array-Offset (CVE-2011-0664)
