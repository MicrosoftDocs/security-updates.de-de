...
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/downloads/de-de/details.aspx?familyid=4f54e498-3825-407d-a036-1900a65d34f1)\*       | Erhöhung von Berechtigungen    | Hoch                             | [MS11-041](https://go.microsoft.com/fwlink/?linkid=217499) |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1876](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1876).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1883](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1883).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1884](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1884).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1885).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1886).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1887](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1887).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1888).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2555917">Microsoft Knowledge Base-Artikel 2555917</a>.</td>
</tr>
<tr class="even">
...
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1874)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1875)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1876)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1877)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1878)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1879)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich NULL-Zeigerdereferenzierung (CVE-2011-1880)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich NULL-Zeigerdereferenzierung (CVE-2011-1881)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1882)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1883)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Win32k-Verwendung (CVE-2011-1884)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich NULL-Zeigerdereferenzierung (CVE-2011-1885)  
-   Herr Liang Yin, Prof. Sihan Qing und Weiping Wen, und Herr Husheng Zhou, [Department of Information Security, Beijing University](https://www.ss.pku.edu.cn/en/), für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich falscher Überprüfung der Parameter ermöglicht Offenlegung von Informationen (CVE-2011-1886)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich NULL-Zeigerdereferenzierung (CVE-2011-1887)  
-   Tarjei Mandt von [Norman](https://www.norman.com) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k bezüglich NULL-Zeigerdereferenzierung (CVE-2011-1888)
