---
TOCTitle: 'MS11-098'
Title: 'Microsoft Security Bulletin MS11-098 - Hoch'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61224817
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms11-098(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-098 - Hoch
===========================================

Sicherheitsanfälligkeit im Windows-Kernel kann Erhöhung von Berechtigungen ermöglichen (2633171)
------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 13. Dezember 2011 | Aktualisiert: Mittwoch, 1. Februar 2012
...
Dieses Sicherheitsupdate wird für alle unterstützten 32-Bit-Editionen von Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 und Windows 7 als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem die Gewährleistung unterstützt wird, dass der Windows-Kernel Objekte im Speicher initialisiert. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2633171](https://support.microsoft.com/kb/2633171) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                    | Erhöhung von Berechtigungen    | Hoch                             | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812)                               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                           | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                 | Erhöhung von Berechtigungen    | Hoch                             | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578)                               |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                      | Erhöhung von Berechtigungen    | Hoch                             | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578)                               |
| [Windows 7 für 32-Bit-Systeme und Windows 7 für 32-Bit-Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | Erhöhung von Berechtigungen    | Hoch                             | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578)                               |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler – CVE-2011-2018</th>
...
Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler – CVE-2011-2018  
-----------------------------------------------------------------------------------
  
Im Windows-Kernel liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie der Kernel auf ein Objekt zugreift, das nicht richtig initialisiert wurde. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler – CVE-2011-2018
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler – CVE-2011-2018
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler – CVE-2011-2018
...
Die Sicherheitsanfälligkeit wird verursacht, wenn der Windows-Kernel auf ein Objekt zugreift, das nicht richtig initialisiert wurde.
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem die Gewährleistung unterstützt wird, dass der Windows-Kernel Objekte im Speicher initialisiert.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2633171$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2633171">Microsoft Knowledge Base-Artikel 2633171</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2633171$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2633171](https://support.microsoft.com/kb/2633171).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Windows-Kernel bezüglich Ausnahmehandler (CVE-2011-2018)
...
-   V1.1 (1. Februar 2012): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2633171 hinzugefügt.
