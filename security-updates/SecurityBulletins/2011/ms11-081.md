...
Microsoft hat dieses Bulletin überarbeitet, um die Veröffentlichung eines Hotfixes anzukündigen, mit dem ein Problem behoben wird, das Benutzer von Internet Explorer 7 betrifft. Dabei werden einige Dropdown-Listen und Kombinationsfelder nicht in Internet Explorer 7 angezeigt, nachdem das Sicherheitsupdate KB2586448 installiert wurde. Weitere Informationen zu diesem Problem und Anweisungen zum Übernehmen des Hotfixes zum Beheben des Problems finden Sie im [Microsoft Knowledge Base-Artikel 2586448](https://support.microsoft.com/kb/2586448).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1993](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1995](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1996](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1997](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1998](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-1999](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2000](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-2001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2586448">Microsoft Knowledge Base-Artikel 2586448</a>.</td>
</tr>
<tr class="even">
...
-   Ivan Fratric in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) für den Hinweis auf die Sicherheitsanfälligkeit in Optionselement bezüglich Remotecodeausführung (CVE-2011-1996)  
-   [GWSlabs](https://www.gwslabs.com) in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung aufgrund von OnLoad-Ereignis (CVE-2011-1997)  
...
-   Ivan Fratric in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) für den Hinweis auf die Sicherheitsanfälligkeit in Select-Element bezüglich Remotecodeausführung (CVE-2011-1999)  
-   Sebastian Apelt in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) für den Hinweis auf die Sicherheitsanfälligkeit in Textelement bezüglich Remotecodeausführung (CVE-2011-2000)  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) zusammenarbeitet, aber anonym bleiben möchten, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle (CVE-2011-2001)  
-   Eduardo Vela Nava von [Google Inc.](https://www.google.com) und David Bloom von [Greplin](https://www.greplin.com) für die Zusammenarbeit mit uns an in diesem Bulletin enthaltenen Tiefenverteidigungsänderungen.  
-   [Soroush Dalili](https://www.secproject.com) für die Zusammenarbeit mit uns an in diesem Bulletin enthaltenen Tiefenverteidigungsänderungen.  
-   Billy Rios von [Google Inc.](https://www.google.com) für die Zusammenarbeit mit uns an den tiefgreifenden Verteidigungsänderungen in diesem Bulletin
