---
TOCTitle: 'MS12-003'
Title: 'Microsoft Security Bulletin MS12-003 - Hoch'
ms:assetid: 'ms12-003'
ms:contentKeyID: 61224822
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-003(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-003 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie das Client/Server-Runtime-Subsystem (CSRSS) Unicode-Zeichen verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=cfc38dc2-c4c7-4a44-8e5a-b98bb9bc0396)                                       | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3956db98-88d9-49fc-be51-247b40bfc272)              | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=39f5f8fb-ee4d-4b7a-9cd7-3d1e9c8abd8c)                              | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e27d85f8-a285-4e95-85a0-0868286cc2b9)                  | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=b69bd01d-9925-4ff1-bfeb-b4473631578c)        | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=73682d4b-3179-4488-8ba9-94ed68c4896b)                                    | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b5c33025-13d9-43d2-a415-a8a4d683a821)                        | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fbf119cf-a8ed-4266-a673-442149992f7c)\*         | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e8e68f89-27f4-4142-94ca-58f086a98157)\*   | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc6491e8-6c3e-43a1-bc56-16c9a2fd2749) | Erhöhung von Berechtigungen    | Hoch                             | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
...
**Betrifft diese Sicherheitsanfälligkeit alle Sprachversionen von Windows?**  
Alle Sprachversionen betroffener Betriebssysteme enthalten die Sicherheitsanfälligkeit, aber sie kann nur dann ausgenutzt werden, wenn das Systemgebietsschema auf Chinesisch, Japanisch oder Koreanisch gesetzt ist. Microsoft empfiehlt als Tiefenverteidigungsmaßnahme die Installation des Updates für alle Sprachversionen betroffener Betriebssysteme. Über Automatische Updates werden unabhängig von der Sprachkonfiguration eines Systems entsprechende Pakete angeboten.

**Was ist das Systemgebietsschema?**  
Durch das Systemgebietsschema werden der Standardzeichensatz (Buchstaben, Symbole und Zahlen) und die Schriftart bestimmt, mit denen in Programmen, die kein Unicode verwenden, Informationen angezeigt und eingegeben werden. Dadurch wird ermöglicht, dass Programme, die kein Unicode unterstützen, auf Ihrem Computer mithilfe der angegebenen Sprache ausgeführt werden. Das Systemgebietsschema betrifft nicht die Sprache in Menüs und Dialogfeldern für Windows oder andere Programme, die Unicode verwenden.

**Wie kann ich das aktuelle Systemgebietsschema auf meinem Computer bestimmen oder ändern?**  
Das Standardsystemgebietsschema hängt von der installierten Sprachversion von Windows ab. So können Sie das Systemgebietsschema anzeigen oder ändern:

1.  Klicken Sie auf **Start** und anschließend auf **Systemsteuerung**.
2.  Klicken Sie in **Regions- und Sprachoptionen** auf die Registerkarte **Erweitert**.
3.  Wählen Sie im Abschnitt **Sprache für Programme, die Unicode nicht unterstützen** das gewünschte Systemgebietsschema aus.

**Hinweis:** Sie müssen über ein Administratorkonto angemeldet sein, um das Systemgebietsschema anzeigen oder ändern zu können.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Januar](https://technet.microsoft.com/security/bulletin/ms12-jan). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in CSRSS bezüglich der Erhöhung von Berechtigungen – CVE-2012-0005</th>
...
Sicherheitsanfälligkeit in CSRSS bezüglich der Erhöhung von Berechtigungen – CVE-2012-0005  
------------------------------------------------------------------------------------------
  
Im Windows CSRSS liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie das CSRSS eine Reihenfolge speziell gestalteter Unicode-Zeichen verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code im Sicherheitskontext des lokalen Systems ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0005).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in CSRSS bezüglich der Erhöhung von Berechtigungen – CVE-2012-0005
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal oder von einem Remotestandort aus anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.  
-   Diese Sicherheitsanfälligkeit kann nur auf Systemen ausgenutzt werden, die mit einem chinesischen, japanischen oder koreanischen Systemgebietsschema konfiguriert wurden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in CSRSS bezüglich der Erhöhung von Berechtigungen – CVE-2012-0005
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in CSRSS bezüglich der Erhöhung von Berechtigungen – CVE-2012-0005
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen im Kontext des lokalen Systems.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit tritt auf Windows-Systemen auf, die mit einem chinesischen, japanischen oder koreanischen Systemgebietsschema konfiguriert sind, wenn das CSRSS eine Reihenfolge speziell gestalteter Unicode-Zeichen verarbeitet und versucht, auf die Inhalte eines Speicherpuffers zuzugreifen, der nicht richtig initialisiert wurde.
...
Arbeitsstationen und Terminalserver, die mit einem Systemgebietsschema einer Multibyte-Sprache (Chinesisch, Japanisch oder Koreanisch) ausgeführt werden, sind hauptsächlich gefährdet. Bei Servern ist das Risiko größer, wenn Administratoren Benutzern ermöglichen, sich bei Servern anzumelden und Programme auszuführen. Es wird jedoch dringend davon abgeraten, diese Erlaubnis zu erteilen.
  
**Was bewirkt das Update?**  
Das Update behebt, wie in im CSRSS Unicode-Zeichen verarbeitet werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2646524$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2646524">Microsoft Knowledge Base-Artikel 2646524</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2646524$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2646524](https://support.microsoft.com/kb/2646524).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Kang Wu vom [Shenzhen Jowto Research Dep](https://www.jowto.com) für den Hinweis auf die Sicherheitsanfälligkeit in CSRSS durch Erhöhung von Berechtigungen (CVE-2012-0005)
