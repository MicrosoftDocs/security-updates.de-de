...
<td style="border:1px solid black;">
KB2621440 in [MS12-020](https://go.microsoft.com/fwlink/?linkid=232664) wird durch KB2685939 ersetzt
</td>
</tr>
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Juni](https://technet.microsoft.com/security/bulletin/ms12-jun). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0173](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173).
...
-   **Aktivieren der Authentifizierung auf Netzwerkebene auf Systemen, auf denen unterstützte Editionen von Windows Vista, Windows 7, Windows Server 2008 und Windows Server 2008 R2 ausgeführt werden**
    ...
    **Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 2685939](https://support.microsoft.com/kb/2685939), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2685939">Microsoft Knowledge Base-Artikel 2685939</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2685939](https://support.microsoft.com/kb/2685939).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
