...
<td style="border:1px solid black;">
KB2744842 in [MS12-063](https://technet.microsoft.com/de-de/security/bulletin/ms12-063) wird durch KB2761465 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2761451 in [MS12-071](https://technet.microsoft.com/de-de/security/bulletin/ms12-071) wird durch KB2761465 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Ja. Das Update KB2761465 ist für Internet Explorer 10 in Windows 8 Release Preview und Internet Explorer 10 in Windows Server 2012 Release Candidate verfügbar. Benutzer mit Windows 8 Release Preview und Windows Server 2012 Release Candidate sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind über [Windows Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Dezember](https://technet.microsoft.com/security/bulletin/ms12-dec). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4782](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4787](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2761465">Microsoft Knowledge Base-Artikel 2761465</a>.</td>
</tr>
<tr class="even">
...
| **Dateiinformationen:**                  | Siehe [Microsoft Knowledge Base-Artikel 2761465](https://support.microsoft.com/kb/2761465).                                                                                                                                                                                                                                   |
...
-   Fermin J. Serna von [Google Inc](https://www.google.com) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch falsche Referenzzählung (CVE-2012-4787).
