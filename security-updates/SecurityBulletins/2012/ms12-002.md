...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=feaeda8c-84ee-47be-8c68-736f0e5b1fc7)                                | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=211827f2-fe6a-4e16-a90c-0cc3b60a722d)       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b8e46267-7988-4fbe-ae94-68b6fdb2e7d9)                       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5975b01e-139b-4b9d-a0d5-a87a279bfea1)           | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=26079c35-4b96-42fc-ad47-138be25a6bf0) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0009](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0009).
...
Windows Object Packager ist ein Tool, mit dem ein Paket erstellt wird, das anschließend in eine Datei eingefügt werden kann. Weitere Informationen zu Object Packager finden Sie in der folgenden [Microsoft-Produktdokumentation](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true).
...
-   Parvez Anwar in Zusammenarbeit mit [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Object Packager durch Starten einer nicht sicheren ausführbaren Datei (CVE-2012-0009)
