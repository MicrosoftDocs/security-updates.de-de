---
TOCTitle: 'MS12-031'
Title: 'Microsoft Security Bulletin MS12-031 - Hoch'
ms:assetid: 'ms12-031'
ms:contentKeyID: 61224850
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-031(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-031 - Hoch
===========================================
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 (32-Bit-Edition)</a><br />
(KB2597981)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2597170 in <a href="https://go.microsoft.com/fwlink/?linkid=238400">MS12-015</a> wird durch KB2597981 ersetzt</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 Service Pack 1 (32-Bit-Edition)</a><br />
(KB2597981)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2597170 in <a href="https://go.microsoft.com/fwlink/?linkid=238400">MS12-015</a> wird durch KB2597981 ersetzt</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 (64-Bit-Edition)</a><br />
(KB2597981)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2597170 in <a href="https://go.microsoft.com/fwlink/?linkid=238400">MS12-015</a> wird durch KB2597981 ersetzt</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 Service Pack 1 (64-Bit-Edition)</a><br />
(KB2597981)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2597170 in <a href="https://go.microsoft.com/fwlink/?linkid=238400">MS12-015</a> wird durch KB2597981 ersetzt</td>
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Mai](https://technet.microsoft.com/security/bulletin/msyy-may). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung – CVE-2012-0018</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung – CVE-2012-0018  
-----------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Microsoft Visio Attribute überprüft, wenn speziell gestaltete Visio-Dateien verarbeitet werden. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0018).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung – CVE-2012-0018
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung – CVE-2012-0018
...
-   **Setzen Sie die Einstellungen der Internetzone und der lokalen Intranetzone auf „Hoch“, um ActiveX-Steuerelemente und Active Scripting in diesen Zonen zu blockieren**
    ...
    3.  Verschieben Sie unter **Sicherheitsstufe für diese Zone** den Schieberegler auf **Hoch**, und klicken Sie dann auf **OK**. Dadurch wird die Sicherheitsstufe für alle besuchten Websites auf Hoch gesetzt.
  
    **Hinweis:** Wenn kein Schieberegler zu sehen ist, klicken Sie auf **Standardstufe**, ziehen Sie den Regler dann auf **Hoch**, und klicken anschließend auf **OK**.
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung – CVE-2012-0018
...
Dieses Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Visio Viewer beim Analysieren speziell gestalteter Visio-Dateien Daten überprüft.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2597981">Microsoft Knowledge Base-Artikel 2597981</a>.</td>
</tr>
<tr class="even">
...
-   Luigi Auriemma in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit im VSD-Dateiformat bezüglich Speicherbeschädigung (CVE-2012-0018)
