---
TOCTitle: 'MS12-053'
Title: 'Microsoft Security Bulletin MS12-053 - Kritisch'
ms:assetid: 'ms12-053'
ms:contentKeyID: 61224872
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-053(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-053 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.
...
<td style="border:1px solid black;">KB2685939 in <a href="https://go.microsoft.com/fwlink/?linkid=246927">MS12-036</a> wird durch KB2723135 ersetzt</td>
</tr>
</tbody>
</table>
...
**Ich habe bereits das ursprüngliche Update KB2723135 erfolgreich installiert. Muss ich die am 09. Oktober 2012 erneut veröffentlichten Updatepakete KB2723135 installieren?**  
Nein. Das erneut veröffentlichte Update gilt nur für Windows XP-Systeme, auf denen das ursprüngliche Update nicht installiert worden ist. Benutzer, die bereits das ursprüngliche Update KB2723135 erfolgreich auf ihren Windows XP-Systemen installiert haben, müssen keine Aktionen durchführen. Benutzern wird dieses Update nicht erneut angeboten, wenn es bereits auf ihren Systemen installiert ist.
  
**Warum wurde dieses Bulletin am 09. Oktober 2012 überarbeitet?**  
Microsoft hat dieses Bulletin überarbeitet, um das Update KB2723135 für Windows XP erneut zu veröffentlichen und um ein Problem mit bestimmten digitalen Zertifikaten zu beheben, die ohne ordnungsgemäße Zeitstempelattribute von Microsoft generiert wurden. Weitere Informationen finden Sie in der [Microsoft-Sicherheitsempfehlung KB 2749655](https://go.microsoft.com/fwlink/?linkid=265301).
  
**Wo befinden sich die Dateiinformationen?**  
Informationen zum Speicherort der Dateiinformationen finden Sie in den Referenztabellen im Abschnitt **Bereitstellung von Sicherheitsupdates**.
  
**Wo sind die Hashes der Sicherheitsupdates?**  
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2723135](https://support.microsoft.com/kb/2723135).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Remotedesktopprotokoll – CVE-2012-2526</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
...
Sicherheitsanfälligkeit im Remotedesktopprotokoll – CVE-2012-2526  
-----------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie das Remotedesktopprotokoll auf ein Objekt im Speicher zugreift, nachdem dieses gelöscht wurde. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann auf dem Zielsystem beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2526).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Remotedesktopprotokoll – CVE-2012-2526
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Standardmäßig ist das Remotedesktopprotokoll nicht auf jedem Windows-Betriebssystem aktiviert. Systeme, auf denen RDP nicht aktiviert ist, sind nicht gefährdet. Unter Windows XP, kann RDP durch Remoteunterstützung aktiviert werden.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Remotedesktopprotokoll – CVE-2012-2526
...
-   **Blockieren des TCP-Ports 3389 an der Umkreisfirewall des Unternehmens**
    ...
    Unter Windows XP kann die Windows-Firewall zum Schutz einzelner Systeme beitragen. Standardmäßig lässt die Windows-Firewall keine Verbindungen zu diesem Port zu, mit Ausnahme von Windows XP Service Pack 2 und Windows XP Service Pack 3, wenn die Funktion „Remotedesktop“ aktiviert ist. Weitere Informationen zum Deaktivieren der Windows-Firewallausnahme für Remotedesktop auf diesen Plattformen finden Sie im TechNet-Artikel [Aktivieren oder Deaktivieren der Remotedesktop-Firewallregel](https://technet.microsoft.com/library/cc736451.aspx). Wenn Sie die Windows-Firewallausnahme für Remotedesktop nicht deaktivieren können, lässt sich u. U. das Ausmaß dieser Sicherheitsanfälligkeit verringern, indem Sie für den Standardwert „Alle Computer“ (einschließlich derer im Internet) das lokale Netzwerk festlegen. Damit können Sie die Wahrscheinlichkeit von Angriffen aus dem Internet verringern.
...
-   **Deaktivieren der Funktion „Remotedesktop“, wenn nicht mehr erforderlich**
    ...
    Weitere Informationen zu Remoteunterstützung einschließlich Anweisungen zum manuellen Deaktivieren von Remoteunterstützung und zum Deaktivieren mithilfe von Gruppenrichtlinien finden Sie im TechNet-Artikel [Remoteunterstützung](https://technet.microsoft.com/library/bb457177.aspx).
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Remotedesktopprotokoll – CVE-2012-2526
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird verursacht, wenn das Remotedesktopprotokoll eine Sequenz speziell gestalteter Pakete verarbeitet, was um Zugriff auf ein Objekt im Speicher führt, das gelöscht wurde.
  
**Was ist das Microsoft-Remotedesktopprotokoll (RDP)?**  
Mit dem Remotedesktopprotokoll (RDP) können Benutzer auf ihren Desktopcomputern eine virtuelle Sitzung erstellen. Mit RDP können Remotebenutzer auf alle Daten und Anwendungen auf ihren Computern zugreifen. Weitere Informationen finden Sie im MSDN-Artikel [Remotedesktopprotokoll](https://msdn.microsoft.com/library/aa383015.aspx).
  
**Ist Remotedesktop standardmäßig aktiviert?**  
Nein, die RDP-Verwaltung ist nicht standardmäßig aktiviert. Jedoch wird Endbenutzern, die RDP nicht aktiviert haben, das Update dennoch angeboten, um den Schutz ihrer Computer sicherzustellen.
...
Bei Systemen, auf denen unterstützte Editionen von Windows XP ausgeführt werden, kann ein nicht authentifizierter Remoteangreifer diese Sicherheitsanfälligkeit ausnutzen, indem er eine Reihe speziell gestalteter RDP-Pakete an das Zielsystem sendet.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Systeme, auf denen RDP aktiviert ist, sind hauptsächlich durch diese Sicherheitsanfälligkeit gefährdet. Systeme, auf denen RDP nicht aktiviert ist, sind nicht gefährdet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2723135-v2$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2723135">Microsoft Knowledge Base-Artikel 2723135</a>.</td>
</tr>
<tr class="even">
...
-   Edward Torkington von der NCC Group für den Hinweis auf die Sicherheitsanfälligkeit im Remotedesktopprotokoll (CVE-2012-2526).
...
-   V2.0 (9. Oktober 2012): Bulletin überarbeitet, um das Update KB723135 für Windows XP erneut zu veröffentlichen. Endbenutzer müssen die erneut veröffentlichten Updatepakete nicht installieren, um ein Problem mit digitalen Zertifikaten zu vermeiden, das in der Microsoft-Sicherheitsempfehlung 2749655 beschrieben ist.
-   V2.1 (10. Oktober 2012): Den Häufig gestellten Fragen (FAQ) wurde ein Eintrag bezüglich des erneut veröffentlichten Updates KB723135 als Anleitung zur Bereitstellung hinzugefügt. Weitere Informationen finden Sie in den häufig gestellten Fragen (FAQs) zu diesem Update.
