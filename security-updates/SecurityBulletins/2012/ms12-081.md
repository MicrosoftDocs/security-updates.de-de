---
TOCTitle: 'MS12-081'
Title: 'Microsoft Security Bulletin MS12-081 - Kritisch'
ms:assetid: 'ms12-081'
ms:contentKeyID: 61224900
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-081(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-081 - Kritisch
===============================================

Sicherheitsanfälligkeit in der Dateiverarbeitungskomponente von Windows kann Remotecodeausführung ermöglichen (2758857)
-----------------------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 11. Dezember 2012 | Aktualisiert: Mittwoch, 22. Mai 2013
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 und Windows Server 2008 R2 als Kritisch eingestuft. Windows 8, Windows Server 2012 und Windows RT sind nicht von der Sicherheitsanfälligkeit betroffen. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Windows Dateien mit speziell gestalteten Namen verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2758857](https://support.microsoft.com/kb/2758857) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB935839 in [MS07-035](https://technet.microsoft.com/de-de/security/bulletin/ms07-035) wird durch KB2758857 ersetzt
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2533623 in [Sicherheitsempfehlung 2269637](https://technet.microsoft.com/de-de/security/advisory/2269637) wird durch KB2758857 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2567680 in [MS11-063](https://technet.microsoft.com/de-de/security/bulletin/ms11-063) wird durch KB2758857 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2758857](https://support.microsoft.com/kb/2758857).

**Sind Windows 8 Release Preview und Windows Server 2012 Release Candidate von der in diesem Bulletin erwähnten Sicherheitsanfälligkeit betroffen?**  
Ja. Das Update KB2758857 ist für Windows 8 Release Preview und Windows Server 2012 Release Candidate verfügbar. Benutzer mit Windows 8 Release Preview und Windows Server 2012 Release Candidate sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens – CVE-2012-4774
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4774](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens – CVE-2012-4774
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens – CVE-2012-4774

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens – CVE-2012-4774

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Windows einen speziell gestalteten Dateinamen oder Unterordnernamen nicht richtig verarbeitet, wodurch Daten in den Speicher kopiert werden können, die nicht ordnungsgemäß zugewiesen wurden.

**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der aktuelle Benutzer erlangen. Wenn der aktuelle Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.

**Wie gehen Angreifer vor, um diese** **Sicherheitsanfälligkeit** **auszunutzen?**  
Ein Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er einen Benutzer dazu verleitet, zu einem Dateisystem zu navigieren, das eine Datei oder einen Unterordner mit einem speziell gestalteten Namen enthält.

In einem Netzwerkangriffsszenario kann ein Angreifer eine Datei mit einem speziell gestalteten Namen auf einer Netzwerk- oder UNC-Freigabe oder einem WebDAV-Speicherort hosten und den Benutzer anschließend dazu verleiten, zu der Datei zu navigieren.

In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Datei bzw. einen Unterordner als Dateianlage sendet und den Benutzer dazu verleitet, zu dem Dateisystem zu navigieren, das die Dateianlage enthält.

In einem webbasierten Angriffsszenario muss ein Angreifer eine Website hosten, die eine Datei mit einem speziell gestalteten Namen enthält. Ein Angreifer kann Benutzer nicht zwingen, eine Website zu besuchen, auf der die Datei gehostet wird. Der Angreifer muss stattdessen den Benutzer zum Besuch dieser Website verleiten, z. B. indem er den Benutzer dazu auffordert, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zur Website des Angreifers zu klicken.
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Windows Dateien mit speziell gestalteten Namen verarbeitet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2758857$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2758857">Microsoft Knowledge Base-Artikel 2758857</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2758857$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2758857](https://support.microsoft.com/kb/2758857).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Lucas Apa von [IOActive](https://ioactive.co.uk/) für den Hinweis auf die Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens (CVE-2012-4774).
...
-   V1.1 (22. Mai 2013): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2758857 hinzugefügt.
