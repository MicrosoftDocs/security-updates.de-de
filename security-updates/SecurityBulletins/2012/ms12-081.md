...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2758857](http://support.microsoft.com/kb/2758857) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB935839 in [MS07-035](http://technet.microsoft.com/de-de/security/bulletin/ms07-035) wird durch KB2758857 ersetzt
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2533623 in [Sicherheitsempfehlung 2269637](http://technet.microsoft.com/de-de/security/advisory/2269637) wird durch KB2758857 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2567680 in [MS11-063](http://technet.microsoft.com/de-de/security/bulletin/ms11-063) wird durch KB2758857 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Ja. Das Update KB2758857 ist für Windows 8 Release Preview und Windows Server 2012 Release Candidate verfügbar. Benutzer mit Windows 8 Release Preview und Windows Server 2012 Release Candidate sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](http://update.microsoft.com/windowsupdate/) verfügbar.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4774](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2758857">Microsoft Knowledge Base-Artikel 2758857</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2758857](http://support.microsoft.com/kb/2758857).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Lucas Apa von [IOActive](http://ioactive.co.uk/) für den Hinweis auf die Sicherheitsanfälligkeit in Windows bei Analyse des Dateinamens (CVE-2012-4774).
