...
<td style="border:1px solid black;">
KB2647516 in [MS12-010](https://go.microsoft.com/fwlink/?linkid=236989) wird durch KB2675157 ersetzt
</td>
</tr>
...
Ja. Das Update KB2675157 ist für die Windows Developer Preview-Version verfügbar. Endbenutzer mit Windows Developer Preview sind angehalten, das Update auf ihren Systemen zu installieren. Das Update ist nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für April](https://technet.microsoft.com/de-de/security/bulletin/ms12-apr). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0168](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0168).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0169](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0169).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0170](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0170).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0171](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0171).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0172](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0172).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2675157">Microsoft Knowledge Base-Artikel 2675157</a>.</td>
</tr>
<tr class="even">
...
-   linx2008 von [AISec](https://www.aisec.cn/) für den Hinweis auf die Sicherheitsanfälligkeit in Druckfunktion bezüglich Remotecodeausführung (CVE-2012-0168)  
-   Roel Spilker von [TOPdesk](https://www.topdesk.com) für den Hinweis auf die Sicherheitsanfälligkeit in JScript9 bezüglich Remotecodeausführung (CVE-2012-0169)  
-   Jose Antonio Vazquez Gonzalez in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com) für den Hinweis auf die Sicherheitsanfälligkeit in OnReadyStateChange bezüglich Remotecodeausführung (CVE-2012-0170)  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in SelectAll bezüglich Remotecodeausführung (CVE-2012-0171)  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com) von [TippingPoint](https://www.tippingpoint.com) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in VML-Stil bezüglich Remotecodeausführung (CVE-2012-0172)  
