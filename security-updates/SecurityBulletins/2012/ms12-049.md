---
TOCTitle: 'MS12-049'
Title: 'Microsoft Security Bulletin MS12-049 - Hoch'
ms:assetid: 'ms12-049'
ms:contentKeyID: 61224868
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-049(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-049 - Hoch
===========================================

Sicherheitsanfälligkeit in TLS kann Offenlegung von Information ermöglichen (2655992)
-------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 10. Juli 2012 | Aktualisiert: Dienstag, 9. Juli 2013
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Windows Secure Channel- (SChannel) und Kryptografie-API: Next Generation (CNG)-Komponenten verschlüsselte Netzwerkpakete senden und empfangen. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;">
KB980436 in [MS10-049](https://go.microsoft.com/fwlink/?linkid=197104) wird durch KB2655992 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2585542 in [MS12-006](https://go.microsoft.com/fwlink/?linkid=232510) wird durch KB2655992 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2207566 in [MS10-085](https://go.microsoft.com/fwlink/?linkid=201705) ersetzt durch KB2655992
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=97030267-6b19-46ae-84ce-0bb1f91ab951) (Server Core-Installation)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f) (Server Core-Installation)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (Server Core-Installation)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (Server Core-Installation)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Offenlegung von Informationen
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2655992](https://support.microsoft.com/kb/2655992).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit im TLS-Protokoll – CVE-2012-1870
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1870](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im TLS-Protokoll – CVE-2012-1870

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Verschlüsselungssammlungen, die den CBC-Modus nicht verwenden, sind nicht betroffen.

#### Problemumgehungen für die Sicherheitsanfälligkeit im TLS-Protokoll – CVE-2012-1870
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im TLS-Protokoll – CVE-2012-1870

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit, die sich auf die Offenlegung von Informationen bezieht.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird durch einen Entwicklungsfehler im TLS-Protokoll verursacht, wenn der Betriebsmodus CBC (Blockchiffreverkettung, Cipher Block Chaining) verwendet wird.
...
Mit dem Update wird geändert, wie Windows Secure Channel (SChannel) und Kryptografie-API: Next Generation (CNG)-Komponenten verschlüsselte Netzwerkpakete senden und empfangen.

**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-1870](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) zugewiesen.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2655992$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2655992">Microsoft Knowledge Base-Artikel 2655992</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2655992$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2655992](https://support.microsoft.com/kb/2655992).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
