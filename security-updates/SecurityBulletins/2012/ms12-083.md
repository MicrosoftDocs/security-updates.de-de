---
TOCTitle: 'MS12-083'
Title: 'Microsoft Security Bulletin MS12-083 - Hoch'
ms:assetid: 'ms12-083'
ms:contentKeyID: 61224902
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-083(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-083 - Hoch
===========================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Server 2008 R2 und Windows Server 2012 als Hoch eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Windows die Gültigkeit von Zertifikaten prüft. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2765809](https://support.microsoft.com/kb/2765809).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit durch Umgehung mit widerrufenem Zertifikat – CVE-2012-2549
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
In Windows liegt eine Sicherheitsanfälligkeit durch Umgehung der Sicherheitsfunktion vor, die dadurch verursacht wird, wie die IP-HTTPS-Komponente Zertifikate verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann Zertifikatgültigkeitsprüfungen umgehen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Umgehung mit widerrufenem Zertifikat – CVE-2012-2549

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Um die Sicherheitsanfälligkeit auszunutzen, muss ein Angreifer ein Zertifikat besitzen, das von der Domäne herausgegeben wird.
-   Für die Anmeldung bei einem System innerhalb des Unternehmens sind immer noch Anmeldeinformationen für das System oder die Domäne erforderlich.

#### Problemumgehungen für die Sicherheitsanfälligkeit durch Umgehung mit widerrufenem Zertifikat – CVE-2012-2549

Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:

-   **Deaktivieren Sie die Domänen-Computerkonten,** **die** **widerrufenen Clientzertifikaten** **zugeordnet sind.**

    Anweisungen zum Deaktivieren von Computerkonten in Windows Server 2008 R2 und Windows Server 2012 finden Sie unter [Computerkonten aktivieren oder deaktivieren](https://technet.microsoft.com/en-us/library/cc732965.aspx).

    Anweisungen zur Verwendung eines Skripts, um mehrere Computerkonten zu deaktivieren, finden Sie unter [Computerkonten deaktivieren](https://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c).

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Umgehung mit widerrufenem Zertifikat – CVE-2012-2549

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit aufgrund der Umgehung von Sicherheitsfunktionen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Windows die Gültigkeit von Zertifikaten nicht richtig prüft.

**Welche** **Komponente ist von dieser Sicherheitsanfälligkeit betroffen?**  
IP-HTTPS ist die Windows-Komponente, die durch diese Sicherheitsanfälligkeit betroffen ist.

**Was ist IP-HTTPS?**  
IP über HTTPS (IP-HTTPS) ist ein Protokoll, mit dem über sichere HTTP-Verbindungen sichere IP-Tunnels eingerichtet werden können. Es wird üblicherweise bei Bereitstellungen von Microsoft DirectAccess verwendet. Weitere Informationen finden Sie in [Tunneling-Protokoll IP über HTTPS (IP-HTTPS)](https://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx).

**Was ist DirectAccess?**  
Mit DirectAccess, das mit den Betriebssystemen Windows 7 und Windows Server 2008 R2 eingeführt wurde, können Remotebenutzer sicher auf Unternehmensfreigaben, Websites und Anwendungen zugreifen, bei denen sichere Protokolle wie IP-HTTPS verwendet werden. Weitere Informationen finden Sie unter [DirectAccess](https://technet.microsoft.com/en-us/network/dd420463.aspx).

**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann eine Sicherheitsfunktion umgehen, die sich auf der Gültigkeit von Zertifikaten stützt.

**Wie gehen Angreifer vor, um diese** **Sicherheitsanfälligkeit** **auszunutzen?**  
Die Sicherheitsanfälligkeit kann eine Umgehung der Sicherheitsfunktion ermöglichen, wenn ein Angreifer einer Anwendung oder einem Dienst, in dem die IP-HTTPS Komponente verwendet wird, ein widerrufenes Zertifikat präsentiert.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Von dieser Sicherheitsanfälligkeit sind Server betroffen.

**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Windows die Gültigkeit von Zertifikaten prüft.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2765809">Microsoft Knowledge Base-Artikel KB2765809</a>.</td>
</tr>
<tr class="odd">
