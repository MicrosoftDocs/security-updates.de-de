...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549).
...
-   **Deaktivieren Sie die Domänen-Computerkonten,** **die** **widerrufenen Clientzertifikaten** **zugeordnet sind.**
    ...
    Anweisungen zum Deaktivieren von Computerkonten in Windows Server 2008 R2 und Windows Server 2012 finden Sie unter [Computerkonten aktivieren oder deaktivieren](http://technet.microsoft.com/en-us/library/cc732965.aspx).

    Anweisungen zur Verwendung eines Skripts, um mehrere Computerkonten zu deaktivieren, finden Sie unter [Computerkonten deaktivieren](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c).
...
**Was ist IP-HTTPS?**  
IP über HTTPS (IP-HTTPS) ist ein Protokoll, mit dem über sichere HTTP-Verbindungen sichere IP-Tunnels eingerichtet werden können. Es wird üblicherweise bei Bereitstellungen von Microsoft DirectAccess verwendet. Weitere Informationen finden Sie in [Tunneling-Protokoll IP über HTTPS (IP-HTTPS)](http://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx).

**Was ist DirectAccess?**  
Mit DirectAccess, das mit den Betriebssystemen Windows 7 und Windows Server 2008 R2 eingeführt wurde, können Remotebenutzer sicher auf Unternehmensfreigaben, Websites und Anwendungen zugreifen, bei denen sichere Protokolle wie IP-HTTPS verwendet werden. Weitere Informationen finden Sie unter [DirectAccess](http://technet.microsoft.com/en-us/network/dd420463.aspx).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2765809">Microsoft Knowledge Base-Artikel KB2765809</a>.</td>
</tr>
<tr class="odd">
