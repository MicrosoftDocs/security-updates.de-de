---
TOCTitle: 'MS12-041'
Title: 'Microsoft Security Bulletin MS12-041 - Hoch'
ms:assetid: 'ms12-041'
ms:contentKeyID: 61224860
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-041(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-041 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie die Windows-Kernelmodustreiber Eingaben überprüfen, die vom Benutzermodus übergeben werden, und wie das Laden von TrueType-Schriftarten verarbeitet wird und außerdem, indem eine zusätzliche Laufzeitüberprüfung in den Threaderstellungsmechanismus eingeführt wird. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;">
KB2641653 in [MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) wird durch KB2709162 ersetzt
</td>
</tr>
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Juni](https://technet.microsoft.com/security/bulletin/ms12-jun). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1864
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1865
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit beim Verarbeiten des Atomnamens des Zwischenablagenformats – CVE-2012-1866
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs im Refcount der Schriftartenressource – CVE-2012-1867
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit durch Racebedingung in Win32k.sys – CVE-2012-1868
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1864
...
#### Problemumgehungen für die Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1864

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1864
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1865](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1865

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1865

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse – CVE-2012-1865
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1866](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Verarbeiten des Atomnamens des Zwischenablagenformats – CVE-2012-1866

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Sicherheitsanfälligkeit beim Verarbeiten des Atomnamens des Zwischenablagenformats – CVE-2012-1866

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Verarbeiten des Atomnamens des Zwischenablagenformats – CVE-2012-1866
...
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, weil die Windows-Kernelmodustreiber beim Verarbeiten von Schriftarten Speicher nicht richtig zuweisen. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen administrativen Benutzerrechten erstellen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1867](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs im Refcount der Schriftartenressource – CVE-2012-1867

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs im Refcount der Schriftartenressource – CVE-2012-1867

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs im Refcount der Schriftartenressource – CVE-2012-1867

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass ein Windows-Kernelmodustreiber den Schriftarttyp TrueType nicht richtig lädt.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows-Kernelmodustreiber den Schriftarttyp TrueType lädt.
...
Im Windows-Kernel liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie der Kernel bestimmte Versuche der Threaderstellung verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen administrativen Benutzerrechten erstellen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Racebedingung in Win32k.sys – CVE-2012-1868

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Sicherheitsanfälligkeit durch Racebedingung in Win32k.sys – CVE-2012-1868

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) Sicherheitsanfälligkeit durch Racebedingung in Win32k.sys – CVE-2012-1868

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit wird von einer Racebedingung beim Erstellen bestimmter Arten von Threads verursacht.
...
**Was bewirkt das Update?**  
Das Update behebt diese Sicherheitsanfälligkeit, indem eine zusätzliche Laufzeitüberprüfung in den Threaderstellungsmechanismus eingeführt wird.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2709162$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2709162">Microsoft Knowledge Base-Artikel 2709162</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2709162$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2709162](https://support.microsoft.com/kb/2709162).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tarjei Mandt von [Azimuth Security](https://www.azimuthsecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit beim Verarbeiten der Zeichenfolgen-Atomklasse (CVE-2012-1864).  
-   Tarjei Mandt von [Azimuth Security](https://www.azimuthsecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Racebedingung in Win32k.sys (CVE-2012-1865).  
-   Tarjei Mandt von [Azimuth Security](https://www.azimuthsecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit beim Verarbeiten des Atomnamens des Zwischenablagenformats (CVE-2012-1866).  
-   [Mateusz „j00 ru“ Jurczyk](https://j00ru.vexillium.org) von [Google Inc.](https://www.google.com) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs im Refcount der Schriftartenressource (CVE-2012-1867).
