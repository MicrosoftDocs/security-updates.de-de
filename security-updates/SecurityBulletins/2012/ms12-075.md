...
<td style="border:1px solid black;">
KB2731847 in [MS12-055](https://go.microsoft.com/fwlink/?linkid=257907) wird ersetzt durch KB2761226
</td>
</tr>
...
Ja. Das Update KB2761226 ist für Windows 8 Release Preview und Windows Server 2012 Release Candidate verfügbar. Benutzer mit Windows 8 Release Preview und Windows Server 2012 Release Candidate sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2761226">Microsoft Knowledge Base-Artikel 2761226</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2761226](https://support.microsoft.com/kb/2761226).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **Dateiinformationen:**                  | Siehe [Microsoft Knowledge Base-Artikel 2761226](https://support.microsoft.com/kb/2761226).                                                                                                                                                  |
...
-   Matthew Jurczyk von [Google Inc](https://www.google.de) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit durch Windows Kernel win32k.sys (CVE-2012-2553).  
-   Eetu Luodemaa und Joni Vähämäki von [Documill](https://www.documill.com) in Zusammenarbeit mit dem Chromium Security Rewards Program für den Hinweis auf die Sicherheitsanfälligkeit durch TrueType-Schriftartanalyse (CVE-2012-2897).
