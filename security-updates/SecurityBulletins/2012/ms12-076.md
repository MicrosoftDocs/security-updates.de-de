...
<td style="border:1px solid black;">
KB2597086 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2687481 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2597161 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2687307 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2597166 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2597126 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665346 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2764048 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2721015 in [MS12-051](https://technet.microsoft.com/de-de/security/bulletin/ms12-051) wird durch KB2764047 ersetzt
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2596842 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2687313 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2597162 in [MS12-030](https://technet.microsoft.com/de-de/security/bulletin/ms12-030) wird durch KB2687311 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für November](https://technet.microsoft.com/security/bulletin/ms12-nov). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1885).
...
**Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 935865](https://support.microsoft.com/kb/935865/de), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
Weitere Informationen zu MOICE finden Sie im [Microsoft Knowledge Base-Artikel 935865](https://support.microsoft.com/kb/935865/de).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1886).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1887](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1887).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2543](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2543).
...
**Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 2501584](https://support.microsoft.com/kb/2501584/de), um diese Problemumgehung in der entsprechenden Office-Software mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2687481">Microsoft Knowledge Base-Artikel 2687481</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2687307">Microsoft Knowledge Base-Artikel 2687307</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2687313">Microsoft Knowledge Base-Artikel 2687313</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2687311">Microsoft Knowledge Base-Artikel 2687311</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2597126">Microsoft Knowledge Base-Artikel 2597126</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.3.5 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=d3d801a2-d57f-4b4c-970a-c296bc716521) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office für Mac 2011-Updates 14.2.5 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=0f4e073f-4fec-440d-a9bf-1e01ee9e92ad) herunter, und installieren Sie sie.
...
-   Sean Larsson in Zusammenarbeit mit [iDefense VCP](https://labs.idefense.com) für den Hinweis auf die Sicherheitsanfälligkeit in Excel SerAuxErrBar durch Heapüberlauf (CVE-2012-1885).  
-   Einer Person, die mit [iDefense VCP](https://labs.idefense.com) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2012-1886).  
-   Einer Person, die mit [iDefense VCP](https://labs.idefense.com) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in durch ungültige Länge in Excel SST (CVE-2012-1887).  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [HP TippingPoints](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit durch Stapelüberlauf im FEAT-Datensatz (CVE-2012-2543).
