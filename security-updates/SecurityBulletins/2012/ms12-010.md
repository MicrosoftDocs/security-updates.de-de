---
TOCTitle: 'MS12-010'
Title: 'Microsoft Security Bulletin MS12-010 - Kritisch'
ms:assetid: 'ms12-010'
ms:contentKeyID: 61224829
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-010(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für Internet Explorer 7, Internet Explorer 8 und Internet Explorer 9 unter Windows-Clients als Kritisch und für Internet Explorer 7, Internet Explorer 8 und Internet Explorer 9 unter Windows-Servern als Mittel eingestuft. Dieses Sicherheitsupdate wird außerdem für Internet Explorer 6 unter allen unterstützten Editionen von Windows XP als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie Internet Explorer Inhalte beim Kopieren und Einfügen verarbeitet, Objekte im Speicher verarbeitet und Zeichenfolgen erstellt und initialisiert. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
Ja. Das Update KB2647516 ist für die Windows Developer Preview-Version verfügbar. Endbenutzer mit Windows Developer Preview sind angehalten, das Update auf ihren Systemen zu installieren. Das Update ist nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Benutzer, die zusätzlichen Support für ältere Software benötigen, müssen sich an ihren Microsoft-Kundenbetreuer, ihren Technical Account Manager oder den jeweiligen Microsoft-Partner wenden, um Supportangebote in Anspruch nehmen zu können. Kunden, die nicht über einen Alliance-, Premier- oder Authorized-Vertrag verfügen, können sich mit der regionalen Microsoft-Vertriebsniederlassung in Verbindung setzen. Kontaktinformationen finden Sie auf der Website [Microsoft Worldwide](https://technet.microsoft.com/de-de/security/advisory). Wählen Sie in der Liste „Kontaktinformationen“ Ihr Land aus, und klicken Sie auf **Go**. Es wird eine Telefonnummer für Ihr Land angezeigt. Wenn Sie unter der angegebenen Nummer anrufen, fragen Sie bitte nach dem regionalen Vertriebsmanager für Premier Support. Weitere Informationen finden Sie auf der Seite [Microsoft Support Lifecycle-Richtlinie – Häufig gestellte Fragen (FAQ)](https://support.microsoft.com/kb/887012/de).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit beim Kopieren und Einfügen durch Offenlegung von Informationen – CVE-2012-0010
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in HTML-Layout bezüglich Remotecodeausführung – CVE-2012-0011
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bei Null-Byte durch Offenlegung von Informationen – CVE-2012-0012
</th>
<th style="border:1px solid black;" >
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0010](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Kopieren und Einfügen durch Offenlegung von Informationen – CVE-2012-0010
...
#### Problemumgehungen für die Sicherheitsanfälligkeit beim Kopieren und Einfügen durch Offenlegung von Informationen – CVE-2012-0010
...
-   Kopieren Sie keine Inhalte von nicht vertrauenswürdigen Quellen, und fügen Sie diese nicht ein.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Kopieren und Einfügen durch Offenlegung von Informationen – CVE-2012-0010

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit, die sich auf die Offenlegung von Informationen bezieht.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Beim Kopieren und Einfügen überprüft Internet Explorer Daten nicht ausreichend, was es Angreifern ermöglicht, auf Inhalte von verschiedenen Domänen zuzugreifen und diese zu lesen.
...
Ein Angreifer kann eine speziell gestaltete Website hosten, die dafür ausgelegt ist, diese Sicherheitsanfälligkeit durch Internet Explorer auszunutzen. Er kann einen Benutzer dazu verleiten, auf dieser Website angezeigte Inhalte zu kopieren und diese dann in eine Zielwebsite einzufügen. Der Angreifer kann auch beeinträchtigte Websites und Websites nutzen, die von Benutzern bereitgestellte Inhalte oder Anzeigen akzeptieren oder hosten. Diese Websites können speziell gestaltete Inhalte enthalten, die dazu beitragen, diese Sicherheitsanfälligkeit auszunutzen. Ein Angreifer kann Endbenutzer jedoch nicht zum Besuch solcher Websites zwingen. Er muss den Benutzer zu einem Besuch dieser Webseite verleiten. Zu diesem Zweck wird der Benutzer normalerweise dazu gebracht, in einer E-Mail oder einer Instant Messenger-Anfrage auf einen Link zur Website des Angreifers zu klicken.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Internet Explorer Inhalte beim Kopieren und Einfügen verarbeitet.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in HTML-Layout bezüglich Remotecodeausführung – CVE-2012-0011
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in HTML-Layout bezüglich Remotecodeausführung – CVE-2012-0011
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in HTML-Layout bezüglich Remotecodeausführung – CVE-2012-0011
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bei Null-Byte durch Offenlegung von Informationen – CVE-2012-0012
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bei Null-Byte durch Offenlegung von Informationen – CVE-2012-0012
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bei Null-Byte durch Offenlegung von Informationen – CVE-2012-0012
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0155](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in VML bezüglich Remotecodeausführung – CVE-2012-0155
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in VML bezüglich Remotecodeausführung – CVE-2012-0155
...
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2647516$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 für alle unterstützten Editionen von Windows XP:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie7updates\KB2647516-IE7\spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 für alle unterstützten Editionen von Windows XP:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie8updates\KB2647516-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2647516">Microsoft Knowledge Base-Artikel 2647516</a>.</td>
</tr>
<tr class="even">
...
-   [Jan Schejbal](https://janschejbal.wordpress.com/) für den Hinweis auf die Sicherheitsanfälligkeit beim Kopieren und Einfügen durch Offenlegung von Informationen (CVE-2012-0010)  
-   Stephen Fewer von [Harmony Security](https://www.harmonysecurity.com/) in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in HTML-Layout bezüglich Remotecodeausführung (CVE-2012-0011)  
-   Jason Hullinger von [HP Cloud Services](https://www.hpcloud.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei Null-Byte durch Offenlegung von Informationen (CVE-2012-0012)  
-   Stephen Fewer von [Harmony Security](https://www.harmonysecurity.com/) in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in VML bezüglich Remotecodeausführung (CVE-2012-0155)
