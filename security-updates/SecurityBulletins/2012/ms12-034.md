...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2681578](https://support.microsoft.com/kb/2681578) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2412687 in [MS11-029](https://go.microsoft.com/fwlink/?linkid=208524) wird durch KB2659262 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2641653 in [MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) wird durch KB2676562 ersetzt  
KB2633171 in [MS11-098](https://go.microsoft.com/fwlink/?linkid=232424) wird durch KB2676562 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2641653 in [MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) wird durch KB2676562 ersetzt  
KB979683 in [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) wird durch KB2676562 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665364 in [MS12-019](https://go.microsoft.com/fwlink/?linkid=239573) wird durch KB2658846 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2641653 in [MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) wird durch KB2676562 ersetzt  
KB2556532 in [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) wird durch KB2676562 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">KB972580 in <a href="https://go.microsoft.com/fwlink/?linkid=161342">MS09-062</a> wird durch KB2598253 ersetzt</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB972581 in <a href="https://go.microsoft.com/fwlink/?linkid=161342">MS09-062</a> wird durch KB2596672 ersetzt</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">
KB2668562 in [MS12-016](https://technet.microsoft.com/de-de/security/bulletin/ms12-016) wird durch KB2690729 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Ja. Die Updates KB2658846, KB2660649 und KB2676562 sind für Windows 8 Consumer Preview verfügbar. Endbenutzer von Windows 8 Consumer Preview sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Mai](https://technet.microsoft.com/de-de/security/bulletin/ms12-may). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2011-3402](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3402).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0159](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0159).
...
-   **Verweigern des Zugriffs auf T2EMBED.DLL**
    ...
    **Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 2639417](https://support.microsoft.com/kb/2639417), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren und so den Zugriff auf t2embed.dll zu verweigern.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0162](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0162).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0164](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0164).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-0164](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0164) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0165](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0165).
...
-   **Deaktivieren der Metadateiverarbeitung**
    ...
    **Auswirkung der Problemumgehung.** Durch das Deaktivieren der Verarbeitung von Metadateien kann die Funktionalitätsleistung von Software oder Systemkomponenten beeinträchtigt werden. Das Deaktivieren der Verarbeitung von Metafiles kann auch einen vollständigen Ausfall von Software oder Systemkomponenten verursachen. Evaluieren Sie die Anwendbarkeit dieser Problemumgehung. Beispiele für ungünstige Ergebnisse beinhalten Folgendes:
    ...
    Weitere Informationen zu dieser Einstellung finden Sie im [Microsoft Knowledge Base-Artikel 941835](https://support.microsoft.com/kb/941835).
...
Weitere Informationen zu Bildtypen und Formaten finden Sie im [Microsoft Knowledge Base-Artikel 320314](https://support.microsoft.com/kb/320314). Weitere Informationen zu Grafikdateiformaten finden Sie in dem MSDN-Artikel [Metadateien](https://msdn.microsoft.com/en-us/library/ms536391.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0167](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0167).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0176](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0176).
...
Windows Presentation Foundation (WPF) stellt erweiterten Textsupport einschließlich Markup auf Glyphenebene bereit, mit direktem Zugriff auf [Glyphen](https://msdn.microsoft.com/en-us/library/system.windows.documents.glyphs.aspx) für Benutzer, die Text nach dem Formatieren abfangen und persistieren möchten. Diese Funktionen stellen wesentliche Unterstützung für die verschiedenen Textdarstellungsanforderungen in den folgenden Szenarien bereit: Bildschirmanzeige von Dokumenten mit festem Format, Druckszenarien und Darstellung von Dokumenten mit festem Format, einschließlich Clients für frühere Versionen von Windows und anderen Geräten ab. Weitere Informationen finden Sie in dem MSDN-Artikel [Einführung in das Objekt „GlyphRun“ und das Element „Glyphs“](https://msdn.microsoft.com/en-us/library/ms748985.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0180](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0180).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0181](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0181).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-0181](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0181) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1848](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1848).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2681578">Microsoft Knowledge Base-Artikel 2681578</a>.</td>
</tr>
<tr class="even">
...
Weitere Informationen zum Installationsprogramm wusa.exe finden Sie im [Microsoft Knowledge Base-Artikel 832475](https://support.microsoft.com/kb/832475/de).
...
<tr class="even">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">Dieses Sicherheitsupdate unterstützt kein HotPatching. Weitere Informationen zum Hotpatching finden Sie im <a href="https://support.microsoft.com/kb/897341/de">Microsoft Knowledge Base-Artikel 897341</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation</strong></td>
<td style="border:1px solid black;">Für alle unterstützten Editionen von Windows Server 2003:<br />
...
-   Alin Rad Pop in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [Tipping Point](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Analyse von TrueType-Schriftarten (CVE-2012-0159).  
-   Vitaliy Toropov in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [Tipping Point](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in .NET Framework durch Pufferzuweisung (CVE-2012-0162).  
-   [Omair](https://krash.in) für den Hinweis auf die Sicherheitsanfälligkeit in GDI+-Datensatztyp (CVE-2012-0165).  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in GDI+-Datensatztyp (CVE-2012-0165).  
-   Einer Person, die mit [VeriSign iDefense Labs](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in GDI bezüglich Heapüberlaufs (CVE-2012-0167).  
-   Alex Plaskett von [MWR InfoSecurity](https://www.mwrinfosecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Silverlight durch doppelte Freigabe (CVE-2012-0176).  
-   Tarjei Mandt von [Azimuth Security](https://www.azimuthsecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Tastaturlayoutdatei (CVE-2012-0181)  
-   Nicolas Economou von [Core Security Technologies](https://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Tastaturlayoutdatei (CVE-2012-0181).  
