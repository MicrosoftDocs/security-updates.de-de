...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2698365](https://support.microsoft.com/kb/2698365) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<sup>[1]</sup>Das Update KB2698365 gilt auch für Windows Data Access Components 6.1. Auf den Systemen der Kunden, die das Update [KB2640696](https://www.microsoft.com/download/details.aspx?id=28422) installiert haben, wird Data Access Components 6.1 installiert sein. Sie müssen das Update KB2698365 installieren, um die Sicherheitsanfälligkeit zu beheben.
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2698365](https://support.microsoft.com/kb/2698365).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2698365">Microsoft Knowledge Base-Artikel 2698365</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">
Dieses Sicherheitsupdate unterstützt kein HotPatching. Weitere Informationen zum Hotpatching finden Sie im [Microsoft Knowledge Base-Artikel 897341](https://support.microsoft.com/kb/897341/de).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2698365](https://support.microsoft.com/kb/2698365).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Einem Forscher, der mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung in ADO Cachesize durch Heapüberlauf (CVE-2012-1891).
