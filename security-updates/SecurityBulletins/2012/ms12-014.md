---
TOCTitle: 'MS12-014'
Title: 'Microsoft Security Bulletin MS12-014 - Hoch'
ms:assetid: 'ms12-014'
ms:contentKeyID: 61224833
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-014(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-014 - Hoch
===========================================

Sicherheitsanfälligkeit im Indeo-Codec kann Remotecodeausführung ermöglichen (2661637)
--------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 14. Februar 2012 | Aktualisiert: Mittwoch, 22. Februar 2012
...
Dieses Sicherheitsupdate wird für Windows XP Service Pack 3 als Hoch eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Indeo-Codec externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2661637](https://support.microsoft.com/kb/2661637) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|----------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit im Indeo-Codec durch nicht sicheres Laden von Bibliotheken – CVE-2010-3138
</th>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie der Indeo-Codec das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3138](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Indeo-Codec durch nicht sicheres Laden von Bibliotheken – CVE-2010-3138
...
-   Damit ein Angriff erfolgreich ist, muss ein Benutzer einen nicht vertrauenswürdigen Speicherort eines Remotedateisystems oder eine WebDAV-Freigabe besuchen und eine Mediendatei (z. B. eine AVI-Datei) öffnen.

#### Problemumgehungen für die Sicherheitsanfälligkeit im Indeo-Codec durch nicht sicheres Laden von Bibliotheken – CVE-2010-3138
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Indeo-Codec durch nicht sicheres Laden von Bibliotheken – CVE-2010-3138
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Indeo-Codec den für das Laden externer Bibliotheken verwendeten Pfad falsch einschränkt.

**Was ist der Indeo-Codec?**  
Mit dem Indeo-Codec werden digitale Mediendateien zur Verwendung in Anwendungen wie Windows Media Player dekomprimiert. Weitere Informationen zu Codecs finden Sie unter [Codecs: Häufig gestellte Fragen (FAQs)](https://windows.microsoft.com/en-us/windows7/codecs-frequently-asked-questions).

**Was ist eine AVI-Mediendatei?**  
AVI (Audio Visual Interleave) ist ein von Microsoft definiertes Multimedia-Containerformat, das das Resource Interchange File Format (RIFF) verwendet. AVI wird von Microsoft definiert. Das AVI-Dateiformat ist ein gängiges Format für Audio- und Videodaten auf einem Computer.
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige Mediendatei (z. B. eine AVI-Datei) zu öffnen, die sich im gleichen Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Beim Öffnen der gültigen Datei kann der Indeo-Codec dann versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.

In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine gültige Datei (z. B. eine AVI-Datei) an einen Benutzer sendet und diesen dazu verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und danach die gültige Datei zu öffnen. Beim Öffnen der gültigen Datei kann der Indeo-Codec dann versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.

In einem Netzwerkangriffsszenario kann ein Angreifer eine gültige Datei (z. B. eine AVI-Datei) und eine speziell gestaltete DLL-Datei auf einer Netzwerkfreigabe, einem UNC- oder einem WebDAV-Speicherort ablegen und den Benutzer anschließend dazu verleiten, die Datei zu öffnen.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Arbeitsstationen, bei denen erwartet werden kann, dass Benutzer Dateianlagen von nicht vertrauenswürdigen Netzwerkspeicherorten öffnen, sind hauptsächlich gefährdet.

**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Indeo-Codec externe Bibliotheken lädt.
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3138](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138) zugewiesen.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2661637$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2661637">Microsoft Knowledge Base-Artikel 2661637</a>.</td>
</tr>
<tr class="even">
...
-   V1.1 (22. Februar 2012): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2661637 hinzugefügt.
