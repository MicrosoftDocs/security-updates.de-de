...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2644615](https://support.microsoft.com/kb/2644615) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                         | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                         | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                             | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                   | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                               | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                                   | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                                    | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                              | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                            | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme und Windows 7 für 32-Bit-Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                               | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme und Windows 7 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme und Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme und Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Umgehung der Sicherheitsfunktion | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
...
-   Diese Sicherheitsanfälligkeit kann nur mit Softwareanwendungen ausgenutzt werden, die mit Microsoft Visual C++ .NET 2003 kompiliert wurden.
    ...
    **Hinweis:** Unterstützung beim Ermitteln des Produkts, mit dem eine bestimmte Softwareanwendung kompiliert wurde, finden Sie im [Microsoft Knowledge Base-Artikel 2644615](https://support.microsoft.com/kb/2644615).
...
-   **Aktivieren von SEHOP (Structured Exception Handling Overwrite Protection)**
    ...
    Unter [Aktivieren von SEHOP (Structured Exception Handling Overwrite Protection) in Windows-Betriebssystemen](https://support.microsoft.com/kb/956607) finden Sie Anweisungen zum Aktivieren von SEHOP für vorhandene Anwendungen auf Systemen mit Windows Vista, Windows 7, Windows Server 2008 und Windows Server 2008 R2.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2644615">Microsoft Knowledge Base-Artikel 2644615</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2644615](https://support.microsoft.com/kb/2644615).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Joshua J. Drake von [Accuvant LABS](https://www.accuvant.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Windows-Kernel durch Umgehung von SafeSEH (CVE-2012-0001)
