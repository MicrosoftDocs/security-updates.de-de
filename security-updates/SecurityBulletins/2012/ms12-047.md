---
TOCTitle: 'MS12-047'
Title: 'Microsoft Security Bulletin MS12-047 - Hoch'
ms:assetid: 'ms12-047'
ms:contentKeyID: 61224866
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-047(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-047 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie der Windows-Kernelmodustreiber Tastaturlayoutdateien verarbeitet und beim Erstellen einer Hookprozedur Rückrufparameter überprüft. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;">
KB2709162 in [MS12-041](https://go.microsoft.com/fwlink/?linkid=251707) wird durch KB2718523 ersetzt
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core-Installation)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Erhöhung von Berechtigungen
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2718523](https://support.microsoft.com/kb/2718523).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit im Tastaturlayout – CVE-2012-1890
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung – CVE-2012-1893
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie der Windows-Kernelmodustreiber bestimmte Tastaturlayouts verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen administrativen Benutzerrechten erstellen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Tastaturlayout – CVE-2012-1890
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Tastaturlayout – CVE-2012-1890

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Tastaturlayout – CVE-2012-1890
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) zugewiesen.
...
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, dass der Windows-Kernelmodustreiber beim Erstellen einer Hookprozedur Parameter falsch überprüft. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung – CVE-2012-1893

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen.

#### Problemumgehungen für die Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung – CVE-2012-1893

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung – CVE-2012-1893

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows-Kernelmodustreiber beim Erstellen einer Hookprozedur Parameter falsch überprüft.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows-Kernelmodustreiber beim Erstellen einer Hookprozedur Rückrufparameter überprüft.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2718523$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2718523">Microsoft Knowledge Base-Artikel 2718523</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2718523$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2718523](https://support.microsoft.com/kb/2718523).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Aufnahme in</strong> <strong>zukünftige</strong> <strong>Service Packs</strong></td>
<td style="border:1px solid black;">Das Update für dieses Problem wird in einem zukünftigen Service Pack oder Update-Rollup enthalten sein.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Bereitstellung:</strong></td>
...
-   Nicolas Economou von [Core Security Technologies](https://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Tastaturlayout (CVE-2012-1890).  
-   [Qihoo 360 Security Center](https://www.360.cn/) für den Hinweis auf die Sicherheitsanfälligkeit im Tastaturlayout (CVE-2012-1890).  
-   Lufeng Li von Neusoft Corporation in Zusammenarbeit mit [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Win32k durch falsche Typhandhabung (CVE-2012-1893).
