...
<td style="border:1px solid black;">
KB2596954 in [MS11-096](https://go.microsoft.com/fwlink/?linkid=232696) wird durch KB2597086 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2553073 in [MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) wird durch KB2597161 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2553070 in [MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) wird durch KB2597166 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2644354 in [MS11-094](https://go.microsoft.com/fwlink/?linkid=232493) wird durch KB2665346 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2644347 in [MS11-089](https://technet.microsoft.com/de-de/security/bulletin/ms11-089) wird durch KB2665351 ersetzt
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2553075 in [MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) wird durch KB2596842 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2553074 in [MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) wird durch KB2597162 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Die Sicherheitsupdatepakete für Microsoft Office 2008 für Mac (KB2665346) und Microsoft Office für Mac 2011 (KB2665351) in diesem Bulletin beheben auch die Sicherheitsanfälligkeiten, die im [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) Security Bulletin beschrieben werden.
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für Mai](https://technet.microsoft.com/de-de/security/bulletin/ms12-may). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0141](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0141).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0142](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0142).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0143](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-0143](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0184](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0184).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0185](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0185).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1847](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1847).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2597086">Microsoft Knowledge Base-Artikel 2597086</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel 2007 finden Sie im <a href="https://support.microsoft.com/kb/2597161">Microsoft Knowledge Base-Artikel 2597161</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Office 2007 finden Sie im <a href="https://support.microsoft.com/kb/2597969">Microsoft Knowledge Base-Artikel 2597969</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel Viewer finden Sie im <a href="https://support.microsoft.com/kb/2596842">Microsoft Knowledge Base-Artikel 2596842</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zum Microsoft Office Compatibility Pack finden Sie im <a href="https://support.microsoft.com/kb/2597162">Microsoft Knowledge Base-Artikel 2597162</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2597166">Microsoft Knowledge Base-Artikel 2597166</a> und <a href="https://support.microsoft.com/kb/2553371">Microsoft Knowledge Base-Artikel 2553371</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.3.3 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=8f85fc23-480e-4835-9ce5-0aa56702ef59) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office für Mac 2011-Updates 14.2.2 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=5d88d3d4-89bd-44c3-9e5a-657998223e2f) herunter, und installieren Sie sie.
...
-   [Omair](https://krash.in/) für den Hinweis auf die Sicherheitsanfälligkeit im Excel-Dateiformat bezüglich Speicherbeschädigung (CVE-2012-0141).  
-   [Omair](https://krash.in/) für den Hinweis auf die Sicherheitsanfälligkeit im Excel-Dateiformat bezüglich Speicherbeschädigung im OBJECTLINK-Datensatz (CVE-2012-0142).  
-   Omair in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung im SXLI-Datensatz (CVE-2012-0184).  
-   Sean Larsson und Jun Mao in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Heapüberlaufs im MergeCells-Datensatz (CVE-2012-0185).  
-   Sean Larsson und Jun Mao in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Typenkonflikts bei der Analyse von Datensätzen der Excel-Reihe (CVE-2012-1847).  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Typenkonflikts bei der Analyse von Datensätzen der Excel-Reihe (CVE-2012-1847).
