...
<td style="border:1px solid black;">
KB2598332 in [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) wird durch KB2687483 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2596917 in [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) wird durch KB2687315 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2345009 in [MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) wird durch KB2687485 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2596880 in [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) wird durch KB2687314 ersetzt
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3582ab6c-930b-4660-afcd-e2423ce56d8f">Word-Automatisierungsdienste</a><br />
(KB2598237)</td>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2742319](https://support.microsoft.com/kb/2742319).
...
Das in diesem Bulletin angebotene Sicherheitsupdatepaket für Microsoft Office Web Apps 2010 Service Pack 1 (KB2687401) behebt auch die im Security Bulletin [MS12-066](https://go.microsoft.com/fwlink/?linkid=260957) beschriebene Sicherheitsanfälligkeit.
  
**Was sind Word-Automatisierungsdienste?**  
Word-Automatisierungsdienste sind eine Dienstanwendung in SharePoint Server 2010. Word-Automatisierungsdienste stellen unbeaufsichtigte, serverseitige Konvertierung von Dokumenten in Formate bereit, die von der Microsoft Word-Clientanwendung unterstützt werden. Weitere Informationen finden Sie in [Word-Automatisierungsdienste: Übersicht](https://msdn.microsoft.com/library/ee558830).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0182](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0182).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2528).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2687483">Microsoft Knowledge Base-Artikel 2687483</a> und <a href="https://support.microsoft.com/kb/2687485">Microsoft Knowledge Base-Artikel 2687485</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2687315">Microsoft Knowledge Base-Artikel 2687315</a> und <a href="https://support.microsoft.com/kb/2687314">Microsoft Knowledge Base-Artikel 2687314</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2553488">Microsoft Knowledge Base-Artikel 2553488</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2598237">Microsoft Knowledge Base-Artikel 2598237</a> und <a href="https://support.microsoft.com/kb/2687401">Microsoft Knowledge Base-Artikel 2687401</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Einer Person, die mit [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Word durch Beschädigung des PAPX-Abschnitts (CVE-2012-0182).  
-   Einer Person, die am [SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html)-Programm von Beyond Security mitarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in listid von RTF-Datei (CVE-2012-2528).
