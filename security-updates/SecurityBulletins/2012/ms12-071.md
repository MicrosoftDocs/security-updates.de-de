...
<td style="border:1px solid black;">
KB2744842 in [MS12-063](https://technet.microsoft.com/de-de/security/bulletin/ms12-063) wird durch KB2761451 ersetzt
</td>
</tr>
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für November](https://technet.microsoft.com/security/bulletin/ms12-nov). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1538](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-4775](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2761451">Microsoft Knowledge Base-Artikel 2761451</a>.</td>
</tr>
<tr class="odd">
...
-   Jose A. Vazquez von spa-s3c.blogspot.com in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in CFormElement (CVE-2012-1538).  
-   [Omair](https://krash.in/) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in CFormElement (CVE-2012-1538).  
-   Jose A. Vazquez von spa-s3c.blogspot.com in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in CTreePos (CVE-2012-1539).  
-   Cheng-da Tsai (Orange), Sung-ting Tsai und Ming-chieh Pan (Nanika) von [Trend Micro](https://www.trendmicro.com/) für den Hinweis auf die Use-after-free-Sicherheitsanfälligkeit in CTreeNode (CVE-2012-4775).
