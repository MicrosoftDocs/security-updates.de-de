...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2719584](https://support.microsoft.com/kb/2719584).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1892](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1892).
...
<td style="border:1px solid black;">Für Microsoft Visual Studio Team Foundation Server 2010 Service Pack 1:<br />
Siehe <a href="https://support.microsoft.com/kb/2719584">Microsoft Knowledge Base-Artikel 2719584</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
-   Sunil Yadav von INR Labs ([Network Intelligence India](https://niiconsulting.com/)) für den Hinweis auf die Sicherheitsanfälligkeit durch siteübergreifende Skripterstellung (CVE-2012-1892).
