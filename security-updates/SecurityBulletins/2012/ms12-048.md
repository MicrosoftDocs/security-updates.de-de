---
TOCTitle: 'MS12-048'
Title: 'Microsoft Security Bulletin MS12-048 - Hoch'
ms:assetid: 'ms12-048'
ms:contentKeyID: 61224867
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-048(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-048 - Hoch
===========================================
...
<td style="border:1px solid black;">
KB2286198 in [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) wird durch KB2691442 ersetzt
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d873c5a-57dc-4792-942e-124ce1a4ec2b) (Server Core-Installation)  
(KB2691442)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d49e3e7e-910a-4069-b0b0-0987bb9fdde2) (Server Core-Installation)  
(KB2691442)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9) (Server Core-Installation)  
(KB2691442)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9) (Server Core-Installation)  
(KB2691442)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2691442](https://support.microsoft.com/kb/2691442).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit durch Befehlseinschleusung – CVE-2012-0175
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Es liegt eine Sicherheitsanfälligkeit vor, die Remotecodeausführung ermöglichen kann und dadurch verursacht wird, wie Windows Datei- und Verzeichnisnamen verarbeitet. Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen, wenn ein Benutzer eine Datei oder ein Verzeichnis mit einem speziell gestalteten Namen öffnet. Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0175](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0175).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Befehlseinschleusung – CVE-2012-0175
...
#### Problemumgehungen für die Sicherheitsanfälligkeit durch Befehlseinschleusung – CVE-2012-0175

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Befehlseinschleusung – CVE-2012-0175
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Windows speziell gestaltete Datei- oder Verzeichnisnamen nicht richtig verarbeitet.
...
In einem E-Mail-Angriffsszenario kann ein Angreifer diese Sicherheitsanfälligkeit ausnutzen, indem er einem Benutzer eine speziell gestaltete E-Mail-Nachricht mit einer Datei sendet und ihn dazu verleitet, die Datei zu öffnen.

In einem webbasierten Angriffsszenario muss ein Angreifer eine Website hosten, die eine Datei mit einem speziell gestalteten Namen enthält. Außerdem können manipulierte Websites und Websites, die von Benutzern bereitgestellte Inhalte akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden kann. Ein Angreifer kann Benutzer nicht zwingen, eine Website zu besuchen, auf der die Datei gehostet wird. Der Angreifer muss stattdessen den Benutzer zum Besuch dieser Website verleiten, z. B. indem er den Benutzer dazu auffordert, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zur Website des Angreifers zu klicken.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Windows Dateien und Verzeichnisse mit speziell gestalteten Namen verarbeitet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2691442$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2691442">Microsoft Knowledge Base-Artikel 2691442</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2691442$\\Spuninst.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2691442](https://support.microsoft.com/kb/2691442).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Adi Cohen von [IBM Security Systems - Application Security](https://blog.watchfire.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Befehlseinschleusung (CVE-2012-0175).
