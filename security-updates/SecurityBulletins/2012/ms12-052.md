---
TOCTitle: 'MS12-052'
Title: 'Microsoft Security Bulletin MS12-052 - Kritisch'
ms:assetid: 'ms12-052'
ms:contentKeyID: 61224871
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-052(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-052 - Kritisch
===============================================

Kumulatives Sicherheitsupdate für Internet Explorer (2722913)
-------------------------------------------------------------

Veröffentlicht: Dienstag, 14. August 2012 | Aktualisiert: Mittwoch, 17. Juli 2013
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2722913](https://support.microsoft.com/kb/2722913) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2699988 in [MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) wird durch KB2722913 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB2719177 in [MS12-044](https://go.microsoft.com/fwlink/?linkid=254377) wird durch KB2722913 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2722913](https://support.microsoft.com/kb/2722913).
...
**In welcher Beziehung steht dieses Sicherheitsupdate zu MS12-056?**  
Die in diesem Bulletin beschriebene Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript (CVE-2012-2523) wird auch von [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) behoben.

Benutzer, die Internet Explorer 8 auf ihren Systemen installiert haben, müssen das in [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 installieren, um vor der in CVE-2012-2523 beschriebenen Sicherheitsanfälligkeit geschützt zu sein.

Benutzer, die Internet Explorer 9 auf ihren Systemen installiert haben, müssen das Update KB2706045 nicht installieren, da dieses in diesem Bulletin beschriebene Update (KB2722913) CVE-2012-2523 auf Systemen behebt, auf denen Internet Explorer 9 ausgeführt wird.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout – CVE-2012-1526
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt – CVE-2012-2521
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle – CVE-2012-2522
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript – CVE-2012-2523
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout – CVE-2012-1526
...
-   Internet Explorer unter Windows Server 2003, Windows Server 2008 und Windows Server 2008 R2 wird standardmäßig in einem eingeschränkten Modus verwendet, der als [verstärkte Sicherheitskonfiguration](https://technet.microsoft.com/de-de/library/dd883248.aspx) bezeichnet wird. Dieser Modus verringert die Sicherheitsanfälligkeit. Weitere Informationen zur verstärkten Sicherheitskonfiguration von Internet Explorer finden Sie im Abschnitt „Häufig gestellte Fragen (FAQs)“.

#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout – CVE-2012-1526
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout – CVE-2012-1526
...
Diese Sicherheitsanfälligkeit setzt voraus, dass der Benutzer bei einem System angemeldet ist und eine Website durchsucht, damit eine Schaden verursachende Aktion erfolgen kann. Deshalb sind alle Systeme, auf denen Internet Explorer 6 und Internet Explorer 7 häufig verwendet werden, z. B. Arbeitsstationen oder Terminalserver, am stärksten durch diese Sicherheitsanfälligkeit gefährdet.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt – CVE-2012-2521
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt – CVE-2012-2521
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt – CVE-2012-2521
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Internet Explorer auf eine beschädigte virtuelle Funktionstabelle zugreift, nachdem diese gelöscht wurde. Die Sicherheitsanfälligkeit kann den Speicher so beschädigen, dass ein Angreifer im Kontext des aktuellen Benutzers beliebigen Code ausführen kann.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle – CVE-2012-2522
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle – CVE-2012-2522
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle – CVE-2012-2522

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung im Kontext des aktuellen Benutzers.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Wenn Internet Explorer versucht, auf eine beschädigte virtuelle Funktionstabelle zuzugreifen, kann der Speicher derart beschädigt werden, dass der Angreifer im Kontext des aktuellen Benutzers beliebigen Code ausführen kann.
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Internet Explorer während eines Kopiervorgangs die Größe eines Objekts im Speicher berechnet. Die Sicherheitsanfälligkeit kann den Speicher so beschädigen, dass ein Angreifer im Kontext des aktuellen Benutzers beliebigen Code ausführen kann.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript – CVE-2012-2523
...
-   Standardmäßig öffnen alle unterstützten Versionen von Microsoft Outlook, Microsoft Outlook Express und Windows Mail HTML-E-Mail-Nachrichten in der Zone für eingeschränkte Sites. Mit der Zone für eingeschränkte Sites, in der Skript und ActiveX-Steuerelemente deaktiviert sind, wird das Risiko verringert, dass ein Angreifer mithilfe dieser Sicherheitsanfälligkeit schädlichen Code ausführt. Klickt ein Benutzer auf einen Link in einer E-Mail, besteht weiterhin die Gefahr einer Ausnutzung dieser Sicherheitsanfälligkeit wie im oben beschriebenen webbasierten Angriffsszenario.
-   Internet Explorer unter Windows Server 2003, Windows Server 2008 und Windows Server 2008 R2 wird standardmäßig in einem eingeschränkten Modus verwendet, der als [verstärkte Sicherheitskonfiguration](https://technet.microsoft.com/de-de/library/dd883248.aspx) bezeichnet wird. Dieser Modus verringert die Sicherheitsanfälligkeit. Weitere Informationen zur verstärkten Sicherheitskonfiguration von Internet Explorer finden Sie im Abschnitt „Häufig gestellte Fragen (FAQs)“.
-   Nur 64-Bit-Versionen von Microsoft Windows, die zusätzlich konfiguriert sind, die 64-Bit-Version von Internet Explorer zu verwenden, sind von dieser Sicherheitsanfälligkeit betroffen.

#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript – CVE-2012-2523
...
-   **Verwendender 32-Bit-Version von Internet Explorer**

    Führen Sie folgende Schritte durch, um eine Verknüpfung zur 32-Bit-Version von Internet Explorer zu erstellen:

    1.  Gehen Sie in Windows Explorer zu „C:\\Programme (x86)\\Internet Explorer\\“.
    2.  Klicken Sie mit der rechten Maustaste auf „iexplore. exe“ und dann auf **Verknüpfung erstellen**.
    3.  Erstellen Sie die Verknüpfung auf Ihrem Desktop. Sie können die Verknüpfung auch in Ihre Schnellstart-Symbolleiste kopieren.

    Verwenden Sie die erstellte Verknüpfung, um die 32-Bit-Version von Internet Explorer zu starten.

    Außerdem können Sie die 32-Bit-Version von Internet Explorer als Standardbrowser festlegen, indem Sie die folgenden Schritte durchführen:

    1.  Öffnen Sie die 32-Bit-Version von Internet Explorer, indem Sie auf die Verknüpfung klicken, die Sie auf dem Desktop erstellt haben.
    2.  Wenn Sie in einer Meldung gefragt werden, ob Sie Internet Explorer als Standardbrowser verwenden möchten, klicken Sie auf **Ja**. Das ist alles.
        Wird keine Meldung anzeigt, fahren Sie mit nächsten Schritt fort.
    3.  Klicken Sie auf die Schaltfläche **Extras** und dann auf **Internetoptionen**.
    4.  Klicken Sie auf die Registerkarte **Programme** und dann auf **Als Standard**.
    5.  Klicken Sie auf **OK**, und schließen Sie Internet Explorer.

    Die 32-Bit-Version von Internet Explorer ist jetzt der Standardwebbrowser.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript – CVE-2012-2523

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung im Kontext des aktuellen Benutzers.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, wenn Internet Explorer während eines Kopiervorgangs die Größe eines Objekts im Speicher falsch berechnet.
...
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Systeme, auf denen Internet Explorer 8 bzw. Internet Explorer 9 aktiv genutzt wird (z. B. Arbeitsstationen oder Terminalserver), sind am stärksten durch diese Sicherheitsanfälligkeit gefährdet.

**Ich führe Internet Explorer für Windows Server 2003, Windows Server 2008 oder Windows Server 2008 R2 aus. Wird dadurch diese Sicherheitsanfälligkeit verringert?**  
Ja. Internet Explorer unter Windows Server 2003, Windows Server 2008 und Windows Server 2008 R2 wird standardmäßig in einem eingeschränkten Modus verwendet, der als [verstärkte Sicherheitskonfiguration](https://technet.microsoft.com/de-de/library/dd883248.aspx) bezeichnet wird. Die verstärkte Sicherheitskonfiguration von Internet Explorer besteht aus einer Gruppe vorkonfigurierter Internet Explorer-Einstellungen, durch die die Wahrscheinlichkeit verringert wird, dass ein Endbenutzer oder Administrator speziell gestaltete Webinhalte auf einen Server herunterlädt und dort ausführt. Dies ist ein schadensbegrenzender Faktor für Websites, die nicht zu den vertrauenswürdigen Sites von Internet Explorer hinzugefügt wurden.

**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit für Internet Explorer 9, indem geändert wird, wie Internet Explorer Objekte im Speicher verarbeitet.

**Hinweis:** Dieses Update behebt diese Sicherheitsanfälligkeit nicht für Internet Explorer 8. Für Internet Explorer 8 ist das in [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 verfügbar.

**Internet Explorer 8 ist auf meinem System installiert. Wo finde ich das Update, mit dem CVE-2012-2523 behoben wird?**  
Benutzer, die Internet Explorer 8 auf ihren Systemen installiert haben, können die in CVE-2012-2523 beschriebene Sicherheitsanfälligkeit beheben, indem Sie das in [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) beschriebene Update KB2706045 installieren.

Benutzer, die Internet Explorer 9 auf ihren Systemen installiert haben, müssen das Update KB2706045 nicht installieren, da dieses Update (KB2722913) CVE-2012-2523 auf Systemen behebt, auf denen Internet Explorer 9 ausgeführt wird.
...
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2722913$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 für alle unterstützten Editionen von Windows XP:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie7updates\KB2722913-IE7\spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 für alle unterstützten Editionen von Windows XP:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie8updates\KB2722913-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2722913">Microsoft Knowledge Base-Artikel 2722913</a>.</td>
</tr>
<tr class="even">
...
-   GWSlabs in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Layout (CVE-2012-1526).  
-   Derek Soeder in Zusammenarbeit mit dem Programm [Beyond Security's SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Zugriff auf asynchrones NULL-Objekt (CVE-2012-2521).  
-   Sung-ting Tsai und Ming-Chieh Pan von [Trend Micro](https://www.trendmicro.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Beschädigung der virtuellen Funktionstabelle (CVE-2012-2522).  
-   Cris Neckar vom [Google's Chrome Security Team](https://chrome.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript (CVE-2012-2523).
...
-   V1.1 (15. August 2012): Fehlerhafte häufig gestellte Fragen (FAQs) zur Veröffentlichung von Windows 8 Release Preview und Windows Server 2012 Release Candidate wurden entfernt. Die Veröffentlichung von Windows 8 Release Preview und Windows Server 2012 Release Candidate sind nicht von den in diesem Bulletin beschriebenen Sicherheitsanfälligkeiten betroffen.  
-   V1.2 (17. Juli 2013): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2722913 hinzugefügt.
