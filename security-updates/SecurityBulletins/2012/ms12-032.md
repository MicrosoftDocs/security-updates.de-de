...
<td style="border:1px solid black;">
KB2588516 in [MS11-083](http://go.microsoft.com/fwlink/?linkid=229071) wird durch KB2688338 ersetzt
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0174](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179).
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2688338">Microsoft Knowledge Base-Artikel 2688338</a>.</td>
</tr>
<tr class="odd">
...
-   Bojan Zdrnja von [INFIGO IS](http://www.infigo.hr/) für den Hinweis auf die Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall (CVE-2012-0174).  
-   Anatoliy Glagolev von [Genesys Telecommunications](http://www.genesyslab.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP (CVE-2012-0179).
