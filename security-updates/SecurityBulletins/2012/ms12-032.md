---
TOCTitle: 'MS12-032'
Title: 'Microsoft Security Bulletin MS12-032 - Hoch'
ms:assetid: 'ms12-032'
ms:contentKeyID: 61224851
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-032(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-032 - Hoch
===========================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie die Windows-Firewall ausgehende Broadcastpakete verarbeitet, und indem geändert wird, wie der Windows TCP/IP-Stapel das Binden einer IPv6-Adresse an eine lokale Schnittstelle verarbeitet. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;">
KB2588516 in [MS11-083](https://go.microsoft.com/fwlink/?linkid=229071) wird durch KB2688338 ersetzt
</td>
</tr>
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall – CVE-2012-0174
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP – CVE-2012-0179
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
In Windows liegt eine Sicherheitsanfälligkeit durch Umgehung der Sicherheitsfunktion vor, die dadurch verursacht wird, wie die Windows-Firewall ausgehende Broadcastpakete verarbeitet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann den Tiefenverteidigungsmechanismus Windows-Firewall umgehen, um die Ausnutzung anderer Sicherheitsanfälligkeiten zu erleichtern.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0174](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall – CVE-2012-0174

Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.

#### Problemumgehungen für die Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall – CVE-2012-0174

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall – CVE-2012-0174

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Dies ist eine Sicherheitsanfälligkeit aufgrund der Umgehung von Sicherheitsfunktionen. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die Windows-Firewall umgehen, um die Ausnutzung anderer Sicherheitsanfälligkeiten zu erleichtern.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass die Windows-Firewall ausgehende Broadcastpakete nicht richtig filtert, wobei eine ausgehende Firewallregel gilt.

**Welche** **Komponente ist von dieser Sicherheitsanfälligkeit betroffen?**  
Die von dieser Sicherheitsanfälligkeit betroffene Komponente ist der TCP/IP-Stapel (tcpip.sys).
...
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die Windows-Firewall umgehen. Ein Angreifer kann dann eine andere Sicherheitsanfälligkeit ausnutzen, um Informationen zum Zielsystem zu erlangen oder Code auf dem Zielsystem auszuführen.

**Wie gehen Angreifer vor, um diese** **Sicherheitsanfälligkeit** **auszunutzen?**  
Um diese Sicherheitsanfälligkeit auszunutzen, muss ein Angreifer zunächst Zugang zum lokalen Subnetz des Zielcomputers erhalten. Ein Angreifer kann dann eine andere Sicherheitsanfälligkeit ausnutzen, um Informationen zum Zielsystem zu erlangen oder Code auf dem Zielsystem auszuführen.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Von dieser Sicherheitsanfälligkeit sind in erster Linie Arbeitsstationen und Server betroffen.

**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie die Windows-Firewall ausgehende Broadcastpakete verarbeitet.

**Wie lautet die standardmäßige ausgehende Firewallrichtlinie?**  
Die standardmäßige ausgehende Firewallrichtlinie ist darauf konfiguriert, jeglichen ausgehenden Netzwerkverkehr vom Host zu ermöglichen. Um unerwünschten ausgehenden Netzwerkverkehr zu blockieren, müssen Benutzer Firewallregeln erstellen, um Datenverkehr zu blockieren. Weitere Informationen zum Hinzufügen ausgehender Firewallregeln finden Sie im TechNet-Artikel [Erstellen von Regeln zum Blockieren von unerwünschtem ausgehendem Netzwerkdatenverkehr](https://technet.microsoft.com/en-us/library/cc732306(v=ws.10).aspx).
...
Im Windows TCP/IP-Stapel liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die Windows 7 und Windows Server 2008 R2 betrifft. Alle Editionen von Microsoft Windows XP, Windows Server 2003, Windows Vista und Windows Server 2008 sind nicht betroffen. Diese Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows TCP/IP-Stapel das Binden von IPv6-Adressen nicht richtig verarbeitet.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP – CVE-2012-0179
...
#### Problemumgehungen für die Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP – CVE-2012-0179

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP – CVE-2012-0179

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows TCP/IP-Stapel das Binden einer IPv6-Adresse an eine lokale Schnittstelle nicht richtig verarbeitet.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie der Windows TCP/IP-Stapel das Binden einer IPv6-Adresse an eine lokale Schnittstelle verarbeitet.

**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2688338">Microsoft Knowledge Base-Artikel 2688338</a>.</td>
</tr>
<tr class="odd">
...
-   Bojan Zdrnja von [INFIGO IS](https://www.infigo.hr/) für den Hinweis auf die Sicherheitsanfälligkeit durch Umgehung der Windows-Firewall (CVE-2012-0174).  
-   Anatoliy Glagolev von [Genesys Telecommunications](https://www.genesyslab.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit durch doppelte Freigabe in TCP/IP (CVE-2012-0179).
...
-   V1.1 (9. Mai 2012): Im Abschnitt **Informationen zu Sicherheitsanfälligkeiten** wurden die schadensbegrenzenden Faktoren für CVE-2012-0174 und CVE-2012-0179 korrigiert.
