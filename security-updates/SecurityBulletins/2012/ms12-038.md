---
TOCTitle: 'MS12-038'
Title: 'Microsoft Security Bulletin MS12-038 - Kritisch'
ms:assetid: 'ms12-038'
ms:contentKeyID: 61224857
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-038(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-038 - Kritisch
===============================================

Sicherheitsanfälligkeit in .NET Framework bezüglich Überprüfung der Parameter (2706726)
---------------------------------------------------------------------------------------
...
**Sind Microsoft .NET Framework 3.5 und Microsoft .NET Framework 4.5 unter Windows Consumer Preview und Microsoft .NET Framework 4.5 Consumer Preview von dieser Sicherheitsanfälligkeit betroffen?**  
Ja. Diese Sicherheitsanfälligkeit wurde nach der Veröffentlichung von Windows Consumer Preview und Microsoft .NET Framework 4.5 Consumer Preview gemeldet. Benutzer, die Consumer Preview-Software ausführen, sind angehalten, das Update auf ihre Systeme herunterzuladen und zu installieren. Weitere Informationen, einschließlich Links zum Microsoft Download Center, finden Sie in den folgenden Microsoft Knowledge Base-Artikeln:

| Betroffene Software                                                                                           | Microsoft Knowledge Base-Artikel                                                    |
|---------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Microsoft .NET Framework 3.5 unter Windows Consumer Preview                                                   | [Microsoft Knowledge Base-Artikel 2686868](https://support.microsoft.com/kb/2686868) |
| Microsoft .NET Framework 4.5 unter Windows Consumer Preview                                                   | [Microsoft Knowledge Base-Artikel 2686837](https://support.microsoft.com/kb/2686837) |
| Microsoft .NET Framework 4.5 Consumer Preview unter Windows Server 2008, Windows 7 und Windows Server 2008 R2 | [Microsoft Knowledge Base-Artikel 2686838](https://support.microsoft.com/kb/2686838) |
...
**Sind Microsoft .NET Framework 3.5 und Microsoft .NET Framework 4.5 unter Windows Release Preview sowie Windows RT und Microsoft .NET Framework 4.5 Release Candidate von dieser Sicherheitsanfälligkeit betroffen?**  
Nein. Die Sicherheitsanfälligkeit wurde vor der Veröffentlichung von Windows Release Preview, Windows RT und Microsoft .NET Framework 4.5 Release Candidate gemeldet. Die Problembehebung für die in diesem Security Bulletin behandelte Sicherheitsanfälligkeit wurde also in jenen Veröffentlichungen abgedeckt.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherzugriffs – CVE-2012-1855
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
In Microsoft .NET Framework liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung aufgrund der fehlerhaften Ausführung eines Funktionszeigers vor. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1855](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1855).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherzugriffs – CVE-2012-1855
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherzugriffs – CVE-2012-1855
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherzugriffs – CVE-2012-1855
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie .NET Framework Daten überprüft, die an Funktionszeiger übergeben werden.
...
Weitere Informationen finden Sie unter [System Center Configuration Manager](https://go.microsoft.com/fwlink/?linkid=21158).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2706726">Microsoft Knowledge Base-Artikel 2706726</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 unter allen unterstützten 32-Bit-Editionen von Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 2.0 Service Pack 2 unter allen unterstützten x64-basierten Editionen von Windows XP Professional:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 4 unter allen unterstützten x64-basierten Editionen von Windows XP Professional:<br />
...
-   Vitaliy Toropov in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in .NET Framework bezüglich Speicherzugriffs (CVE-2012-1855).
...
-   V1.0 (12. Juni 20012): Bulletin veröffentlicht.
