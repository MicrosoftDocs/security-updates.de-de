...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527).
...
Der Aktenkoffer ist eine Funktion in Windows, mit der die Inhalte von zwei Ordnern synchronisiert werden. Der Aktenkoffer hilft Benutzern, Ordner zwischen Geräten wie USB-Sticks und Computern zu synchronisieren. Weitere Informationen finden Sie in [Synchronisierung mithilfe des Aktenkoffers](https://windows.microsoft.com/en-us/windows7/sync-using-briefcase).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2727528">Microsoft Knowledge Base-Artikel 2727528</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2727528](https://support.microsoft.com/kb/2727528).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tal Zeltzer in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Ganzzahlunterlauf in Windows Aktenkoffer (CVE-2012-1527).  
-   Tal Zeltzer in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Ganzzahlüberlauf in Windows Aktenkoffer (CVE-2012-1528).
