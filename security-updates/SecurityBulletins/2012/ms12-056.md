---
TOCTitle: 'MS12-056'
Title: 'Microsoft Security Bulletin MS12-056 - Hoch'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61224875
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms12-056(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-056 - Hoch
===========================================
...
Dieses Sicherheitsupdate wird für JScript 5.8 und VBScript 5.8 auf 64-Bit Windows-Clients als Wichtig eingestuft. Dieses Sicherheitsupdate wird für JScript 5.8 und VBScript 5.8 auf 64-Bit Windows-Servern als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie JScript und VBScript Objekte im Speicher verarbeiten. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Niedrig</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Niedrig</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 und VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Niedrig</td>
<td style="border:1px solid black;">KB2510531 in <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> wird durch KB2706045 ersetzt</td>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2706045](https://support.microsoft.com/kb/2706045).
...
**In welcher Beziehung steht dieses Sicherheitsupdate zu MS12-052?**  
Die in diesem Bulletin beschriebene Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript (CVE-2012-2523) wird auch von [MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) behoben.

Benutzer, die Internet Explorer 8 auf ihren Systemen installiert haben, müssen das in diesem Bulletin beschriebene Update KB2706045 installieren, um vor der in CVE-2012-2523 beschriebenen Sicherheitsanfälligkeit geschützt zu sein.

Benutzer, die Internet Explorer 9 auf ihren Systemen installiert haben, müssen das in [MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) beschriebene Update KB2722913 installieren, um vor der in CVE-2012-2523 beschriebenen Sicherheitsanfälligkeit geschützt zu sein.

**Wie ermittle ich, welche Versionen der Skriptmodule JScript und VBScript auf meinem System installiert sind?**  
Internet Explorer 8, Internet Explorer 9 und Internet Explorer 10 beinhalten die Skriptmodule JScript 5.8 und VBScript 5.8. Das Updatepaket KB2706045 aktualisiert die JScript- und VBScript-Versionen von Internet Explorer 8. Das in MS12-052 beschriebene Updatepaket KB2722913 aktualisiert die Versionen in Internet Explorer 9. Die Versionen von Internet Explorer 10 sind bereits auf dem neuesten Stand und müssen nicht aktualisiert werden.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Ganzzahlüberlauf in JavaScript – CVE-2012-2523</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Hoch</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Hoch</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Server 2008 für x64-basierte Systeme Service Pack 2</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows 7 für x64-basierte Systeme</td>
<td style="border:1px solid black;"><strong>Hoch</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows 7 für x64-basierte Systeme Service Pack 1</td>
<td style="border:1px solid black;"><strong>Hoch</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Server 2008 R2 für x64-basierte Systeme</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 auf Windows Server 2008 R2 für Itanium-basierte Systeme</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter Windows Server 2008 R2 für Itanium-basierte Systeme Service Pack 1</td>
<td style="border:1px solid black;"><strong>Niedrig</strong><br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Niedrig</strong></td>
</tr>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie die Skriptmodule JScript und VBScript die Größe eines Objekts im Speicher berechnen. Die Sicherheitsanfälligkeit kann den Speicher so beschädigen, dass ein Angreifer im Kontext des aktuellen Benutzers beliebigen Code ausführen kann. Wenn der aktuelle Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
...
Die Sicherheitsanfälligkeit wird verursacht, wenn das JScript-Modul während eines Kopiervorgangs die Größe eines Objekts im Speicher falsch berechnet.
...
Systeme, auf denen Internet Explorer 8 und Internet Explorer 9 häufig verwendet werden, z. B. Arbeitsstationen oder Terminalserver, sind am stärksten durch diese Sicherheitsanfälligkeit gefährdet.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie JScript und VBScript Objekte im Speicher verarbeiten.
...
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows XP:<br />
...
<td style="border:1px solid black;">Für JScript 5.8 und VBScript 5.8: KB2706045-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Für JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows XP:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie8updates\KB2706045-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2706045">Microsoft Knowledge Base-Artikel 2706045</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows Server 2003:<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installieren ohne neu zu starten</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation</strong></td>
<td style="border:1px solid black;">Für JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows Server 2003:<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\ie8updates\KB2706045-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows Vista:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows Server 2008:<br />
IE8-Windows6.0-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installieren ohne neu zu starten</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows 7:<br />
...
#### Windows Server 2008 R2 (64-Bit-Editionen)
...
<tr class="odd">
<td style="border:1px solid black;">Installieren ohne Benutzereingriff</td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten x64-basierten Editionen von Windows Server 2008 R2:<br />
Windows6.1-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 und VBScript 5.8 unter allen unterstützten Itanium-basierten Editionen von Windows Server 2008 R2:<br />
