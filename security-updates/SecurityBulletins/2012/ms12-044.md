...
<td style="border:1px solid black;">
KB2699988 in [MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) wird durch KB2719177 ersetzt
</td>
</tr>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2719177](https://support.microsoft.com/kb/2719177).
...
Ja. Das Update KB2719177 ist für Windows 8 Consumer Preview und Windows Server 2012 Consumer Preview verfügbar. Benutzer mit Windows 8 Consumer Preview und Windows Server 2012 Consumer Preview sind angehalten, die Updates auf ihren Systemen zu installieren. Die Updates sind nur auf [Windows-Update](https://update.microsoft.com/windowsupdate/) verfügbar.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1522).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1524).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2719177">Microsoft Knowledge Base-Artikel 2719177</a>.</td>
</tr>
<tr class="odd">
...
-   Jose A. Vazquez von spa-s3c.blogspot.com in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch zwischengespeichertes Objekt (CVE-2012-1522).  
-   Omair in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Remotecodeausführung durch Attributentfernung (CVE-2012-1524).
