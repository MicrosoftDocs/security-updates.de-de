...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1537](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1537).
...
5.  Stellen Sie sicher, dass das Kontrollkästchen **Öffnen** für die folgenden Dateitypen ausgewählt ist:  
    ...
    &ndash; Word 2003-Dokumente und -Vorlagen
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2770660">Microsoft Knowledge Base-Artikel KB2770660</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel KB2770660](https://support.microsoft.com/kb/2770660).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Aniway](mailto:aniway.anyway@gmail.com) in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in DirectPlay bezüglich Heapüberlaufs (CVE-2012-1537).
