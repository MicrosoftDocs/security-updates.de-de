...
<td style="border:1px solid black;">
KB958644 in [MS08-067](https://go.microsoft.com/fwlink/?linkid=130719) wird durch KB2705219 ersetzt
</td>
</tr>
...
<td style="border:1px solid black;">
KB961501 in [MS09-022](https://go.microsoft.com/fwlink/?linkid=141786) wird durch KB2712808 ersetzt
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=354e502b-3016-4c5e-8611-bc1b35e1a7eb) (Server Core-Installation)  
(KB2705219)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=35fb03b1-162a-4552-8bb9-6b564acbd57b) (Server Core-Installation)  
(KB2712808)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2b8a730c-46ac-49b7-b9ae-73062d5a79f2) (Server Core-Installation)  
(KB2705219)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e89024ca-a9e8-4ebf-91eb-cbf8e05398e7) (Server Core-Installation)  
(KB2712808)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175) (Server Core-Installation)  
(KB2705219)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a) (Server Core-Installation)  
(KB2712808)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175) (Server Core-Installation)  
(KB2705219)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a) (Server Core-Installation)  
(KB2712808)
</td>
<td style="border:1px solid black;">
DoS (Denial of Service)
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2733594](https://support.microsoft.com/kb/2733594).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1850](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850).
...
Das Remote Administration Protocol (RAP) verarbeitet administrative Funktionen, die Aufgaben wie die Wartung von Freigaben und die Druckerwartung auf LAN-Manager-Servern umfassen. Weitere Informationen finden Sie in [\[MS-RAP\]: Spezifikation Remote Administration Protocol](https://msdn.microsoft.com/en-us/library/cc240191(v=prot.13)).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1851](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1852](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2012-1853](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2705219">Microsoft Knowledge Base-Artikel 2705219</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2712808">Microsoft Knowledge Base-Artikel 2712808</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2705219](https://support.microsoft.com/kb/2705219).  
Siehe [Microsoft Knowledge Base-Artikel 2712808](https://support.microsoft.com/kb/2712808).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2705219">Microsoft Knowledge Base-Artikel 2705219</a>.<strong><br />
</strong>Siehe <a href="https://support.microsoft.com/kb/2712808">Microsoft Knowledge Base-Artikel 2712808</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Denial-of-Service im Remote Administration Protocol (CVE-2012-1850).  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Druckerwarteschlangendienst durch Formatzeichenfolge (CVE-2012-1851).  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs im Remote Administration Protocol (CVE-2012-1852).  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Stapelüberlaufs im Remote Administration Protocol (CVE-2012-1853).
