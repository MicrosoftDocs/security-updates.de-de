...
<td style="border:1px solid black;">
2646524 in [MS12-003](https://technet.microsoft.com/de-de/security/bulletin/ms12-003)
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1295](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1295).
...
Unter Windows XP, Windows Vista und Windows Server 2008 kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, bewirken, dass das System nicht mehr reagiert, bis es neu gestartet wird.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2820917">Microsoft Knowledge Base-Artikel 2820917</a>.</td>
</tr>
<tr class="even">
