...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2790655](https://support.microsoft.com/kb/2790655) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2688338 in [MS12-032](https://technet.microsoft.com/de-de/security/bulletin/ms12-032)
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2790655">Microsoft Knowledge Base-Artikel 2790655</a>.</td>
</tr>
<tr class="odd">
...
| **Dateiinformationen**                   | Siehe [Microsoft Knowledge Base-Artikel 2790655](https://support.microsoft.com/kb/2790655).                                                                                                                                         |
