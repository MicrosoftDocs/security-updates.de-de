---
TOCTitle: 'MS13-001'
Title: 'Microsoft Security Bulletin MS13-001 - Kritisch'
ms:assetid: 'ms13-001'
ms:contentKeyID: 61224903
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms13-001(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-001 - Kritisch
===============================================

Sicherheitsanfälligkeit in Komponenten der Windows-Druckwarteschlange kann Remotecodeausführung ermöglichen (2769369)
---------------------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 8. Januar 2013
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows 7 und Windows Server 2008 R2 als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Windows Druckwarteschlange speziell gestaltete Druckaufträge verarbeitet. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2769369](https://support.microsoft.com/kb/2769369).

**Ich führe Windows Server 2008 R2 (Server Core-Installation) aus, die in der Tabelle „Betroffene Software“ aufgeführt ist. Warum wird mir das Update KB2769369 nicht angeboten?**  
Das Update KB2769369 wird nur Systemen mit Server Core-Installation von Windows Server 2008 R2 angeboten, wenn die Einstellung Printing-ServerCore-Rolle aktiviert ist.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Komponenten der Windows-Druckwarteschlange – CVE-2013-0011
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Es liegt eine Sicherheitsanfälligkeit vor, die dadurch verursacht wird, wie Microsoft Windows speziell gestaltete Druckaufträge verarbeitet. Durch die Sicherheitsanfälligkeit kann der Speicher in einer solchen Weise beschädigt werden, dass ein Angreifer beliebigen Code ausführen kann.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0011).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Komponenten der Windows-Druckwarteschlange – CVE-2013-0011
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Komponenten der Windows-Druckwarteschlange – CVE-2013-0011
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Komponenten der Windows-Druckwarteschlange – CVE-2013-0011

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit wird verursacht, wenn ein speziell gestalteter Druckauftrag nicht richtig in der Windows-Druckwarteschlange verarbeitet wird.
...
Ein nicht authentifizierter Remoteangreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er einen speziell gestalteten Druckauftrag an den Druckserver sendet.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Von dieser Sicherheitsanfälligkeit sind in erster Linie Arbeitsstationen und Server betroffen.

**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Windows-Druckwarteschlange speziell gestaltete Druckaufträge verarbeitet.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2769369">Microsoft Knowledge Base-Artikel 2769369</a>.</td>
</tr>
<tr class="odd">
