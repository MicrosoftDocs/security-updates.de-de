...
<td style="border:1px solid black;">
979909 in [MS10-041](https://technet.microsoft.com/de-de/security/bulletin/ms10-041)
</td>
</tr>
...
<td style="border:1px solid black;">
979910 in [MS10-041](https://technet.microsoft.com/de-de/security/bulletin/ms10-041)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1336](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1336).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1337).

#### Schadensbegrenzende Faktoren

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Standardmäßig ist der WCF-Authentifizierungsmodus in der Eigenschaft [userNamePasswordValidationMode](https://msdn.microsoft.com/en-us/library/system.servicemodel.security.usernamepasswordservicecredential.usernamepasswordvalidationmode.aspx), die nicht anfällig ist, auf „Windows“ gesetzt.

#### Problemumgehungen

Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:

-   [netHttpBinding](https://msdn.microsoft.com/library/system.servicemodel.nethttpbinding) mit [TransportWithMessageCredential](https://msdn.microsoft.com/library/ms789011) statt [netHttpsBinding](https://msdn.microsoft.com/library/system.servicemodel.nethttpsbinding) verwenden
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass .NET Framework beim Einrichten benutzerdefinierter WCF-Endpunktauthentifizierung, wobei der Parameter [userNamePasswordValidationMode](https://msdn.microsoft.com/library/system.servicemodel.security.usernamepasswordservicecredential.usernamepasswordvalidationmode) verwendet wird, der für die Klassen [netHttpsBinding](https://msdn.microsoft.com/library/system.servicemodel.nethttpsbinding) bzw. [basicHttpsBinding](https://msdn.microsoft.com/library/system.servicemodel.basichttpsbinding) spezifisch ist, die Richtlinienanforderungen für die Authentifizierung nicht richtig erstellt.

**Was ist WCF?**  
WCF (Windows Communication Foundation) ist das einheitliche Programmiermodell von Microsoft zum Erstellen diensteorientierter Anwendungen, mit denen Entwickler sichere, zuverlässige, transaktionsgebundene Lösungen erstellen können, die plattformübergreifend integriert werden und mit vorhandenen Investitionen zusammenarbeiten können. Weitere Informationen zu WCF finden Sie unter [Windows Communication Foundation](https://msdn.microsoft.com/de-de/library/dd456779.aspx).
...
KB2804576\_\*\_\*-Microsoft .NET Framework 4 Client Profile-MSP0.txt<br />
KB2804576\_\*\_\*.html</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2836440">Microsoft Knowledge Base-Artikel 2836440</a>.</td>
</tr>
<tr class="even">
...
KB2804582\_\*\_\*-Microsoft .NET Framework 4.5-MSP0.txt<br />
KB2804582\_\*\_\*.html</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Neustartanforderung</strong></td>
...
| **Dateiinformationen**               | Siehe [Microsoft Knowledge Base-Artikel 2836440](https://support.microsoft.com/kb/2836440).                                                                                                                                             |
