...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2769327](https://support.microsoft.com/kb/2769327) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2769327](https://support.microsoft.com/kb/2769327).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005).
...
-   **Anfordern der Authentifizierung von Clients, die eine Verbindung zu IIS herstellen**
    ...
    Weitere Informationen zu IIS 7 finden Sie unter [Konfigurieren der Authentifizierung in IIS 7](https://technet.microsoft.com/en-us/library/cc733010(v=ws.10).aspx)

    Weitere Informationen zu IIS 6.0 finden Sie unter [Integrierte Windows-Authentifizierung in IIS 6.0](https://technet.microsoft.com/en-us/library/cc738016(v=ws.10).aspx)
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2736416">Microsoft Knowledge Base-Artikel 2736416</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2736428">Microsoft Knowledge Base-Artikel 2736428</a>.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2736418">Microsoft Knowledge Base-Artikel 2736418</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2736422">Microsoft Knowledge Base-Artikel 2736422</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2736428">Microsoft Knowledge Base-Artikel 2736428</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2736693">Microsoft Knowledge Base-Artikel 2736693</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2736693">Microsoft Knowledge Base-Artikel 2736693</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2753596">Microsoft Knowledge Base-Artikel 2753596</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Microsoft .NET Framework 3.5:<br />
