...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1332](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1332).
...
Dxgkrnl.sys ist das Kernel-Subsystem von Microsoft DirectX. Es ist ein Kernelmodustreiber, der vom Miniport-Treiber der Anzeige aufgerufen wird, um eine [DXGKRNL\_INTERFACE](http://msdn.microsoft.com/en-us/library/windows/hardware/ff560942%28v=vs.85%29.aspx)-Struktur an die Funktion [DxgkDdiStartDevice](http://msdn.microsoft.com/en-us/library/windows/hardware/ff560775%28v=vs.85%29.aspx) des Miniport-Treibers der Anzeige weiterzugeben.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1333](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1333).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1334](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1334).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2829361">Microsoft Knowledge Base-Artikel 2829361</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2830290">Microsoft Knowledge Base-Artikel 2830290</a>.<br />
Siehe <a href="http://support.microsoft.com/kb/2829361">Microsoft Knowledge Base-Artikel 2829361</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des</strong> <strong>Registrierung</strong> <strong>sschlüssels</strong></td>
