...
<td style="border:1px solid black;">
KB2567680 in [MS11-063](https://technet.microsoft.com/de-de/security/bulletin/ms11-063)
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0076](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2013-0076](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2790113">Microsoft Knowledge Base-Artikel 2790113</a>.</td>
</tr>
<tr class="odd">
