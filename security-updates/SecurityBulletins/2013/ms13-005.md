---
TOCTitle: 'MS13-005'
Title: 'Microsoft Security Bulletin MS13-005 - Hoch'
ms:assetid: 'ms13-005'
ms:contentKeyID: 61224907
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms13-005(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-005 - Hoch
===========================================

Sicherheitsanfälligkeit in Windows-Kernelmodustreiber kann Erhöhung von Berechtigungen ermöglichen (2778930)
------------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 8. Januar 2013 | Aktualisiert: Dienstag, 12. Februar 2013
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2778930](https://support.microsoft.com/kb/2778930) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2779030 in [MS12-078](https://technet.microsoft.com/de-de/security/bulletin/ms12-078) wird durch KB2778930 ersetzt
</td>
</tr>
...
Anhand der Hashes SHA1 und SHA2 der Sicherheitsupdates kann die Echtheit der heruntergeladenen Sicherheitsupdatepakete überprüft werden. Weitere Informationen zu Hashes, die dieses Update betreffen, finden Sie im [Microsoft Knowledge Base-Artikel 2778930](https://support.microsoft.com/kb/2778930).
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Win32k durch fehlerhafte Nachrichtenverarbeitung – CVE-2013-0008
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, wenn der Windows-Kernel Windows-Broadcastmeldungen falsch verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0008).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Win32k durch fehlerhafte Nachrichtenverarbeitung – CVE-2013-0008
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Win32k durch fehlerhafte Nachrichtenverarbeitung – CVE-2013-0008

Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Win32k durch fehlerhafte Nachrichtenverarbeitung – CVE-2013-0008

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows-Kernelmodustreiber Windows-Broadcastmeldungen falsch verarbeitet.
...
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kontext eines Prozesses einer höheren Integritätsebene beliebigen Code ausführen. Wenn ein Benutzer mit administrativen Benutzerberechtigungen angemeldet ist, kann ein Angreifer vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist der Integritätsmechanismus von Windows?**  
Der Integritätsmechanismus von Windows ist eine Kernkomponente der Sicherheitsarchitektur von Windows. Dabei werden mithilfe von Integritätsebenen die Zugriffsberechtigungen von Anwendungen eingeschränkt, die unter demselben Benutzerkonto ausgeführt werden und weniger vertrauenswürdig sind. Die Integritätsebene ist eine Darstellung der Vertrauenswürdigkeit von ausgeführten Anwendungsprozessen und Objekten wie Dateien, die von der Anwendung erstellt werden. Der Integritätsmechanismus stellt Ressourcen-Managern wie dem Dateisystem die Möglichkeit zur Verfügung, vordefinierte Richtlinien zu verwenden, mit denen Prozesse niederer Integrität oder Vertrauenswürdigkeit daran gehindert werden, Objekte höherer Integrität zu lesen oder zu ändern. Durch den Integritätsmechanismus kann das Windows-Sicherheitsmodell neue Zugriffssteuerungseinschränkungen durchsetzen, die nicht definiert werden können, indem in den Zugriffssteuerungslisten (ACLs) Benutzer- oder Gruppenberechtigungen gewährt werden.

**Wie gehen Angreifer vor, um diese** **Sicherheitsanfälligkeit** **auszunutzen?**  
Diese Sicherheitsanfälligkeit erfordert, dass ein Angreifer einen Benutzer dazu verleitet, eine speziell gestaltete Anwendung auszuführen.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows-Kernelmodustreiber Windows-Broadcastmeldungen verarbeitet.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2778930">Microsoft Knowledge Base-Artikel 2778930</a>.</td>
</tr>
<tr class="odd">
...
| **Dateiinformationen**                   | Siehe [Microsoft Knowledge Base-Artikel 2778930](https://support.microsoft.com/kb/2778930).                                                                                                                                         |
...
-   V1.1 (9. Januar 2013): Die Tabellen der Erkennungs- und Bereitstellungszusammenfassung wurde korrigiert. Dies ist lediglich eine Informationsänderung. Benutzer, die ihre Systeme bereits erfolgreich aktualisiert haben, müssen keine Maßnahmen ergreifen.  
-   V1.2 (12. Februar 2013): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2778930 hinzugefügt.
