...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2778930](http://support.microsoft.com/kb/2778930) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2779030 in [MS12-078](http://technet.microsoft.com/de-de/security/bulletin/ms12-078) wird durch KB2778930 ersetzt
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-0008](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0008).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2778930">Microsoft Knowledge Base-Artikel 2778930</a>.</td>
</tr>
<tr class="odd">
...
| **Dateiinformationen**                   | Siehe [Microsoft Knowledge Base-Artikel 2778930](http://support.microsoft.com/kb/2778930).                                                                                                                                         |
