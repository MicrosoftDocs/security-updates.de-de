...
<td style="border:1px solid black;">
2799494 in [MS13-017](http://technet.microsoft.com/de-de/security/bulletin/ms13-017)
</td>
</tr>
...
<td style="border:1px solid black;">
2620712 in [MS11-097](http://go.microsoft.com/fwlink/?linkid=232663) und  
2799494 in [MS13-017](http://technet.microsoft.com/de-de/security/bulletin/ms13-017)
</td>
</tr>
<tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1284).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1294](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1294).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2813170">Microsoft Knowledge Base-Artikel 2813170</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/kb2813170">Microsoft Knowledge Base-Artikel 2813170</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;"><strong>Hinweis</strong> Es ist kein Registrierungsschlüssel vorhanden, um die Anwesenheit dieses Updates zu belegen.</td>
...
| **Dateiinformationen**               | Siehe [Microsoft Knowledge Base-Artikel 2813170](http://support.microsoft.com/kb/kb2813170).                                                                                                                                       |
