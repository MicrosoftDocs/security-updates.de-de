...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2799494](https://support.microsoft.com/kb/2799494) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
KB2724197 in [MS12-068](https://technet.microsoft.com/de-de/security/bulletin/ms12-068)
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2013-1280](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2799494">Microsoft Knowledge Base-Artikel 2799494</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Siehe [Microsoft Knowledge Base-Artikel 2799494](https://support.microsoft.com/kb/2799494).
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **Dateiinformationen**                   | Siehe [Microsoft Knowledge Base-Artikel 2799494](https://support.microsoft.com/kb/2799494).                                                                                                                                         |
...
-   [Gynvael Coldwind](https://gynvael.coldwind.pl/) und [Mateusz “j00 ru“ Jurczyk](https://j00ru.vexillium.org/) von [Google Inc](https://www.google.com) für den Hinweis auf die Sicherheitsanfälligkeit durch Racebedingung im Kernel (CVE-2013-1278).  
-   [Gynvael Coldwind](https://gynvael.coldwind.pl/) und [Mateusz “j00 ru“ Jurczyk](https://j00ru.vexillium.org/) von [Google Inc](https://www.google.com) für den Hinweis auf die Sicherheitsanfälligkeit durch Racebedingung im Kernel (CVE-2013-1279).
