...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=1f063c4a-b0bf-49c6-928b-f1f076c69612)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f7241deb-9e2d-401a-9d71-10acab4450af).
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=594ad01b-f333-4c56-9c12-d1a8b82f2a6e)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=1a4fcfde-e549-4078-a180-076a23cb8bb7)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3ba63af8-3d36-4f3c-bfee-11b62572af73)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=994b14b4-ee98-4b61-bdbe-ca5c20094855)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Shell-Sicherheitsanfälligkeit – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2122">CAN-2005-2122</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Shell-Sicherheitsanfälligkeit – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2118">CAN-2005-2118</a></td>
<td style="border:1px solid black;">Codeausführung von Remotestandorten aus<br />
</td>
<td style="border:1px solid black;">Hoch<br />
</td>
...
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Bezug auf Skripteinschleusung in der Webansicht – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2117">CAN-2005-2117</a></td>
<td style="border:1px solid black;">Codeausführung von Remotestandorten aus<br />
</td>
...
|---------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------|------------------------------------|
| [**MS05-016**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms05-016.mspx) | Ersetzt      | Ersetzt                     | Ersetzt             | Nicht anwendbar                    |
| [**MS05-024**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms05-024.mspx) | Ersetzt      | Nicht anwendbar             | Nicht anwendbar     | Nicht anwendbar                    |
...
-   **Blockieren Sie die TCP-Ports 139 und 445 an der Perimeterfirewall:**  
    Diese Ports werden verwendet, um mit Hilfe des SMB-Protokolls (Server Message Block) eine Verbindung zu initiieren. Durch das Blockieren des ausgehenden SMB-Datenverkehrs an der Perimeterfirewall ist das System besser vor Versuchen geschützt, eine Verbindung mit einem manipulierten Dateiserver außerhalb der Firewall herzustellen. Weitere Informationen zu den verwendeten Ports finden Sie auf der folgenden [Website](https://go.microsoft.com/fwlink/?linkid=21312).
...
-   Cesar Cerudo von [Argeniss](https://www.argeniss.com) für den Hinweis auf die Shell-Sicherheitsanfälligkeit (CAN-2005-2122) sowie die Shell-Sicherheitsanfälligkeit (CAN-2005-2118).
-   Brett Moore von [security-assessment.com](https://www.security-assessment.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Bezug auf Skripteinschleusung in der Webansicht (CAN-2005-2117).
