---
TOCTitle: 'MS05-039'
Title: 'Microsoft Security Bulletin MS05-039 - Kritisch'
ms:assetid: 'ms05-039'
ms:contentKeyID: 61224300
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms05-039(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS05-039 - Kritisch
===============================================
...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9a3bfbdd-62ea-4db2-88d2-415e095e207f).
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=89d90e25-4773-4782-ad06-9b7517bab3c8&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6275d7b7-dab1-47c8-8745-533eb471072c)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=be18d39d-3e4c-4c6f-b841-2ccd8d4c3f50)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=d976316d-3b17-4ad4-9198-513ffdac98e4&displaylang=en)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Plug-and-Play-Sicherheitsanfälligkeit – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-xxxx">CAN-2005-1983</a></td>
<td style="border:1px solid black;">Remotecodeausführung und lokale Erhöhung von Berechtigungen</td>
...
#### Sicherheitsanfälligkeit in Plug-and-Play – CAN-2005-1983:
  
Plug-and-Play weist eine Sicherheitsanfälligkeit auf, die das Ausführen von Code von Remotestandorten aus sowie eine lokale Erhöhung von Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) ermöglichen kann. Wenn ein Angreifer diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann er die vollständige Kontrolle über das betroffene System erlangen.
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Plug-and-Play – CAN-2005-1983:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Plug-and-Play – CAN-2005-1983:
...
**Hinweis:** Wie im Abschnitt „Schadensbegrenzende Faktoren“ erwähnt wird, sind Windows XP Service Pack 2 und Windows Server 2003 hauptsächlich durch lokal angemeldete Benutzer für dieses Problem anfällig. Die folgenden Problemumgehungen sind in erster Linie für ältere Betriebssystemversionen bestimmt, die für anonyme netzwerkbasierte Angriffe anfällig sind.
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Plug-and-Play – CAN-2005-1983:
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**  
  
Diese Sicherheitsanfälligkeit kann die Codeausführung von Remotestandorten aus sowie die lokale Erhöhung von Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) ermöglichen. Unter Windows 2000 könnte ein anonymer Angreifer diese Sicherheitsanfälligkeit von Remotestandorten aus ausnutzen. Unter Windows XP Service Pack 1 können nur authentifizierte Benutzer diese Sicherheitsanfälligkeit von einem Remotestandort aus ausnutzen. Unter Windows XP Service Pack 2 und Windows Server 2003 kann nur der Administrator von Remotestandorten aus auf die betroffene Komponente zugreifen. Deshalb handelt es sich unter Windows XP Service Pack 2 und Windows Server 2003 bei dieser Sicherheitsanfälligkeit ausschließlich um eine lokale Erhöhung von Berechtigungen. Ein anonymer Benutzer kann diese Sicherheitsanfälligkeit unter Windows XP Service Pack 2 and Windows Server 2003 nicht remote ausnutzen.  
...
Ein ungeprüfter Puffer im Plug-and-Play-Dienst.
...
Unter Windows 2000 könnte ein Angreifer versuchen, die Sicherheitsanfälligkeit auszunutzen, indem er eine speziell gestaltete Nachricht erstellt und diese dann an ein betroffenes System sendet. Diese Nachricht könnte daraufhin bewirken, dass das betroffene System Code ausführt. Das wäre unter Windows XP Service Pack 1 nur durch authentifizierte Benutzer von Remotestandorten aus möglich. Unter Windows XP Service Pack 2 und Windows Server 2003 muss sich der Angreifer zum Ausnutzen dieser Sicherheitsanfälligkeit lokal bei einem System anmelden und dann eine speziell gestaltete Anwendung ausführen können.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Hauptsächlich Windows 2000-Systeme sind durch diese Sicherheitsanfälligkeit gefährdet. Unter Windows XP Service Pack 1, Windows XP Service Pack 2 und Windows Server 2003 benötigt der Angreifer gültige Anmeldeinformationen, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann unter Windows XP Service Pack 1, Windows XP Service Pack 2 und Windows Server 2003 nicht remote von anonymen Benutzern ausgenutzt werden.
  
**Kann diese Sicherheitsanfälligkeit über das Internet ausgenutzt werden?**  
Ja, von anonymen Benutzern unter Windows 2000 und von authentifizierten Benutzern unter Windows XP Service Pack 1. Mit Hilfe bewährter Methoden für die Firewall und standardisierten Firewallkonfigurationen können Sie sich vor Remoteangriffen aus dem Internet schützen. Microsoft stellt Informationen darüber zur Verfügung, wie Sie Ihren PC schützen können.
...
Unter Windows XP Service Pack 2 und Windows Server 2003 muss ein Angreifer in der Lage sein, sich am jeweiligen System anzumelden, das angegriffen werden soll. Ein anonymer Angreifer kann diese Sicherheitsanfälligkeit nicht ausnutzen, um von einem Remotestandort aus ein Programm zu laden und auszuführen.
  
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem sichergestellt wird, dass der Plug-and-Play-Dienst die Länge einer Nachricht einwandfrei überprüft, bevor diese an den zugewiesenen Puffer übergeben wird. Darüber hinaus schränkt das Update unter Windows 2000 den anonymen Zugriff auf die betroffenen Komponenten ein, indem von den Benutzer verlangt wird, sich vor der Remotenutzung dieser Funktion bei der betroffenen Komponente zu authentifizieren. Diese Änderung entspricht den Standardeinstellungen in Windows XP Service Pack 1.
...
**Hinweis:** Durch die Verwendung der Installationsoption **/quiet** werden alle Meldungen unterdrückt. Dies gilt auch für Fehlermeldungen. Bei Verwendung der Installationsoption **/quiet** sollten Administratoren anhand einer der empfohlenen Methoden überprüfen, ob die Installation erfolgreich war. Administratoren sollten bei Verwendung dieser Option außerdem in der Protokolldatei KB899588.log überprüfen, ob Fehlermeldungen vorliegen.
...
Systemadministratoren können das Dienstprogramm Spuninst.exe zum Entfernen dieses Sicherheitsupdates verwenden. Das Dienstprogramm Spuninst.exe befindet sich im Ordner %Windir%\\$NTUninstallKB899588$\\Spuninst.
...
-   Neel Mehta von [ISS X-Force](https://www.iss.net) für den Hinweis auf die Sicherheitsanfälligkeit in Plug-and-Play (CAN-2005-1983).
-   Jean-Baptiste Marchand von [Herve Schauer Consultants](https://www.hsc.fr) für die Zusammenarbeit hinsichtlich eines Problems, das mit den betroffenen Komponenten in Zusammenhang steht.
