...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3832ff23-6b04-4ca2-80b9-d344b4cc98ea)
...
|---------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|
| Windows-Kernel-Sicherheitsanfälligkeit – [CAN-2005-2827](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2827) | Erhöhung der Berechtigungen            | Hoch         |
...
Bei einem ein asynchronen Prozedurenaufruf (APC) handelt es sich um eine Funktion, die asynchron im Kontext eines bestimmten Threads ausgeführt wird. Weitere Informationen finden Sie auf dieser [Microsoft-Website](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dllproc/base/asynchronous_procedure_calls.asp).
...
-   [eEye Digital Security](https://www.eeye.com/) für den Hinweis auf die Windows-Kernel-Sicherheitsanfälligkeit – (CAN-2005-2827).
