...
|-------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-----------------------|--------------|------------|---------------------|
| Sicherheitsanfälligkeit im Telefoniedienst – [CAN-2005-0058](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0058) | Codeausführung von Remotestandorten aus | Nicht kritisch        | Hoch         | Hoch       | Hoch                |
...
Nein. Obgleich Windows 98, Windows 98 Second Edition und Windows Millennium Edition die betroffene Komponente enthalten, ist die Sicherheitsanfälligkeit für diese Betriebssysteme nicht kritisch. Weitere Informationen zu den Bewertungen des Schweregrads finden Sie auf dieser [Website](https://www.microsoft.com/germany/technet/datenbank/articles/527029.mspx).
...
Diese Sicherheitsanfälligkeit kann je nach Betriebssystemversion und Konfiguration die Codeausführung von Remotestandorten aus oder die Erhöhung lokaler Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) ermöglichen. Weitere Informationen finden Sie im Abschnitt „Häufig gestellte Fragen“ unter der Frage „Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?“. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerberechtigungen erstellen.
...
-   Die Webseite [Microsoft TechNet Sicherheit](https://www.microsoft.com/germany/technet/sicherheit/default.mspx) bietet weitere Informationen zur Sicherheit von Microsoft-Produkten.
