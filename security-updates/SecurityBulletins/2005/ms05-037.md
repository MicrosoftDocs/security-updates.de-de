...
-   JView Profiler
-   Internet Explorer 5.01 Service Pack 4 unter Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=25982e02-ec6d-44ce-82de-12ddef1addd6)
-   Internet Explorer 6 Service Pack 1 unter Microsoft Windows 2000 Service Pack 4 oder unter Microsoft Windows XP Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2a506c16-01ef-4060-bcf8-6993c55840a9)
-   Internet Explorer 6 für Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c1381768-6c6d-4568-97b1-600db8798ebf)
-   Internet Explorer 6 für Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f368e231-9918-4881-9f17-60312f82183f)
-   Internet Explorer 6 für Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium), Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d785f9ab-dbe9-4272-a87e-64205690f98e)
-   Internet Explorer 6 für Microsoft Windows Server 2003 x64 Edition und Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=68209225-a682-4008-a22b-881c401486f7&displaylang=en)
...
<th style="border:1px solid black;" >Internet Explorer 5.5 Service Pack 2 unter Windows ME</th>
<th style="border:1px solid black;" >Internet Explorer 6 Service Pack 1 (alle unterstützten Betriebssystemversionen vor Windows Server 2003)</th>
<th style="border:1px solid black;" >Internet Explorer 6 für Windows Server 2003 und Windows Server 2003 Service Pack 1</th>
<th style="border:1px solid black;" >Internet Explorer 6 für Windows XP Service Pack 2</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in JView Profiler – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2087">CAN-2005-2087</a></td>
...
Nein. Wenn Sie das in der [Sicherheitsempfehlung](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/903144.mspx) vom 5. Juli 2005 genannte Update installiert haben, müssen Sie das vorliegende Sicherheitsupdate nicht mehr anwenden.

**Enthält dieses Update Funktionsänderungen?**  
Nein. Da der Zugriff auf das COM-Objekt JView Profiler nicht über Internet Explorer erfolgen sollte, wird mit diesem Update das [Kill Bit](https://support.microsoft.com/kb/240797) für JView Profiler (Javaprxy.dll) gesetzt. Damit Kunden geschützt sind, die dieses Objekt installiert haben, verhindert das Update, dass das Objekt in Internet Explorer ausgeführt werden kann. Weitere Informationen zu Kill Bits finden Sie im [Microsoft Knowledge Base-Artikel 240797](https://support.microsoft.com/kb/240797). Die Klassenkennung (CLSIDs) für dieses Objekt lautet:
...
Ja. Windows 98, Windows 98 Second Edition und Windows Millennium Edition sind auf kritische Weise von dieser Sicherheitsanfälligkeit betroffen. Diese Sicherheitsupdates stehen auf der Website [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) zum Download zur Verfügung. Weitere Informationen zu den Bewertungen des Schweregrads finden Sie auf dieser [Website](https://www.microsoft.com/germany/technet/datenbank/articles/527029.mspx).
...
JView Profiler ist eine Debugger-Schnittstelle für Microsoft Java Virtual Machine (MSJVM). Weitere Informationen über Microsoft Java Virtual Machine (MSJVM) erhalten Sie auf der Website zu [Microsoft Java Virtual Machine](https://www.microsoft.com/mscorp/java/faq.asp).

**Wie kann ich feststellen, ob die Datei Javaprxy.dll auf meinem Computer vorhanden ist?**  
Sie können entweder direkt nach der Datei suchen oder das [Diagnoseprogramm für Microsoft Java Virtual Machine (MSJVM)](https://www.microsoft.com/download/details.aspx?familyid=4e38f4f9-ce7e-4271-8836-a7d7293a992f&displaylang=de) nutzen. Das Tool steht auch über die Website [Microsoft Java Virtual Machine Support](https://www.microsoft.com/mscorp/java/) zur Verfügung. Mit seiner Hilfe können Sie Systeme sowohl lokal als auch remote nach der MSJVM oder nach zur MSJVM-gehörender Software durchsuchen.
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CAN-2005-2087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2087) zugewiesen.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die allgemeine Nummer für Sicherheitsfälligkeit [CAN-2005-2087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2087) zugewiesen.
...
Bei diesem Update wird dasselbe Installationsprogramm verwendet wie bei früheren Versionen, nämlich Iexpress. Weitere Informationen zu Iexpress finden Sie im [Microsoft Knowledge Base-Artikel 197147](https://support.microsoft.com/kb/197147).
...
Bei diesem Update wird dasselbe Installationsprogramm verwendet wie bei früheren Versionen, nämlich Iexpress. Weitere Informationen zu Iexpress finden Sie im [Microsoft Knowledge Base-Artikel 197147](https://support.microsoft.com/kb/197147). Dieses Sicherheitsupdate unterstützt folgende Installationsoptionen:
