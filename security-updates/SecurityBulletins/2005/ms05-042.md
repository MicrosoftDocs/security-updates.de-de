...
|---------------------------------------------------------------------------------------------------------------------|--------------------------------------------|---------------------------|---------------------|------------|---------------------|
| Kerberos-Sicherheitsanfälligkeit – [CAN-2005-1981](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1981) | DoS (Denial-of-Service)                    | Keine                     | Mittel              | Keine      | Mittel              |
| PKINIT-Sicherheitsanfälligkeit – [CAN-2005-1982](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1982)   | Offenlegung von Informationen und Spoofing | Gering                    | Gering              | Gering     | Gering              |
...
-   Das von einem Angreifer verwendete Konto sowie das vom Ziel dieses Angriffs verwendete Konto müssen beide für Smartcard-Authentifizierung aktiviert sein. Weitere Informationen dazu, wie Sie die Verwendung von Smartcards in Ihrem Unternehmen aktivieren können, finden Sie auf dieser [Website](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/b989f4fd-febd-42e1-a130-9e0f33800734.mspx).
...
-   [Tony Chin](mailto:tony.chin@shell.com) von [Shell, Inc.](https://www.shell.com) für den Hinweis auf die Sicherheitsanfälligkeit bzgl. Kerberos (CAN-2005-1981).
