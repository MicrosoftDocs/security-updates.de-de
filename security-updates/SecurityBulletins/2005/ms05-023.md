...
-   Microsoft Word 2000 und Microsoft Works Suite 2001 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=9f4b6868-2f94-478f-b0bc-0da3e0571523&displaylang=de)
-   Microsoft Word 2002, Microsoft Works Suite 2002, Microsoft Works Suite 2003, and Microsoft Works Suite 2004 - [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=34998255-e004-4a29-9418-35c5818e54cb&displaylang=de)
-   Microsoft Office Word 2003 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=9158279d-4421-4932-9318-02ca829a9b43&displaylang=de)
-   Microsoft Word 2003 Viewer – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf&displaylang=de)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Pufferüberlauf in Microsoft Word <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0963">CAN-2004-0963</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Pufferüberlauf in Microsoft Word <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0558">CAN-2005-0558</a></td>
<td style="border:1px solid black;">Codeausführung von Remotestandorten aus<br />
Erhöhung von Berechtigungen</td>
...
Sie können dieses Update mit Hilfe der auf dieser englischsprachigen [Webseite](https://go.microsoft.com/fwlink/?linkid=33333) beschriebenen Funktionen für Inventur und Softwareverteilung von SMS bereitstellen.
...
Microsoft Works Suite enthält Microsoft Word. Benutzer von Microsoft Works sollten mit [Office Update](https://go.microsoft.com/fwlink/?linkid=21135) das entsprechende Update ermitteln und installieren.
...
-   Office 2000 Service Pack 3 (SP3) oder Microsoft Works 2001 muss installiert sein. Installieren Sie vor diesem Update Office 2000 SP3. Weitere Informationen zum Installieren von Office 2000 SP3 finden Sie im [Microsoft Knowledge Base-Artikel 326585](https://support.microsoft.com/kb/326585).
  
Weitere Informationen zum Ermitteln der auf dem Computer vorhandenen Version von Office finden Sie im [Microsoft Knowledge Base-Artikel 255275](https://support.microsoft.com/kb/255275).
...
1.  [Laden Sie die Clientversion dieses Sicherheitsupdates herunter.](https://download.microsoft.com/download/2/5/f/25fb0117-a114-46df-968e-c76d9cddd3cd/office2000-kb887977-client-enu.exe)  
...
1.  [Klicken Sie auf](https://download.microsoft.com/download/2/5/f/25fb0117-a114-46df-968e-c76d9cddd3cd/office2000-kb887977-fullfile-enu.exe) **Speichern**, und speichern Sie die Updatedatei im Ordner C:\\ADMINUPDATE.  
...
**Hinweis:** Weitere Anleitungen sind im [Microsoft Knowledge Base-Artikel 887977](https://support.microsoft.com/kb/887977) enthalten. Informationen zu diesem Update finden Sie auch auf der [Microsoft Office 2000 Resource Kit-Website](https://office.microsoft.com/en-us/fx011511491033.aspx). Die [Dokumentation zu Windows Installer](https://go.microsoft.com/fwlink/?linkid=21685) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
...
1.  [Laden Sie die Clientversion dieses Sicherheitsupdates herunter.](https://download.microsoft.com/download/3/f/b/3fb3ccec-212b-426e-872c-ec8153e881c4/officexp-kb887978-client-enu.exe)  
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.  
3.  Klicken Sie auf **Speichern**.  
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.  
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.  
...
1.  [Klicken Sie auf](https://download.microsoft.com/download/3/f/b/3fb3ccec-212b-426e-872c-ec8153e881c4/officexp-kb887978-fullfile-enu.exe) **Speichern**, und speichern Sie die Updatedatei im Ordner C:\\ADMINUPDATE.  
2.  Klicken Sie auf **Start** und dann auf **Ausführen**, geben Sie im Feld **Öffnen** den Befehl "cmd" (ohne die Anführungszeichen) ein, und klicken Sie anschließend auf **OK**.  
3.  Geben Sie an der Eingabeaufforderung die folgenden Zeilen ein. Drücken Sie dabei nach jeder Zeile die Eingabetaste:  
    cd c:\\adminupdate  
...
**Hinweis:** Weitere Anleitungen sind im [Microsoft Knowledge Base-Artikel 887978](https://support.microsoft.com/kb/887978) enthalten. Informationen zu diesem Update finden Sie auch auf der [Microsoft Office XP Resource Kit-Website](https://go.microsoft.com/fwlink/?linkid=33339). Die [Dokumentation zu Windows Installer](https://go.microsoft.com/fwlink/?linkid=21685) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
...
Office 2003 (Word 2003) Service Pack 1 muss installiert sein. Installieren Sie vor diesem Update [Office 2003 SP1](https://www.microsoft.com/download/details.aspx?familyid=9c51d3a6-7cb1-4f61-837e-5f938254fc47&displaylang=de). Weitere Informationen zum Installieren von Office 2003 SP1 finden Sie im [Microsoft Knowledge Base-Artikel 842532](https://support.microsoft.com/kb/842532). Das Administratorupdate kann auch auf Systemen installiert werden, auf denen Office 2003 RTM ausgeführt wird.
  
Um weitere Informationen zum Ermitteln der auf dem Computer vorhandenen Version von Office 2003 zu erhalten, lesen Sie den [Microsoft Knowledge Base-Artikel 821549](https://support.microsoft.com/kb/821549).
...
1.  [Laden Sie die Clientversion dieses Sicherheitsupdates herunter.](https://download.microsoft.com/download/2/9/e/29eb1bcc-bed2-42d2-a72e-360622a194a3/office2003-kb887979-client-enu.exe)  
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.  
3.  Klicken Sie auf **Speichern**.  
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.  
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.  
...
1.  [Klicken Sie auf](https://download.microsoft.com/download/2/9/e/29eb1bcc-bed2-42d2-a72e-360622a194a3/office2003-kb887979-fullfile-enu.exe) **Speichern**, und speichern Sie die Updatedatei im Ordner C:\\ADMINUPDATE.  
2.  Klicken Sie auf **Start** und dann auf **Ausführen**, geben Sie im Feld **Öffnen** den Befehl "cmd" (ohne die Anführungszeichen) ein, und klicken Sie anschließend auf **OK**.  
3.  Geben Sie an der Eingabeaufforderung die folgenden Zeilen ein. Drücken Sie dabei nach jeder Zeile die Eingabetaste:  
    cd c:\\adminupdate  
...
**Hinweis:** Weitere Anleitungen sind im [Microsoft Knowledge Base-Artikel 887979](https://support.microsoft.com/kb/887979) enthalten. Informationen zu diesem Update finden Sie auch auf der [Microsoft Office 2003 Resource Kit-Website](https://office.microsoft.com/en-us/fx011511471033.aspx). Die [Dokumentation zu Windows Installer](https://go.microsoft.com/fwlink/?linkid=21685) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
