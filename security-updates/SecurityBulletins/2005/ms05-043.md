---
TOCTitle: 'MS05-043'
Title: 'Microsoft Security Bulletin MS05-043 - Kritisch'
ms:assetid: 'ms05-043'
ms:contentKeyID: 61224304
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms05-043(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS05-043 - Kritisch
===============================================

Sicherheitsanfälligkeit im Druckerwarteschlangendienst kann Codeausführung von Remotestandorten aus ermöglichen (896423)
------------------------------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 9. August 2005 | Aktualisiert: Mittwoch, 18. April 2007
...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 908506](https://support.microsoft.com/kb/908506) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 908506](https://support.microsoft.com/kb/908506).

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=3dd3b530-7f43-4c18-8298-6e8797431a5d&displaylang=de)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=ef402946-1c3b-47e9-9d51-77d890df8725&displaylang=de)
-   Microsoft Windows Server 2003 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=25469675-df28-4889-8d13-25efcd498388&displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=f0aec064-34a3-4ee4-9f15-be1e3dd02bc7&displaylang=de)
...
Dieses Update behebt eine neue, von einem Privatanwender entdeckte Sicherheitsanfälligkeit. Der Druckerwarteschlangendienst weist eine Sicherheitsanfälligkeit auf, die eine Codeausführung von Remotestandorten aus ermöglichen kann. Die Sicherheitsanfälligkeit wird im Abschnitt „Einzelheiten zu dieser Sicherheitsanfälligkeit“ dieses Bulletins dokumentiert.
...
|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|---------------------------|---------------------------|---------------------|
| Sicherheitsanfälligkeit im Druckerwarteschlangendienst – [CAN-2005-1984](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1984) | Remotecodeausführung                   | Kritisch     | Kritisch                  | Mittel                    | Mittel              |
...
[Microsoft Knowledge Base-Artikel 908506](https://support.microsoft.com/kb/908506): Unter Umständen sind Sie nicht in der Lage, auf einem Netzwerkdrucker zu drucken, nachdem Sie das Sicherheitsupdate 896423 auf einem Computer unter Windows 2000 mit Service Pack 4 installiert haben.
...
Weitere Informationen finden Sie unter [Häufig gestellte Fragen zum Supportlebenszyklus für Windows](https://support.microsoft.com/default.aspx?scid=fh;%5bln%5d;lifewinfaq).
...
Ja. MBSA 1.2.1 kann feststellen, ob dieses Update erforderlich ist. Weitere Informationen zu MBSA finden Sie auf der [MBSA-Website](https://www.microsoft.com/germany/technet/sicherheit/tools/mbsa/2_0.mspx).
**Kann ich mit dem Microsoft Baseline Security Analyzer (MBSA) 2.0 überprüfen, ob dieses Update erforderlich ist?**  
Ja. MBSA 2.0 kann feststellen, ob dieses Update erforderlich ist. MBSA 2.0 erkennt erforderliche Sicherheitsupdates für von Microsoft Update unterstützte Produkte. Weitere Informationen zu MBSA finden Sie auf der [MBSA-Website](https://www.microsoft.com/germany/technet/sicherheit/tools/mbsa/2_0.mspx).
...
#### Sicherheitsanfälligkeit im Druckerwarteschlangendienst – CAN-2005-1984:

Eine Sicherheitsanfälligkeit im Druckerwarteschlangendienst kann die Codeausführung von Remotestandorten aus ermöglichen. Wenn ein Angreifer diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann er die vollständige Kontrolle über das betroffene System erlangen.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Druckerwarteschlangendienst – CAN-2005-1984:

-   Unter Windows XP Service Pack 2 und Windows Server 2003 ist diese Sicherheitsanfälligkeit auf authentifizierte Benutzer beschränkt. Außerdem muss ein lokaler Benutzer mit den entsprechenden Berechtigungen zunächst einen Drucker freigeben oder versuchen, die Verbindung zu einem freigegebenen Drucker herzustellen, bevor dieses Problem zu dem Risiko eines Remoteangriffs führen kann. Wenn kein Benutzer mit den entsprechenden Berechtigungen einen Drucker freigibt oder versucht, die Verbindung zu einem freigegebenen Drucker herzustellen, muss ein Angreifer über gültige Anmeldeinformationen verfügen und sich lokal anmelden können, um diese Sicherheitsanfälligkeit ausnutzen zu können.
-   Unter Windows XP Service Pack 2 und Windows Server 2003 würde dies zu einem Denial-of-Service führen. Diese Sicherheitsanfälligkeit kann unter Windows XP Service Pack 2 und Windows Server 2003 nicht zur Codeausführung von Remotestandorten oder Erhöhung von Berechtigungen ausgenutzt werden.
    Auf anderen Betriebssystemen führen Angriffe, die eine Ausnutzung dieser Sicherheitsanfälligkeit versuchen, höchstwahrscheinlich zu einem Denial-of-Service. Eine Remotecodeausführung aus ist jedoch ebenfalls möglich.
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Druckerwarteschlangendienst – CAN-2005-1984:
...
-   **Entfernen Sie unter Windows 2000 Server Service Pack 4 den Druckerwarteschlangendienst aus dem Registrierungsschlüssel NullSessionPipes:**  
    Windows 2000 Server Service Pack 4 und Windows XP Service Pack 1 ermöglichen anonyme Verbindungen zu dem betroffenen Dienst. Um die Ausnutzung dieser Sicherheitsanfälligkeit durch anonyme Angreifer zu unterbinden, entfernen Sie den Druckerwarteschlangendienst aus dem Unterschlüssel NullSessionPipes. Diese Problemumgehung schützt nicht vor Angriffen durch authentifizierte Benutzern. Verwenden Sie diese Problemumgehung nur, wenn Sie den Druckerwarteschlangendienst nicht deaktivieren können.
    ...
    **Auswirkung der Problemumgehung:** Anonyme Verbindungen zum Druckerwarteschlangendienst sind nicht mehr möglich. Dies ist das Standardverhalten bei späteren Versionen des Betriebssystems.

#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Druckerwarteschlangendienst – CAN-2005-1984:

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann eine Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er von einem Remotestandort aus die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Höchstwahrscheinlich würde das Ausnutzen dieser Sicherheitsanfälligkeit jedoch zu einem Denial-of-Service führen.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit entsteht durch einen ungeprüften Puffer im Druckerwarteschlangendienst.

**Was ist der Druckerwarteschlangendienst?**  
Der Druckerwarteschlangendienst Spoolsv.exe ist eine Programmdatei, die als Dienst installiert wurde. Die Warteschlange (Spooler) wird beim Start des Betriebssystems geladen und so lange ausgeführt, bis das System heruntergefahren wird. Der Druckerwarteschlangendienst verwaltet den Druckprozess. Dazu zählen Aufgaben wie das Abrufen des richtigen Druckertreibers, das Laden dieses Treibers, das Spoolen von High-Level-Funktionsaufrufen in einen Druckauftrag sowie die zeitliche Planung von Druckaufträgen. Wenn diese Aufgaben für einen bestimmten Druckauftrag abgeschlossen sind, gibt der Druckerwarteschlangendienst diesen Auftrag an den Druckrouter weiter. Weitere Informationen über den Druckerwarteschlangendienst finden Sie auf dieser [Website](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/techref/d58ce7b9-49cf-4f5e-95e9-1ade005c13e0.mspx).

**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Wenn ein Angreifer diese Sicherheitsanfälligkeit erfolgreich zur Codeausführung von Remotestandorten aus ausnutzt, kann er die vollständige Kontrolle über das betroffene System erlangen. Unter Windows XP Service Pack 2 und Windows Server 2003 würde dies zu einem Denial-of-Service führen. Bei anderen betroffenen Betriebssystemversionen würde eine Ausnutzung dieser Sicherheitsanfälligkeit höchstwahrscheinlich zu einem Denial-of-Service führen. Eine Remotecodeausführung aus ist jedoch ebenfalls möglich.

**Wer könnte diese Sicherheitsanfälligkeit ausnutzen?**  
Jeder anonyme Benutzer, der eine speziell gestaltete Nachricht an das betroffene System übermitteln kann, könnte unter Windows 2000 und Windows XP Service Pack 1 versuchen, diese Sicherheitsanfälligkeit auszunutzen. Unter Windows XP Service Pack 2 und Windows Server 2003 ist diese Sicherheitsanfälligkeit auf authentifizierte Benutzer beschränkt. Ein authentifizierter Benutzer könnte auch in der Lage sein, sich lokal bei einem System anzumelden, und dann versuchen, diese Sicherheitsanfälligkeit auf allen betroffenen Betriebssystemversionen auszunutzen.

**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Ein Angreifer könnte versuchen, die Sicherheitsanfälligkeit von einem Remotestandort aus auszunutzen, indem er eine speziell gestaltete Nachricht erstellt und diese dann an ein betroffenes System sendet. Diese Nachricht könnte daraufhin bewirken, dass das betroffene System Code auf Betriebssystemversionen und Konfigurationen ausführt, die für diese Angriffsmethode anfällig sind. Windows 2000 und Windows XP Service Pack 1 sind standardmäßig für Remoteangriffe anfällig. Das Risiko eines Remoteangriffs kann unter Windows XP SP2 oder Windows Server 2003 nur dann entstehen, wenn ein Benutzer mit den entsprechenden Berechtigungen einen Drucker freigibt oder versucht, eine Verbindung zu einem freigegebenen Drucker herzustellen.
Um diese Sicherheitsanfälligkeit lokal auszunutzen, müsste sich der Angreifer zunächst am System anmelden. Er könnte dann ein besonders konzipiertes Programm ausführen, das die Sicherheitsanfälligkeit ausnutzt.

**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Von dieser Sicherheitsanfälligkeit sind in erster Linie Windows 2000 und Windows XP Service Pack 1 betroffen. Windows XP Service Pack 2 und Windows Server 2003 sind weniger gefährdet, da auf diesen Betriebssystemversionen zusätzliche schadensbegrenzende Faktoren vorhanden sind. Als Druckserver konfigurierte Systeme sind durch diese Sicherheitsanfälligkeit jedoch besonders gefährdet.
...
Das Update behebt die Sicherheitsanfälligkeit, indem sichergestellt wird, dass der Druckerwarteschlangendienst die Länge einer Nachricht einwandfrei überprüft, bevor diese an den zugewiesenen Puffer übergeben wird.
...
**Hinweis** Durch die Verwendung der Installationsoption **/quiet** werden alle Meldungen unterdrückt. Dies gilt auch für Fehlermeldungen. Bei Verwendung der Installationsoption **/quiet** sollten Administratoren anhand einer der empfohlenen Methoden überprüfen, ob die Installation erfolgreich war. Administratoren sollten bei Verwendung dieser Option außerdem in der Protokolldatei KB896423.log überprüfen, ob Fehlermeldungen vorliegen.
...
Für dieses Update ist kein Neustart des Computers erforderlich. Damit nicht unbedingt ein Neustart ausgeführt werden muss, beenden Sie den Warteschlangendienst, und schließen Sie alle Anwendungen, die auf die betroffenen Dateien zugreifen, bevor Sie das Sicherheitsupdate installieren. Weitere Informationen zu möglichen Gründen für einen Neustart des Computers finden Sie im [Microsoft Knowledge Base-Artikel 887012](https://support.microsoft.com/kb/887012).

**Informationen zur Deinstallation**

Verwenden Sie zum Entfernen dieses Updates die Option „Software“ in der Systemsteuerung.

Systemadministratoren können das Dienstprogramm Spuninst.exe zum Entfernen dieses Sicherheitsupdates verwenden. Das Dienstprogramm Spuninst.exe befindet sich im Ordner %Windir%\\$NTUninstallKB896423$\\Spuninst.
...
-   [Kostya Kortchinsky](https://technet.microsoft.com/de-DE/mailto:kostya.kortchinsky@renater.fr) von CERT RENATER für den Hinweis auf die Sicherheitsanfälligkeit im Druckerwarteschlangendienst (CAN-2005-1984).
...
-   V1.1 (17. August 2005): Aktualisierung des Bulletins zur Verdeutlichung von Text, der im Abschnitt „Problemumgehung“ bereitgestellt wird.
-   V1.2 (18. April 2007): Aktualisierung des Bulletins mit einem Verweis auf den Microsoft Knowledge Base-Artikel 908506 als Vorsichtsmaßnahme im Abschnitt „Zusammenfassung“ sowie ein bekanntes Problem in dem Abschnitt „Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate“.
