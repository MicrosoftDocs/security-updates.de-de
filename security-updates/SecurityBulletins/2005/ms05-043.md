...
|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|---------------------------|---------------------------|---------------------|
| Sicherheitsanfälligkeit im Druckerwarteschlangendienst – [CAN-2005-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1984) | Remotecodeausführung                   | Kritisch     | Kritisch                  | Mittel                    | Mittel              |
...
[Microsoft Knowledge Base-Artikel 908506](http://support.microsoft.com/kb/908506): Unter Umständen sind Sie nicht in der Lage, auf einem Netzwerkdrucker zu drucken, nachdem Sie das Sicherheitsupdate 896423 auf einem Computer unter Windows 2000 mit Service Pack 4 installiert haben.
...
Weitere Informationen finden Sie unter [Häufig gestellte Fragen zum Supportlebenszyklus für Windows](http://support.microsoft.com/default.aspx?scid=fh;%5bln%5d;lifewinfaq).
