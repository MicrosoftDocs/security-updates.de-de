...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=34ebe5d3-40c9-41dc-aaff-64608d3ac7b1&displaylang=de)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=a6e2cb0a-146f-4300-95cb-7078ce9f9844&displaylang=de)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=997a633a-8836-4c0f-98f9-1fd378de4b0c&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=5132c3bc-f3af-464e-a615-60f72677bd4b&displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=527cc785-e69e-4ade-aaf7-61f96ac3ca7a&displaylang=de)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=fd1253b0-f4db-4808-a381-98ff9870ebb3&displaylang=en)
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit in HTML-Hilfe durch Pufferüberlauf – [CVE-2006-3357](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3357) | Remotecodeausführung                   | Kritisch     | Kritisch                  | Kritisch                  | Mittel              | Mittel                             |
...
Im [Microsoft Knowledge Base-Artikel 922616](https://support.microsoft.com/kb/922616) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates u. U. auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 922616](https://support.microsoft.com/kb/922616).
...
8.  Fügen Sie im Feld **Wert** durch Strichpunkte getrennt URL-Präfixe hinzu, und drücken Sie die Eingabetaste.
    Beispielsweise „https://www.wingtiptoys.com/help/helpdocuments;https://myintranetapplication/help/helpfiles“ (ohne die Anführungszeichen).  
...
-   **Deaktivieren Sie vorübergehend das ActiveX-Steuerelement der HTML-Hilfe, damit es in Internet Explorer nicht mehr ausgeführt werden kann.**
    ...
    **Warnung:** Eine fehlerhafte Verwendung des Registrierungs-Editors kann unter Umständen ernste Probleme verursachen, die eine erneute Installation des Betriebssystems erfordern können. Microsoft übernimmt keine Garantie dafür, dass Sie Probleme lösen können, die auf das fehlerhafte Verwenden des Registrierungs-Editors zurückzuführen sind. Verwenden Sie den Registrierungs-Editor auf eigenes Risiko.
    ...
    Ausführliche Anweisungen dazu, wie die Ausführung eines ActiveX-Steuerelements in Internet Explorer verhindert wird, finden Sie im [Microsoft Knowledge Base-Artikel 240797](https://support.microsoft.com/kb/240797). Befolgen Sie diese Schritte, und erstellen Sie einen Wert für Kompatibilitätskennzeichen in der Registrierung, um zu verhindern, dass das ActiveX-Steuerelement in Internet Explorer instanziiert wird.  
...
**Was ist HTML-Hilfe?**  
Microsoft [HTML-Hilfe](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconhh1start.asp) ist das Standardhilfesystem für die Windows-Plattform. Das ActiveX-Steuerelement in der HTML-Hilfe ist ein Programm, das eine HTML-Datei mit Hilfenavigation und sekundärer Fensterfunktionalität ausstattet. Weitere Informationen über das ActiveX-Steuerelement in HTML-Hilfe finden Sie in der [Produktdokumentation](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconocxov.asp).
...
-   [Für Heimanwender](https://go.microsoft.com/fwlink/?linkid=21169)
-   [Für IT-Profis und Entwickler](https://go.microsoft.com/fwlink/?linkid=21171)
...
Microsoft [dankt](https://www.microsoft.com/germany/technet/sicherheit/bulletins/policy.mspx) den folgenden Personen, dass sie zum Schutz von Kunden mit uns zusammengearbeitet haben:

-   Cody Pierce vom [Tipping Point Security Research Team](https://www.tippingpoint.com/security) für die Zusammenarbeit mit Microsoft bezüglich der Sicherheitsanfälligkeit in der HTML-Hilfe durch Pufferüberlauf – [CVE-2006-3357](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3357).
