...
-   Microsoft Office 2004 für Mac
    -   Microsoft Excel 2004 für Mac – [Update herunterladen (KB921213)](http://www.microsoft.com/mac/)
-   Microsoft Office X für Mac
    -   Microsoft Excel X für Mac – [Update herunterladen (KB921214)](http://www.microsoft.com/mac/)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------------------------------------|----------------------|----------------------|------------------------------------------------------------|
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften SELECTION-Datensatzes – [CVE-2006-1301](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1301) | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften SELECTION-Datensatzes – [CVE-2006-1302](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1302) | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften COLINFO-Datensatzes – [CVE-2006-1304](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1304)   | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften OBJECT-Datensatzes – [CVE-2006-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1306)    | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften FNGROUPCOUNT-Wertes – [CVE-2006-1308](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1308)   | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften LABEL-Datensatzes – [CVE-2006-1309](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1309)     | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund einer fehlerhaften Datei – [CVE-2006-2388](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2388)                 | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund einer fehlerhaften Datei – [CVE-2006-3059](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3059)                 | Codeausführung von Remotestandorten aus | Hoch                                       | Hoch                 | Kritisch             | Hoch                                                       |
...
|---------------------------------------------------------------------------------------------|------------|--------------------------------------------------------|------------------------------------------------------------|
| [**MS06-012**](http://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-012.mspx) | Ersetzt    | Ersetzt                                                | Ersetzt                                                    |
...
1.  Laden Sie das [Sicherheitsupdate für Excel 2003](http://download.microsoft.com/download/2/0/1/201f36a9-915e-4e51-a9ba-468668a4db01/office2003-kb918419-fullfile-enu.exe) bzw. das [Sicherheitsupdate für Excel 2003 Viewer](http://download.microsoft.com/download/1/e/5/1e576bbc-ac53-4a4d-9594-12524ea25c26/office2003-kb918425-fullfile-enu.exe) herunter.
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2002 herunter](http://download.microsoft.com/download/e/1/5/e15445fc-1e7d-4019-a0de-0ced260f1e90/officexp-kb918420-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2000 herunter](http://download.microsoft.com/download/4/f/f/4ffb141e-2294-4942-a73c-028220283408/office2000-kb918424-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   [Posidron](https://technet.microsoft.com/de-DE/mailto:posidron@tripbit.net) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften SELECTION-Datensatzes – [CVE-2006-1301](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1301).
-   [NSFOCUS Security Team](http://www.nsfocus.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften SELECTION-Datensatzes – [CVE-2006-1302](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1302).
-   [NSFOCUS Security Team](http://www.nsfocus.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften COLINFO-Datensatzes – [CVE-2006-1304](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1304).
-   [Arnaud Dovi](mailto:ad@heapoverflow.com) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften OBJECT-Datensatzes – [CVE-2006-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1306).
-   [iDEFENSE](http://www.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften OBJECT-Datensatzes – [CVE-2006-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1306).
-   [Sowhat](mailto:isowhat@gmail.com) von Nevis Labs für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften OBJECT-Datensatzes – [CVE-2006-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1306).
-   Xin Ouyang von [Nevis Networks](http://www.nevisnetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften FNGROUPCOUNT-Wertes – [CVE-2006-1308](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1308).
-   Shaun Colley von [NGSS Consulting](http://www.ngssoftware.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften LABEL-Datensatzes – [CVE-2006-1309](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1309).
-   Arnaud Dovi in Zusammenarbeit mit [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) und [TippingPoint](http://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel bei der Neuerstellung – [CVE-2006-2388](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2388).
-   Costin Ionescu von [Symantec](http://www.symantec.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund einer fehlerhaften Datei – [CVE-2006-3059](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3059).
