...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 918165](https://support.microsoft.com/kb/918165) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 918165](https://support.microsoft.com/kb/918165).
...
|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Windows-Shell-Sicherheitsanfälligkeit – [CVE-2006-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0012) | Codeausführung von Remotestandorten aus | Kritisch              | Kritisch     | Kritisch                  | Kritisch                  | Kritisch            | Kritisch                           |
...
**Hinweis:** Benutzer, die das Update MS06-015 bereits installiert haben und nicht mit den im [Microsoft Knowledge Base-Artikel 918165](https://support.microsoft.com/kb/918165) beschriebenen Problemen konfrontiert sind, müssen keine Maßnahmen ergreifen.

**Welche Änderungen beinhaltet das überarbeitete Sicherheitsupdate?**  
Das überarbeitete Sicherheitsupdate enthält keine Änderungen an den Binärdateien, die im ersten Sicherheitsupdate enthalten sind. Während der Installation platziert das überarbeitete Sicherheitsupdate die folgenden Einträge in der Liste der zulässigen Elemente, wie im [Microsoft Knowledge Base-Artikel 918165](https://support.microsoft.com/kb/918165) angegeben.
...
-   **Verwenden Sie Einstellungen für Gruppenrichtlinien zum Deaktivieren des WebClient-Diensts auf allen betroffenen Systemen, die diese Komponente nicht benötigen.**
    ...
    **Hinweis:** Sie können auch das [Sicherheitshandbuch für Windows Server 2003](https://www.microsoft.com/germany/technet/datenbank/articles/900117.mspx) zurate ziehen. Dieses Handbuch enthält Informationen zum Deaktivieren von Diensten.
    ...
    -   [Windows 2000 Group Policy](https://www.microsoft.com/technet/prodtechnol/windows2000serv/howto/grpolwt.mspx)
    -   [Group Policy in Windows Server 2003](https://www.microsoft.com/windowsserver2003/techinfo/overview/gpintro.mspx)
...
-   [NISCC](https://www.niscc.gov.uk/) für den Hinweis auf die Windows-Shell-Sicherheitsanfälligkeit (CVE-2006-0012).
