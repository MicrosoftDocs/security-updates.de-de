...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e&displaylang=de)
-   Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=2f54258f-1071-467b-80a2-e4dbfc050667&displaylang=de)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=f23574f7-4033-45ac-8ad8-6cced2ee9285&displaylang=de)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|-----------------------------|----------------------------------------|------------------------------------------------------------|
| Sicherheitsanfälligkeit im Microsoft Client Service für NetWare durch Speicherbeschädigung – [CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) | Remotecodeausführung                   | Hoch                        | Hoch                                   | Mittel                                                     |
| Sicherheitsanfälligkeit in NetWare-Treiber bezüglich Denial-of-Service – [CVE-2006-4689](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689)                     | DoS (Denial of Service)                | Mittel                      | Mittel                                 | Niedrig                                                    |
...
-   **Verwenden Sie zum Schutz vor netzwerkbasierten Versuchen zur Ausnutzung dieser Sicherheitsanfälligkeit eine persönliche Firewall, wie die** [**Windows-Firewall**](https://www.microsoft.com/germany/athome/security/protect/windowsxp/default.mspx)**, die im Lieferumfang von Windows XP enthalten ist.**
...
-   Peter Winter-Smith von [NGS Software](https://www.ngssoftware.com/%20\t%20_blank) für den Hinweis auf die Sicherheitsanfälligkeit im Client Service für NetWare durch Speicherbeschädigung (CVE-2006-4688).
-   Sam Arun Raj von [McAfee](https://www.mcafee.com/us%20\t%20_blank) für den Hinweis auf die Sicherheitsanfälligkeit im Client Service für NetWare durch Speicherbeschädigung (CVE-2006-4688) und die Sicherheitsanfälligkeit in NetWare-Treiber bezüglich Denial-of-Service (CVE-2006-4689).
