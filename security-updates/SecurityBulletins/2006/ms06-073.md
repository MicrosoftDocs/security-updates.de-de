...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 925674](https://support.microsoft.com/kb/925674) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 925674](https://support.microsoft.com/kb/925674).

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Visual Studio 2005 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=c2682c53-8e9a-4c7d-b782-be78512dcbfa&displaylang=de)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in WMI Object Broker – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704">CVE-2006-4704</a></td>
...
-   [TippingPoint](https://www.tippingpoint.com/) und die [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in WMI Object Broker – [CVE-2006-4704](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704).
