...
-   Microsoft Office 2004 für Mac
    -   Microsoft Excel 2004 für Mac – [Update herunterladen (KB924999)](https://www.microsoft.com/mac/)
-   Microsoft Office X für Mac
    -   Microsoft Excel X für Mac – [Update herunterladen (KB924998)](https://www.microsoft.com/mac/)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------|----------------------|--------------------------------------------|--------------------------------------------------|
| Sicherheitsanfälligkeit in Excel aufgrund fehlerhaften DATETIME-Datensatzes – [CVE-2006-2387](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2387)    | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                                       | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund fehlerhaften STYLE-Datensatzes – [CVE-2006-3431](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3431)       | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                                       | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund Verarbeitung einer Lotus 1-2-3-Datei – [CVE-2006-3867](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3867) | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                                       | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund fehlerhaften COLINFO-Datensatzes – [CVE-2006-3875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875)     | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                                       | Hoch                                             |
...
Microsoft hat dieses Bulletin und die zugehörigen Sicherheitsupdates aktualisiert, um die in [Microsoft Knowledge Base-Artikel 924164](https://support.microsoft.com/kb/924164) beschriebenen Probleme in Zusammenhang mit Microsoft Excel 2002 zu beheben.
...
|---------------------------------------------------------------------------------------------|----------------------|----------------------|--------------------------------------------|--------------------------------------------------|
| [**MS06-037**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-037.mspx) | Ersetzt              | Ersetzt              | Ersetzt                                    | Ersetzt                                          |
...
Ausführliche Informationen zu den Anleitungen zur Erkennung und Bereitstellung finden Sie im [Microsoft Knowledge Base-Artikel 910723](https://support.microsoft.com/kb/910723).
...
-   **Ändern Sie den Wert „InstallLanguage“ in Nicht-Doppelbytezeichen (Non-Double Byte characters, DBCS).**
    ...
    **Hinweis:** Eine Liste mit den Sprachkennungen finden Sie im [Knowledge Base-Artikel 324097](https://support.microsoft.com/?id=324097).
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2000 herunter](https://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2002 herunter](https://download.microsoft.com/download/6/e/4/6e483fd2-420f-45e2-9d21-e725f461c097/officexp-kb923089-v2-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  Laden Sie das [Sicherheitsupdate für Excel 2003](https://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) bzw. das [Sicherheitsupdate für Excel 2003 Viewer](https://download.microsoft.com/download/2/2/e/22e6365d-2a66-4a8c-8867-06a723dc53cc/office2003-kb923275-fullfile-enu.exe) herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   Manuel Santamarina Suarez in Zusammenarbeit mit [Zero Day Initiative (ZDI](https://www.zerodayinitiative.com/)) und [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich eines Parsingüberlaufs im Excel-Dateiformat – CVE-2006-2387.
-   [NSFocus Security Team](https://www.nsfocus.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften COLINFO-Datensatzes - [CVE-2006-3875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875).
...
-   V2.0 (12. Dezember 2006): Das Bulletin wurde für Microsoft Excel 2002 überarbeitet und erneut veröffentlicht, um die im [Microsoft Knowledge Base-Artikel 924164](https://support.microsoft.com/kb/924164) beschriebenen Probleme zu behandeln.
