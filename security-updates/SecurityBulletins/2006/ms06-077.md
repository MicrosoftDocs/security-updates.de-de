...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 926121](https://support.microsoft.com/kb/926121) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 926121](https://support.microsoft.com/kb/926121).

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=0ed62db9-4534-4f27-a49e-020c7a7d69e0&displaylang=de)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit im schreibbaren Pfad des RIS – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5584">CVE-2006-5584</a></td>
...
Weitere Informationen zum Bereitstellen von Sicherheitsupdates mithilfe der Windows Server Update Services finden Sie auf der [Windows Server Update Services-Website](https://go.microsoft.com/fwlink/?linkid=50120).
