...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|---------------------------|---------------------------|---------------------|
| Sicherheitsanfälligkeit in MSDTC durch ungültigen Speicherzugriff – [CVE-2006-0034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0034)            | DoS (Denial-of-Service)                | Mittel       | Gering                    | Keine                     | Gering              |
| Sicherheitsanfälligkeit in MSDTC, die zu einem Denial-of-Service führen kann – [CVE-2006-1184](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1184) | DoS (Denial-of-Service)                | Mittel       | Gering                    | Gering                    | Gering              |
...
-   **Verwenden von Gruppenrichtlinien-Einstellungen zum Deaktivieren von Distributed Transaction Coordinator auf allen betroffenen Systemen, die diese Komponente nicht benötigen**  
    ...
    **Hinweis:** Sie können auch das [Windows 2000-Sicherheitshandbuch](https://www.microsoft.com/germany/technet/datenbank/articles/900220.mspx) zurate ziehen. Dieses Handbuch enthält Informationen zum Deaktivieren von Diensten.
...
-   **Verwenden von Gruppenrichtlinien-Einstellungen zum Deaktivieren von Distributed Transaction Coordinator auf allen betroffenen Systemen, die diese Komponente nicht benötigen**  
    ...
    **Hinweis:** Sie können auch das Handbuch [Windows 2000-Sicherheitshandbuch](https://www.microsoft.com/germany/technet/datenbank/articles/900220.mspx) zurate ziehen. Dieses Handbuch enthält Informationen zum Deaktivieren von Diensten.

    Weitere Informationen zu Gruppenrichtlinien finden Sie auf den folgenden Websites:

    -   [Leitfaden zum Verständnis der Gruppenrichtlinienfunktionen](https://www.microsoft.com/germany/technet/datenbank/articles/600539.mspx)
    -   [Windows 2000-Gruppenrichtlinie](https://download.microsoft.com/download/5/2/f/52f3dbd6-2864-4d97-8792-276544ad6426/grouppolwp.doc)
    -   [Gruppenrichtlinien in Windows Server 2003](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/management/gp/default.mspx)
...
-   [EEye Digital Security](https://www.eeye.com/html/) für den Hinweis auf die Sicherheitsanfälligkeit in MSDTC durch ungültigen Speicherzugriff (CVE-2006-0034) und die Sicherheitsanfälligkeit in MSDTC, die zu einem Denial-of-Service führen kann (CVE-2006-1184).
-   Xiao Chen von [McAfee](https://www.mcafee.com) für den Hinweis auf die Sicherheitsanfälligkeit in MSDTC durch ungültigen Speicherzugriff (CVE-2006-0034).
-   Kai Zhang von [VenusTech](https://www.venustech.com.cn) für den Hinweis auf die Sicherheitsanfälligkeit in MSDTC, die zu einem Denial-of-Service führen kann (CVE-2006-1184).
