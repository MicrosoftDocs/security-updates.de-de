...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Sicherheitsanfälligkeit durch Beschädigung in der Dateiaufstellung</strong> – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5585">CVE-2006-5585</a></td>
...
Es liegt eine Sicherheitsanfälligkeit des Typs Erhöhung von Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) in der Art vor, wie Microsoft Windows Anwendungen mit speziell gestalteten Dateiaufstellungen startet. Durch diese Sicherheitsanfälligkeit kann ein angemeldeter Angreifer vollständige Kontrolle über das System erlangen.
