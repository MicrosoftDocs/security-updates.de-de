...
-   Internet Explorer 5.01 Service Pack 4 unter Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=c0df2fc3-2075-46b5-945f-6e0bd6806151&displaylang=de)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------------------|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|---------------------------------------------------|
| Sicherheitsanfälligkeit bzgl. Speicherbeschädigung bei Analyse von WMF-Bildern – [CVE-2006-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0020) | Codeausführung von Remotestandorten aus | Kritisch                              | Keine                                                                                                   | Keine                                                                              | Keine                                             |
...
Nein. Diese Sicherheitsanfälligkeit ist unter Windows 98, Windows 98 Second Edition oder Windows Millennium Edition bei [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) nicht vorhanden. Hierbei handelt es sich um die einzige Version von Internet Explorer, die für diese Versionen von Windows wird. Weitere Informationen zu den Bewertungen des Schweregrads finden Sie auf dieser [Website](https://www.microsoft.com/germany/technet/datenbank/articles/527029.mspx). Microsoft veröffentlicht Sicherheitsupdates für die betroffenen Betriebssysteme, und die Bewertung des Schweregrads gilt bis zum 30. Juni 2006. Benutzer dieser Betriebssystemversionen sollten möglichst bald zu Versionen migrieren, für die Support angeboten wird, um sich vor künftigen Sicherheitsanfälligkeiten zu schützen. Weitere Informationen zu den Windows-Produktzyklen finden Sie auf der Website [Microsoft Support Lifecycle](https://support.microsoft.com/gp/lifean1).

**Wie steht es mit Internet Explorer 5.5 Service Pack 2 unter Windows Millennium Edition?**  
Internet Explorer 5.5 Service Pack 2 unter Windows Millennium Edition hat das Ende seines Lebenszyklus erreicht. Benutzer dieser Version von Internet Explorer sollten möglichst bald zu [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) migrieren, um sich vor künftigen Sicherheitsanfälligkeiten zu schützen. Weitere Informationen zu den Windows-Produktzyklen finden Sie auf der Website [Microsoft Support Lifecycle](https://support.microsoft.com/gp/lifean1). Spezifische Support-Daten für Internet Explorer 5.5 Service Pack 2 unter Windows Millennium Edition finden Sie auf der Website [Microsoft Support Lifecycle](https://support.microsoft.com/gp/lifesupsps).
...
Da Internet Explorer 5.5 Service Pack 2 unter Windows Millennium Edition das Ende seines Lebenszyklus erreicht hat, sollten Sie zu [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) migrieren, um sich vor künftigen Sicherheitsanfälligkeiten zu schützen.
...
Ja. MBSA 1.2.1 kann feststellen, ob dieses Update erforderlich ist. MBSA unterstützt nur Betriebssysteme für Arbeitsstationen, beispielsweise Windows 2000 (und höher). Weitere Informationen zu MBSA finden Sie [hier](https://www.microsoft.com/germany/technet/sicherheit/tools/mbsa.mspx).

**Kann ich mit dem Microsoft Baseline Security Analyzer (MBSA) 2.0 überprüfen, ob dieses Update erforderlich ist?**  
Ja. MBS 2.0 kann feststellen, ob dieses Update erforderlich ist. MBSA 2.0 erkennt erforderliche Sicherheitsupdates für von Microsoft Update unterstützte Produkte. MBSA unterstützt nur Betriebssysteme für Arbeitsstationen, beispielsweise Windows 2000 (und höher). Weitere Informationen zu MBSA finden Sie [hier](https://www.microsoft.com/germany/technet/sicherheit/tools/mbsa.mspx).

**Kann ich mit Systems Management Server (SMS) überprüfen, ob dieses Update erforderlich ist?**  
Ja. SMS kann Sie bei der Erkennung und Bereitstellung dieses Sicherheitsupdates unterstützen. Weitere Informationen zu SMS finden Sie auf der [SMS-Website](https://www.microsoft.com/germany/smserver/default.mspx).
...
-   Benutzer von [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) sind von dieser Sicherheitsanfälligkeit nicht betroffen; auch Angriffe über eine E-Mail bleiben hier wirkungslos.
...
Benutzer von Windows 2000 Service Pack 4 mit Internet Explorer 5.01 Service Pack 4 sollten unbedingt das Update installieren oder [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) installieren.
...
Nein. Hierbei handelt es sich um eine andere Sicherheitsanfälligkeit. Diese Meldungen wurden im [Microsoft Security Response Center Blog](https://blogs.technet.com/msrc/archive/2006/01/09/417198.aspx) erörtert.
...
-   Updates für Kundenplattformen können Sie auf der [Microsoft Update-Website](https://update.microsoft.com/microsoftupdate) abrufen.
