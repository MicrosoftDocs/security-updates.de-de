...
-   Golan Yosef vom [Malicious Code Research Center (MCRC)](https://www.finjan.com/) von Finjan für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit in Microsoft Windows MDAC - [CVE-2006-0003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0003).
-   Stefano Meller und Mirko Gatto von [Yarix](https://www.yarix.com/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit in Microsoft Windows MDAC - [CVE-2006-0003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0003).
