...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit durch Dialogfeldspoofing in Object Packager – [CVE-2006-4692](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4692) | Remotecodeausführung                   | Mittel                    | Mittel                    | Niedrig             | Niedrig                            |
...
Objekt Packager ist ein Tool, mit dem ein Paket erstellt wird, das anschließend in eine Datei eingefügt werden kann. Weitere Informationen zu Object Packager finden Sie in dieser [Microsoft-Produktdokumentation](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true).
...
-   Andreas Sandblad von [Secunia Research](https://www.secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Dialogfeldspoofing in Object Packager – CVE-2006-4692
