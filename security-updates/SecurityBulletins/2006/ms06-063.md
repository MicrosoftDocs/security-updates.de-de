...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=de)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=08ab17b9-149c-44d4-96cf-87a8c6b9dc22&displaylang=de)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=433fd0f9-938f-432d-99d4-f41b92235dcf&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=abad4cc1-4ea6-4051-bc5a-79deb4dbe72b&displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=849eedef-332b-4792-b84e-3750d407a86f&displaylang=de)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=31e448f7-298d-417c-a857-1646689e0817&displaylang=en)
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit im Serverdienst durch Denial-of-Service – [CVE-2006-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) | DoS (Denial of Service)                 | Hoch         | Hoch                      | Hoch                      | Hoch                | Hoch                               |
| Sicherheitsanfälligkeit in SMB bezüglich Umbenennung – [CVE-2006-4696](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)            | Codeausführung von Remotestandorten aus | Hoch         | Hoch                      | Hoch                      | Hoch                | Hoch                               |
...
Weitere Informationen zu den Programmen, die von Microsoft Update und MBSA 2.0 derzeit nicht erkannt werden, finden Sie im [Microsoft Knowledge Base-Artikel 895660](https://support.microsoft.com/kb/895660).
...
Im Serverdienst liegt eine Sicherheitsanfälligkeit vor, die zu einem [Denial-of-Service](https://go.microsoft.com/fwlink/?linkid=21142) führen kann und durch die Art der Verarbeitung bestimmter Netzwerknachrichten verursacht wird. Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Netzwerknachricht an einen Computer sendet, der den Serverdienst ausführt. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass der Computer nicht mehr reagiert.
...
Dieses Sicherheitsupdate unterstützt HotPatching. Weitere Informationen zum HotPatching und zum Bereitstellen dieses Sicherheitsupdates als HotPatch finden Sie im [Microsoft Knowledge Base-Artikel 897341](https://support.microsoft.com/kb/897341).
...
-   Gerardo Richarte von [Core Security Technologies](https://www.coresecurity.com) für den Hinweis auf die Sicherheitsanfälligkeit im Serverdienst durch Denial-of-Service (CVE-2006-3942).
-   [NS Focus](https://www.nsfocus.com) für den Hinweis auf die Sicherheitsanfälligkeit im Serverdienst durch Denial-of-Service (CVE-2006-3942).
-   [Fortinet](https://www.fortinet.com) für den Hinweis auf die Sicherheitsanfälligkeit in SMB bezüglich Umbenennung (CVE-2006-4696).
-   Matthew Amdur von [VMWare](https://www.vmware.com) für den Hinweis auf die Sicherheitsanfälligkeit in SMB bezüglich Umbenennung (CVE-2006-4696).
