...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit durch RASMAN-Speicherbeschädigung – [CVE-2006-2370](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2370)           | Codeausführung von Remotestandorten aus | Kritisch     | Hoch                      | Hoch                      | Hoch                | Hoch                               |
| Sicherheitsanfälligkeit durch Beschädigung der RASMAN-Registrierung – [CVE-2006-2371](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2371) | Codeausführung von Remotestandorten aus | Kritisch     | Hoch                      | Hoch                      | Hoch                | Hoch                               |
...
-   Peter Winter-Smith von [NGS Software](http://www.ngssoftware.com/index.htm) für den Hinweis auf die Sicherheitsanfälligkeit durch Beschädigung der RASMAN-Registrierung (CVE-2006-2371).
...
V2.0 (27. Juni 2006): Microsoft hat das Bulletin und die zugehörigen Updates aktualisiert, um die im [Microsoft Knowledge Base-Artikel 911280](http://support.microsoft.com/kb/911280) beschriebenen Probleme zu adressieren.
