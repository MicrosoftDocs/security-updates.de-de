...
**Vorsichtsmaßnahmen:** Der [Microsoft Knowledge Base-Artikel 911280](https://support.microsoft.com/kb/911280) dokumentiert die derzeit bekannten Probleme, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können.

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=c1af96b2-2807-444b-82df-b6b61ec63715&amp;displaylang=de)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=74838e2b-bd5f-4584-81f1-3250e6b69728&amp;displaylang=de)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=09d1a284-6a16-44a5-a95e-8eb566401ce9&amp;displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=b4264cb9-8979-40e8-b903-bc8deda00fec&amp;displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=890535c9-98cf-49a9-ae50-178e3c5fac6b&amp;displaylang=de)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=bf9cef95-89fd-4ec3-be0a-93902f2bb768&amp;displaylang=en)
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit durch RASMAN-Speicherbeschädigung – [CVE-2006-2370](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2370)           | Codeausführung von Remotestandorten aus | Kritisch     | Hoch                      | Hoch                      | Hoch                | Hoch                               |
| Sicherheitsanfälligkeit durch Beschädigung der RASMAN-Registrierung – [CVE-2006-2371](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2371) | Codeausführung von Remotestandorten aus | Kritisch     | Hoch                      | Hoch                      | Hoch                | Hoch                               |
...
Microsoft hat das Bulletin und die zugehörigen Updates aktualisiert, um die im [Microsoft Knowledge Base-Artikel 911280](https://support.microsoft.com/kb/911280) beschriebenen Probleme zu adressieren. Von den Problemen sind nur Kunden betroffen, die Einwahlverbindungen verwenden, auf die folgendes zutrifft: Es werden Skripte eingesetzt, die das Gerät für Parität konfigurieren, es kommen Stop-Bits oder Data-Bits zum Einsatz, ein nach der Verbindung erscheinendes Terminal-Fenster oder Dial-Up-Scripting werden verwendet.
...
Während RRAS als Technologieklasse angesehen werden kann, adressiert dieses Update speziell Anfälligkeiten, die im Zusammenhang mit der RAS-Verbindungsverwaltung identifiziert wurden – einem Dienst, der auch unter dem Namen RASMAN bekannt ist. Weitere Informationen zu RRAS finden Sie [in diesem MSDN-Artikel](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/rras/rras/routing_and_remote_access_service_rras_start_page.asp) (in englischer Sprache).
...
-   Peter Winter-Smith von [NGS Software](https://www.ngssoftware.com/index.htm) für den Hinweis auf die Sicherheitsanfälligkeit durch Beschädigung der RASMAN-Registrierung (CVE-2006-2371).
...
V1.1 (19. Juni 2006): In den Abschnitten "Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate" und "Einzelheiten zu dieser Sicherheitsanfälligkeit" Erläuterungen zur betroffenen RASMAN-Komponente eingefügt. Unter "Vorsichtsmaßnahmen" Hinweis auf derzeit bekannte Probleme eingefügt.

V1.2 (21. Juni 2006): Das Bulletin wurde aktualisiert, um eine zusätzliche Differenzierung zwischen RRAS-, RAS- und RASMAN-Komponenten bereitzustellen.

V2.0 (27. Juni 2006): Microsoft hat das Bulletin und die zugehörigen Updates aktualisiert, um die im [Microsoft Knowledge Base-Artikel 911280](https://support.microsoft.com/kb/911280) beschriebenen Probleme zu adressieren.
