...
-   Microsoft Works Suite-Versionen:
    ...
    -   Microsoft Works Suite 2005 – [Update herunterladen (KB917335) (identisch mit Microsoft Word 2002-Update)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c&amp;displaylang=de)
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------|---------------------|------------------------------------------|
| Sicherheitsanfälligkeit in Microsoft Word durch fehlerhaften Objektzeiger – [CVE-2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492) | Remotecodeausführung                   | Kritisch            | Hoch                | Hoch                                     |
...
|-----------------------------------------------------------------------------------------|---------------------|---------------------|------------------------------------|----------------------------|
| [MS06-012](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-012.mspx) | Ersetzt             | Ersetzt             | Nicht anwendbar                    | Nicht anwendbar            |
| [MS05-023](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms05-023.mspx) | Nicht anwendbar     | Nicht anwendbar     | Ersetzt                            | Ersetzt                    |
...
-   **Verwenden Sie Microsoft Word immer im abgesicherten Modus.**
    ...
    **Manuell (Benutzereingriff)**
    ...
    Weitere Informationen zum Aktivieren und Deaktivieren von Word als E-Mail-Editor finden Sie auf [dieser Webseite](https://office.microsoft.com/en-us/assistance/hp052428491033.aspx).
    ...
    **Verwenden von Gruppenrichtlinien**
    ...
    Informationen zur Verwendung von Registrierungsschlüsseln in Verbindung mit Gruppenrichtlinien finden Sie unter [Using Administrative Template Files with Registry-Based Group Policy](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/management/gp/admtgp.mspx) und [Distributing Registry Changes](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnw2kmag01/html/distributingregistrychanges.asp).
    ...
    **Für Unternehmenskunden**
    ...
    Alle Word-Versionen verfügen über eine Funktion zur Anwendungswiederherstellung, mit der Word im abgesicherten Modus ausgeführt werden kann. Im abgesicherten Modus wird die betroffene Funktion deaktiviert, sodass kein angreifbarer Code ausgeführt werden kann. Die gesamten Einschränkungen finden Sie unter folgender Adresse: [https://office.microsoft.com/en-us/assistance/HP030823931033.aspx](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx).
    ...
    **Auswirkung der Problemumgehung:** Das Arbeiten im abgesicherten Modus ist mit den auf [dieser Webseite](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx) beschriebenen Einschränkungen verbunden.
    ...
    **Hinweis:** Beim Wert „Command“ handelt es sich um eine versions- und sprachenspezifisch codierte Zeichenfolge, die nicht auf allen System genau der obigen gleicht.
    ...
    ```
    **Auswirkung der Problemumgehung:** Das Arbeiten im abgesicherten Modus ist mit den auf der folgenden Onlinehilfeseite beschriebenen Einschränkungen verbunden: [https://office.microsoft.com/en-us/assistance/HP030823931033.aspx](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx)
...
1.  [Laden Sie dieses Sicherheitsupdate herunter.](https://download.microsoft.com/download/3/5/3/353ea965-4ce1-440a-947e-b3272578543c/office2000-kb917345-fullfile-enu.exe)
...
1.  [Laden Sie dieses Sicherheitsupdate herunter.](https://download.microsoft.com/download/3/2/1/32142319-d15c-4370-af74-bafd1422f94e/officexp-kb917335-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  Laden Sie das [Sicherheitsupdate für Word 2003](https://download.microsoft.com/download/5/0/1/5018537a-628b-40d8-9d54-3fdbae8705a9/office2003-kb917334-fullfile-enu.exe) und/oder das [Sicherheitsupdate für Word Viewer 2003](https://download.microsoft.com/download/2/e/1/2e1188b9-3819-4bcf-9991-41013b6c7e24/office2003-kb917346-fullfile-enu.exe) herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   Shih-hao Weng von [Information & Communication Security Technology Center](https://www.icst.org.tw/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Word durch fehlerhaften Objektzeiger – [CVE-2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492).
-   Andreas Marx von [AV-Test.org](https://av-test.com/) für die Zusammenarbeit mit Microsoft bei der Sicherheitsanfälligkeit in Microsoft Word durch fehlerhaften Objektzeiger – [CVE-2006-2492.](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)
