...
-   Microsoft Windows XP Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=383c13dc-51a9-4b12-89e3-871a1a3de98f&displaylang=de)
-   Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=b5f19858-4e86-4fd4-a264-e4823ff6d0a9&displaylang=de)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=afd3279c-6171-4f20-a36e-b9b56ee4c7f1&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=af8f3a58-ba7a-41bf-bb1b-3a9ddfdc3e27&displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=271e9c78-1c6a-443e-924d-43fd6d51e643&displaylang=de)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=e2cb474f-fc1b-4b7d-a607-02a1528c6743&displaylang=en)

**Getestete Microsoft Windows-Komponenten:**

**Betroffene Komponenten:**

-   Internet Explorer 5.01 Service Pack 4 unter Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=4c48ff93-6559-4616-9c2d-406e808b7e97&displaylang=de)
-   Internet Explorer 6 Service Pack 1 unter Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=ea7de30f-d765-4e5b-bfd4-64f3fed578ff&displaylang=de)
...
|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit durch Pufferüberlauf in VML – [CVE-2006-4868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4868) | Remotecodeausführung                   | Kritisch                    | Kritisch                  | Kritisch                  | Kritisch            | Mittel                             |
...
Wenn die Problemumgehung "Beschränken Sie die Zugriffsteuerungsliste für VGX.DLL" angewendet wird, lässt sich Software, in der die Datei vgx.dll zum Einsatz kommt, unter Umständen nicht installieren. Ein Beispiel hierfür sind [Internet Explorer 7 Release Candidate 1](https://www.microsoft.com/windows/ie/default.mspx) und spätere Versionen von Internet Explorer 7. Bevor diese Software installiert werden kann, muss die Problemumgehung rückgängig gemacht und die ursprüngliche ACL-Konfiguration für vgx.dll wiederhergestellt werden.
...
Die [verstärkte Sicherheitskonfiguration](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp) von Internet Explorer enthält keine schadensbegrenzenden Maßnahmen für Anwendungen wie Microsoft Outlook, die unter Windows Server 2003 installiert werden können.
...
**Was ist VML?**  
Vector Markup Language (VML) ist ein XML-basiertes Format für das Austauschen, Bearbeiten und Weitergeben qualitativ hochwertiger Vektorgrafiken über das Internet. Es erfüllt sowohl die Anforderungen normaler Benutzer als auch die von Grafikspezialisten. XML ist eine einfache, flexible, Open Text-basierte Sprache zur Ergänzung von HTML. Weitere Informationen zu VML finden Sie in der [Produktdokumentation](https://msdn.microsoft.com/library/default.asp?url=/workshop/author/vml/default.asp?).
...
-   [ISS X-Force](https://www.iss.net/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit durch Pufferüberlauf in VML (CVE-2006-4868).
-   [iDEFENSE](https://www.idefense.com/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit durch Pufferüberlauf in VML (CVE-2006-4868).
-   Dan Hubbard von [Websense Security Labs](https://www.websense.com/securitylabs/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit durch Pufferüberlauf in VML (CVE-2006-4868).
