...
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=ce264ac4-6ca3-4732-9016-3143ff1bca2f&displaylang=de)
...
|--------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------------|
| Sicherheitsanfälligkeit in PGM bezüglich Codeausführung – [CVE-2006-3442](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3442) | Remotecodeausführung                   | Hoch                      | Hoch                      |
...
PGM ist ein zuverlässiges und skalierbares Multicastprotokoll, mit dem Empfänger den Verlust von Daten erkennen und die erneute Übertragung verlorener Daten anfordern bzw. eine Anwendung über endgültig verlorene Daten informieren können. PGM ist ein Empfänger-basiertes Protokoll, d. h. der Empfänger stellt sicher, dass alle Daten empfangen werden und nimmt dem Absender so die Verantwortung ab. PGM ist für Anwendungen geeignet, die eine Übertragung von Multicastdaten von mehreren Quellen zu mehreren Empfängern ohne Vervielfältigung erfordern. PGM unterstützt nicht die Bestätigung der Übertragung und garantiert nicht die Anforderung von Paketen von mehreren Absendern. Weitere Informationen zu PGM finden Sie im folgenden [MSDN-Artikel](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/winsock/winsock/pgm_senders_and_receivers.asp).

**Was ist MSMQ und der MSMQ-Dienst?**  
Microsoft Message Queuing Services (MSMQ) ermöglicht Anwendungen, die zu unterschiedlichen Zeiten ausgeführt werden, die Kommunikation über heterogene Netzwerke und Systeme, die möglicherweise vorübergehend offline sind. Weitere Informationen zu PGM finden Sie im folgenden [MSDN-Artikel](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/msmq/html/ff917e87-05d5-478f-9430-0f560675ece1.asp).
