---
TOCTitle: 'MS06-040'
Title: 'Microsoft Security Bulletin MS06-040 - Kritisch'
ms:assetid: 'ms06-040'
ms:contentKeyID: 61224356
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms06-040(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS06-040 - Kritisch
===============================================

Sicherheitsanfälligkeit im Serverdienst kann Remotecodeausführung ermöglichen (921883)
--------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 8. August 2006 | Aktualisiert: Dienstag, 12. September 2006
...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 921883](https://support.microsoft.com/kb/921883) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 921883](https://support.microsoft.com/kb/921883).

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=3b61153d-359f-4441-a448-24062cb2387c&displaylang=de)
-   Microsoft Windows XP Service Pack 1 und Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=2996b9b6-03ff-4636-861a-46b3eac7a305&displaylang=de)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=314c7c2c-9a02-4e56-98cf-97703fecf0be&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec&displaylang=de)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=af970833-2044-4284-937d-3beb2e2f286d&displaylang=de)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=3b0c1954-fca5-4e95-abb2-6066a9d6bc76&displaylang=en)
...
Dieses Update behebt eine von einem Privatanwender gemeldete Sicherheitsanfälligkeit sowie zusätzliche Probleme, die bei internen Untersuchungen festgestellt wurden.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst – [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | Remotecodeausführung                   | Kritisch     | Kritisch                  | Kritisch                  | Kritisch            | Kritisch                           |
...
-   Der Schweregrad für Windows Server 2003 und Windows Server 2003 Service Pack 1 für Itanium-basierte Systeme ist der gleiche wie der für Windows Server 2003.
...
Microsoft hat dieses Bulletin und die dazugehörigen Sicherheitsupdates aktualisiert, um die im Microsoft [Knowledge Base-Artikel 921883](https://support.microsoft.com/kb/921883) genannten Probleme in Zusammenhang mit Microsoft Windows Server 2003 mit Service Pack 1 und Microsoft Windows XP Professional X64 Edition zu behandeln. Sind unter Microsoft Windows Server 2003 mit Service Pack 1 und Microsoft Windows XP Professional X64 Edition Anwendungen mit großem Speicherbedarf installiert, funktioniert das Betriebssystem u. U. nach der Installation der Vorversion dieses Updates nicht mehr einwandfrei.
...
#### Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst – CVE-2006-3439:
...
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst – CVE-2006-3439:
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst – CVE-2006-3439:
...
Von diesem Problem sind alle Arbeitsstationen und Server betroffen, doch aufgrund der einzigartigen Merkmale der Sicherheitsanfälligkeit und des betroffenen Codepfads sind in erster Linie Systeme mit Windows 2000 betroffen.
...
Das Update behebt die Sicherheitsanfälligkeit, indem sichergestellt wird, dass der Serverdienst die Länge einer Nachricht überprüft, bevor diese an den zugewiesenen Puffer übergeben wird.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit CVE-2006-3439 zugewiesen.

**In welcher Beziehung steht diese Sicherheitsanfälligkeit zu der durch MS06-035 behobenen Sicherheitsanfälligkeit?**  
Beide Sicherheitsanfälligkeiten befanden sich im Serverdienst, doch dieses Update behebt eine neue Sicherheitsanfälligkeit, die nicht als Teil von MS06-035 behandelt wurde. MS05-035 bietet Schutz vor der im entsprechenden Bulletin beschriebenen Sicherheitsanfälligkeit, behebt aber nicht diese neue Sicherheitsanfälligkeit. Dieses Update ersetzt nicht MS05-035. Sie müssen dieses Update sowie das als Teil von Security Bulletin MS05-035 zur Verfügung gestellte Update installieren, um Ihr System vor beiden Sicherheitsanfälligkeiten zu schützen.
...
**Hinweis:** Durch die Verwendung der Installationsoption **/quiet** werden alle Meldungen unterdrückt. Dies gilt auch für Fehlermeldungen. Bei Verwendung der Installationsoption **/quiet** sollten Administratoren anhand einer der empfohlenen Methoden überprüfen, ob die Installation erfolgreich war. Administratoren sollten bei Verwendung dieser Option außerdem in der Protokolldatei KB921883.log prüfen, ob Fehlermeldungen vorliegen.
...
**Hinweis:** Nicht alle Sicherheitsupdates unterstützen HotPatching. Einige Sicherheitsupdates, die HotPatching unterstützen, könnten einen Neustart des Servers erfordern, nachdem Sie das Sicherheitsupdate installiert haben. HotPatching wird nur unterstützt, wenn es sich bei den Dateien, die durch das Sicherheitsupdate ersetzt werden, um GDR-Dateien (General Distribution Release) handelt. Weitere Informationen zu diesem Verhalten finden Sie im [Microsoft Knowledge Base-Artikel 897341](https://support.microsoft.com/kb/897341) und im [Microsoft Knowledge Base-Artikel 824994](https://support.microsoft.com/kb/824994).

**Informationen zur Deinstallation**

Verwenden Sie zum Entfernen dieses Updates die Option „Software“ in der Systemsteuerung.

Systemadministratoren können das Dienstprogramm Spuninst.exe zum Entfernen dieses Sicherheitsupdates verwenden. Das Dienstprogramm Spuninst.exe befindet sich im Ordner %Windir%\\$NTUninstallKB921883$\\Spuninst.
...
-   [US-CERT](https://www.us-cert.gov/) für die Zusammenarbeit bezüglich der Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst (CVE-2006-3439).
-   [SANS](https://www.sans.org/) für die Zusammenarbeit bezüglich der Sicherheitsanfälligkeit durch Pufferüberlauf im Serverdienst (CVE-2006-3439).
...
-   V1.1 (14. August 2006): Vorsichtsmaßnahmen im Hinblick auf Veröffentlichung von KB921883 aktualisiert. Auswirkung im Abschnitt „Problemumgehungen“ für das Blockieren der genannten Ports überarbeitet.
-   V2.0 (12. September 2006): Das Update wurde überarbeitet und für Microsoft Windows 2003 und Microsoft Windows XP Professional X64 Edition erneut veröffentlicht, um die im [Microsoft Knowledge Base-Artikel 921883](https://support.microsoft.com/kb/921883) genannten Probleme zu behandeln.
