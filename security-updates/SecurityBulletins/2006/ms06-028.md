...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft PowerPoint 2000 – [Update herunterladen (KB916520)](https://www.microsoft.com/download/details.aspx?familyid=f635f2cb-cfee-4129-bb77-4779a3b05674&amp;displaylang=de)
-   Microsoft Office XP Service Pack 3
    -   Microsoft PowerPoint 2002 – [Update herunterladen (KB916519)](https://www.microsoft.com/download/details.aspx?familyid=60a1eb9f-f04b-4d21-a95e-ccc90d9782ab&amp;displaylang=dehttps://www.microsoft.com/download/details.aspx?familyid=fced8804-45b4-4fd2-8fdb-4960c5bb8954)
-   Microsoft Office 2003 Service Pack 1 oder Service Pack 2
    -   Microsoft PowerPoint 2003 – [Update herunterladen (KB916518)](https://www.microsoft.com/download/details.aspx?familyid=fced8804-45b4-4fd2-8fdb-4960c5bb8954&amp;displaylang=de)
-   Microsoft Office 2004 für Mac
    -   Microsoft PowerPoint 2004 für Mac – [Update herunterladen (KB918963)](https://www.microsoft.com/mac/)
-   Microsoft Office X für Mac
    -   Microsoft PowerPoint v. X für Mac – [Update herunterladen (KB918963)](https://www.microsoft.com/mac/)
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------------|---------------------------|-----------------------------------|-----------------------------------|
| Sicherheitsanfälligkeit in Microsoft PowerPoint bezüglich einer durch einen fehlerhaften Datensatz hervorgerufen Remotecodeausführung – [CVE-2006-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022) | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                      | Hoch                              | Hoch                              |
...
|---------------------------------------------------------------------------------------------|---------------------------|---------------------------|---------------------------|-----------------------------------|-----------------------------------|
| [**MS06-010**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-010.mspx) | Ersetzt                   | Nicht anwendbar           | Nicht anwendbar           | Nicht anwendbar                   | Nicht anwendbar                   |
...
1.  [Laden Sie dieses Sicherheitsupdate herunter.](https://download.microsoft.com/download/8/c/d/8cd18498-aa99-4afb-8c57-52d704211757/office2000-kb916520-fullfile-enu.exe)
...
1.  [Laden Sie dieses Sicherheitsupdate herunter.](https://download.microsoft.com/download/d/0/9/d0933324-aabb-4caf-a433-5f42ababfdf5/officexp-kb916519-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie dieses Sicherheitsupdate herunter](https://download.microsoft.com/download/a/c/a/aca69765-b6cc-4d4a-8bb2-a183f63a3de2/office2003-kb916518-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   Nicolas Ruff, Fabrice Desclaux und Kostya Kortchinsky von der [European Aeronautic Defence and Space Company](https://www.eads.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft PowerPoint bezüglich einer durch einen fehlerhaften Datensatz hervorgerufen Remotecodeausführung – [CVE-2006-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).
-   [Elia Florio](mailto:elia_florio@symantec.com) von [Symantec](https://www.symantec.com/index.htm) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft PowerPoint bezüglich einer durch einen fehlerhaften Datensatz hervorgerufen Remotecodeausführung – [CVE-2006-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).
-   Dejun Meng vom [Fortinet Security Response Team](https://www.fortinet.com/) für die Zusammenarbeit mit Microsoft bei der Sicherheitsanfälligkeit in Microsoft PowerPoint bezüglich einer durch einen fehlerhaften Datensatz hervorgerufen Remotecodeausführung - [CVE-2006-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).

**Weitere Sicherheitsupdates:**

Updates für andere Sicherheitsrisiken sind unter den folgenden Adressen erhältlich:

-   Sicherheitsupdates sind im [Microsoft Download Center](https://www.microsoft.com/downloads/results.aspx?displaylang=de&freetext=security_patch) verfügbar und können am einfachsten durch eine Suche nach dem Begriff „security\_patch“ oder „security\_update“ ermittelt werden.
