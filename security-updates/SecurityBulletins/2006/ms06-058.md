---
TOCTitle: 'MS06-058'
Title: 'Microsoft Security Bulletin MS06-058 - Kritisch'
ms:assetid: 'ms06-058'
ms:contentKeyID: 61224374
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms06-058(v=Security.10)'
---
...
Sicherheitsanfälligkeiten in Microsoft PowerPoint können Remotecodeausführung ermöglichen (924163)
--------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 10. Oktober 2006 | Aktualisiert: Mittwoch, 21. Februar 2007
...
-   Microsoft Office 2000 Service Pack 3 – [Update herunterladen (KB923093)](https://www.microsoft.com/download/details.aspx?familyid=14a61fda-bfe2-47ca-8313-40b772359994&amp;displaylang=de)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 – [Update herunterladen (KB923092)](https://www.microsoft.com/download/details.aspx?familyid=0fbd66fb-28bb-4587-9425-ad4a3f10651d&amp;displaylang=de)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 oder Service Pack 2 – [Update herunterladen (KB923091)](https://www.microsoft.com/download/details.aspx?familyid=d0e30f77-b48f-4b8b-a6fa-105a354b1a4e&amp;displaylang=de)
    -   Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 für Mac
    -   Microsoft PowerPoint 2004 für Mac – [Update herunterladen (KB924999)](https://www.microsoft.com/mac/)
-   Microsoft Office X für Mac
    -   Microsoft PowerPoint X für Mac – [Update herunterladen (KB924998)](https://www.microsoft.com/mac/)
...
Wenn ein Benutzer bei gefährdeten PowerPoint-Versionen mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über das System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

Wir empfehlen Benutzern die sofortige Installation des Updates.

**Bewertungen des Schweregrads und Kennungen der Sicherheitsanfälligkeit:**

| Kennungen der Sicherheitsanfälligkeit                                                                                                                                                       | Auswirkung der Sicherheitsanfälligkeit | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 für Mac oder PowerPoint X für Mac |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------------|----------------------------------|-------------------------------------------------------------|
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – [CVE-2006- 3435](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435)                         | Remotecodeausführung                   | Keine                     | Keine                     | Hoch                             | Keine                                                       |
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3876](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876)                            | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                             | Hoch                                                        |
| Sicherheitsanfälligkeit in PowerPoint durch Speicherbeschädigung aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                             | Hoch                                                        |
| Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-4694](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4694)                            | Remotecodeausführung                   | Kritisch                  | Hoch                      | Hoch                             | Hoch                                                        |
...
**Warum hat Microsoft dieses Bulletin am 13. Februar 2007 minimal überarbeitet?**  
Weitere Untersuchungen von CVE-2006-3877, wie ursprünglich ausgeführt, haben ergeben, dass das Update die Sicherheitsanfälligkeit nicht wirksam von betroffenen Systemen entfernt hat. Das Microsoft Security Bulletin MS07-015 wurde veröffentlicht, um CVE-2006-3877 vollständig zu beheben. Benutzer sollten die Updates in diesem Bulletin sofort anwenden.
...
| Kennung des Bulletins                                                                       | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 für Mac oder PowerPoint X für Mac |
|---------------------------------------------------------------------------------------------|---------------------------|---------------------------|----------------------------------|-------------------------------------------------------------|
| [**MS06-028**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-028.mspx) | Ersetzt                   | Ersetzt                   | Ersetzt                          | Ersetzt                                                     |
...
#### Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – CVE-2006- 3435:

Eine Sicherheitsanfälligkeit in PowerPoint kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn PowerPoint eine Datei mit fehlerhaftem Objektzeiger analysiert.
...
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – CVE-2006-3435:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – CVE-2006-3435:
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – CVE-2006-3435:
...
PowerPoint führt bei der Verarbeitung des Inhalts einer .ppt-Datei keine ausreichende Datenüberprüfung durch. Wenn PowerPoint eine speziell gestaltete PowerPoint-Datei öffnet und ein fehlerhaftes Objekt analysiert, könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie PowerPoint die Datei analysiert und den Objektzeiger überprüft, bevor die Datei an den zugewiesenen Puffer übergeben wird.
...
#### Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – CVE-2006-3876:

Eine Sicherheitsanfälligkeit in PowerPoint kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn PowerPoint eine Datei mit fehlerhaftem Datensatz analysiert.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes -2006-3876:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – CVE-2006-3876:

-   Öffnen und speichern Sie keine Microsoft PowerPoint-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen (FAQ) zur Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – CVE-2006-3876:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
PowerPoint führt bei der Verarbeitung des Inhalts einer .ppt-Datei keine ausreichende Datenüberprüfung durch. Wenn PowerPoint eine speziell gestaltete PowerPoint-Datei öffnet und einen fehlerhaften Datensatz analysiert, könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie PowerPoint die Datei analysiert und die Länge eines Datensatzes überprüft, bevor die Datei an den zugewiesenen Puffer übergeben wird.
...
#### Sicherheitsanfälligkeit in PowerPoint aufgrund Speicherkorrumpierung durch fehlerhaften Datensatz – CVE-2006-3877:

In PowerPoint liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die ausgenutzt werden könnte, wenn PowerPoint eine speziell gestaltete Datei öffnet. Eine solche Datei kann in einer E-Mail-Anlage enthalten sein oder auf einer schädlichen Website gehostet werden. Ein Angreifer könnte die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete PowerPoint-Datei sendet, die eine Remotecodeausführung ermöglichen kann.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in PowerPoint aufgrund Speicherkorrumpierung durch fehlerhaften Datensatz - CVE-2006-3877:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in PowerPoint aufgrund Speicherkorrumpierung durch fehlerhaften Datensatz - CVE-2006-3877:

-   Öffnen und speichern Sie keine Microsoft PowerPoint-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen (FAQ) zur Sicherheitsanfälligkeit in PowerPoint aufgrund Speicherkorrumpierung durch fehlerhaften Datensatz - CVE-2006-3877:

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
In PowerPoint liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die ausgenutzt werden könnte, wenn PowerPoint eine Datei mit einem fehlerhaften Datensatz öffnet. Eine solche Datei kann in einer E-Mail-Anlage enthalten sein oder auf einer schädlichen Website gehostet werden. Ein Angreifer könnte die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete PowerPoint-Datei sendet, die eine Remotecodeausführung ermöglichen kann.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird verursacht, wenn PowerPoint eine speziell gestaltete PowerPoint-Datei öffnet, wodurch beim Analysieren von Platzhalterdaten auf Speicher außerhalb der vorgesehenen Regionen zugegriffen wird.
...
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
In einem webbasierten Angriffsszenario könnte ein Angreifer eine Webseite mit einer Seite einrichten, die diese Sicherheitsanfälligkeit ausnutzt. Außerdem können manipulierte Websites und Websites, die von Benutzern bereitgestellte Inhalte oder Werbemitteilungen akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden könnte. Ein Angreifer kann Benutzer jedoch nicht zum Besuch solcher Websites zwingen. Er muss den Benutzer zum Besuch dieser Webseite verleiten. Zu diesem Zweck wird der Benutzer meist dazu gebracht, in einer E-Mail oder einer Instant Messenger-Nachricht auf einen Link zur Website des Angreifers zu klicken.
Bei einem E-Mail-Angriff könnte ein Angreifer diese Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete PowerPoint-Datei an den Benutzer sendet und ihn dazu verleitet, die Datei zu öffnen.
...
#### Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – CVE-2006-4694:

In PowerPoint liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die ausgenutzt werden könnte, wenn PowerPoint eine speziell gestaltete Datei öffnet. Eine solche Datei kann in einer E-Mail-Anlage enthalten sein oder auf einer schädlichen Website gehostet werden. Ein Angreifer könnte die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete PowerPoint-Datei sendet, die eine Remotecodeausführung ermöglichen kann.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes - CVE-2006-4694:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes - CVE-2006-4694:

-   Öffnen und speichern Sie keine Microsoft PowerPoint-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen (FAQ) zur Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes - CVE-2006-4694:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird durch die Art und Weise verursacht, wie PowerPoint eine speziell gestaltete PowerPoint-Datei öffnet. Dieser Fehler kann zu Zugriff auf Speicher außerhalb vorgesehener Regionen führen, wenn PowerPoint Platzhalterdaten analysiert.
...
1.  [Laden Sie dieses Sicherheitsupdate für PowerPoint 2000 herunter](https://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
|--------------|--------------|-------------|---------|-----------|
| Powerpnt.exe | 9.00.00.8952 | 27-Sep-2006 | 05:08   | 4.259.892 |
...
1.  [Laden Sie dieses Sicherheitsupdate für](https://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe) PowerPoint 2002 herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie dieses Sicherheitsupdate für PowerPoint 2002 herunter](https://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält. Klicken Sie auf **Start** und danach auf **Ausführen**, geben Sie den folgenden Befehl zum Extrahieren der MSP-Datei ein, und klicken Sie danach auf **OK**:
...
1.  [Laden Sie das Sicherheitsupdate](https://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) für PowerPoint 2003 herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie das Sicherheitsupdate für PowerPoint 2003 herunter.](https://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mit Hilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält. Klicken Sie auf **Start** und danach auf **Ausführen**, geben Sie den folgenden Befehl zum Extrahieren der MSP-Datei ein, und klicken Sie danach auf **OK**:
...
-   Arnaud Dovi in Zusammenarbeit mit [Zero Day Initiative (ZDI)](https://www.zerodayinitiative.com/) und [TippingPoint](https://tippingpoint.com) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Objektzeigers – [CVE-2006- 3435](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435).
-   Dejun Meng von [Fortinet Inc.](https://www.fortinet.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3876](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876).
-   Chris Ries von [VigilantMinds Inc.](https://www.vigilantminds.com) für den Hinweis auf die Sicherheitsanfälligkeit in PowerPoint durch Speicherbeschädigung aufgrund eines fehlerhaften Datensatzes – [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877).
...
-   V1.1 (21. Februar 2007): Aktualisierung das Bulletins: Weitere Untersuchungen von CVE-2006-3877, wie ursprünglich ausgeführt, haben ergeben, dass das Update die Sicherheitsanfälligkeit nicht wirksam von betroffenen Systemen entfernt hat. Das Microsoft Security Bulletin MS07-015 wurde veröffentlicht, um CVE-2006-3877 vollständig zu beheben. Benutzer sollten die Updates in diesem Bulletin sofort anwenden.
