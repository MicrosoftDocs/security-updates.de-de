---
TOCTitle: 'MS10-042'
Title: 'Microsoft Security Bulletin MS10-042 - Kritisch'
ms:assetid: 'ms10-042'
ms:contentKeyID: 61224655
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-042(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-042 - Kritisch
===============================================

Sicherheitsanfälligkeit im Hilfe- und Supportcenter kann Remotecodeausführung ermöglichen (2229593)
---------------------------------------------------------------------------------------------------
Veröffentlicht: Dienstag, 13. Juli 2010
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP als Kritisch und für alle unterstützten Versionen von Windows Server 2003 als Niedrig eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Daten überprüft werden, wenn diese an das Windows Hilfe- und Supportcenter übergeben werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.

Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 2219475](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/2219475.mspx) beschrieben wurde.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7c2122bb-0ecf-4467-a3ba-6fb862f603c5&displaylang=de)  | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9232a336-9ded-4820-bac4-2d68877ee76c)                      | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cd4363b2-d7a7-4fff-8bcd-6fd02bd1ac07)                                      | Remotecodeausführung           | Niedrig                          | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a6bafd3b-c921-466d-bee0-59a3fe126712&displaylang=de)           | Remotecodeausführung           | Niedrig                          | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=b61cc2d5-8432-4681-aa2c-a8807ec1fcf4&displaylang=de) | Remotecodeausführung           | Niedrig                          | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit beim Überprüfen der Hilfecenter-URL – CVE-2010-1885</th>
...
Sicherheitsanfälligkeit beim Überprüfen der Hilfecenter-URL – CVE-2010-1885  
---------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Ausführung nicht authentifizierten Remotecodes vor, die dadurch verursacht wird, wie das Microsoft Hilfe- und Supportcenter speziell gestaltete URLs überprüft. Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen, wenn ein Benutzer in einem Webbrowser eine speziell gestaltete Webseite anzeigt oder auf einen speziell gestalteten Link in einer E-Mail-Nachricht klickt. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Überprüfen der Hilfecenter-URL – CVE-2010-1885
...
#### Problemumgehungen für die Sicherheitsanfälligkeit beim Überprüfen der Hilfecenter-URL – CVE-2010-1885
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Aufheben der Registrierung des HCP-Protokolls**
  
**Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 2229593](https://support.microsoft.com/kb/2229593), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
Durch die Aufhebung der Registrierung des HCP-Protokolls wird verhindert, dass dieses Problem auf betroffenen Systemen ausgenutzt wird.
...
4.  Geben Sie in das Dialogfeld „Registrierungsdatei exportieren“ den Namen **HCP\_Procotol\_Backup.reg** ein, und klicken Sie auf **Speichern**.  
...
2.  Speichern Sie anschließend Folgendes in einer Datei mit der Erweiterung .REG, z. B. Disable\_HCP\_Protocol.reg:  
...
**Auswirkung der Problemumgehung:** Das Aufheben der Registrierung des HCP-Protokolls unterbricht alle lokalen, gültigen Hilfelinks, die hcp:// verwenden. Beispielsweise funktionieren Links in der Systemsteuerung möglicherweise nicht mehr.
...
3.  Klicken Sie im Dialogfeld „Registrierungsdatei importieren“ auf **HCP\_Procotol\_Backup.reg** und dann auf **Öffnen**.
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Überprüfen der Hilfecenter-URL – CVE-2010-1885
...
Das Windows Hilfe- und Supportcenter überprüft URLs bei der Verwendung des HCP-Protokolls nicht richtig.
  
**Was ist das Hilfe- und Supportcenter?**    
Das Hilfe- und Supportcenter (HSC) ist eine Komponente von Windows, die Unterstützung zu zahlreichen Themen bietet. Benutzer können sich z. B. mit HSC über bestimmte Windows-Funktionen informieren, Softwareupdates herunterladen und installieren, die Windows-Kompatibilität bestimmter Hardwaregeräte prüfen, Unterstützung durch Microsoft erhalten usw. Benutzer und Programme können über URL-Verknüpfungen zum Hilfe- und Supportcenter gelangen, indem sie in einer URL-Verknüpfung das Präfix „hcp://“ verwenden.
  
**Was ist das HCP-Protokoll?**    
Dieses Protokoll ähnelt dem HTTP-Protokoll, das zum Ausführen von URL-Verknüpfungen und zum Öffnen eines Webbrowsers verwendet wird. Das HCP-Protokoll kann zum Ausführen von URL-Verknüpfungen und zum Öffnen der Komponente Hilfe- und Supportcenter verwendet werden.
  
**Sind Anwendungen von Drittanbietern direkt von diesem Problem betroffen?**    
Nein. Allerdings kann dieses Problem unabhängig vom Webbrowsertyp mithilfe von Webtransaktionen ausgenutzt werden. In einem webbasierten Angriffsszenario müsste ein Angreifer eine Webseite hosten, die eine speziell gestaltete URI enthält. Jede Anwendung, die das HCP-Protokoll verarbeiten kann, kann als Angriff verwendet werden, um dieses Problem auszunutzen.
  
**Weshalb wurde diese Sicherheitsanfälligkeit unter Windows Server 2003 mit niedrigem Schweregrad eingestuft?**    
Die Sicherheitsanfälligkeit liegt in Windows Server 2003 vor, aber wir haben keine Methode gefunden, um die Sicherheitsanfälligkeit von einem Remotestandort aus auf Servern mit Windows Server 2003 auszuführen. Dennoch behebt dieses Update die Sicherheitsanfälligkeit für Windows Server 2003, um die beschriebene Bedrohung durch einen Remoteangriff zu beheben.
...
In erster Linie sind Windows XP-Systeme von dieser Sicherheitsanfälligkeit betroffen. Systeme mit Windows Server 2003 sind ebenfalls gefährdet, aber wir haben keine Möglichkeit finden können, dieses Problem von einem Remotestandort aus unter Windows Server 2003 auszunutzen.
  
**Was bewirkt das Update?**    
Dieses Update behebt diese Sicherheitsanfälligkeit, indem geändert wird, wie Daten überprüft werden, die an das Windows Hilfe- und Supportcenter übergeben werden.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) zugewiesen. Die Sicherheitsanfälligkeit wurde erstmals in der [Microsoft-Sicherheitsempfehlung 2219475](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/2219475.mspx) beschrieben.
  
**Lagen Microsoft zum Zeitpunkt der Veröffentlichung dieses Security Bulletins Informationen vor, dass diese Sicherheitsanfälligkeit bereits ausgenutzt wurde?**    
Ja. Microsoft ist sich aktiver Angriffe bewusst, bei denen versucht wird, die Sicherheitsanfälligkeit auszunutzen. Auf Grundlage der analysierten Proben sind Windows Server 2003-Systeme derzeit nicht durch diese Angriffe gefährdet.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2229593$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2229593">Microsoft Knowledge Base-Artikel 2229593</a>.</td>
</tr>
<tr class="even">
