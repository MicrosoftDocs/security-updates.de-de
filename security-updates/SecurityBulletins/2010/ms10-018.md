...
Mit diesem Sicherheitsupdate wird auch die Sicherheitsanfälligkeit behoben, die erstmals in der [Microsoft-Sicherheitsempfehlung 981374](https://technet.microsoft.com/security/advisory/981374) beschrieben wurde. Die Sicherheitsanfälligkeit [CVE-2010-0806](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806) wirkt sich nicht auf Windows 7, Windows Server 2008 R2 oder Internet Explorer 8 aus.
...
Die Dateiinformationen befinden sich im [Microsoft Knowledge Base-Artikel 980182](https://support.microsoft.com/kb/980182).
...
Bei der folgenden Bewertung des Schweregrads wird die potenzielle maximale Auswirkung der Sicherheitsanfälligkeit angenommen. Informationen zur Wahrscheinlichkeit der Ausnutzung der Sicherheitsanfälligkeit in Bezug auf die Bewertung des Schweregrads und die Sicherheitsauswirkung innerhalb von 30 Tagen nach Veröffentlichung dieses Security Bulletins finden Sie im Ausnutzbarkeitsindex im [Bulletin Summary für März](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-mar.mspx). Weitere Informationen finden Sie in [Microsoft-Ausnutzbarkeitsindex](https://technet.microsoft.com/de-de/security/cc998259.aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0267](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0488](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0489](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0490](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0491](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0494](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0805](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0806](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806).
...
-   **Aktivieren Sie DEP für Internet Explorer 7 mithilfe der automatisierten Microsoft Fix it-Lösung**
    ...
    Im [Microsoft Knowledge Base-Artikel 980182](https://support.microsoft.com/kb/980182) finden Sie Informationen zur Aktivierung und Deaktivierung dieser Problemumgehung mithilfe der automatisierten Microsoft Fix it-Lösung.
...
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-0806](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806) zugewiesen. Außerdem wurde sie in der [Microsoft-Sicherheitsempfehlung 981374](https://technet.microsoft.com/security/advisory/981374) beschrieben.
...
Wenn Sie die in der [Microsoft-Sicherheitsempfehlung 981374](https://technet.microsoft.com/security/advisory/981374) bereitgestellten Problemumgehungen installiert haben, müssen Sie sie rückgängig machen, indem Sie die Anweisungen zum Rückgängigmachen der Problemumgehung im Unterabschnitt „Problemumgehungen für die Sicherheitsanfälligkeit durch Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2010-0806“ rückgängig machen. Wenn die Problemumgehungen „iepeers.dll“ oder DEP mit der in der [Microsoft-Sicherheitsempfehlung 981374](https://technet.microsoft.com/security/advisory/981374) bereitgestellten Funktion „Diese Problemumgehung aktivieren“ installiert wurden, können Sie die Problemumgehung rückgängig machen, indem Sie die Option „Diese Problembehebung deaktivieren“ für diese Problemumgehungen in [Microsoft Knowledge Base-Artikel 980182](https://support.microsoft.com/kb/980182) auswählen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0807](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/980182">Microsoft Knowledge Base-Artikel 980182</a>.</td>
</tr>
<tr class="even">
...
-   [Secunia](https://secunia.com) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2010-0267).  
-   Daiki Fukumori von [Cyber Defense Institute Inc.](https://www.cyberdefense.jp/) für den Hinweis auf die Sicherheitsanfälligkeit durch Offenlegung von Informationen nach dem Codieren (CVE-2010-0488).  
-   Alexander Kornbrust von [Red Database Security](https://www.red-database-security.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2010-0490).  
-   Ivan Fratric von [iSIGHT Partners](https://www.isightpartners.com/) Global Vulnerability Partnership für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2010-0490).  
-   Wushi von [team509](https://www.team509.com/) in Zusammenarbeit mit [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Objekten (CVE-2010-0491).  
-   Simon Zuckerbraun, der mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Objekten (CVE-2010-0492).  
-   Paul Stone von [Context Information Security](https://www.contextis.co.uk/) für den Hinweis auf die Sicherheitsanfälligkeit bei domänenübergreifenden HTML-Elementen (CVE-2010-0494).  
-   Einer Person, die mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung (CVE-2010-0805).  
-   ADLab von [VenusTech](https://www.venustech.com.cn/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung (CVE-2010-0806).  
-   ADLab von [VenusTech](https://www.venustech.com.cn/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Rendering (CVE-2010-0807).
