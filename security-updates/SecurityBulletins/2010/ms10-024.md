...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 981832](https://support.microsoft.com/kb/981832) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Weitere Informationen finden Sie im TechNet-Artikel [Vorgehensweise beim Installieren des aktuellen Service Packs oder Update-Rollups für Exchange 2007](https://technet.microsoft.com/de-de/library/ee221147(exchg.80).aspx).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0025).
...
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 976323](https://support.microsoft.com/kb/976323).                                                               |
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/976323">Microsoft Knowledge Base-Artikel 976323</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/976703">Microsoft Knowledge Base-Artikel 976703</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/976702">Microsoft Knowledge Base-Artikel 976702</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Für Microsoft Exchange Server 2007 Service Pack 1 für x64-basierte Systeme:<br />
Siehe <a href="https://support.microsoft.com/kb/981407">Microsoft Knowledge Base-Artikel 981407</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Exchange Server 2007 Service Pack 2 für x64-basierte Systeme:<br />
Siehe <a href="https://support.microsoft.com/kb/981383">Microsoft Knowledge Base-Artikel 981383</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Microsoft Exchange Server 2007 Service Pack 1 für x64-basierte Systeme:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/981401">Microsoft Knowledge Base-Artikel 981401</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Für Microsoft Exchange Server 2010 für x64-basierte Systeme:<br />
