---
TOCTitle: 'MS10-097'
Title: 'Microsoft Security Bulletin MS10-097 - Kritisch'
ms:assetid: 'ms10-097'
ms:contentKeyID: 61224710
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-097(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-097 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Assistent zum Anmelden von Internetverbindungen externe Bibliotheken lädt. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=fa9a1aac-b9c5-4d4e-9083-a080ad4ccc6f)                                | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6dabc306-c858-46b1-815c-cd8d011ff62e)                      | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8fa2cfa4-a01d-4910-b69f-736aeb585bab)                       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=17b0b340-73b2-42a7-9d86-1297c63dcc2b)           | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=04a178cc-1afd-4e47-8cab-05e402e5a568) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen – CVE-2010-3144</th>
...
Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen – CVE-2010-3144  
--------------------------------------------------------------------------------------------------------------------------------------------
  
Eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung existiert durch die Art und Weise, wie der Assistent zum Anmelden von Internetverbindungen, eine Komponente von Microsoft Windows, das Laden von DLL-Dateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3144](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen – CVE-2010-3144
...
#### Problemumgehungen für die Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen – CVE-2010-3144
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen – CVE-2010-3144
...
Diese Sicherheitsanfälligkeit wird dadurch verursacht, dass der Assistent zum Anmelden von Internetverbindungen den für das Laden externer Bibliotheken verwendeten Pfad falsch einschränkt.
  
**Was ist der Assistent zum Anmelden von Internetverbindungen?**  
Der Assistent zum Anmelden von Internetverbindungen ermöglicht einem Benutzer, eine Verbindung auf einem neuen Computer zu konfigurieren oder ein Internetdienstkonto zu verwenden, das auf einem vorherigen Computer vorhanden war. Der Assistent unterstützt außerdem Benutzer, deren Interneteinstellungen beschädigt wurden. Die automatische Konfigurationsfunktion stellt die Einstellungen wieder her – der Benutzer muss lediglich die Benutzer-ID, das Kennwort und den Namen des POP-Servers (Point of Presence) angeben.
...
Ein Angreifer kann einen Benutzer dazu verleiten, eine gültige INS oder ISP-Datei zu öffnen, die sich im selben Netzwerkverzeichnis befindet wie eine speziell gestaltete DLL-Datei (Dynamic Link Library). Beim Öffnen der Datei kann dann der Assistent zum Anmelden von Internetverbindungen versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem E-Mail-Angriffsszenario kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine gültige INS- oder ISP-Dateianlage an einen Benutzer sendet und diesen verleitet, die Dateianlage in einem Verzeichnis abzulegen, das eine speziell gestaltete DLL-Datei enthält, und danach die INS- oder ISP-Datei zu öffnen. Beim Öffnen der INS- oder ISP-Datei kann dann der Assistent zum Anmelden von Internetverbindungen versuchen, die DLL-Datei zu laden und den darin enthaltenen Code auszuführen.
  
In einem Netzwerkszenario kann ein Angreifer einer gültigen INS- oder ISP-Datei und eine speziell gestaltete DLL an einem UNC- oder WebDAV-Speicherort ablegen und dann den Benutzer verleiten, die PRX-Datei zu öffnen. Ein Angreifer kann auch eine Website hosten und von dieser Website aus auf die gültige Datei verweisen, was dann dazu führt, dass die Sicherheitsanfälligkeit über einen Webbrowser ausgelöst wird.
...
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der Assistent zum Anmelden von Internetverbindungen externe Bibliotheken lädt.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**    
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3144](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144) zugewiesen.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2443105$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2443105">Microsoft Knowledge Base-Artikel 2443105</a>.</td>
</tr>
<tr class="even">
...
-   Muhaimin Dzulfakar von [NGS Software](https://www.ngssoftware.com/) für den Hinweis auf die Sicherheitsanfälligkeit aufgrund nicht sicheren Ladens von Bibliotheken im Assistenten zum Anmelden von Internetverbindungen (CVE-2010-3144)
