---
TOCTitle: 'MS10-102'
Title: 'Microsoft Security Bulletin MS10-102 - Kritisch'
ms:assetid: 'ms10-102'
ms:contentKeyID: 61224715
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-102(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-102 - Kritisch
===============================================

Sicherheitsanfälligkeit in Hyper-V kann Denial-of-Service ermöglichen (2345316)
-------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 14. Dezember 2010 | Aktualisiert: Mittwoch, 12. Januar 2011
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Hyper-V Server fehlerhafte Pakete überprüft, die innerhalb seiner virtuellen Gastcomputer an den VMBus gesendet werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.**  Im [Microsoft Knowledge Base-Artikel 2345316](https://support.microsoft.com/kb/2345316) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed)\* | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118)\*                                                              | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
Das Deinstallieren dieses Updates erfordert zwei Neustarts aufgrund der Anwesenheit von bestimmten Binärdateien, die im Update angeboten werden. Systeme, die nach der Deinstallation des Updates nicht zweimal neu gestartet wurden, erfahren u. U. einen Verlust der Netzwerkkonnektivität. Weitere Informationen zu diesem Update finden Sie im [Microsoft Knowledge Base-Artikel 2345316](https://support.microsoft.com/kb/2345316).
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im VMBus von Hyper-V – CVE-2010-3960</th>
...
Sicherheitsanfälligkeit im VMBus von Hyper-V – CVE-2010-3960  
------------------------------------------------------------
  
In Windows Server 2008 Hyper-V und Windows Server 2008 R2 Hyper-V liegt eine Sicherheitsanfälligkeit vor, die Denial-of-Service ermöglicht, wenn ein authentifizierter Benutzer ein speziell gestaltetes Paket an den VMBus in einem der virtuellen Gastcomputer sendet, die vom Hyper-V Server gehostet werden. Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal bei einem virtuellen Gastcomputer anmelden können, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht per Remotezugriff oder von anonymen Benutzern ausgenutzt werden.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3960](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im VMBus von Hyper-V – CVE-2010-3960
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal bei einem virtuellen Computer in Hyper-V anmelden können, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht per Remotezugriff oder von anonymen Benutzern ausgenutzt werden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit im VMBus von Hyper-V – CVE-2010-3960
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit im VMBus von Hyper-V – CVE-2010-3960
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass der betroffene Hyper-V Server nicht mehr reagiert und neu gestartet werden muss. Beachten Sie, dass eine Sicherheitsanfälligkeit vom Typ Denial-of-Service einem Angreifer keine Codeausführung oder Erhöhung von Benutzerberechtigungen ermöglicht, sondern dazu führt, dass das betroffene System keine Anforderungen mehr annimmt.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit wird dadurch verursacht, dass der Hyper-V-Server besonders gekapselte Pakete nicht richtig überprüft, die an den Hyper-V VMBus gesendet werden. Aufgrund dieses Überprüfungsmangels kann die Verarbeitung dieser Pakete bewirken, dass die Hyper-V-Serveranwendung nicht mehr reagiert.
  
**Was ist Hyper-V?**    
Hyper-V ist eine auf Hypervisor basierende Technologie, die eine Schlüsselfunktion von Windows Server 2008 und Windows Server 2008 R2 ist. Sie stellt eine skalierbare, zuverlässige und hochverfügbare Virtualisierungsplattform bereit. Eine Virtualisierungsumgebung ist nützlich, da Benutzer virtuelle Computer erstellen und verwalten können. Dadurch können sie auf einem physischen Computer mehrere Betriebssysteme ausführen und die Betriebssysteme voneinander isolieren.
  
**Was ist VMBus?**    
Der VMBus ist ein logischer Kommunikationskanal zwischen den Partitionen. Weitere Informationen zu der VMBus- und Hyper-V-Architektur finden Sie in dem MSDN-Artikel [Hyper-V-Architektur](https://msdn.microsoft.com/en-us/library/cc768520(bts.10).aspx).
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**    
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass das System eines Benutzers nicht mehr reagiert, bis es neu gestartet wird. Beachten Sie, dass Ausnutzung dieser Sicherheitsanfälligkeit bewirken kann, dass der eigentliche Hyper-V Server nicht mehr reagiert, einschließlich aller virtuellen Gastcomputer, die von jenem Server gehostet werden.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer muss ein authentifizierter Benutzer auf einem der virtuellen Gastcomputer sein, die vom Hyper-V Server gehostet werden, und die Möglichkeit haben, beliebigen Code auf dem System auszuführen. Ein Angreifer muss dann einen benutzerdefinierten Treiber erstellen, der speziell gestaltete Pakete erstellt, die an den VMBus übergeben werden, wodurch der Hyper-V-Server nicht mehr reagiert.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Hyper-V-Server, die virtuelle Gastcomputer hosten, die nicht vertrauenswürdigen Benutzern Zugriff ermöglichen, sind durch diese Sicherheitsanfälligkeit besonders gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Hyper-V-Server speziell gestaltete Pakete überprüft und verarbeitet, die von virtuellen Gastcomputern an den Hyper-V VMBus übergeben werden.
...
#### Windows Server 2008 (alle x64-basierten Editionen)
...
<br />
Das Deinstallieren dieses Updates erfordert zwei Neustarts, um einen Verlust der Netzwerkkonnektivität zu vermeiden. Weitere Informationen zu dieser Erkennungsänderung finden Sie im <a href="https://support.microsoft.com/kb/2345316">Microsoft Knowledge Base-Artikel 2345316</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2345316">Microsoft Knowledge Base-Artikel 2345316</a>.</td>
</tr>
<tr class="odd">
...
-   [HP](https://www.hp.com) und [techit](https://www.techit.de) für den Hinweis auf die Sicherheitsanfälligkeit im VMBus von Hyper-V (CVE-2010-3960)
...
-   V1.1 (12. Januar 2011): Eine häufig gestellte Frage (FAQs) zu diesem Update wurde hinzugefügt, um zu verdeutlichen, dass das Update nur auf jenen betroffenen Betriebssystemen installiert werden kann, auf denen die Hyper-V-Rolle aktiviert ist.
