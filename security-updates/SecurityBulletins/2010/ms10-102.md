...
**Bekannte Probleme.**  Im [Microsoft Knowledge Base-Artikel 2345316](http://support.microsoft.com/kb/2345316) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3960](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960).
...
**Was ist VMBus?**    
Der VMBus ist ein logischer Kommunikationskanal zwischen den Partitionen. Weitere Informationen zu der VMBus- und Hyper-V-Architektur finden Sie in dem MSDN-Artikel [Hyper-V-Architektur](http://msdn.microsoft.com/en-us/library/cc768520(bts.10).aspx).
...
<br />
Das Deinstallieren dieses Updates erfordert zwei Neustarts, um einen Verlust der Netzwerkkonnektivität zu vermeiden. Weitere Informationen zu dieser Erkennungsänderung finden Sie im <a href="http://support.microsoft.com/kb/2345316">Microsoft Knowledge Base-Artikel 2345316</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2345316">Microsoft Knowledge Base-Artikel 2345316</a>.</td>
</tr>
<tr class="odd">
...
-   [HP](http://www.hp.com) und [techit](http://www.techit.de) für den Hinweis auf die Sicherheitsanfälligkeit im VMBus von Hyper-V (CVE-2010-3960)
