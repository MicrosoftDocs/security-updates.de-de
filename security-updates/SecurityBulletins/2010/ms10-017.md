...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=03429f8a-8aab-4a59-97e4-7ce047f100a5&displaylang=de)<sup>[1]</sup>
(KB978382)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=03429f8a-8aab-4a59-97e4-7ce047f100a5&displaylang=de)<sup>[1]</sup>
(KB978382)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=94ddf6ef-3392-4d77-a02b-3bc0470721cd&displaylang=de)<sup>[2]</sup>
(KB979439)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=94ddf6ef-3392-4d77-a02b-3bc0470721cd&displaylang=de)<sup>[2]</sup>
(KB979439)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=06f6bffb-3fad-4fb5-878b-39550812e9b5&displaylang=de)<sup>[2]</sup>
(KB979439)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?familyid=06f6bffb-3fad-4fb5-878b-39550812e9b5&displaylang=de)<sup>[2]</sup>
(KB979439)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
Im [Microsoft Knowledge Base-Artikel 980150](https://support.microsoft.com/kb/980150) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258).
...
-   **Verwenden Sie die Microsoft Office Isolated Conversion Environment (MOICE), wenn Sie Dateien von unbekannten oder nicht vertrauenswürdigen Quellen öffnen.**
    ...
    [https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=de](https://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=de-de)
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0262](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Office 2007-Dokumenten von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](https://support.microsoft.com/kb/922848) erörtert ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, können Office 2007-Dateien nicht in Office 2003 oder Microsoft Office System 2007 öffnen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/978471">Microsoft Knowledge Base-Artikel 978471</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/978474">Microsoft Knowledge Base-Artikel 978474</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<a href="https://support.microsoft.com/kb/978382">Microsoft Knowledge Base-Artikel 978382</a><br />
<br />
Um Informationen zu Excel Viewer zu erhalten, siehe:<br />
<a href="https://support.microsoft.com/kb/978383">Microsoft Knowledge Base-Artikel 978383</a><br />
<br />
...
<a href="https://support.microsoft.com/kb/978380">Microsoft Knowledge Base-Artikel 978380</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.5.8 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=ae5936f8-fe3f-4d23-a37c-d80f228e475e) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.2.4 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=e0ed1569-ab2f-407c-b728-4eddc463c385&displaylang=de) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.1.4 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=4c5487d5-c912-4087-8c83-769e3fb78ea9&displaylang=de) herunter, und installieren Sie sie.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/979439">Microsoft Knowledge Base-Artikel 979439</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Microsoft Office Excel-Datensatz (CVE-2010-0257)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Objekttypverwechslung bei Microsoft Office Excel-Tabellen (CVE-2010-0258)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs bei Microsoft Office Excel-MDXTUPLE-Datensatz (CVE-2010-0260)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs bei Microsoft Office Excel-MDXSET-Datensatz (CVE-2010-0261)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich nicht initialisierten Speichers bei Microsoft Office Excel-FNGROUPNAME-Datensatz – CVE-2010-0262  
-   Einer Person, die mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Office Excel bezüglich Codeausführung bei XLSX-Datei-Analyse (CVE-2010-0263)  
-   Damián Frizza von [Core Security Technologies](https://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Office Excel bezüglich DbOrParamQry-Datensatz-Analyse (CVE-2010-0264)
