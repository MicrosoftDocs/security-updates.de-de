...
Bekannte Probleme. Der [Microsoft Knowledge Base-Artikel 2027452](https://support.microsoft.com/kb/2027452) dokumentiert derzeit bekannte Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können. Der Artikel beschreibt auch empfohlene Lösungen für diese Probleme.
...
Mit den Sicherheitsupdatepaketen in [MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) für Microsoft Office Excel 2003 (KB982133) und Microsoft Office Excel 2007 (KB982308) werden auch die in diesem Bulletin, MS10-038, beschriebenen Sicherheitsanfälligkeiten behoben. Benutzer mit Microsoft Office Excel 2003 oder Microsoft Office Excel 2007 müssen diese Sicherheitsupdatepakete nur einmal installieren. Außerdem bietet [MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) zugeordnete Microsoft Office Updates (KB982311 oder KB982312) an, die Benutzer ebenfalls installieren müssen, um die in [MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) beschriebene Sicherheitsanfälligkeit zu beheben.
...
Ja, das Updatepaket für Microsoft Office Excel 2007 Service Pack 1 und Microsoft Office Excel 2007 Service Pack 2 (KB982308) beinhaltet die Änderungen an Excel 2007, die im [Microsoft Knowledge Base-Artikel 981046](https://support.microsoft.com/kb/981046) beschrieben werden.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0821](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0821).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0822](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0823](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0824](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1245](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1246](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1247](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1248](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/982299">Microsoft Knowledge Base-Artikel 982299</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Dateiinformationen:</td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/982133">Microsoft Knowledge Base-Artikel 982133</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Überprüfung des Registrierungsschlüssels</td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<td style="border:1px solid black;">Dateiinformationen:</td>
<td style="border:1px solid black;">Für Excel 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/982308">Microsoft Knowledge Base-Artikel 982308</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Excel Viewer:<br />
Siehe <a href="https://support.microsoft.com/kb/982333">Microsoft Knowledge Base-Artikel 982333</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007:<br />
Siehe <a href="https://support.microsoft.com/kb/982331">Microsoft Knowledge Base-Artikel 982331</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Überprüfung des Registrierungsschlüssels</td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Einer Person, die mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung beim Analysieren von Excel-Datensätzen (CVE-2010-0821).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bzgl. Überlaufs im Objektstapel (CVE-2010-0822).  
-   Bing Liu von [Fortinets FortiGuard Labs](https://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2010-0823).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung in Datensätzen (CVE-2010-0824).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung in Datensätzen (CVE-2010-1245).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel-RTD bezüglich Speicherbeschädigung (CVE-2010-1246).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2010-1247).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel-HFPicture bezüglich Speicherbeschädigung (CVE-2010-1248).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2010-1249).  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel-EDG bezüglich Speicherbeschädigung (CVE-2010-1250).  
-   Carsten Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Excel-Datensatz bezüglich Stapelbeschädigung (CVE-2010-1251).  
-   Carsten Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Zeichenfolgenvariablen von Excel (CVE-2010-1252).  
-   Ein Forscher, der mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit im ADO-Objekt von Excel (CVE-2010-1253).  
