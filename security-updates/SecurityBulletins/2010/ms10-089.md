...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2316074](https://support.microsoft.com/kb/2316074) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2732](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2732).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2733](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2733).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2734](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2734).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3936).
...
<td style="border:1px solid black;">Für Forefront Unified Access Gateway 2010 (KB2433585):<br />
Siehe <a href="https://support.microsoft.com/kb/2433585">Microsoft Knowledge Base-Artikel 2433585</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Forefront Unified Access Gateway 2010 Update 1 (KB2433584):<br />
Siehe <a href="https://support.microsoft.com/kb/2433584">Microsoft Knowledge Base-Artikel 2433584</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Forefront Unified Access Gateway 2010 Update 2 (KB2418933):<br />
Siehe <a href="https://support.microsoft.com/kb/2418933">Microsoft Knowledge Base-Artikel 2418933</a>.</td>
</tr>
<tr class="even">
...
-   Eyal Gruner von [BugSec](https://www.bugsec.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit bei UAG-Umleitung bzgl. Spoofing (CVE-2010-2732)
-   Eyal Gruner von [BugSec](https://www.bugsec.com/) für die Zusammenarbeit mit uns an „Sicherheitsanfälligkeit in UAG durch siteübergreifende Skripterstellung ermöglicht Erhöhung von Berechtigungen“ (CVE-2010-2733)
-   Eyal Gruner von [BugSec](https://www.bugsec.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit durch siteübergreifende Skripterstellung in Signurl.asp (CVE-2010-3936)
