...
**Bekannte Probleme.** Der [Microsoft Knowledge Base-Artikel 982666](https://support.microsoft.com/kb/982666) dokumentiert derzeit bekannte Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können. Der Artikel beschreibt auch empfohlene Lösungen für diese Probleme.
...
<sup>[1]</sup>Dieses Betriebssystem ist nur betroffen, wenn der erweiterte Authentifizierungsschutz installiert wurde. Siehe [Microsoft Knowledge Base-Artikel 973917](https://support.microsoft.com/kb/973917). Weitere Informationen finden Sie im Eintrag in **Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate**.
...
Diese Sicherheitsanfälligkeit betrifft Systeme mit Windows 7 und Windows Server 2008 R2. Außerdem betrifft es Systeme mit Windows Server 2003, Windows Vista und Windows Server 2008, auf denen [KB973917](https://support.microsoft.com/kb/973917) installiert ist, ein nicht sicherheitsrelevantes Update, das den erweiterten Authentifizierungsschutz implementiert.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256).
...
-   **Tokenüberprüfung erforderlich**
    ...
    Systeme, auf denen Internetinformationsdienste dafür konfiguriert wurden, den erweiterten Schutz zu verwenden, um eine Tokenüberprüfung erforderlich zu machen (siehe [Microsoft Knowledge Base-Artikel 973917](https://support.microsoft.com/kb/973917)), sind von der Sicherheitsanfälligkeit nicht betroffen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/982666">Microsoft Knowledge Base-Artikel 982666</a>.</td>
</tr>
<tr class="even">
