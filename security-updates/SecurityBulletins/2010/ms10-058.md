...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1892](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1892).
...
-   **Deaktivieren der IPv6-Komponenten (Internetprotokoll Version 6)**
    ...
    **Hinweis:** Im [Microsoft Knowledge Base-Artikel 929852](http://support.microsoft.com/kb/929852) finden Sie Informationen zur Verwendung der automatisierten **Microsoft Fix it**-Lösung 50440, um IPv6-Komponenten zu deaktivieren. Diese Fix it-Lösung erfordert nach Abschluss einen Neustart, um wirksam zu werden.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1893).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/978886">Microsoft Knowledge Base-Artikel 978886</a>.</td>
</tr>
<tr class="odd">
...
-   Darren Willis vom [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/) für den Hinweis auf die Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung (CVE-2010-1892)  
-   Matthieu Suiche von [MoonSols](http://moonsols.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs (CVE-2010-1893)
