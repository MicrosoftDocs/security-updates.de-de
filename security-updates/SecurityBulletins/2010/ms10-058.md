---
TOCTitle: 'MS10-058'
Title: 'Microsoft Security Bulletin MS10-058 - Hoch'
ms:assetid: 'ms10-058'
ms:contentKeyID: 61224671
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-058(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 10. August 2010 | Aktualisiert: Dienstag, 13. März 2012
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie der TCP/IP-Stapel fehlerhafte IPv6-Pakete und -Daten verarbeitet, die aus dem Benutzermodus kopiert wurden. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4684c4df-0a5c-4dba-82e5-059378737118)                                                        | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=18152cd4-815f-425f-8694-fbabcbe80609)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=844404be-f2e8-47bc-9650-9e2bbe383814)\*                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=08491c73-66b1-4c4c-8740-ea596a730fc1)\*       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8aa12902-c234-4fd9-bba3-6767eafc38fc) | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=3a5a088e-644a-4a0e-9a09-0370bcd97688)                                                                                         | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=163fe2bd-f999-47c1-9a35-c4fc868bda51)                                                                                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=a1f95600-34e5-44b3-b2cb-b2b2cbf645cb)\*                                                                    | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c3cd7f2f-e198-4fbd-a65d-21a1bf51eb61)                                                                  | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
**Weshalb wurde dieses Bulletin** **am13. März** **2012 überarbeitet?**  
Microsoft hat dieses Security Bulletin überarbeitet, um eine Erkennungsänderung anzukündigen, mit der MS10-029 als ersetztes Bulletin für alle unterstützten Editionen von Windows Vista und Windows Server 2008 entfernt wird: Mit diesem Update werden keine Bulletins für diese Betriebssysteme ersetzt. Dies ist lediglich eine Erkennungsänderung. Die Dateien des Sicherheitsupdates wurden nicht verändert. Benutzer, die dieses Update bereits erfolgreich installiert haben, müssen es nicht erneut installieren. Sie sollten jedoch sicherstellen, dass KB978338 auf Systemen mit Windows Vista und Windows Server 2008 installiert ist, um vor der in MS10-029 beschriebenen Sicherheitsanfälligkeit geschützt zu sein.

**Wo befinden sich die Dateiinformationen?**  
Informationen zum Speicherort der Dateiinformationen finden Sie in den Referenztabellen im Abschnitt **Bereitstellung von Sicherheitsupdates**.

**Warum behebt dieses Update zwei gemeldete Sicherheitsanfälligkeiten?**  
Dieses Update bietet Unterstützung für zwei Sicherheitsanfälligkeiten, da die Änderungen, die zum Beheben dieser Probleme erforderlich sind, in zueinander in Beziehung stehenden Dateien enthalten sind. Auf diese Weise müssen Benutzer nicht zwei separate Updates installieren, die nahezu identisch sind, sondern nur dieses eine Update.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs – CVE-2010-1893</th>
...
Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892  
------------------------------------------------------------------------------
  
In Microsoft Windows liegt in der Verarbeitung von TCP/IP eine Sicherheitsanfälligkeit bezüglich Denial-of-Service vor, die durch einen Fehler in der Verarbeitung speziell gestalteter IPv6-Pakete mit fehlerhaftem Erweiterungsheader entsteht. Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine kleine Zahl speziell gestalteter Pakete an das Zielsystem sendet, die bewirken, dass das betroffene System nicht mehr reagiert.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1892](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1892).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892
  
Für diese Sicherheitsanfälligkeit gibt es noch keine schadensbegrenzenden Faktoren.
  
#### Problemumgehung für die Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Deaktivieren der IPv6-Komponenten (Internetprotokoll Version 6)**
  
    **Hinweis:** Im [Microsoft Knowledge Base-Artikel 929852](https://support.microsoft.com/kb/929852) finden Sie Informationen zur Verwendung der automatisierten **Microsoft Fix it**-Lösung 50444, um IPv6-Komponenten, mit Ausnahme der Loopback-Schnittstelle, zu deaktivieren. Diese Fix it-Lösung erfordert nach Abschluss einen Neustart, um wirksam zu werden. Diese Fix it-Lösung stellt die Problemumgehung bereit und hat folglich die gleichen Auswirkungen auf Benutzer. Wir empfehlen Administratoren, den KB-Artikel sorgfältig zu lesen, bevor sie diese Fix it-Lösung bereitstellen.
    ...
    **Hinweis:** Eine fehlerhafte Verwendung des Registrierungs-Editors kann unter Umständen ernste Probleme verursachen, die eine erneute Installation des Betriebssystems erfordern können. Microsoft kann nicht gewährleisten, dass Probleme, die sich aus der fehlerhaften Verwendung des Registrierungs-Editors ergeben, behoben werden können. Verwenden Sie den Registrierungs-Editor auf eigenes Risiko. Weitere Informationen zum Bearbeiten der Registrierung finden Sie im Hilfethema Ändern von Schlüsseln und Werten im Registrierungs-Editor (Regedit.exe) oder in den Hilfethemen über das Hinzufügen und das Löschen von Informationen in der Registrierung und im Hilfethema Bearbeiten der Registrierungsdaten in Regedt32.exe.
    ...
    1.  Klicken Sie auf **Start**, geben Sie **regedit** im Feld **Suche starten** ein, und klicken Sie dann in der Liste **Programme** auf **regedit.exe**.  
    2.  Klicken Sie im Dialogfeld **Benutzerkontensteuerung** auf **Weiter**.  
    3.  Suchen Sie im Registrierungs-Editor den folgenden Registrierungsunterschlüssel und klicken Sie dann darauf:  
        `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters\`  
    4.  Doppelklicken Sie auf **DisabledComponents**, um diesen Eintrag zu ändern.  
        ...
        **Hinweis:** Wenn der Eintrag „DisabledComponents“ nicht verfügbar ist, müssen Sie ihn erstellen. Führen Sie zu diesem Zweck die folgenden Schritte durch:  
        a. Zeigen Sie im Menü **Bearbeiten** auf **Neu**, und klicken Sie dann auf **DWORD-Wert (32-Bit)**.  
        b. Geben Sie **DisabledComponents** ein, und drücken Sie dann die **Eingabetaste**.  
        c. Doppelklicken Sie auf **DisabledComponents.**  
    5.  Geben Sie **0xffffffff** ein, um alle IPv6-Komponenten, mit Ausnahme der IPv6-Loopback-Schnittstelle, zu deaktivieren. Dieser Wert konfiguriert auch Windows, sodass Internetprotokoll Version 4 (IPv4) statt IPv6 in den Präfixrichtlinien verwendet wird.  
    6.  Klicken Sie auf **OK**. Sie müssen Ihren Computer neu starten, damit diese Änderungen wirksam werden.
  
    **Auswirkung der Problemumgehung:**Der Routing- und RAS-Dienst funktioniert nicht mehr, nachdem diese Änderung wirksam wird.
  
    **So machen Sie die Problemumgehung rückgängig.**
  
    **Hinweis:** Im [Microsoft Knowledge Base-Artikel 929852](https://support.microsoft.com/kb/929852) finden Sie Informationen zur Verwendung der automatisierten **Microsoft Fix it**-Lösung 50440, um IPv6-Komponenten zu deaktivieren. Diese Fix it-Lösung erfordert nach Abschluss einen Neustart, um wirksam zu werden.
  
    1.  Klicken Sie auf **Start**, geben Sie **regedit** im Feld **Suche starten** ein, und klicken Sie dann in der Liste **Programme** auf **regedit.exe**.  
    2.  Klicken Sie im Dialogfeld **Benutzerkontensteuerung** auf **Weiter**.  
    3.  Suchen Sie im Registrierungs-Editor den folgenden Registrierungsunterschlüssel und klicken Sie dann darauf:  
        `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters\`  
    4.  Löschen Sie den Eintrag **DisabledComponents**.  
    5.  Sie müssen Ihren Computer neu starten, damit diese Änderungen wirksam werden.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892
...
Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine kleine Zahl speziell gestalteter, fehlerhafter IPv6-Pakete an ein Zielsystem sendet.
...
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows TCP/IP-Stapel fehlerhafte IPv6-Pakete verarbeitet.
...
Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs – CVE-2010-1893  
-----------------------------------------------------------------------------------------
  
In der TCP/IP-Verarbeitung in Microsoft Windows liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die durch Verarbeitung eines bestimmten Eingabepuffers verursacht wird. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code mit Berechtigungen aus Systemebene ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1893).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs – CVE-2010-1893
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs – CVE-2010-1893
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs – CVE-2010-1893
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows TCP/IP-Stapel aus dem Benutzermodus kopierte Daten nicht richtig verarbeitet, was zu einem Ganzzahlüberlauf führt.
...
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Um diese Sicherheitsanfälligkeit auszunutzen, muss sich ein Angreifer zuerst am System anmelden. Ein Angreifer kann dann eine speziell gestaltete Anwendung ausführen, die die Sicherheitsanfälligkeit ausnutzt, und auf diese Weise vollständige Kontrolle über ein betroffenes System übernehmen. Dies ist lediglich eine lokale Sicherheitsanfälligkeit, die nicht per Remotezugriff ausgenutzt werden kann.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Systeme wie Terminalserver, auf denen Benutzern ermöglicht wird, nicht vertrauenswürdigen Code auszuführen, sind insbesondere von dieser Sicherheitsanfälligkeit betroffen.
  
**Was bewirkt das Update?**  
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows TCP/IP-Stapel aus dem Benutzermodus kopierte Daten verarbeitet.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/978886">Microsoft Knowledge Base-Artikel 978886</a>.</td>
</tr>
<tr class="odd">
...
-   Darren Willis vom [Fourteenforty Research Institute, Inc.](https://www.fourteenforty.jp/) für den Hinweis auf die Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung (CVE-2010-1892)  
-   Matthieu Suiche von [MoonSols](https://moonsols.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Windows-Netzwerken bezüglich Ganzzahlüberlaufs (CVE-2010-1893)
...
-   V1.1 (18. August 2010): Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in IPv6 bezüglich Speicherbeschädigung – CVE-2010-1892 wurden hinzugefügt.  
-   V2.0 (13. März 2012): Das Bulletin wurde überarbeitet, um eine Erkennungsänderung anzukündigen, durch die MS10-029 als ersetztes Bulletin für alle unterstützten Editionen von Windows Vista und Windows Server 2008 entfernt wird. Weitere Informationen finden Sie in dem diesbezüglichen Eintrag in den häufig gestellten Fragen (FAQs) zu diesem Update.
