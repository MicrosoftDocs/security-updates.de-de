---
TOCTitle: 'MS10-005'
Title: 'Microsoft Security Bulletin MS10-005 - Mittel'
ms:assetid: 'ms10-005'
ms:contentKeyID: 61224618
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-005(v=Security.10)'
---
...
Dieses Sicherheitsupdate wird für Microsoft Windows 2000, Windows XP und Windows Server 2003 als Mittel eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Paint JPEG-Bilddateien decodiert. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e5861705-8f49-45cb-8a92-cf052ccf4134)                    | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f)  | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155)                      | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec)                       | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a)           | Remotecodeausführung           | Mittel                           | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ee603435-26af-4ab9-9f22-92734346dc0a) | Remotecodeausführung           | Mittel                           | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs – CVE-2010-0028</th>
...
Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs – CVE-2010-0028  
-------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Microsoft Paint JPEG-Bilder decodiert. Diese Sicherheitsanfälligkeit kann eine Remotecodeausführung ermöglichen, wenn ein Benutzer eine speziell gestaltete JPEG-Bilddatei in Microsoft Paint öffnet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Berechtigungen erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs – CVE-2010-0028
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Wenn ein Benutzer auf eine JPEG-Datei doppelklickt, wird die Datei standardmäßig in der Windows Bild- und Faxanzeige geöffnet. Um die Sicherheitsanfälligkeit auszunutzen, muss ein Angreifer den Benutzer dazu verleiten, die speziell gestaltete Datei in Microsoft Paint zu öffnen.  
-   Ein Angreifer kann die speziell gestaltete Datei als E-Mail-Anlage senden, müsste aber den Benutzer dazu verleiten, die Dateianlage in Microsoft Paint zu öffnen, um die Sicherheitsanfälligkeit ausnutzen zu können.  
-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs – CVE-2010-0028
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
-   **Deaktivieren Sie Microsoft Paint**
  
    Führen Sie für 32-Bit-Windows folgenden Befehl an einer Eingabeaufforderung aus:
  
    `cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N`
  
    Führen Sie für 64-Bit-Windows folgenden Befehl an einer Eingabeaufforderung aus:
  
    `cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N`
  
    **Auswirkung der Problemumgehung:** Benutzer können Microsoft Paint nicht ausführen.
...
-   **Entfernen Sie Microsoft Paint unter Windows XP und Windows Server 2003**
  
    1.  Öffnen Sie **Software** in der **Systemsteuerung**.  
    2.  Klicken Sie auf **Windows-Komponenten hinzufügen/entfernen**.  
    3.  Wählen Sie im **Assistenten für Windows-Komponenten** die Option **Zubehör und Dienstprogramme** aus, und klicken Sie dann auf **Details**.  
    4.  Wählen Sie **Zubehör** aus, und klicken Sie auf **Details**.  
    5.  Klicken Sie, um das Kontrollkästchen **Paint** zu deaktivieren, und klicken Sie dann zweimal auf **OK**.  
    6.  Stellen Sie im **Assistenten für Windows-Komponenten** sicher, dass das Kontrollkästchen **Zubehör und Dienstprogramme** grau ist, und klicken Sie dann auf **Weiter**.  
    7.  Wenn das Entfernen der Dateien abgeschlossen ist, klicken Sie auf **Fertig stellen**, um den Assistenten zu beenden.
  
    **Auswirkung der Problemumgehung:** Benutzer können Microsoft Paint nicht ausführen.
  
    **So machen Sie die Problemumgehung rückgängig:** Installieren Sie Microsoft Paint neu mithilfe des Assistenten für Windows-Komponenten unter „Software“.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs – CVE-2010-0028
...
Diese Sicherheitsanfälligkeit wird durch Speicherbeschädigung beim Decodieren von JPEG-Bildern verursacht, die von Microsoft Paint verarbeitet werden.
  
**Was ist Microsoft Paint?**  
Microsoft Paint ist ein Tool für das Erstellen sowohl einfacher als auch anspruchsvoller Zeichnungen. Außerdem kann Microsoft Paint für das Anzeigen und Bearbeiten gescannter Fotos verwendet werden.
...
Diese Sicherheitsanfälligkeit erfordert, dass ein Benutzer eine speziell gestaltete Bilddatei öffnet oder anzeigt. Ein Angreifer müsste einem Benutzer eine speziell gestaltete JPEG-Bilddatei senden und den Benutzer dazu verleiten, die Datei mit Microsoft Paint zu öffnen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Damit über diese Sicherheitsanfälligkeit eine schädliche Aktion erfolgen kann, muss ein Benutzer angemeldet sein und JPEG-Bilder mittels Microsoft Paint bearbeiten oder anzeigen. Für Systeme, auf denen E-Mail-Nachrichten gelesen werden oder Internet Explorer aktiv genutzt wird oder auf denen Benutzer Zugriff auf Netzwerkfreigaben haben, wie Arbeitsstationen oder Terminalserver, besteht daher das größte Risiko.
  
**Was bewirkt das Update?**  
Das Update entfernt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Paint JPEG-Bilddateien decodiert.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB978706$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/978706">Microsoft Knowledge Base-Artikel 978706</a>.</td>
</tr>
<tr class="even">
...
-   Tielei Wang von ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Peking University/China) in Zusammenarbeit mit [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs (CVE-2010-0028)
