...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/978706">Microsoft Knowledge Base-Artikel 978706</a>.</td>
</tr>
<tr class="even">
...
-   Tielei Wang von ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Peking University/China) in Zusammenarbeit mit [Secunia](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in MS Paint bezüglich Ganzzahlüberlaufs (CVE-2010-0028)
