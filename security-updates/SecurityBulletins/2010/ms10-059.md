...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
...
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554) zugewiesen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2555](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2555).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/982799">Microsoft Knowledge Base-Artikel 982799</a>.</td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo von [Argeniss](http://www.argeniss.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Ablaufverfolgung bezüglich der Registrierungsschlüssel-ACL (CVE-2010-2554)  
-   Cesar Cerrudo von [Argeniss](http://www.argeniss.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der Ablaufverfolgung bezüglich Speicherbeschädigung (CVE-2010-2555)
