---
TOCTitle: 'MS10-029'
Title: 'Microsoft Security Bulletin MS10-029 - Mittel'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61224642
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-029(v=Security.10)'
---
...
Sicherheitsanfälligkeit in Windows ISATAP-Komponente kann Spoofing ermöglichen (978338)
---------------------------------------------------------------------------------------
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                              | Spoofing                       | Mittel                           | Keine                                                     |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                                                  | Spoofing                       | Mittel                           | Keine                                                     |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                                   | Spoofing                       | Mittel                           | Keine                                                     |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                       | Spoofing                       | Mittel                           | Keine                                                     |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                             | Spoofing                       | Mittel                           | Keine                                                     |
| [Windows Vista, Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                         | Spoofing                       | Mittel                           | [MS10-009](https://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7c1d1622-1b67-438d-aae4-1a3954974a36)     | Spoofing                       | Mittel                           | [MS10-009](https://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*                   | Spoofing                       | Mittel                           | [MS10-009](https://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*       | Spoofing                       | Mittel                           | [MS10-009](https://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842) | Spoofing                       | Mittel                           | [MS10-009](https://go.microsoft.com/fwlink/?linkid=167190) |

**\*Die Server Core-Installation ist betroffen.** Dieses Update gilt wie angezeigt mit der gleichen Bewertung des Schweregrads für unterstützte Editionen von Windows Server 2008. Dabei spielt es keine Rolle, ob sie mit der Server Core-Installationsoption installiert wurden oder nicht. Weitere Informationen zur dieser Installationsoption finden Sie in dem MSDN-Artikel [Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx). Beachten Sie, dass die Server Core-Installationsoption für bestimmte Editionen von Windows Server 2008 nicht gilt; siehe dazu [Vergleichen von Server Core-Installationsoptionen](https://www.microsoft.com/germany/windowsserver2008/editionen/r2-vergleich-server-core.mspx).
...
Dieses Sicherheitsupdate implementiert zwei neue Sicherheitsfunktionen:

-   **Liste der potentiellen Router (PRL) auf ISATAP-Clients:** Die PRL ermöglicht Clients, die Quelladresse für eingehende, getunnelte ISATAP-Pakete zu prüfen. Die PRL wird standardmäßig beim Installieren dieses Sicherheitsupdates aktiviert und hilft, die in CVE-2010-0812 beschriebene Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse zu beheben. Weitere Informationen zur PRL finden Sie im [Microsoft Knowledge Base-Artikel 978338](https://support.microsoft.com/kb/978338).
-   **Neighbor Unreachability Detection (NUD) bei ISATAP-Schnittstellen:** NUD wird verwendet, um zu überprüfen, ob ein Nachbar erreichbar ist oder nicht. NUD wird von ISATAP-Knoten vor dem Senden von ISATAP-Paketen durchgeführt. NUD ist standardmäßig nicht aktiviert und muss von Netzwerkadministratoren manuell konfiguriert werden. Weitere Informationen zu NUD und zu ihrer Aktivierung finden Sie im [Microsoft Knowledge Base-Artikel 978338](https://support.microsoft.com/kb/978338).

**Weshalb ist Microsoft Windows 2000 nicht von dieser Sicherheitsanfälligkeit betroffen?**  
Microsoft Windows 2000 umfasst keine Unterstützung für IPv6, und deshalb ist dieses Betriebssystem nicht betroffen.

**Weshalb sind Windows 7 und Windows Server 2008 R2 nicht von dieser Sicherheitsanfälligkeit betroffen?**  
Die von diesem Sicherheitsupdate bereitgestellten Funktionen PRL (Potential Router List, Liste der potentiellen Router) und NUD (Neighbor Unreachability Detection) sind in Windows 7 und Windows Server 2008 R2 bereits vorhanden.

**Hinweis:** Während PRL auf diesen Plattformen standardmäßig aktiviert ist, ist NUD standardmäßig nicht aktiviert und muss vom Netzwerkadministrator manuell konfiguriert werden. Weitere Informationen zu dieser Funktion finden Sie im [Microsoft Knowledge Base-Artikel 978338](https://support.microsoft.com/kb/978338).

**Wird dieses Update angeboten, selbst wenn ich IPv6 nicht aktiviert habe?**  
Ja, dieses Sicherheitsupdate wird über Automatische Updates angeboten, weil der anfällige Code auf diesen Systemen vorhanden ist. Wir empfehlen, dass Benutzer das Sicherheitsupdate installieren, wenn sie planen, IPv6 in Zukunft bereitzustellen.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse – CVE-2010-0812</th>
...
Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse – CVE-2010-0812  
-----------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0812](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse – CVE-2010-0812
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Diese Sicherheitsanfälligkeit betrifft nur Windows-Systeme mit konfigurierter ISATAP-Schnittstelle.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse – CVE-2010-0812
...
-   **Blockieren des IP-Protokolltyps 41 (ISATAP) an der Firewall**
    ...
    Das ISATAP-Protokoll wird durch [RFC4214: ISATAP (Intra-Site Automatic Tunnel Addressing Protocol)](https://www.ietf.org/rfc/rfc4214.txt). Das Blockieren dieses Protokolltyps an der Firewall schützt Systeme hinter dieser Firewall vor Angriffen, die diese Sicherheitsanfälligkeit auszunutzen versuchen. Microsoft empfiehlt das Blockieren der gesamten unerwünscht eingehenden Kommunikation aus dem Internet. So können Sie Angriffe verhindern, bei denen möglicherweise andere Ports oder Protokolle verwendet werden.
  
-   **Deaktivieren Sie die ISATAP-IPv6-Schnittstelle**
  
    Um die ISATAP-IPv6-Schnittstelle zu deaktivieren, führen Sie an einer erhöhten Eingabeaufforderung den folgenden Befehl aus:
    ...
    **Auswirkung der Problemumgehung:** Durch Deaktivieren der ISATAP-Schnittstelle wird verhindert, dass das System ISATAP als IPv6-Tunnelmechanismus verwendet.
  
    **So machen Sie die Problemumgehung rückgängig:**
  
    Um die ISATAP-IPv6-Schnittstelle wieder zu aktivieren, führen Sie an einer erhöhten Eingabeaufforderung den folgenden Befehl aus:
  
    `netsh interface isatap set state enabled`
  
    **Hinweis:** Sie müssen als Administrator angemeldet sein oder über administrative Anmeldeinformationen verfügen, um diese Problemumgehung zu implementieren.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse – CVE-2010-0812
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Dies ist eine Sicherheitsanfälligkeit durch Spoofing. Diese Sicherheitsanfälligkeit kann einem Angreifer ermöglichen, eine IPv4-Adresse vorzutäuschen, um die Filtergeräte zu umgehen, die die IPv4-Quelladresse verwenden.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows TCP/IP-Stapel die IPv6-Quelladresse in einem getunnelten ISATAP-Paket nicht richtig überprüft.
  
**Was ist ISATAP?**    
ISATAP (Intra-Site Automatic Tunnel Addressing Protocol) stellt innerhalb eines IPv4-Intranets IPv6-Konnektivität bereit. Weitere Informationen zu ISATAP finden Sie unter [RFC5214: ISATAP (Intra-Site Automatic Tunnel Addressing Protocol)](https://www.ietf.org/rfc/rfc5214.txt).
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**    
Ein Angreifer kann u. U. einen anderen Benutzer oder ein anderes System nachahmen und dadurch Quelladressfilter, wie z. B. Edge- oder Host-Firewalls, umgehen.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann versuchen, die Sicherheitsanfälligkeit auszunutzen, indem er speziell gestaltete Netzwerkpakete mit einer speziell gestalteten IPv6-Quelladresse in einer ISATAP-Verbindung erstellt, die nicht mit der entsprechenden IPv4-Quelladresse übereinstimmt.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Alle Betriebssysteme, bei denen die IPv6-ISATAP-Funktionen aktiviert sind, sind durch diese Sicherheitsanfälligkeit gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt diese Sicherheitsanfälligkeit, indem geändert wird, wie der Windows TCP/IP-Stapel die IPv6-Quelladresse in einem getunnelten ISATAP-Paket prüft.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB978338$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/978338">Microsoft Knowledge Base-Artikel 978338</a>.</td>
</tr>
<tr class="even">
...
Gabi Nakibly vom National EW Research & Simulation Center (bei Rafael) für den Hinweis auf die Sicherheitsanfälligkeit durch Spoofing der ISATAP-IPv6-Quelladresse (CVE-2010-0812).
...
-   V1.1 (21. April 2010): Die Bulletin-Ersetzungsinformationen für alle Windows Vista- und Windows Server 2008-Updatepakete wurden korrigiert.
