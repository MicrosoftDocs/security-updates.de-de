---
TOCTitle: 'MS10-057'
Title: 'Microsoft Security Bulletin MS10-057 - Kritisch'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61224670
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-057(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-057 - Kritisch
===============================================

Sicherheitsanfälligkeit in Microsoft Office Excel kann Remotecodeausführung ermöglichen (2269707)
-------------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 10. August 2010 | Aktualisiert: Mittwoch, 11. August 2010
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office 2004 für Mac und Microsoft Office 2008 für Mac sowie für Open XML-Dateiformatkonverter für Mac als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office Excel speziell gestaltete Excel-Dateien analysiert. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.

**Empfehlung.** Microsoft empfiehlt Benutzern, dieses Sicherheitsupdate so schnell wie möglich zu installieren.

**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2269707](https://support.microsoft.com/kb/2269707) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Ein eigenständiges Office-Programm ist mit der gleichen Bewertung des Schweregrads wie die entsprechende Komponente in einer Office Suite betroffen. Zum Beispiel ist eine eigenständige Installation von Microsoft Office Excel mit der gleichen Bewertung des Schweregrads wie eine Installation von Microsoft Office Excel betroffen, die mit einer Office Suite bereitgestellt wurde.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung – CVE-2010-2562
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2562](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung – CVE-2010-2562
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung – CVE-2010-2562
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung – CVE-2010-2562
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2264397">Microsoft Knowledge Base-Artikel 2264397</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2264403">Microsoft Knowledge Base-Artikel 2264403</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Damián Frizza von [Core Security Technologies](https://www.coresecurity.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich Speicherbeschädigung (CVE-2010-2562)
...
-   V1.1 (11. August 2010): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2269707 hinzugefügt.
