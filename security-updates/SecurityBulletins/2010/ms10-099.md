---
TOCTitle: 'MS10-099'
Title: 'Microsoft Security Bulletin MS10-099 - Kritisch'
ms:assetid: 'ms10-099'
ms:contentKeyID: 61224712
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-099(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-099 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Komponente „Routing and Remote Access“ überprüft wird. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50)                      | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c87af292-a068-4089-aab8-115c18b4b024)                       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)           | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ad896d80-167f-4e8f-a448-cac93516f4d0) | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf – CVE-2010-3963</th>
...
Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf – CVE-2010-3963  
---------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3963](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf – CVE-2010-3963
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf – CVE-2010-3963
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf – CVE-2010-3963
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Komponente „Routing and Remote Access NDProxy“ überprüft benutzerdefinierte Eingaben nicht ordnungsgemäß, wenn Daten vom Benutzermodus an den Kernel übergeben werden.
...
Mit RAS können Benutzer per Telefonleitung eine Verbindung zu einem Remotecomputer herstellen und anschließend so arbeiten, als ob ihr System physisch mit dem Remotenetzwerk verbunden wäre. Diese Dienste ermöglichen Remotebenutzern die Durchführung von Aktivitäten wie das Senden und Empfangen von E-Mail und Faxdokumenten, das Abrufen von Dateien und das Drucken von Dokumenten auf einem Bürodrucker.
  
Der Remotezugriffsdienst ist ein systemeigener Dienst in Windows XP und Windows Server 2003.
  
**Was ist NDProxy?**    
NDPROXY ist ein vom System bereitgestellter Treiber, der WAN-Miniport-Treiber, Anruf-Manager und Miniport-Anruf-Manager mit den TAPI-Diensten (Telephony Application Programming Interfaces) verbindet. Weitere Informationen finden Sie im MSDN-Artikel [NDPROXY: Überblick](https://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx).
...
Das Update behebt die Sicherheitsanfälligkeit, indem die vom Benutzermodus durch die Komponente „Routing and Remote Access“ an den Windows-Kernel übergebene Eingabe ordnungsgemäß überprüft wird.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2440591$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2440591">Microsoft Knowledge Base-Artikel 2440591</a>.</td>
</tr>
<tr class="even">
...
-   Honggang Ren von [Fortinets FortiGuard Labs](https://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in NDProxy im Kernel durch Pufferüberlauf (CVE-2010-3963)
