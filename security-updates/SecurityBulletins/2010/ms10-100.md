---
TOCTitle: 'MS10-100'
Title: 'Microsoft Security Bulletin MS10-100 - Kritisch'
ms:assetid: 'ms10-100'
ms:contentKeyID: 61224713
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-100(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-100 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Zustimmungsbenutzeroberfläche Werte verarbeitet, die aus der Registrierung gelesen wurden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=85265a23-5094-4007-8d33-f402cabd1664)                                                        | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=63c7257a-16bf-4108-80b9-9dfe53528348)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a)\*\*                 | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f)\*\*     | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164) | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401)                                                                                         | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e52c36f5-637b-4928-83d0-27514c6cc384)                                                                                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a)\*\*                                                                  | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90)                                                                  | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche – CVE-2010-3961</th>
...
Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche – CVE-2010-3961  
------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, dass die Zustimmungsbenutzeroberfläche bestimmte Werte, die aus der Registrierung gelesen wurden, falsch verarbeitet. Diese Sicherheitsanfälligkeit kann einem Angreifer ermöglichen, Code mit erhöhten Berechtigungen auszuführen. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3961](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche – CVE-2010-3961
...
-   Um diese Sicherheitsanfälligkeit erfolgreich auszunutzen, muss der Angreifer über die SeImpersonatePrivilege-Berechtigung verfügen. Die folgenden Komponenten verfügen ebenfalls über dieses Benutzerrecht:  
    ...
    - IIS-Dienste, wenn diese für die Ausführung als regulärer Benutzer konfiguriert sind
  
#### Problemumgehungen für die Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche – CVE-2010-3961
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche – CVE-2010-3961
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass die Zustimmungsbenutzeroberfläche einen Registrierungsschlüssel nicht richtig verarbeitet, der auf einen bestimmten Wert gesetzt wurde.
  
**Was ist die Zustimmungsbenutzeroberfläche?**    
Die Zustimmungsbenutzeroberfläche ist Bestandteil der Benutzerkontensteuerung. Wenn die Benutzerkontensteuerung vollständig aktiviert ist, werden interaktive Administratoren normalerweise mit den geringsten Benutzerberechtigungen ausgeführt. Sie können ihren Status aber selbst erhöhen, um administrative Aufgaben durchzuführen, indem sie mit der Zustimmungsbenutzeroberfläche ausdrücklich ihre Zustimmung geben. Solche administrativen Aufgaben umfassen das Installieren von Software und Treibern, das Ändern systemweiter Einstellungen, das Anzeigen oder Ändern anderer Benutzerkonten und das Ausführen von administrativen Tools. Weitere Informationen finden Sie in dem MSDN-Artikel [Benutzerkontensteuerung](https://msdn.microsoft.com/en-us/library/aa511445.aspx).
  
**Was ist SeImpersonatePrivilege?**    
SeImpersonatePrivilege oder das Benutzerrecht „Nachahmen eines Clients nach der Authentifizierung“ ist eine Sicherheitseinstellung, die zum ersten Mal mit Microsoft Windows 2000 Service Pack 4 eingeführt wurde. Dieses Benutzerrecht wird standardmäßig den Mitgliedern der lokalen Administratorgruppe des Geräts und dem LocalService-Konto des Geräts zugewiesen. Die SeImpersonatePrivilege-Einstellung ist in [Microsoft Knowledge Base-Artikel 821546](https://support.microsoft.com/kb/821546) beschrieben.
...
Dieser Angriff kann nur von Benutzerkonten durchgeführt werden, denen die SeImpersonatePrivilege-Berechtigung gewährt wurde. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann mithilfe der LocalSystem-Berechtigung speziell gestalteten Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Zustimmungsbenutzeroberfläche Werte verarbeitet, die aus der Registrierung gelesen wurden.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2442962">Microsoft Knowledge Base-Artikel 2442962</a>.</td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo von [Argeniss](https://www.argeniss.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Nachahmung der Zustimmungsbenutzeroberfläche (CVE-2010-3961)
