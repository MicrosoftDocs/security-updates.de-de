---
TOCTitle: 'MS10-055'
Title: 'Microsoft Security Bulletin MS10-055 - Kritisch'
ms:assetid: 'ms10-055'
ms:contentKeyID: 61224668
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-055(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 10. August 2010 | Aktualisiert: Donnerstag, 12. August 2010
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows XP, Windows Vista und Windows 7 als Kritisch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Cinepak Codec Mediendateien dekomprimiert. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 982665](https://support.microsoft.com/kb/982665) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77)                                                             | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6)                                                   | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f)                         | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5) | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224)                                                          | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=24751193-592f-4c44-a8d6-f4112d4f011b)                                                    | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
Windows 7 Service Pack 1 Beta ist von der in diesem Bulletin beschriebenen Sicherheitsanfälligkeit betroffen. Benutzer, die diese Betaversion ausführen, sind angehalten, das Update auf ihre Systeme herunterzuladen und zu installieren. Sicherheitsupdates sind unter [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) und [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) verfügbar. Das Sicherheitsupdate steht auch im [Microsoft Download Center](https://www.microsoft.com/downloads/results.aspx?displaylang=de&freetext=sicherheitsupdate) zum Herunterladen zur Verfügung.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung – CVE-2010-2553</th>
...
Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung – CVE-2010-2553  
----------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit vor, die Remotecodeausführung ermöglicht und durch die Art und Weise verursacht wird, wie der Cinepak Codec unterstützte Formatdateien verarbeitet. Diese Sicherheitsanfälligkeit kann Codeausführung ermöglichen, wenn ein Benutzer eine speziell gestaltete Mediendatei öffnet. Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung – CVE-2010-2553
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung – CVE-2010-2553
  
Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:
  
- **Ändern der Zugriffssteuerungsliste (ACL) für iccvid.dll**
  
   Beschränken Sie die ACL für iccvid.dll.
  
   Führen Sie bei 32-Bit-Editionen von Windows XP die folgenden Befehle an einer Eingabeaufforderung aus (erfordert Administratorrechte):  
   `cacls %WINDIR%\SYSTEM32\iccvid.DLL /E /P everyone:N`
  
   Führen Sie bei 64-Bit-Editionen von Windows XP die folgenden Befehle an einer Eingabeaufforderung aus (erfordert Administratorrechte):  
   `cacls %WINDIR%\SYSWOW64\iccvid.DLL /E /P everyone:N `
  
   `Führen Sie für 32-Bit-Editionen von` Windows Vista und Windows 7 folgende Befehle an einer erhöhten Eingabeaufforderung aus:  
   ```
   ...
   **Auswirkung der Problemumgehung:** Mit dem Cinepak Codec codierte Mediendateien werden nicht mehr in Multimedia wiedergegeben.
...
- **Deaktivieren der Analyse von mit Cinepak codierten Dateien in DirectShow**
  
   Deaktivieren Sie in DirectShow die Analyse von Mediendateien, die mit dem Cinepak Codec codiert sind.
   ...
   **Verwenden der interaktiven Methode**
   ...
   4.  Geben Sie in das Dialogfeld „Registrierungsdatei exportieren“ den Namen **Drivers32\_Backup.reg** ein, und klicken Sie auf **Speichern**.  
   ...
   5.  Suchen Sie nach dem Zeichenfolgenwert mit dem Namen **vidc.cvid** und den Daten **iccvid.dll**, und wählen Sie diesen aus.  
   6.  Drücken Sie die Taste **Entf** auf der Tastatur, um den Registrierungsschlüssel zu löschen. Wenn Sie über das Dialogfeld „Löschen des Schlüssels bestätigen“ aufgefordert werden, den Registrierungsschlüssel zu löschen, klicken Sie auf **Ja**.
    ...
    **Verwenden eines verwalteten Bereitstellungsskripts**
    ...
    2.  Speichern Sie anschließend Folgendes in einer Datei mit der Erweiterung .REG, z. B. Disable\_Cinepak\_Parser.reg:  
        **Für 32-Bit-Windows-Systeme**:  
        ```
    ...
    **So machen Sie die Problemumgehung rückgängig.**
    ...
    3.  Klicken Sie im Dialogfeld „Registrierungsdatei importieren“ auf **Drivers32\_Backup.reg** und dann auf **Öffnen**.
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung – CVE-2010-2553
...
Der in Microsoft Windows enthaltene Cinepak Codec verarbeitet speziell gestaltete Mediendateien nicht richtig.
  
**Was ist der Cinepak Codec?**    
Der Cinepak Codec ist ein Media Encoder und Decoder, der von Windows Media Player unterstützt wird. Dieser Codec ermöglicht die Datenstromcodierung und -decodierung von Mediendateien. Cinepak verwendet auf Vektorquantifizierung basierte Bildkomprimierung und Differenzcodierung.
...
Ein Codec kann aus zwei Komponenten bestehen: einem Encoder und einem Decoder. Der Encoder führt die Komprimierungsfunktion (Codierung) durch, und der Decoder führt die Dekomprimierungsfunktion (Decodierung) durch. Einige Codecs beinhalten beide Komponenten und einige Codecs nur eine davon.
...
Das Update behebt das Problem, indem korrigiert wird, wie der Cinepak Codec Mediendateien dekomprimiert.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB982665$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/982665">Microsoft Knowledge Base-Artikel 982665</a>.</td>
</tr>
<tr class="even">
...
-   Einer Person, die mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Cinepak Codec bezüglich Dekomprimierung (CVE-2010-2553).
...
-   V1.1 (12. August 2010): Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2 wurden in die Tabelle der nicht betroffenen Software hinzugefügt.
