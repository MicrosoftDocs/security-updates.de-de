---
TOCTitle: 'MS10-066'
Title: 'Microsoft Security Bulletin MS10-066 - Kritisch'
ms:assetid: 'ms10-066'
ms:contentKeyID: 61224679
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-066(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-066 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der RPC-Client vor dem Laden von RPC-Antworten, die von einem Remoteserver übergeben werden, Speicher richtig zuweist. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6&displaylang=de)                                | Remotecodeausführung           | Hoch                             | [MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d)                      | Remotecodeausführung           | Hoch                             | [MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c&displaylang=de)                       | Remotecodeausführung           | Hoch                             | [MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39&displaylang=de)           | Remotecodeausführung           | Hoch                             | [MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73&displaylang=de) | Remotecodeausführung           | Hoch                             | [MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung – CVE-2010-2567</th>
...
Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung – CVE-2010-2567  
-----------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Ausführung nicht authentifizierten Remotecodes vor, die dadurch verursacht wird, wie die Implementierung des RPC-Clients (Remote Procedure Call, Remoteprozeduraufruf) beim Analysieren speziell gestalteter RPC-Antworten Speicher zuweist. Ein Versuch, die Sicherheitsanfälligkeit auszunutzen, erfordert keine Authentifizierung. Dadurch kann ein Angreifer die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete RPC-Antwort auf eine vom Client initiierte RPC-Anforderung sendet. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2567](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung – CVE-2010-2567
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Der Angreifer muss den Benutzer dazu verleiten, eine RPC-Verbindung zu einem schädlichen Server zu initiieren, der sich unter der Kontrolle des Angreifers befindet. Ein Angreifer kann diese Sicherheitsanfälligkeit nicht ohne Benutzereingriff von einem Remotestandort aus ausnutzen.  
-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung – CVE-2010-2567
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung – CVE-2010-2567
...
Die Sicherheitsanfälligkeit wird verursacht, wenn die Implementierung des Microsoft-RPC-Clients (Remote Procedure Call, Remoteprozeduraufruf) bei der Analyse speziell gestalteter RPC-Antworten Speicher falsch zuweist.
  
**Was ist RPC (Remote Procedure Call)?**  
Der Microsoft-Remoteprozeduraufruf (Remote Procedure Call, RPC) ist ein Netzwerkprogrammierungsstandard, der ursprünglich in den frühen 1980er Jahren entwickelt wurde. Eine RPC-Einrichtung ermöglicht einem Programmierer, eine Anwendung zu erstellen, die aus beliebig vielen Prozeduren besteht, von denen einige lokal und andere über ein Netzwerk auf Remotecomputern ausgeführt werden.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**    
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann Code im Sicherheitskontext der RPC-Clientanwendung ausführen. Wenn die RPC-Clientanwendung unter LocalSystem oder unter einem Konto mit Administratorrechten ausgeführt wird, kann ein Angreifer vollständige Kontrolle über ein betroffenes System erlangen.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann einen speziell gestalteten RPC-Server hosten, der zum Ausnutzen dieser Sicherheitsanfälligkeit entwickelt wurde, und dann einen Benutzer dazu verleiten, einen Remoteprozeduraufruf an den Server zu initiieren. Außerdem kann ein Angreifer im lokalen Netzwerk einen Man-in-the-Middle-Angriff durchführen, um mit einer fehlerhaften RPC-Antwort auf einen gültigen Remoteprozeduraufruf zu antworten.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Alle Systeme, die unterstützte Editionen von Windows XP und Windows Server 2003 ausführen, sind gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der RPC-Client vor dem Laden von RPC-Antworten, die von einem Remoteserver übergeben werden, Speicher richtig zuweist.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB982802$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/982802">Microsoft Knowledge Base-Artikel 982802</a>.</td>
</tr>
<tr class="even">
...
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in RPC bezüglich Speicherbeschädigung (CVE-2010-2567)
