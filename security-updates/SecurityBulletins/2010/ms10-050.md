---
TOCTitle: 'MS10-050'
Title: 'Microsoft Security Bulletin MS10-050 - Kritisch'
ms:assetid: 'ms10-050'
ms:contentKeyID: 61224663
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-050(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-050 - Kritisch
===============================================

Sicherheitsanfälligkeit in Windows Movie Maker kann Remotecodeausführung ermöglichen (981997)
---------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 10. August 2010 | Aktualisiert: Mittwoch, 15. September 2010
...
Dieses Sicherheitsupdate wird für Windows Movie Maker 2.1, Windows Movie Maker 2.6 und Windows Movie Maker 6.0 als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Movie Maker-Projektdateien von Windows Movie Maker analysiert werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 981997](https://support.microsoft.com/kb/981997) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=b211664b-434d-4626-816f-c77510cfd44d">Movie Maker 2.1</a><sup>[1]</sup></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=decb1fe6-adc8-44f7-89c5-f25767f0cefe">Movie Maker 2.1</a><sup>[1]</sup></td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-016.mspx">MS10-016</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=8aded9dd-08d6-4b19-955f-0d8414868cf9">Movie Maker 6.0</a><sup>[1]</sup><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=a1d8ed0d-a3b5-416a-ab8b-77501da62132">Movie Maker 2.6</a><sup>[2]</sup></td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-016.mspx">MS10-016</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=4baff9ae-dd25-4942-b45e-f281d0e1f4ac">Movie Maker 6.0</a><sup>[1]</sup><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=0a226592-8f98-4f67-ac60-1d00cbc56598">Movie Maker 2.6</a><sup>[2]</sup></td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-016.mspx">MS10-016</a></td>
</tr>
...
Für Benutzer von Windows 7 empfiehlt Microsoft Windows Live Movie Maker. Windows Live Movie Maker ist als Download vom [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=741ce3ed-baa2-4610-9f7d-42ab694e2b15) verfügbar und ist von der in diesem Bulletin beschriebenen Sicherheitsanfälligkeit nicht betroffen.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker – CVE-2010-2564</th>
<th style="border:1px solid black;" >Bewertung des Gesamtschweregrads</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Movie Maker 2.1 unter Windows XP Service Pack 3</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Movie Maker 6.0 unter Windows Vista Service Pack 1 und Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Hoch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Movie Maker 6.0 unter Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Hoch</strong> <br />
Remotecodeausführung</td>
<td style="border:1px solid black;"><strong>Hoch</strong></td>
</tr>
...
Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker – CVE-2010-2564  
-------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie Windows Movie Maker speziell gestaltete Projektdateien verarbeitet. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2564](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker – CVE-2010-2564
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker – CVE-2010-2564
...
-   **Entfernen der .MSWMM-Dateizuordnung von Movie Maker**
    ...
    **Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 981997](https://support.microsoft.com/kb/981997), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren. Diese Fix it-Lösung stellt die Problemumgehung bereit und hat folglich die gleichen Auswirkungen auf Benutzer. Wir empfehlen Administratoren, den KB-Artikel sorgfältig zu lesen, bevor sie diese Fix it-Lösung bereitstellen.
...
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker – CVE-2010-2564
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, wie Windows Movie Maker die Projektdateiformate analysiert. Zur Ausnutzung dieser Sicherheitsanfälligkeit muss ein böswilliger Benutzer eine speziell gestaltete Movie Maker-Datei senden und den Benutzer dazu verleiten, die speziell gestaltete Datei zu öffnen.
  
**Was ist Windows Movie Maker?**    
Windows Movie Maker ist eine Anwendung, die Benutzern ermöglicht, Filmaufnahmen zu erstellen, zu bearbeiten und ihnen Spezialeffekte hinzuzufügen. Windows Movie Maker ist in den Versionen von Windows XP und Windows Vista enthalten.
...
Die Ausnutzung dieser Sicherheitsanfälligkeit erfordert, dass ein Benutzer eine speziell gestaltete Movie Maker-Projektdatei mit einer betroffenen Version von Windows Movie Maker öffnet.
  
Bei einem E-Mail-Angriffsszenario kann ein Angreifer diese Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Movie Maker-Projektdatei an den Benutzer sendet und ihn zum Öffnen der Datei verleitet.
  
In einem webbasierten Angriffsszenario muss ein Angreifer eine Website mit einer speziell gestalteten Movie Maker-Projektdatei einrichten, durch die diese Sicherheitsanfälligkeit ausgenutzt wird. Außerdem können manipulierte Websites und Websites, die von Benutzern bereitgestellte Inhalte akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden kann. Ein Angreifer kann Benutzer nicht zum Besuch einer speziell gestalteten Website zwingen. Stattdessen muss er den Benutzer zum Besuch dieser Website verleiten. Zu diesem Zweck wird der Benutzer meist dazu gebracht, auf einen Link zur Website des Angreifers zu klicken und anschließend die speziell gestaltete Movie Maker-Projektdatei zu öffnen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Windows-Systeme, auf denen Windows Movie Maker verwendet wird, sind hauptsächlich gefährdet.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Movie Maker-Projektdateien von Windows Movie Maker analysiert werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB981997$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/981997">Microsoft Knowledge Base-Artikel 981997</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Für Movie Maker 2.6 unter allen unterstützten 32-Bit- und x64-basierten Editionen von Windows Vista:
...
-   Dyon Balding von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung in Movie Maker (CVE-2010-2564)
...
-   V1.1 (11. August 2010): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 981997 hinzugefügt.  
-   V1.2 (15 September 2010): Es wurde ein Verweis auf den Microsoft Knowledge Base-Artikel 981997 hinzugefügt, um eine automatisierte **Microsoft Fix it**-Lösung für die Problemumgehung „Entfernen der .MSWMM-Dateizuordnung von Movie Maker“ bereitzustellen.
