---
TOCTitle: 'MS10-047'
Title: 'Microsoft Security Bulletin MS10-047 - Kritisch'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61224660
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-047(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-047 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für Windows XP, Windows Vista und Windows Server 2008 als Hoch und für Windows 7 und Windows Server 2008 R2 als Mittel eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem die Initialisierung von Windows-Kernelobjekten und Überprüfung von Zugriffssteuerungslisten korrigiert wird und indem eine zusätzliche Laufzeitüberprüfung des Threaderstellungsmechanismus eingeführt wird. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71)                                                                                            | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1)                                                        | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc)                                | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27)\*                   | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=131f3512-1585-462e-a4f1-3f359aac44bd)\*       | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79) | Erhöhung von Berechtigungen    | Hoch                             | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14)                                                                                         | DoS (Denial of Service)        | Mittel                           | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8)                                                                                   | DoS (Denial of Service)        | Mittel                           | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4)\*                                                                    | DoS (Denial of Service)        | Mittel                           | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                                  | DoS (Denial of Service)        | Mittel                           | [MS10-021](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-021.mspx) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel – CVE-2010-1888</th>
<th style="border:1px solid black;" >„Double Free“-Sicherheitsanfälligkeit im Windows-Kernel – CVE-2010-1889</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung – CVE-2010-1890</th>
...
Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel – CVE-2010-1888  
--------------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel – CVE-2010-1888
...
#### Problemumgehungen für die Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel – CVE-2010-1888
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel – CVE-2010-1888
...
„Double Free“-Sicherheitsanfälligkeit im Windows-Kernel – CVE-2010-1889  
-----------------------------------------------------------------------
  
Im Windows-Kernel liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie der Kernel beim Verarbeiten bestimmter Fehler Objekte initialisiert. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1889](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889).
  
#### Schadensbegrenzende Faktoren für die „Double Free“-Sicherheitsanfälligkeit im Windows-Kernel – CVE-2010-1889
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht per Remotezugriff oder von anonymen Benutzern ausgenutzt werden.
  
#### Problemumgehungen für die „Double Free“-Sicherheitsanfälligkeit im Windows-Kernel – CVE-2010-1889
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur „Double Free“-Sicherheitsanfälligkeit im Windows-Kernel – CVE-2010-1889
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Windows-Kernel initialisiert beim Verarbeiten bestimmter Fehler Objekte nicht richtig.
...
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem sichergestellt wird, dass der Windows-Kernel beim Verarbeiten bestimmter Fehler Objekte richtig initialisiert.
...
Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung – CVE-2010-1890  
-------------------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Denial-of-Service vor, die dadurch verursacht wird, wie der Windows-Kernel Zugriffssteuerungslisten auf Kernelobjekten überprüft. Ein Angreifer kann die Sicherheitsanfälligkeit ausnutzen, indem er eine speziell gestaltete Anwendung ausführt, die einen Neustart des Systems verursacht.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung – CVE-2010-1890
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht per Remotezugriff oder von anonymen Benutzern ausgenutzt werden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung – CVE-2010-1890
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung – CVE-2010-1890
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Der Windows-Kernel überprüft Zugriffssteuerungslisten auf Kernelobjekten nicht richtig.
...
**Was bewirkt das Update?**    
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der Windows-Kernel Zugriffssteuerungslisten überprüft, die auf Kernelobjekte angewendet wurden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB981852$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/981852">Microsoft Knowledge Base-Artikel 981852</a>.</td>
</tr>
<tr class="even">
...
-   Tavis Ormandy von [Google Inc.](https://www.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Dateninitialisierung im Windows-Kernel (CVE-2010-1888).  
-   Tavis Ormandy von [Google Inc.](https://www.google.com/) für den Hinweis auf die „Double Free“-Sicherheitsanfälligkeit im Windows-Kernel (CVE-2010-1889).  
-   Tavis Ormandy von [Google Inc.](https://www.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Windows-Kernel aufgrund fehlerhafter Überprüfung (CVE-2010-1890).
