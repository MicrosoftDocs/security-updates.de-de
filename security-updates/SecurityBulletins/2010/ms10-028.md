...
Weitere Informationen zu aktuellen und zurückgezogenen Versionen von Microsoft Office Viewer finden Sie im [Microsoft Knowledge Base-Artikel 979860](https://support.microsoft.com/?id=979860).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/979364">Microsoft Knowledge Base-Artikel 979364</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/979356">Microsoft Knowledge Base-Artikel 979356</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/979365">Microsoft Knowledge Base-Artikel 979365</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Bing Liu von Fortinets [FortiGuard Labs](https://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Visio bezüglich Speicherbeschädigung bei Attributüberprüfung (CVE-2010-0254).  
-   Bing Liu von Fortinets [FortiGuard Labs](https://www.fortiguard.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Visio bezüglich Speicherbeschädigung bei Indexberechnung (CVE-2010-0256).
