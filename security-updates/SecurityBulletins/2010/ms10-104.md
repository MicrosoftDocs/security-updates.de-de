...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=3c8fb9f9-7920-43ea-b618-e26dc3360c60">Microsoft Office SharePoint Server 2007 Service Pack 2 (32-Bit-Editionen)</a><br />
(KB2433089)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=3db09280-24bd-42e0-9ae3-02c9bf3e8ee3">Microsoft Office SharePoint Server 2007 Service Pack 2 (64-Bit-Editionen)</a><br />
(KB2433089)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3964](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964).
...
-   **Blockieren von Ports, die vom Office-Startprogrammdienst für die Dokumentkonvertierung verwendet werden, an der Firewall**
    ...
    **So machen Sie die Problemumgehung rückgängig.**
    ...
    Heben Sie die Blockierung des TCP-Ports 8082 an der Firewall auf. Weitere Informationen zu den Ports finden Sie im TechNet-Artikel [TCP- und UDP-Portzuweisungen](https://go.microsoft.com/fwlink/?linkid=21312).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2433089">Microsoft Knowledge Base-Artikel 2433089</a>.</td>
</tr>
<tr class="even">
...
-   Oleksandr Mirosh in Zusammenarbeit mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich fehlerhafter Anforderung zur Codeausführung (CVE-2010-3964)
