---
TOCTitle: 'MS10-007'
Title: 'Microsoft Security Bulletin MS10-007 - Kritisch'
ms:assetid: 'ms10-007'
ms:contentKeyID: 61224620
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-007(v=Security.10)'
---
...
Sicherheitsanfälligkeit in Windows Shell Handler kann Remotecodeausführung ermöglichen (975713)
-----------------------------------------------------------------------------------------------
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die ShellExecute-API Eingabeparameter überprüft. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3)                    | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Service Pack 2 und Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4)  | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)                      | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11)                       | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=90360537-9311-45e2-8047-9a971f90c3c3)           | Remotecodeausführung           | Kritisch                         | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da) | Remotecodeausführung           | Kritisch                         | Keine                                             |
...
**In welcher Beziehung steht dieses Sicherheitsupdate zu CVE-2010-0027, das in MS10-002 beschrieben ist?**  
Die Sicherheitsanfälligkeit bezüglich URL-Überprüfung (CVE-2010-0027) wird durch dieses Update (MS10-007) und durch das [Kumulative Sicherheitsupdate für Internet Explorer (MS10-002)](https://go.microsoft.com/fwlink/?linkid=179104) behoben, je nachdem, welche Version von Microsoft Windows und welche Version von Internet Explorer auf dem System des Benutzers installiert ist.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit bezüglich URL-Überprüfung - CVE-2010-0027</th>
...
In betroffenen Versionen von Microsoft Windows liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor. Die Sicherheitsanfälligkeit resultiert aus der falschen Überprüfung der Eingabe, die an die ShellExecute API-Funktion gesendet wird. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen.
...
Diese Sicherheitsanfälligkeit kann eine Remotecodeausführung ermöglichen. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann dann mit den gleichen Rechten wie der derzeit angemeldete Benutzer Aktionen durchführen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Wenn eine Anwendung wie ein Webbrowser mit der ShellExecute API-Funktion speziell gestaltete Daten verarbeitet, überprüft ShellExecute jenen Datenstrom u. U. nicht richtig und führt auf dem lokalen Clientsystem eine Binärdatei aus.
...
ShellExecute ist Bestandteil der Windows-Shell API-Funktionen (Anwendungsprogrammierschnittstelle). Es führt einen Vorgang an einer angegebenen Datei durch. Dies kann z. B. bedeuten, dass der richtige Handler für diesen bestimmten Dateityp aufgerufen wird. Weitere Informationen zu der ShellExecute-Funktion finden Sie in dem MSDN-Artikel [ShellExecute-Funktion](https://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx).
  
**Was ist eine Anwendungsprogrammierschnittstelle (API)?**  
Eine API ist ein Satz an Funktionen, die für die Arbeit an einer Komponente, Anwendung oder einem Betriebssystem verwenden können. In der Regel besteht eine API aus einer oder mehreren DLLs, die eine bestimmte Funktionalität bereitstellen.
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**  
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann als angemeldeter Benutzer beliebigen Code ausführen. Wenn ein Benutzer mit administrativen Benutzerberechtigungen angemeldet ist, kann ein Angreifer vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**  
Ein Angreifer kann Inhalte wie eine speziell gestaltete Webseite bereitstellen, die bewirkt, dass eine Anwendung eine fehlerhafte Zeichenfolge analysiert. Wenn diese Inhalte an den Aufruf der ShellExecute API gesendet werden, z. B. als Hyperlink, kann dies einem Angreifer ermöglichen, ohne Wissen des angemeldeten Benutzers im Clientsystem eine Binärdatei auszuführen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**  
Clientsysteme, die nicht vertrauenswürdige Internetinhalte durchsuchen, sind hauptsächlich durch diese Sicherheitsanfälligkeit gefährdet, die Ausnutzung im Kontext des angemeldeten Benutzers ermöglichen kann.
  
**Was bewirkt das Update?**  
Dieses Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die ShellExecute API unter unterstützten Editionen von Microsoft Windows 2000, Windows XP und Windows Server 2003 Eingabeparameter überprüft.
...
| **Bereitstellung:**                          |                                                                                                                                                        |  
| Installieren ohne Benutzereingriff           | Windows2000-KB975713-x86-ENU /quiet                                                                                                                    |  
| Installieren ohne neu zu starten             | Windows2000-KB975713-x86-ENU /norestart                                                                                                                |  
| Protokolldatei aktualisieren                 | kb975713.log                                                                                                                                           |  
...
| **Informationen zur Deinstallation:**        | Verwenden Sie die Option **Software** in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB975713$\\Spuninst. |  
| **Dateiinformationen:**                      | Siehe [Microsoft Knowledge Base-Artikel 975713](https://support.microsoft.com/kb/975713).                                                               |  
| **Überprüfung des Registrierungsschlüssels** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB975713\\Filelist                                                              |
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB975713$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/975713">Microsoft Knowledge Base-Artikel 975713</a>.</td>
</tr>
<tr class="even">
