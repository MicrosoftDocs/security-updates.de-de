---
TOCTitle: 'MS10-105'
Title: 'Microsoft Security Bulletin MS10-105 - Kritisch'
ms:assetid: 'ms10-105'
ms:contentKeyID: 61224718
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-105(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-105 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für Microsoft Works 9, das Microsoft Office-Konvertierungspaket und unterstützte Editionen von Microsoft Office XP und Microsoft Office 2003 als Hoch eingestuft. Weitere Informationen finden Sie in dem Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Update behebt die Sicherheitsanfälligkeiten, indem geändert wird, wie Microsoft Office bestimmte Bildformate analysiert und beim Darstellen von Bildern Daten überprüft. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.

**Empfehlung.** Microsoft empfiehlt Benutzern, dieses Sicherheitsupdate so schnell wie möglich zu installieren.

**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 968095](https://support.microsoft.com/kb/968095) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Wenn die derzeit bekannten Probleme und empfohlenen Lösungen nur auf bestimmte Veröffentlichungen dieser Software zutreffen, werden in diesem Artikel Verknüpfungen zu weiteren Artikeln bereitgestellt.
...
[Microsoft Office XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=724d0ad6-ba5f-4dbf-b280-3fb36335d33b)<sup>[1]</sup>
(KB2289162)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=976857e9-77fc-4667-88ca-7637e57536cd)<sup>[1]</sup>
(KB2289163)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=676eeed6-f2b7-4265-afc7-a82ffdbeb290)  
(KB2288931)
</td>
<td style="border:1px solid black;">
Keine
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6d644494-b530-4b37-bc37-8a8a7edefe53)  
(KB2289078)
</td>
<td style="border:1px solid black;">
Keine
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=58e54779-aa8f-41b3-9993-8cec12c49082)  
(KB2289078)
</td>
<td style="border:1px solid black;">
Keine
...
<tr>
<td style="border:1px solid black;">
[Microsoft Works 9](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=10f6f330-05d8-4b60-9ebb-822a7321ac0f)  
(KB2431831)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<sup>[1]</sup>Benutzer, die die angezeigte Software verwenden, müssen auch das in MS10-087 bereitgestellte Microsoft Office Update installieren, um vor den in diesem Bulletin (MS10-105) beschriebenen Sicherheitsanfälligkeiten geschützt zu sein.
...
**Muss ich das in MS10-087 enthaltene Update installieren, um vor den in diesem Bulletin (MS10-105) beschriebenen Sicherheitsanfälligkeiten geschützt zu sein?**  
Benutzern, die Microsoft Office XP und Microsoft Office 2003 verwenden, wird empfohlen, das in [MS10-087](https://go.microsoft.com/fwlink/?linkid=203241), „Sicherheitsanfälligkeiten in Microsoft Office können Remotecodeausführung ermöglichen (2423930)“, bereitgestellte Microsoft Office Update zu installieren, um vor den in diesem Bulletin (MS10-105) beschriebenen Sicherheitsanfälligkeiten geschützt zu sein. Sowohl das in MS10-087 als auch das in MS10-105 enthaltene Update müssen installiert werden, aber Benutzer müssen die Updates nicht in einer bestimmten Reihenfolge installieren.
...
Ja. Dieses Update beinhaltet nicht sicherheitsrelevante Änderungen, die Unterstützung zum Außerkraftsetzen der Liste von Konvertern und Filtern bereitstellen, die in Microsoft Office 2007 und Microsoft Office 2010 standardmäßig blockiert sind. Weitere Informationen zu Sicherheitseinstellungen für Microsoft Office-Grafikfilter finden Sie im [Microsoft Knowledge Base-Artikel 2479871](https://support.microsoft.com/kb/2479871).

**Enthält dieses Update sicherheitsbezogene Funktionsänderungen?**  
Dieses Update beinhaltet ein Tiefenverteidigungsupdate, das die Liste von Konvertern und Filtern erweitert, die standardmäßig in Microsoft Office 2007 und Microsoft Office 2010 blockiert sind.
...
Ein eigenständiges Microsoft Office-Programm ist mit der gleichen Bewertung des Schweregrads wie die entsprechende Komponente in einer Microsoft Office Suite betroffen. Eine eigenständige Installation von Microsoft Excel, Microsoft Word oder Microsoft PowerPoint wird z. B. mit der gleichen Bewertung des Schweregrads eingestuft wie eine Installation der betroffenen Microsoft Office Suite.
...
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in CGM-Bildkonverter durch Pufferüberlauf – CVE-2010-3945
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf – CVE-2010-3946
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Heapüberlauf – CVE-2010-3947
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Pufferüberlauf – CVE-2010-3949
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Speicherbeschädigung – CVE-2010-3950
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Pufferüberlauf – CVE-2010-3951
</th>
<th style="border:1px solid black;" >
Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Heap-Beschädigung – CVE-2010-3952
</th>
<th style="border:1px solid black;" >
Bewertung des Gesamtschweregrads
</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3945](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in CGM-Bildkonverter durch Pufferüberlauf – CVE-2010-3945
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in CGM-Bildkonverter durch Pufferüberlauf – CVE-2010-3945

Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:

-   **Ändern der Zugriffssteuerungsliste, um allen Benutzern den Zugriff auf cgmimp32.flt zu verweigern**

    Führen Sie als Administrator folgenden Befehl an einer Eingabeaufforderung aus:

    **Für alle unterstützten 32-Bit-Editionen von Windows XP und Windows Server 2003:**  
    `cacls "%CommonProgramFiles%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N`

    **Für alle unterstützten 64-Bit-Editionen von Windows XP und Windows Server 2003:**  
    `cacls "%CommonProgramFiles(x86)%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N`

    **Für alle unterstützten 32-Bit-Editionen von Windows** **Vista, Windows Server 2008 und Windows 7:**  
    ```
    ...
    ```
    **Für alle unterstützten 64-Bit-Editionen von Windows Vista, Windows Server 2008, Windows 7 und Windows Server 2008 R2:**  
    ```
    ...
    **Auswirkung der Problemumgehung:** Office-Anwendungen können keine CGM-Bilder importieren.

    **So machen Sie die Problemumgehung rückgängig.**

    Führen Sie als Administrator folgenden Befehl an einer Eingabeaufforderung aus:

    Für alle unterstützten 32-Bit-Editionen von Windows Vista und Windows Server 2003:  
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in CGM-Bildkonverter durch Pufferüberlauf – CVE-2010-3945

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird verursacht, wenn Microsoft Office Puffergrößen im Speicher falsch zuweist.
...
Die Ausnutzung dieser Sicherheitsanfälligkeit erfordert, dass ein Benutzer ein speziell gestaltetes Office-Dokument mit einer betroffenen Version von Microsoft Office öffnet.

Bei einem E-Mail-Angriff kann ein Angreifer diese Sicherheitsanfälligkeit ausnutzen, indem er ein speziell gestaltetes Office-Dokument an den Benutzer sendet und ihn dazu verleitet, die Datei zu öffnen.

In einem webbasierten Angriffsszenario muss ein Angreifer eine Website mit einem Office-Dokument einrichten, durch die diese Sicherheitsanfälligkeit ausgenutzt wird. Außerdem können manipulierte Websites und Websites, die von Benutzern bereitgestellte Inhalte akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden kann. Ein Angreifer kann Benutzer nicht zum Besuch einer speziell gestalteten Website zwingen. Stattdessen muss er den Benutzer zu einem Besuch dieser Website verleiten. Zu diesem Zweck wird der Benutzer meist dazu gebracht, auf einen Link zur Website des Angreifers zu klicken und anschließend das speziell gestaltete Office-Dokument zu öffnen.
...
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office beim Darstellen von CGM-Bildern Daten überprüft.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3946](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf – CVE-2010-3946
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf – CVE-2010-3946
...
-   **Ändern der Zugriffssteuerungsliste, um allen Benutzern den Zugriff auf pictim32.flt zu verweigern**
    ...
    **Auswirkung der Problemumgehung:** Office-Anwendungen können keine PICT-Bilder importieren.
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf – CVE-2010-3946
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office beim Darstellen von PICT-Bildern Daten überprüft.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3947](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Heapüberlauf – CVE-2010-3947
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Heapüberlauf – CVE-2010-3947

Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:

-   **Ändern der Zugriffssteuerungsliste, um allen Benutzern den Zugriff auf tiffim32.flt zu verweigern**
    ...
    **Auswirkung der Problemumgehung:** Office-Anwendungen können keine TIFF-Bilder importieren.
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Heapüberlauf – CVE-2010-3947

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Microsoft Office Daten in TIFF-Bilddateien nicht richtig überprüft.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem die Datenüberprüfung in Microsoft Office beim Darstellen von TIFF-Bildern geändert wird.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3949](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Pufferüberlauf – CVE-2010-3949
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Pufferüberlauf – CVE-2010-3949
...
-   **Ändern der Zugriffssteuerungsliste, um allen Benutzern den Zugriff auf MSPCORE.DLL zu verweigern**
    ...
    **Auswirkung der Problemumgehung:** Die Office Document Imaging-Anwendung kann keine TIFF-Dateien importieren.
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Pufferüberlauf – CVE-2010-3949

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Microsoft Office Daten beim Analysieren von TIFF-Bilddateien nicht richtig konvertiert.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Microsoft Office beim Analysieren von TIFF-Bilddateien Daten konvertiert.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3950](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Speicherbeschädigung – CVE-2010-3950
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Speicherbeschädigung – CVE-2010-3950
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Speicherbeschädigung – CVE-2010-3950
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3951](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Pufferüberlauf – CVE-2010-3951

Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:

-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
-   Der FlashPix-Bildkonverter ist nicht standardmäßig in Microsoft Office installiert. Es sind nur jene Systeme von der Sicherheitsanfälligkeit betroffen, auf denen der FlashPix-Bildkonverter manuell installiert wurde.
-   Die Sicherheitsanfälligkeit kann nicht automatisch über E-Mail ausgenutzt werden. Ein Benutzer muss eine zusammen mit einer E-Mail-Nachricht gesendete Dateianlage öffnen, damit ein Angriff erfolgreich ist.
-   In einem webbasierten Angriffsszenario kann ein Angreifer eine Website mit einer Webseite einrichten, die diese Sicherheitsanfälligkeit ausnutzt. Außerdem können manipulierte Websites und Websites, die von Endbenutzern bereitgestellte Inhalte oder Werbemitteilungen akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden könnte. Ein Angreifer kann Endbenutzer jedoch nicht zum Besuch solcher Websites zwingen. Stattdessen muss ein Angreifer Benutzer dazu verleiten, die Website zu besuchen. Zu diesem Zweck werden die Benutzer normalerweise dazu gebracht, auf einen Link in einer E-Mail- oder Instant Messenger-Nachricht zu klicken, der die Benutzer zur Website des Angreifers führt. Dort werden die Benutzer dazu verleitet, die speziell gestaltete Office-Datei zu öffnen.

#### Problemumgehungen für die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Pufferüberlauf – CVE-2010-3951

Problemumgehung bezieht sich auf eine Einstellung oder Konfigurationsänderung, die die zugrunde liegende Sicherheitsanfälligkeit nicht behebt, sondern die bekannten Angriffsmethoden blockiert, bevor Sie das Update installieren. Microsoft hat die folgenden Problemumgehungen getestet und gibt in der Beschreibung an, ob eine Problembehebung die Funktionalität einschränkt:

-   **Ändern der Zugriffssteuerungsliste, um allen Benutzern den Zugriff auf fpx32.flt zu verweigern**
    ...
    **Auswirkung der Problemumgehung:** Office-Anwendungen können keine FlashPix-Bilddateien importieren.
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Pufferüberlauf – CVE-2010-3951

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass Microsoft Office Daten in FlashPix-Bilddateien nicht richtig analysiert.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Microsoft Office beim Darstellen von FlashPix-Bildern Daten überprüft.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3952](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952).

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Heap-Beschädigung  CVE-2010-3952
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Heap-Beschädigung – CVE-2010-3952
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Heap-Beschädigung – CVE-2010-3952

**Worin genau besteht diese Sicherheitsanfälligkeit?**  
Diese Sicherheitsanfälligkeit kann Remotecodeausführung ermöglichen. Nutzt ein Angreifer diese Sicherheitsanfälligkeit erfolgreich aus, kann er die vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.

**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Die Sicherheitsanfälligkeit wird dadurch verursacht, wie Microsoft Office Daten in FlashPix-Bilddateien analysiert.
...
-   Informationen zum Erstellen eines Netzwerksinstallationspunkts für unterstützte Versionen von Microsoft Office finden Sie unter [Erstellen eines Netzwerkinstallationspunkts für Microsoft Office](https://technet.microsoft.com/de-de/library/cc179063).  
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2289162">Microsoft Knowledge Base-Artikel 2289162</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2289163">Microsoft Knowledge Base-Artikel 2289163</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2288931">Microsoft Knowledge Base-Artikel 2288931</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2289078">Microsoft Knowledge Base-Artikel 2289078</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2456849">Microsoft Knowledge Base-Artikel 2456849</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2431831">Microsoft Knowledge Base-Artikel 2431831</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in CGM-Bildkonverter durch Pufferüberlauf (CVE-2010-3945)  
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf (CVE-2010-3946)  
-   Alin Rad Pop von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in PICT-Bildkonverter durch Ganzzahlüberlauf (CVE-2010-3946)  
-   Carsten Eiram von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Heapüberlauf (CVE-2010-3947)  
-   Carsten Eiram von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Pufferüberlauf (CVE-2010-3949)  
-   Carsten Eiram von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in TIFF-Bildkonverter durch Speicherbeschädigung (CVE-2010-3950)  
-   Dyon Balding von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Pufferüberlauf (CVE-2010-3951)  
-   Dyon Balding von [Secunia Research](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in FlashPix-Bildkonverter durch Heap-Beschädigung (CVE-2010-3952)
...
-   V1.1 (15. Dezember 2010): Es wird verdeutlicht, dass Benutzer von Microsoft Office XP und Microsoft Office 2003 das Update in MS10-087 installieren müssen, um vor den in diesem Bulletin (MS10-105) beschriebenen Sicherheitsanfälligkeiten geschützt zu sein.
