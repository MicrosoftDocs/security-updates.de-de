---
TOCTitle: 'MS10-101'
Title: 'Microsoft Security Bulletin MS10-101 - Kritisch'
ms:assetid: 'ms10-101'
ms:contentKeyID: 61224714
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-101(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-101 - Kritisch
===============================================
...
Dieses Sicherheitsupdate wird für alle unterstützten Editionen von Windows Server 2003, Windows Server 2008 (außer Itanium-basierten Editionen) und Windows Server 2008 R2 (außer Itanium-basierten Editionen) als Hoch eingestuft. Weitere Informationen finden Sie im Unterabschnitt **Betroffene und nicht betroffene Software** in diesem Abschnitt.

Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die von Benutzern bereitgestellten Daten in der Schnittstelle des Netlogon RPC-Dienstes validiert werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ad843b97-2f6e-4406-a17a-627b7db8a926)                                                                             | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=0b0a06e7-0ae5-41f4-9ff5-d524fc0afbfa)                                                                 | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7c0c2850-e81d-4347-aeb3-47036caa7c1b)                                                       | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6793f75b-cdf4-42ef-a53e-a1acb5b662d1)\*             | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=85add876-ca5a-4a92-984e-188a72e349fc)\* | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d7307afd-84a0-434e-9658-bf9f8ae4b938)\*                                                              | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
Das Update wird nur Systemen angeboten, auf denen die betroffene Komponente sowohl installiert als auch aktiviert ist. Microsoft Windows Server-Systeme, die nicht für die Rolle eines Domänencontrollers konfiguriert sind, sind nicht betroffen und erhalten dieses Update nicht.
...
<th style="border:1px solid black;" >DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC – CVE-2010-2742</th>
...
DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC – CVE-2010-2742  
------------------------------------------------------------------------------------------------
  
In Implementierungen des Netlogon RPC-Dienstes auf betroffenen Versionen von Windows Server liegt eine Denial-of-Service-Sicherheitsanfälligkeit vor. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass die betroffenen Versionen von Windows Server neu starten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2742](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742).
  
#### Schadensbegrenzende Faktoren für die DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC – CVE-2010-2742
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Diese Sicherheitsanfälligkeit betrifft nur Windows-Server, die als Domänencontroller konfiguriert sind.  
-   Ein Angreifer benötigt zur Ausnutzung dieser Sicherheitsanfälligkeit Administratorrechte auf einem Computer, der mit derselben Domäne verknüpft ist wie der betroffene Domänencontroller.
  
#### Problemumgehungen für die DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC – CVE-2010-2742
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC – CVE-2010-2742
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Es handelt sich bei dieser Sicherheitsanfälligkeit um einen Denial-of-Service-Angriff. Ein Angreifer, der diese Sicherheitsanfälligkeit ausnutzt, kann bewirken, dass das betroffene System neu startet. Beachten Sie, dass eine DoS-Sicherheitsanfälligkeit (Denial of Service) einem Angreifer keine Codeausführung oder Erhöhung von Benutzerberechtigungen ermöglicht, stattdessen aber dazu führen kann, dass das betroffene System neu startet.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit besteht, wenn der Netlogon RPC-Dienst von Benutzern bereitgestellte Daten nicht richtig überprüft.
  
**Was ist Netlogon RPC?**    
Das Netlogon Remote-Protokoll ist eine RPC-Schnittstelle (Remoteprozeduraufruf), die für Benutzer- und Computerauthentifizierung in domänenbasierten Netzwerken verwendet wird. Weitere Informationen zu Netlogon RPC finden Sie im MSDN-Artikel [Netlogon Remote Protocol Specification](https://msdn.microsoft.com/en-us/library/cc237009(v=prot.10).aspx).
  
**Was kann ein Angreifer über diese Sicherheitsanfälligkeit erreichen?**    
Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann bewirken, dass die Domänencontroller neu starten.
  
**Wie gehen Angreifer vor, um diese Sicherheitsanfälligkeit auszunutzen?**    
Ein Angreifer kann diese Sicherheitsanfälligkeit ausnutzen, indem er ein speziell gestaltetes RPC-Paket an die Schnittstelle des Netlogon RPC-Dienstes sendet. Auf allen anderen betroffenen Plattformen muss der Angreifer über gültige Anmeldeinformationen für die Authentifizierung und entsprechende Administratorberechtigungen verfügen, um diese Sicherheitsanfälligkeit auszunutzen.
  
**Für welche Systeme stellt diese Sicherheitsanfälligkeit hauptsächlich ein Risiko dar?**    
Von dieser Sicherheitsanfälligkeit sind Windows-Server betroffen, die als Domänencontroller konfiguriert sind und den Netlogon-Dienst hosten. Windows-Client-Betriebssysteme sind von der Sicherheitsanfälligkeit nicht betroffen.
  
**Wie kann ich feststellen, ob mein Windows-Server als Domänencontroller konfiguriert ist?**    
Wenn der Registrierungsschlüssel HKLM\\SYSTEM\\CurrentControlSet\\Control\\ProductOptions\\ProductType auf LanmanNT gesetzt ist, ist Ihr System als Domänencontroller konfiguriert.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem die von Benutzern bereitgestellten Daten in der Schnittstelle des Netlogon RPC-Dienstes richtig überprüft werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2207559$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2207559">Microsoft Knowledge Base-Artikel 2207559</a>.</td>
</tr>
<tr class="even">
...
-   Matthias Dieter Wallnöfer und Andrew Bartlett von The Samba Team für den Hinweis auf die DoS-Sicherheitsanfälligkeit aufgrund einer Null-Dereferenzierung in Netlogon RPC (CVE-2010-2742)
