---
TOCTitle: 'MS10-081'
Title: 'Microsoft Security Bulletin MS10-081 - Kritisch'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61224694
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-081(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-081 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die allgemeinen Windows-Steuerelemente Nachrichten verarbeiten, die von einem SVG-Viewer (skalierbare Vektorgrafiken) eines Drittanbieters übergeben werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1&displaylang=de)                                                                                            | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                                  | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45&displaylang=de)                                                                                   | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb&displaylang=de)                                                                       | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3&displaylang=de)                                                             | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd&displaylang=de)                                                        | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb&displaylang=de)                                | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c&displaylang=de)\*\*                 | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da&displaylang=de)\*\*     | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6&displaylang=de) | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c&displaylang=de)                                                                                         | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28&displaylang=de)                                                                                   | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418&displaylang=de)\*\*                                                                  | Remotecodeausführung           | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790&displaylang=de)                                                                  | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs – CVE-2010-2746</th>
...
Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs – CVE-2010-2746  
---------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich Remotecodeausführung vor, die dadurch verursacht wird, wie die Bibliothek der allgemeinen Windows-Steuerelemente speziell gestaltete Websites darstellt, wenn dazu ein SVG-Viewer (skalierbare Vektorgrafiken) eines Drittanbieters verwendet wird. Wenn ein Benutzer eine speziell gestaltete Webseite besucht, kann diese Sicherheitsanfälligkeit Remotecodeausführung ermöglichen. Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, kann ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2746](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs – CVE-2010-2746
...
-   Diese Sicherheitsanfälligkeit kann in der standardmäßigen Windows-Konfiguration nicht ausgenutzt werden. Um für das Problem anfällig zu sein, muss auf dem System eine Drittanbieteranwendung installiert sein, mit der skalierbare Vektorgrafiken (SVG) dargestellt werden.
  
#### Problemumgehung für die Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs – CVE-2010-2746
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs – CVE-2010-2746
...
Die Bibliothek der allgemeinen Windows-Steuerelemente verarbeitet bestimmte Nachrichten nicht richtig, wenn skalierbare Vektorgrafiken dargestellt werden, die von einem SVG-Viewer (skalierbare Vektorgrafiken) eines Drittanbieters übergeben werden.
  
**Was ist die Bibliothek der allgemeinen Windows-Steuerelemente?**    
...
**Kann diese Sicherheitsanfälligkeit in der standardmäßigen Windows-Konfiguration ausgenutzt werden?**    
Nein. Um für das Problem anfällig zu sein, muss auf dem System eine Drittanbieteranwendung installiert sein, mit der skalierbare Vektorgrafiken (SVG) dargestellt werden. Microsoft hat keine Angriffsmethode festgestellt, wenn dieser Viewer eines Drittanbieters nicht auf dem System installiert ist. Eine Liste von SVG-Implementierungen finden Sie in der Liste des World Wide Web Consortium (W3C) für [SVG-Implementierungen](https://www.w3.org/graphics/svg/wg/wiki/implementations).
  
**Was sind skalierbare Vektorgrafiken?**    
Skalierbare Vektorgrafiken (SVG) ist ein Standard zum Verfassen und Bereitstellen zweidimensionaler Vektorgrafiken mithilfe von XML-Dokumenten. Es ist eine Empfehlung des World Wide Web Consortium (W3C), die von einigen Industrieunternehmen verfasst wurde und befürwortet wird. Eine SVG ist im Wesentlichen ein XML-Dokument, das dem Schema entspricht, welches als Teil des SVG-Bestätigungsprozesses definiert wurde. In der Spezifikation sind verschiedene grundlegende geometrische Formen wie Rechtecke, Kreise, Ellipsen, Linien, Hilfskonturen, Polygone und Glyphenelemente wie Text definiert. Komplexere Formen können mithilfe des Pfadelements erstellt werden, mit dem Sie Formen als Abfolge von Linien, Bogen und komplizierten Bezier-Kurven definieren können. Mithilfe dieser grundlegenden Formen und ein wenig Findigkeit können selbst die komplexesten geometrischen Konstruktionen erstellt werden.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie die Bibliothek der allgemeinen Windows-Steuerelemente bestimmte Nachrichten verarbeitet, die von einem SVG-Viewer (skalierbare Vektorgrafiken) eines Drittanbieters übergeben werden.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2296011$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2296011">Microsoft Knowledge Base-Artikel 2296011</a>.</td>
</tr>
<tr class="even">
...
-   Krystian Kloskowski (h07) in Zusammenarbeit mit [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Comctl32 bezüglich Heapüberlaufs (CVE-2010-2746)
