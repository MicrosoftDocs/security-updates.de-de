...
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [Windows Media Player 9-Reihe](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043) | Remotecodeausführung           | Kritisch                         | [MS07-047](https://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 2             | [Windows Media Player 9-Reihe](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5) | Remotecodeausführung           | Kritisch                         | [MS07-047](https://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 3             | [Windows Media Player 9-Reihe](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721) | Remotecodeausführung           | Kritisch                         | Keine                                                    |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0268](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268).
...
Anweisungen zum Ermitteln der Version von Windows Media Player auf Ihrem System finden Sie im [Microsoft Knowledge Base-Artikel 190990](https://support.microsoft.com/kb/190990).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/979402">Microsoft Knowledge Base-Artikel 979402</a>.</td>
</tr>
<tr class="even">
...
-   Einer Person, die mit [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Media Player bezüglich Remotecodeausführung (CVE-2010-0268).
