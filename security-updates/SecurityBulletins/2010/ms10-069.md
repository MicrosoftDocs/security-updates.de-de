---
TOCTitle: 'MS10-069'
Title: 'Microsoft Security Bulletin MS10-069 - Kritisch'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61224682
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-069(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-069 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie das Client/Server-Runtime-Subsystem (CSRSS) beim Verarbeiten bestimmter Transaktionen Speicher zuweist. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.

**Empfehlung.**  Die Mehrheit der Benutzer hat die automatische Aktualisierung aktiviert und muss keine Maßnahmen ergreifen, da dieses Sicherheitsupdate automatisch heruntergeladen und installiert wird. Benutzer, die die automatische Aktualisierung nicht aktiviert haben, müssen auf Updates prüfen und dieses Update manuell installieren. Weitere Informationen zu bestimmten Konfigurationsoptionen bei der automatischen Aktualisierung finden Sie im [Microsoft Knowledge Base-Artikel 294871](https://support.microsoft.com/kb/294871/de).

Für Administratoren und für Installationen in Unternehmen bzw. für Endbenutzer, die dieses Sicherheitsupdate manuell installieren möchten, empfiehlt Microsoft, das Update so schnell wie möglich zu installieren.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305&displaylang=de)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                                    |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6)                      | Erhöhung von Berechtigungen    | Hoch                             | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7&displaylang=de)                       | Erhöhung von Berechtigungen    | Hoch                             | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85&displaylang=de)           | Erhöhung von Berechtigungen    | Hoch                             | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5&displaylang=de) | Erhöhung von Berechtigungen    | Hoch                             | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
...
**Ich verwende keine chinesische, japanische oder koreanische Sprachversion von Windows. Gilt dieses Security Bulletin auch für mich?**  
Alle Sprachversionen betroffener Betriebssysteme enthalten die durch dieses Bulletin behobene Sicherheitsanfälligkeit, aber die Sicherheitsanfälligkeit kann nur dann ausgenutzt werden, wenn das System mit einem chinesischen, japanischen oder koreanischen Systemgebietsschema konfiguriert ist.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891</th>
...
Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891  
--------------------------------------------------------------------------------------
  
In Windows CSRSS liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, wie CSRSS für bestimmte Benutzertransaktionen Speicher zuweist. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code im Sicherheitskontext des lokalen Systems ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Nur Systeme, die mit einem chinesischen, japanischen oder koreanischen Systemgebietsschema konfiguriert sind, sind betroffen.  
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891
...
Windows CSRSS weist bei der Verarbeitung bestimmter Benutzertransaktionen auf Windows-Systemen, die mit einem chinesischen, japanischen oder koreanischen Systemgebietsschema konfiguriert sind, nicht immer ausreichend Speicher zu.
  
**Was ist das Windows Client/Server-Runtime-Subsystem (CSRSS)?**    
Das Client/Server-Runtime-Subsystem (CSRSS) stellt den Teil des Win32-Subsystems für den Benutzermodus dar (Win32.sys ist der Teil für den Kernel-Modus). CSRSS steht für Client/Server-Runtime-Subsystem und ist ein unbedingt erforderliches Subsystem, das immer ausgeführt werden muss. CSRSS ist für Konsolenfenster und das Erstellen und/oder Löschen von Threads zuständig.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie CSRSS beim Verarbeiten bestimmter Transaktionen Speicher zuweist.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2121546$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2121546">Microsoft Knowledge Base-Artikel 2121546</a>.</td>
</tr>
<tr class="even">
...
-   [IBM Japan](https://www.ibm.com/jp/ja/) für den Hinweis auf die Sicherheitsanfälligkeit in CSRSS durch Erhöhung lokaler Berechtigungen – CVE-2010-1891
