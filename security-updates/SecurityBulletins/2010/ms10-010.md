---
TOCTitle: 'MS10-010'
Title: 'Microsoft Security Bulletin MS10-010 - Kritisch'
ms:assetid: 'ms10-010'
ms:contentKeyID: 61224623
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-010(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-010 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Hyper-V Server die Codierung von Computeranweisungen überprüft, die auf dessen virtuellen Gastcomputern ausgeführt werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3463a63c-e88a-4036-ab60-f84d4bf4191a&displaylang=de)\* | DoS (Denial of Service)        | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=3214b347-d901-4aac-85ce-676e4602de87&displaylang=de)\*                                                              | DoS (Denial of Service)        | Hoch                             | Keine                                             |
...
**Dieses Update kann manuell auf** betroffenen Plattformen installiert werden, selbst wenn die Hyper-V-Rolle nicht aktiviert ist. Das Update wird jedoch nur dann über Automatische Updates angeboten, wenn die Hyper-V-Rolle aktiviert ist.
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes – CVE-2010-0026</th>
...
Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes – CVE-2010-0026  
-----------------------------------------------------------------------------------------------
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes – CVE-2010-0026
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes – CVE-2010-0026
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes – CVE-2010-0026
...
Diese Sicherheitsanfälligkeit wird dadurch verursacht, dass Hyper-V Server die Codierung bestimmter Computeranweisungen falsch überprüft, die in den virtuellen Gastcomputern ausgeführt werden. Aufgrund dieses Überprüfungsmangels kann die Verarbeitung dieser Anweisungen bewirken, dass die Hyper-V Serveranwendung nicht mehr reagiert.
...
Ein Angreifer muss ein authentifizierter Benutzer auf einem der virtuellen Gastcomputer sein, die vom Hyper-V Server gehostet werden, und die Möglichkeit haben, beliebigen Code auf dem System auszuführen. Ein Angreifer kann dann eine nicht vertrauenswürdige ausführbare Datei auf dem System ausführen, die eine fehlerhafte Sequenz von Computeranweisungen aufruft und somit bewirkt, dass Hyper-V Server nicht mehr reagiert.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie Hyper-V Server die Codierung von Computeranweisungen überprüft, die auf dessen virtuellen Gastcomputern ausgeführt werden.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/977894">Microsoft Knowledge Base-Artikel 977894</a>.</td>
</tr>
<tr class="odd">
...
-   Jan Bottorff für den Hinweis auf die Sicherheitsanfälligkeit in Hyper-V bezüglich Überprüfung des Instruktionssatzes (CVE-2010-0026).
...
-   V1.1 (10. Februar 2010): In der **Systems Management Server**-Tabelle wurde der Eintrag für SMS 2003 mit ITMU für Windows Server 2008 R2 geändert. Dies ist lediglich eine Informationsänderung. An den Dateien des Sicherheitsupdates oder der Erkennungslogik wurden keine Änderungen vorgenommen.
