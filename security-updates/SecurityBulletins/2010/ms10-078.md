---
TOCTitle: 'MS10-078'
Title: 'Microsoft Security Bulletin MS10-078 - Kritisch'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61224691
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-078(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-078 - Kritisch
===============================================
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeiten, indem korrigiert wird, wie der OTF-Formattreiber (OpenType Font) beim Bearbeiten von OpenType-Schriftarten Speicher zuweist und Ganzzahlberechnungen durchführt. Weitere Informationen zu den Sicherheitsanfälligkeiten finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag im nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc&displaylang=de)                                | Erhöhung von Berechtigungen    | Hoch                             | [MS10-037](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-037.mspx) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b)                      | Erhöhung von Berechtigungen    | Hoch                             | [MS10-037](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-037.mspx) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d&displaylang=de)                       | Erhöhung von Berechtigungen    | Hoch                             | [MS10-037](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-037.mspx) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963&displaylang=de)           | Erhöhung von Berechtigungen    | Hoch                             | [MS10-037](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-037.mspx) |
| [Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa&displaylang=de) | Erhöhung von Berechtigungen    | Hoch                             | [MS10-037](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-037.mspx) |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten – CVE-2010-2740</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten – CVE-2010-2741</th>
...
Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten – CVE-2010-2740  
----------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, dass der Windows OTF-Formattreiber (OpenType Font) speziell gestaltete OpenType-Schriftarten falsch analysiert. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2740](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten – CVE-2010-2740
...
#### Problemumgehungen für die Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten – CVE-2010-2740
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten – CVE-2010-2740
...
Die Sicherheitsanfälligkeit wird verursacht, wenn der OTF-Formattreiber (OpenType Font) beim Analysieren einer speziell gestalteten Schriftart Speicher nicht richtig zuweist.
  
**Was ist das OpenType-Schriftartformat?**    
OpenType ist ein Schriftartformat, das von Microsoft und Adobe gemeinschaftlich als Erweiterung des TrueType-Schriftartformats von Apple entwickelt wurde. Eine OpenType-Schriftartdatei enthält Daten in Tabellenformat, die entweder aus einer TrueType- oder PostScript-Konturenschriftart besteht. Rasterprogramme verwenden Kombinationen von Daten aus den Tabellen, die in der Schriftart enthalten sind, um die Konturen von TrueType- oder PostScript-Symbolkonturen darzustellen. Einige dieser Unterstützungsdaten werden unabhängig davon verwendet, welches Konturenformat verwendet wird, und einige der Unterstützungsdaten sind spezifisch für entweder TrueType oder PostScript. Weitere Informationen finden Sie in den [Häufig gestellten Fragen zur Microsoft-Typografie OpenType](https://www.microsoft.com/typography/opentypefaq.mspx).
...
Ja. Webbrowser von Drittanbietern sind von dieser Sicherheitsanfälligkeit betroffen, wenn sie standardmäßig OTF-Schriftarten (OpenType Font) darstellen. Bei diesen Anwendungen kann diese Sicherheitsanfälligkeit Remotecodeausführung im Kontext des angemeldeten Benutzers ermöglichen, wenn damit eine Website mit einer eingebetteten, speziell gestalteten Schriftart angezeigt wird. Standardmäßig ist Internet Explorer nicht von diesem Problem betroffen.
  
**Was bewirkt das Update?**    
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der OTF-Formattreiber (OpenType Font) beim Analysieren einer Schriftart Speicher zuweist.
...
Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten – CVE-2010-2741  
---------------------------------------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, dass der Windows OTF-Formattreiber (OpenType Font) speziell gestaltete OpenType-Schriftarten falsch analysiert. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann im Kernel-Modus beliebigen Code ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2741](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten – CVE-2010-2741
  
Schadensbegrenzung bezieht sich auf eine Einstellung, häufige Konfiguration oder allgemeine empfohlene Vorgehensweise, die in einem Standardzustand existieren und den Schweregrad der Ausnutzung einer Sicherheitsanfälligkeit verringern können. Die folgenden schadensbegrenzenden Faktoren könnten hilfreich für Sie sein:
  
-   Ein Angreifer benötigt gültige Anmeldeinformationen und muss sich lokal anmelden können, um diese Sicherheitsanfälligkeit auszunutzen. Die Sicherheitsanfälligkeit kann nicht per Remotezugriff oder von anonymen Benutzern ausgenutzt werden.
  
#### Problemumgehungen für die Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten – CVE-2010-2741
  
Für diese Sicherheitsanfälligkeit gibt es bislang keine Problemumgehungen.
  
#### Häufig gestellte Fragen (FAQs) zur Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten – CVE-2010-2741
  
**Worin genau besteht diese Sicherheitsanfälligkeit?**    
Diese Sicherheitsanfälligkeit kann für eine lokale Erhöhung von Berechtigungen ausgenutzt werden. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code ausführen und vollständige Kontrolle über das betroffene System erlangen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**    
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der OTF-Formattreiber (OpenType Font) beim Bearbeiten speziell gestalteter OpenType-Schriftarten keine richtige Ganzzahlberechnung durchführt.
...
**Sind Webbrowser von Drittanbietern von dieser Sicherheitsanfälligkeit betroffen?**  
Ja. Webbrowser von Drittanbietern sind von dieser Sicherheitsanfälligkeit betroffen, wenn sie standardmäßig OTF-Schriftarten (OpenType Font) darstellen. Bei diesen Anwendungen kann diese Sicherheitsanfälligkeit Remotecodeausführung im Kontext des angemeldeten Benutzers ermöglichen, wenn damit eine Website mit einer eingebetteten, speziell gestalteten Schriftart angezeigt wird.
  
**Was bewirkt das Update?**    
Das Update behebt diese Sicherheitsanfälligkeit, indem korrigiert wird, wie der OTF-Formattreiber (OpenType Font) beim Bearbeiten von OpenType-Schriftarten Ganzzahlberechnungen durchführt.
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2279986$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2279986">Microsoft Knowledge Base-Artikel 2279986</a>.</td>
</tr>
<tr class="even">
...
-   Sebastian Apelt von [Siberas](https://www.siberas.de/) für den Hinweis auf die Sicherheitsanfälligkeit beim Analysieren von OpenType-Schriftarten (CVE-2010-2740)
-   Diego Juarez von [Core Security Technologies](https://www.coresecurity.com) für den Hinweis auf die Sicherheitsanfälligkeit beim Überprüfen von OpenType-Schriftarten (CVE-2010-2741)
