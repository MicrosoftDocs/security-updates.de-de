...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2265906](https://support.microsoft.com/kb/2265906) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<tr>
<td style="border:1px solid black;">
[Microsoft Silverlight 2](https://www.microsoft.com/getsilverlight/get-started/install/default.aspx)<sup>[1]</sup> bei Installation unter Mac OS  
(KB982926)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
Mithilfe der Silverlight-Funktion für automatische Updates wird sichergestellt, dass Ihre Silverlight-Installation mit der aktuellen Version von Silverlight, Silverlight-Funktionen und Sicherheitsfunktionen auf dem neuesten Stand gehalten wird. Weitere Informationen zur Silverlight-Funktion für automatische Updates finden Sie unter [Microsoft Silverlight Updater](https://www.microsoft.com/getsilverlight/resources/documentation/updater.aspx). Benutzer, die die Silverlight-Funktion für automatische Updates deaktiviert haben, können sich bei [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) anmelden, um die aktuelle Version von Silverlight zu erhalten. Sie können die aktuelle Version von Silverlight aber auch mit dem Downloadlink in der Tabelle „Betroffene Software“ im Abschnitt **Betroffene und nicht betroffene Software** weiter oben manuell herunterladen. Weitere Informationen zum Bereitstellen von Silverlight in einer Unternehmensumgebung finden Sie im [Silverlight Enterprise-Bereitstellungshandbuch](https://go.microsoft.com/fwlink/?linkid=119611).

**Enthält dieses Update weitere nicht sicherheitsbezogene Funktionsänderungen?**  
Weitere Informationen zu nicht sicherheitsrelevanten Änderungen, die in der aktuellen Version von Silverlight enthalten sind, finden Sie im [Microsoft Silverlight-Veröffentlichungsverlauf](https://go.microsoft.com/fwlink/?linkid=92598).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0019).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1898](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1898).
...
-   **Aktualisieren Sie auf die aktuelle Version von Microsoft Silverlight**
    ...
    Silverlight 4 ist von dieser Sicherheitsanfälligkeit nicht betroffen. Statt das Silverlight-Sicherheitsupdate zu installieren, können Benutzer eine Aktualisierung auf die aktuelle Version von Silverlight durchführen. Weitere Informationen finden Sie unter [Microsoft Silverlight](https://www.microsoft.com/germany/net/silverlight/).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2265906">Microsoft Knowledge Base-Artikel 2265906</a>.</td>
</tr>
<tr class="odd">
...
-   [Eamon Nerbonne](https://eamon.nerbonne.org) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Silverlight und Microsoft .NET Framework CLR bezüglich Delegaten virtueller Methoden (CVE-2010-1898)
