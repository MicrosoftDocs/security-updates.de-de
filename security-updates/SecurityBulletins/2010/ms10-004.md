...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=cfc697b4-2ceb-4030-86c5-be9bc8bfd07c)  
(KB973143)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=2291ae24-fa39-4ad8-a7d0-12726b68ad96)  
(KB976881)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2004 für Mac](https://www.microsoft.com/download/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8&displaylang=de)  
(KB979674)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
Im [Microsoft Knowledge Base-Artikel 975416](https://support.microsoft.com/kb/975416) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Dies liegt daran, dass eigenständige Installationen des PowerPoint Viewer 2003 das [Ende ihres Supportlebenszyklus](https://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx) erreicht haben und daher dieses Update für sie nicht angeboten wird. Stattdessen wird dieses Update Benutzern von Microsoft Office PowerPoint 2003 angeboten, damit sie die aktualisierte Version ihrer Präsentationen veröffentlichen können, die mithilfe der [Funktion „Verpacken einer Präsentation für CD“](https://support.microsoft.com/kb/828504) in PowerPoint erstellt wurden, die PowerPoint Viewer 2003 verwendet.

Benutzer eigenständiger Installationen des PowerPoint Viewer 2003 sollten zu Versionen migrieren, für die Support angeboten wird, um sich vor potentiellen Sicherheitsanfälligkeiten zu schützen. PowerPoint Viewer 2007 ist nicht von den in diesem Bulletin beschriebenen Sicherheitsanfälligkeiten betroffen und ist im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en) verfügbar.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922847](https://support.microsoft.com/kb/922847) beschrieben ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, können Dateien aus Office 2003 oder früheren Versionen nicht in Office 2003 öffnen.
...
-   **Verwenden Sie die Microsoft Office Isolated Conversion Environment (MOICE), wenn Sie Dateien von unbekannten oder nicht vertrauenswürdigen Quellen öffnen.**
    ...
    <https://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=de-de>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033).
...
-   In einem webbasierten Angriffsszenario kann ein Angreifer eine Website mit einer Webseite einrichten, die diese Sicherheitsanfälligkeit ausnutzt. Außerdem können manipulierte Websites und Websites, die von Endbenutzern bereitgestellte Inhalte oder Werbemitteilungen akzeptieren oder hosten, speziell gestaltete Inhalte enthalten, über die diese Sicherheitsanfälligkeit ausgenutzt werden könnte. Ein Angreifer kann Endbenutzer jedoch nicht zum Besuch solcher Websites zwingen. Stattdessen muss ein Angreifer Benutzer dazu verleiten, die Website zu besuchen. Zu diesem Zweck werden die Benutzer normalerweise dazu gebracht, auf einen Link in einer E-Mail-Nachricht oder Instant Messenger-Nachricht zu klicken, die die Benutzer zur Website des Angreifers führt. Dort werden die Benutzer dazu verleitet, die speziell gestaltete PowerPoint-Datei zu öffnen.
-   Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann die gleichen Benutzerrechte wie der lokale Endbenutzer erlangen. Für Endbenutzer, deren Konten mit weniger Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerrechten arbeiten.
-   Microsoft Office PowerPoint Viewer 2007 ist von dieser Sicherheitsanfälligkeit nicht betroffen. Benutzer können Microsoft Office PowerPoint Viewer 2007 über das [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en) installieren.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/973143">Microsoft Knowledge Base-Artikel 973143</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/976881">Microsoft Knowledge Base-Artikel 976881</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.5.7 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8) herunter, und installieren Sie sie.
...
-   Carsten Eiram von [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Pufferüberlauf bei Dateipfadverarbeitung durch PowerPoint (CVE-2010-0029)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Heapüberlaufs und LinkedSlideAtom in PowerPoint (CVE-2010-0030)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich ungültiger Arrayindizierung, OEPlaceholderAtom und „placementId“ in PowerPoint (CVE-2010-0031)  
-   Sean Larsson von [VeriSign iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Use-after-Free-Sicherheitsanfälligkeit bezüglich OEPlaceholderAtom in PowerPoint (CVE-2010-0032)  
-   SkD in Zusammenarbeit mit der [Zero Day Initiative](https://www.zerodayinitiative.com/) von [TippingPoint](https://www.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Datensatz-Stapelüberlaufs und TextBytesAtom in PowerPoint Viewer (CVE-2010-0033).  
-   Cody Pierce von [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Datensatz-Stapelüberlaufs und TextCharsAtom in Office PowerPoint Viewer (CVE-2010-0034)
