...
<td style="border:1px solid black;">
[MS10-035](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-035.mspx)
</td>
</tr>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-1258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1258).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2556).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2557).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2558](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2558).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2559](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2559).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2560](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2560).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2183461">Microsoft Knowledge Base-Artikel 2183461</a>.</td>
</tr>
<tr class="even">
...
-   David Bloom von [Google Inc.](https://www.google.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei domänenübergreifenden Ereignishandlern – CVE-2010-1258  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2010-2556  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung – CVE-2010-2557  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund einer Racebedingung – CVE-2010-2558  
...
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei HTML-Layout – CVE-2010-2560
