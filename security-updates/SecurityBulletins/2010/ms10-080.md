...
<td style="border:1px solid black;">
[MS10-038](http://www.microsoft.com/germany/technet/sicherheit/bulletins/ms10-038.mspx)
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3230](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](http://support.microsoft.com/kb/922848) erörtert ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, können Dateien im Format Office 2003 oder früheren Versionen nicht in Office 2003 oder Office 2007 öffnen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233).
...
Standardmäßig ist das Öffnen von Lotus 1-2-3-Dateien in Microsoft Excel 2003 Service Pack 3 blockiert. Dieser schadensbegrenzende Faktor verringert die Bewertung des Schweregrads von CVE-2010-3233 für Microsoft Excel 2003 Service Pack 3. Weitere Informationen zu Dateitypen, die nach der Installation von Microsoft Office 2003 Service Pack 3 blockiert sind, finden Sie im [Microsoft Knowledge Base-Artikel 938810](http://support.microsoft.com/kb/938810/).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3234](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3236](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](http://support.microsoft.com/kb/922848) beschrieben ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, können Dateien aus Office 2003 oder früheren Versionen nicht in Office 2003 öffnen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3240](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Auswirkung der Problemumgehung:** Benutzer, die die Dateiblockierungsrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](http://support.microsoft.com/kb/922848) beschrieben ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, können Dateien aus Office 2003 oder früheren Versionen nicht in Office 2007 öffnen.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3241](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3242](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242).
...
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2345017">Microsoft Knowledge Base-Artikel 2345017</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="http://support.microsoft.com/kb/2344893">Microsoft Knowledge Base-Artikel 2344893</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel 2007 finden Sie im <a href="http://support.microsoft.com/kb/2345035">Microsoft Knowledge Base-Artikel 2345035</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Excel Viewer finden Sie im <a href="http://support.microsoft.com/kb/2345088">Microsoft Knowledge Base-Artikel 2345088</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zum Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 finden Sie im <a href="http://support.microsoft.com/kb/2344875">Microsoft Knowledge Base-Artikel 2344875</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
-   Alin Rad Pop von [Secunia](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Ganzzahlüberlaufs beim Analysieren von Excel-Datensätzen (CVE-2010-3230)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung beim Analysieren von Excel-Datensätzen (CVE-2010-3231)  
-   Omair für den Hinweis auf die Sicherheitsanfälligkeit in Excel bezüglich der Analyse von Dateiformaten (CVE-2010-3232)  
-   Carsten H. Eiram von [Secunia](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Lotus 1-2-3 bezüglich der Analyse von Arbeitsmappen (CVE-2010-3233)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich untergeordneten Formeldatenstroms und Speicherbeschädigung (CVE-2010-3234)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Biff-Formeldatensatzes (CVE-2010-3235)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich überschrittener Arraygrenzen (CVE-2010-3236)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Datensatzzeiger bei Zellenzusammenführung (CVE-2010-3237)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich negativer Zukunftsfunktion (CVE-2010-3238)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Grenzüberschreitung bei Datensatzanalyse (CVE-2010-3239)  
-   Alin Rad Pop von [Secunia](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Grenzüberschreitung bei Datensatzanalyse (CVE-2010-3239)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Echtzeit-Datenarray-Datensatzes (CVE-2010-3240)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Schreibens außerhalb des gültigen Speicherbereichs bei Analyse (CVE-2010-3241)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](http://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei Analyse des Typs inaktiver Datensätze (CVE-2010-3242)  
-   Carsten H. Eiram von [Secunia](http://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei Analyse des Typs inaktiver Datensätze (CVE-2010-3242)
