...
<td style="border:1px solid black;">
[Microsoft Word 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f22d10fd-cb12-43e8-88d5-2116cf4317c4)  
(KB2328360)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=172f3743-cdfa-42d7-aeb4-27ba0e4139f7)  
(KB2344911)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Word 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ccad4871-32f2-4982-a23e-9b5824397615)<sup>[1]</sup>
(KB2344993)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Word 2010 (32-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=6c3b8690-e568-42ed-a858-0cbdd5ea3669)  
(KB2345000)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<td style="border:1px solid black;">
[Microsoft Word 2010 (64-Bit-Editionen)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f31a1f9b-02df-4a85-a7d1-7d1e31baa30f)  
(KB2345000)
</td>
<td style="border:1px solid black;">
Remotecodeausführung
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2004 für Mac](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=464965fa-971a-49dd-bcee-c4d91fac86a9)  
(KB2422343)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2008 für Mac](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=abd05074-8ffc-41a4-a2f3-1d8047574552)  
(KB2422352)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Open XML-Dateiformatkonverter für Mac](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5c759c46-ead3-44ea-b7c8-a308b3140d2e)  
(KB2422398)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=553d28ae-c352-4985-97c3-e5038414be45)  
(KB2345043)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Word Viewer](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=1cb5ab02-074d-4877-b378-7058959705ae)  
(KB2345009)
</td>
<td style="border:1px solid black;">
Nicht anwendbar
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=8fb56eb9-9601-4c1e-905a-9fe4802b2c8d">Microsoft Office Web Apps</a>[2]<br />
(KB2346411)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=13b24264-ec3d-44e8-81e3-82ac767defd3">Microsoft Word Web App</a>[2]<br />
(KB2345015)</td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2747](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2747).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2748](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2748).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-2750](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2750).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3214).
...
-   **Verwenden Sie die Dateiblockierungsrichtlinie von Microsoft Office, um das Öffnen von Dokumenten aus Office 2003 oder früher von unbekannten oder nicht vertrauenswürdigen Quellen und Orten zu blockieren.**
    ...
    **Für Office 2010** 
    ...
    Alternativ kann der Zugriffsschutz mithilfe der Gruppenrichtlinie angewendet werden. Weitere Informationen finden Sie in dem TechNet-Artikel [Planen von Einstellungen für den Zugriffsschutz für Office 2010](https://technet.microsoft.com/en-us/library/cc179230.aspx).

    **Auswirkung der Problemumgehung:** In Microsoft Office 2003 und Microsoft Office 2007 können Benutzer, die die Zugriffsschutzrichtlinie konfiguriert und nicht wie im [Microsoft Knowledge Base-Artikel 922848](https://support.microsoft.com/kb/922848) erörtert ein gesondertes „Ausnahmeverzeichnis“ konfiguriert haben, Dateien im Format Office 2003 oder früheren Versionen nicht öffnen. In Microsoft Office 2007, Office 2003 oder früheren Versionen werden die Dateien entweder nicht oder im geschütztem Modus geöffnet, je nach dem ausgewählten Öffnungsverhalten.
...
-   **Verwenden Sie die Microsoft Office Isolated Conversion Environment (MOICE), wenn Sie Dateien von unbekannten oder nicht vertrauenswürdigen Quellen öffnen.**
    ...
    [https://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=en-us](https://update.microsoft.com/microsoftupdate/v6/default.aspx)

    **Aktivieren Sie MOICE**

    **Hinweis:** Siehe [Microsoft Knowledge Base-Artikel 935865](https://support.microsoft.com/kb/935865), um diese Problemumgehung mithilfe der automatisierten **Microsoft Fix it**-Lösung zu aktivieren bzw. zu deaktivieren.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3215](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3215).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3216](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3216).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3217).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3218](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3218).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3219](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3219).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3220](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3220).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3221](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3221).
...
-   Informationen zum Erstellen eines Netzwerksinstallationspunkts für unterstützte Versionen von Microsoft Office finden Sie unter [Erstellen eines Netzwerkinstallationspunkts für Microsoft Office](https://technet.microsoft.com/de-de/library/cc179063.aspx).  
    **Hinweis:** Wenn Sie vorhaben, Sicherheitsupdates zentral zu verwalten, verwenden Windows Server Update Services. Weitere Informationen zum Bereitstellen von Sicherheitsupdates für Microsoft Office finden Sie auf der [Windows Server Update Services-Website](https://technet.microsoft.com/de-de/wsus/default.aspx).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2328360">Microsoft Knowledge Base-Artikel 2328360</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2344911">Microsoft Knowledge Base-Artikel 2344911</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Word 2007 finden Sie im <a href="https://support.microsoft.com/kb/2344993">Microsoft Knowledge Base-Artikel 2344993</a>.<br />
<br />
Informationen zum Microsoft Office Compatibility Pack für die Dateiformate von Word, Excel und PowerPoint 2007 finden Sie im <a href="https://support.microsoft.com/kb/2345043">Microsoft Knowledge Base-Artikel 2345043</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen:</strong></td>
<td style="border:1px solid black;">Informationen zu Microsoft Office 2010 finden Sie im <a href="https://support.microsoft.com/kb/2345000">Microsoft Knowledge Base-Artikel 2345000</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Word Web App finden Sie im <a href="https://support.microsoft.com/kb/2345015">Microsoft Knowledge Base-Artikel 2345015</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Informationen zu Microsoft Office Web Apps finden Sie im <a href="https://support.microsoft.com/kb/2346411">Microsoft Knowledge Base-Artikel 2346411</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
<td style="border:1px solid black;">Nicht anwendbar</td>
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2004-Updates für Mac 11.6.1 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=464965fa-971a-49dd-bcee-c4d91fac86a9) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Microsoft Office 2008-Updates für Mac 12.2.7 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=abd05074-8ffc-41a4-a2f3-1d8047574552) herunter, und installieren Sie sie.
...
Laden Sie die entsprechende Sprachversion des Open XML-Dateiformatkonverter-Updates für Mac 1.1.7 im [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5c759c46-ead3-44ea-b7c8-a308b3140d2e) herunter, und installieren Sie sie.
...
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich nicht initialisierter Zeiger (CVE-2010-2747)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Grenzüberprüfung (CVE-2010-2748)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Index (CVE-2010-2750)  
-   Nicolas Joly vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Stapelüberlaufs (CVE-2010-3214)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Rückgabewerten (CVE-2010-3215)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Lesezeichen (CVE-2010-3216)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Zeigern (CVE-2010-3217)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bezüglich Heapüberlaufs (CVE-2010-3218)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word beim Analysieren des Index (CVE-2010-3219)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bei Analyse (CVE-2010-3220)  
-   Chaouki Bekrar vom [VUPEN Vulnerability Research Team](https://www.vupen.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Word bei Analyse (CVE-2010-3221)
