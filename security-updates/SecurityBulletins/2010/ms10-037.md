...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-0819](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/980218">Microsoft Knowledge Base-Artikel 980218</a>.</td>
</tr>
<tr class="even">
...
-   Chris Carton von Laserforce International in Zusammenarbeit mit [Secunia](https://secunia.com/) für den Hinweis auf die Sicherheitsanfälligkeit im OpenType CFF-Treiber bezüglich Speicherbeschädigung (CVE-2010-0819)
