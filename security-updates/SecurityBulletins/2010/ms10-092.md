---
TOCTitle: 'MS10-092'
Title: 'Microsoft Security Bulletin MS10-092 - Kritisch'
ms:assetid: 'ms10-092'
ms:contentKeyID: 61224705
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms10-092(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-092 - Kritisch
===============================================

Sicherheitsanfälligkeit in Taskplaner kann Erhöhung von Berechtigungen ermöglichen (2305420)
--------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 14. Dezember 2010 | Aktualisiert: Mittwoch, 2. März 2011
...
Das Sicherheitsupdate behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Taskplaner Integritätsprüfungen ausführt, um zu überprüfen, ob Aufgaben mit den vorgesehenen Benutzerberechtigungen ausgeführt werden. Weitere Informationen zur Sicherheitsanfälligkeit finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt **Informationen zu Sicherheitsanfälligkeiten**.
...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 2305420](https://support.microsoft.com/?kbid=2305420) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| [Windows Vista Service Pack 1 und Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846)                                                        | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Vista x64 Edition Service Pack 1 und Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613)                                | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für 32-Bit-Systeme und Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17)                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für x64-basierte Systeme und Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6)       | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 für Itanium-basierte Systeme und Windows Server 2008 für Itanium-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee) | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für 32-Bit-Systeme](https://www.microsoft.com/download/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a)                                                                                         | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows 7 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d)                                                                                   | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für x64-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb)\*                                                                    | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
| [Windows Server 2008 R2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961)                                                                  | Erhöhung von Berechtigungen    | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Taskplaner - CVE-2010-3338</th>
...
Sicherheitsanfälligkeit im Taskplaner - CVE-2010-3338  
-----------------------------------------------------
  
Es liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen vor, die dadurch verursacht wird, dass der Windows Taskplaner nicht richtig überprüft, ob geplante Aufgaben im vorgesehenen Sicherheitskontext ausgeführt werden. Ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann beliebigen Code im Sicherheitskontext des lokalen Systems ausführen. Ein Angreifer kann dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen.
  
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338).
  
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit im Taskplaner - CVE-2010-3338
...
#### Problemumgehungen für die Sicherheitsanfälligkeit im Taskplaner - CVE-2010-3338
...
-   **Ausschalten des Taskplanerdienstes**
    ...
    **Auswirkung der Problemumgehung:** Der Benutzer kann keine geplanten Aufgaben auf dem Computer ausführen.
...
#### Häufig gestellte Fragen (FAQs) zu der Sicherheitsanfälligkeit im Taskplaner - CVE-2010-3338
...
Die Sicherheitsanfälligkeit wird dadurch verursacht, dass der Windows Taskplaner nicht richtig überprüft, ob geplante Aufgaben im vorgesehenen Sicherheitskontext ausgeführt werden. Dies kann einem lokalen Angreifer ermöglichen, eine Aufgabe zu planen und im Kontext des System- oder Administratorkontos auszuführen.
  
**Was ist der Windows Taskplaner?**  
Taskplaner ist ein Windows-Dienst, der die Automatisierung von alltäglichen Aufgaben auf einem ausgewählten Computer ermöglicht. Der Taskplaner tut dies, indem er die Kriterien (Trigger genannt) überwacht, die der Benutzer zum Initiieren von Aufgaben ausgewählt hat, und dann die Aufgaben ausführt, wenn die Kriterien erfüllt sind. Weitere Informationen finden Sie in dem Eintrag [Taskplaner](https://msdn.microsoft.com/en-us/library/aa383614(vs.85).aspx) der MSDN-Bibliothek.
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie der Taskplaner Integritätsprüfungen ausführt, um zu überprüfen, ob Aufgaben mit den vorgesehenen Benutzerberechtigungen ausgeführt werden.
  
**War diese Sicherheitsanfälligkeit zum Zeitpunkt der Veröffentlichung dieses Security Bulletins bereits öffentlich bekannt?**  
Ja. Diese Sicherheitsanfälligkeit wurde veröffentlicht. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2010-3338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) zugewiesen.
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2305420">Microsoft Knowledge Base-Artikel 2305420</a>.</td>
</tr>
<tr class="odd">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin und Alexey Monastyrsky von [Kaspersky Lab](https://usa.kaspersky.com/) und Vitaly Kiktenko und Alexander Saprykin von [Design and Test Lab](https://www.dnt-lab.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Taskplaner (CVE-2010-3338)  
-   Liam O Murchu von [Symantec](https://www.symantec.com/index.jsp) für den Hinweis auf die Sicherheitsanfälligkeit im Taskplaner (CVE-2010-3338)  
-   Alexandr Matrosov, Eugene Rodionov, Juraj Malcho und David Harley von [ESET](https://www.eset.com/) für den Hinweis auf die Sicherheitsanfälligkeit im Taskplaner (CVE-2010-3338)
...
-   V1.1 (2. März 2011): Dem Abschnitt „Bekannte Probleme“ in der Kurzzusammenfassung wurde eine Verknüpfung zum Microsoft Knowledge Base-Artikel 2305420hinzugefügt.
