...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=bda9d0b4-f7cb-4d9d-b030-043d7437734b) | Remotecodeausführung           | Hoch                             | [MS05-017](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms05-017.mspx) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=09d4e6ae-5d19-4f11-bb7e-60cee8263bc8)             | Erhöhung von Berechtigungen    | Mittel                           | Keine                                                                                   |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit im Message Queuing-Dienst bezüglich Remotecodeausführung – CVE-2007-3039</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-3039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039).
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:
Verwenden Sie das Tool „Software“ in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB937894$\Spuninst</td>
</tr>
<tr class="odd">
...
-   [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit in MSMQ bezüglich Remotecodeausführung – (CVE-2007-3039).
-   ADLAB von [Venustech](https://www.venustech.com.cn/) für den Hinweis auf die Sicherheitsanfälligkeit in MSMQ bezüglich Remotecodeausführung – (CVE-2007-3039).
