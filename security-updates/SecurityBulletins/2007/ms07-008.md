...
-   Microsoft Windows 2000 Service Pack 4 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=211a9c07-88ff-4ae4-a82a-ce2045c6c4fe)
-   Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=a3700273-d7da-4a60-ba80-c95c8036d670)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=69ef4daa-cf0f-4898-8675-911428e7fd74&displaylang=en)
-   Microsoft Windows Server 2003 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5a1f1607-b6ec-41e2-aac0-34387f1211a7)
-   Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5a1f1607-b6ec-41e2-aac0-34387f1211a7)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d638c8e8-5fbe-4a32-945c-440a4b684b0f)
-   Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=d638c8e8-5fbe-4a32-945c-440a4b684b0f)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=65bf2245-6c89-43db-8d28-12988791c395&displaylang=en)
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit im ActiveX-Steuerelement der HTML-Hilfe – [CVE-2007-0214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0214) | Remotecodeausführung                   | Kritisch                    | Kritisch                  | Mittel              | Mittel                             |
...
|---------------------------------------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-046**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-046.mspx) | Ersetzt                     | Ersetzt                   | Ersetzt             | Ersetzt                            |

**Welches sind die bekannten Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können?**  
Im [Microsoft Knowledge Base-Artikel 928843](https://support.microsoft.com/kb/928843) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
-   **Deaktivieren Sie vorübergehend das ActiveX-Steuerelement der HTML-Hilfe, damit es in Internet Explorer nicht mehr ausgeführt werden kann**
    ...
    **Warnung:** Eine fehlerhafte Verwendung des Registrierungs-Editors kann unter Umständen ernste Probleme verursachen, die eine erneute Installation des Betriebssystems erfordern können. Microsoft übernimmt keine Garantie dafür, dass Sie Probleme lösen können, die auf das fehlerhafte Verwenden des Registrierungs-Editors zurückzuführen sind. Verwenden Sie den Registrierungs-Editor auf eigene Gefahr.
    ...
    Ausführliche Anweisungen dazu, wie die Ausführung eines ActiveX-Steuerelements in Internet Explorer verhindert wird, finden Sie im [Microsoft Knowledge Base-Artikel 240797](https://support.microsoft.com/kb/240797). Befolgen Sie diese Schritte, und erstellen Sie einen Wert für Kompatibilitätskennzeichen in der Registrierung, um zu verhindern, dass das ActiveX-Steuerelement der HTML-Hilfe in Internet Explorer instanziiert wird.  
...
-   H. D. Moore von [BreakingPoint Systems](https://www.bpointsys.com/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit im ActiveX-Steuerelement der HTML-Hilfe (CVE-2007-0214).
