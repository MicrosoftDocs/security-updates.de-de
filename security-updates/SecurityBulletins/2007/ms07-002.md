---
TOCTitle: 'MS07-002'
Title: 'Microsoft Security Bulletin MS07-002 - Kritisch'
ms:assetid: 'ms07-002'
ms:contentKeyID: 61224395
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms07-002(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS07-002 - Kritisch
===============================================

Sicherheitsanfälligkeiten in Microsoft Excel können Remotecodeausführung ermöglichen (927198)
---------------------------------------------------------------------------------------------

Veröffentlicht: Dienstag, 9. Januar 2007 | Aktualisiert: Donnerstag, 18. Januar 2007
...
**Vorsichtsmaßnahmen:** Der [Microsoft Knowledge Base-Artikel 927198](https://support.microsoft.com/kb/927198) dokumentiert die derzeit bekannten Probleme, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 927198](https://support.microsoft.com/kb/927198).
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Excel 2000 - [Update herunterladen (KB925524)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=5ccf4455-6b22-4249-93d7-661d12839292)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Excel 2002 - [Update herunterladen (KB925523)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ee7278ea-3aee-4994-9657-66019961d63c)
-   Microsoft Office 2003 Service Pack 2
    -   Microsoft Excel 2003 - [Update herunterladen (KB925257)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=79b88ce8-5c56-462f-ac1a-4bce04c8f543)
    -   Microsoft Office Excel Viewer 2003 - [Update herunterladen (KB925525)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=99ae7653-f0fd-4dba-a151-098fd03e6ea4)
-   Microsoft Works Suite-Versionen:
    -   Microsoft Works Suite 2004 - [Update herunterladen (KB925523)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ee7278ea-3aee-4994-9657-66019961d63c) (identisch mit Microsoft Excel 2002-Update)
    -   Microsoft Works Suite 2005 - [Update herunterladen (KB925523)](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ee7278ea-3aee-4994-9657-66019961d63c) (identisch mit Microsoft Excel 2002-Update)
-   Microsoft Office 2004 für Mac - [Update herunterladen (KB930402)](https://www.microsoft.com/mac/)
-   Microsoft Office X für Mac - [Update herunterladen (KB930403)](https://www.microsoft.com/mac/)
...
| Kennungen der Sicherheitsanfälligkeit                                                                                                                                 | Auswirkung der Sicherheitsanfälligkeit | Microsoft Excel 2000 | Microsoft Excel 2002 | Microsoft Office Excel 2003 | Microsoft Excel Viewer 2003 | Microsoft Excel 2004 für Mac und Excel X für Mac |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------|----------------------|-----------------------------|-----------------------------|--------------------------------------------------|
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - [CVE-2007-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0027)    | Remotecodeausführung                   | Kritisch             | Hoch                 | Keine                       | Keine                       | Hoch                                             |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften Datensatzes - [CVE-2007-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0028) | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund einer fehlerhaften Zeichenfolge - [CVE-2007-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)          | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - [CVE-2007-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)    | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - [CVE-2007-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0031)   | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Keine                       | Hoch                                             |
| **Gemeinsamer Schweregrad aller Sicherheitsanfälligkeiten**                                                                                                           | ****                                   | **Kritisch**         | **Hoch**             | **Hoch**                    | **Hoch**                    | **Hoch**                                         |
...
Der Schweregrad für Microsoft Works Suite 2004 und 2005 ist derselbe wie für Microsoft Excel 2002.

Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate
---------------------------------------------------------------------------

**Warum hat Microsoft dieses Bulletin am 18. Januar 2006 aktualisiert?**  
Dieses Bulletin wurde erneut veröffentlicht, um Benutzern von Microsoft Excel 2000 noch einmal das Sicherheitsupdate anzubieten. Phonetische Informationen, die in Dateien eingebettet sind, die im ausführbaren Modus der koreanischen, chinesischen oder japanischen Version von Excel 2000 erstellt wurden, wurden durch das Sicherheitsupdate zuvor nicht richtig verarbeitet. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 931183](https://support.microsoft.com/kb/931183).

**Welches sind die bekannten Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können?**  
Der [Microsoft Knowledge Base-Artikel 927198](https://support.microsoft.com/kb/927198) dokumentiert die derzeit bekannten Probleme, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 927198](https://support.microsoft.com/kb/927198).

-   [Microsoft Knowledge Base-Artikel 931183:](https://support.microsoft.com/kb/931183) Excel 2000 öffnet einige Dateien nicht, nachdem Sicherheitsupdate 925524 installiert wurde, das in Microsoft Security Bulletin MS07-002 dokumentiert ist.
...
|---------------------------------------------------------------------------------------------|----------------------|----------------------|--------------------------------------------|--------------------------------------------------|
| [**MS06-059**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-059.mspx) | Ersetzt              | Ersetzt              | Ersetzt                                    | Ersetzt                                          |
...
**Hinweis:** Der Schweregrad der Updates für Microsoft Works 2004 und 2005 ist derselbe wie für das Microsoft Excel 2002-Update.
...
#### Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - CVE-2007-0027:

Eine Sicherheitsanfälligkeit in Microsoft Excel kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn Excel eine Datei analysiert und einen fehlerhaften IMDATA-Datensatz verarbeitet.
...
#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - CVE-2007-0027:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - CVE-2007-0027:
...
#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - CVE-2007-0027:
...
Excel führt bei der Verarbeitung des Inhalts einer Datei keine ausreichende Datenüberprüfung durch. Beim Öffnen einer speziell gestalteten Excel-Datei und beim Analysieren eines fehlerhaften IMDATA-Datensatzes durch Excel könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
#### Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - CVE-2007-0028:

Eine Sicherheitsanfälligkeit in Microsoft Excel kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn Excel eine Datei analysiert und einen fehlerhaften Datensatz verarbeitet.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - CVE-2007-0028:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - CVE-2007-0028:

-   Öffnen und speichern Sie keine Microsoft Excel-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - CVE-2007-0028:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Excel führt bei der Verarbeitung des Inhalts einer Datei keine ausreichende Datenüberprüfung durch. Beim Öffnen einer speziell gestalteten Excel-Datei und beim Analysieren eines fehlerhaften Datensatzes durch Excel könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
#### Sicherheitsanfälligkeit in Excel aufgrund einer fehlerhaften Zeichenfolge - CVE-2007-0029:

Eine Sicherheitsanfälligkeit in Microsoft Excel kann die Codeausführung von Remotestandorten aus ermöglichen. Wenn ein Angreifer diese Sicherheitsanfälligkeit erfolgreich ausnutzt, kann er die vollständige Kontrolle über das betroffene System erlangen.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - CVE-2007-0029:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel aufgrund einer fehlerhaften Zeichenfolge - CVE-2007-0029:

-   Öffnen und speichern Sie keine Microsoft Excel-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Excel aufgrund einer fehlerhaften Zeichenfolge - CVE-2007-0029:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Excel führt bei der Verarbeitung des Inhalts einer Datei keine ausreichende Datenüberprüfung durch. Beim Öffnen einer speziell gestalteten Excel-Datei und beim Analysieren einer fehlerhaften Zeichenfolge durch Excel könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Excel die Datei analysiert und eine Zeichenfolge überprüft, bevor die Daten an den zugewiesenen Puffer übergeben werden.
...
#### Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - CVE-2007-0030:

Eine Sicherheitsanfälligkeit in Microsoft Excel kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn Excel eine Datei analysiert und einen fehlerhaften Spaltendatensatz verarbeitet.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - CVE-2007-0030:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - CVE-2007-0030:

-   Öffnen und speichern Sie keine Microsoft Excel-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - CVE-2007-0030:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Excel führt bei der Verarbeitung des Inhalts einer Datei keine ausreichende Datenüberprüfung durch. Beim Öffnen einer speziell gestalteten Excel-Datei und beim Analysieren eines fehlerhaften Spaltendatensatzes durch Excel könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Excel die Datei analysiert und einen Spaltendatensatz überprüft, bevor die Daten an den zugewiesenen Puffer übergeben werden.
...
#### Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - CVE-2007-0031:

Eine Sicherheitsanfälligkeit in Microsoft Excel kann die Codeausführung von Remotestandorten aus ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn Excel eine Datei analysiert und einen fehlerhaften Paletten-Datensatz verarbeitet.

Wenn ein Benutzer mit administrativen Benutzerrechten angemeldet ist, könnte ein Angreifer, der diese Sicherheitsanfälligkeit erfolgreich ausnutzt, vollständige Kontrolle über ein betroffenes System erlangen. Ein Angreifer könnte dann Programme installieren, Daten anzeigen, ändern oder löschen oder neue Konten mit sämtlichen Benutzerrechten erstellen. Für Benutzer, deren Konten mit geringeren Benutzerrechten konfiguriert sind, kann dies geringere Auswirkungen haben als für Benutzer, die mit administrativen Benutzerberechtigungen arbeiten.

#### Schadensbegrenzende Faktoren für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - CVE-2007-0031:
...
#### Problemumgehungen für die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - CVE-2007-0031:

-   Öffnen und speichern Sie keine Microsoft Excel-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine speziell gestaltete Datei öffnet.

#### Häufig gestellte Fragen zur Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - CVE-2007-0031:
...
**Was ist die Ursache dieser Sicherheitsanfälligkeit?**  
Excel führt bei der Verarbeitung des Inhalts einer Datei keine ausreichende Datenüberprüfung durch. Beim Öffnen einer speziell gestalteten Excel-Datei und beim Analysieren eines fehlerhaften Paletten-Datensatzes durch Excel könnte der Systemspeicher so beeinträchtigt werden, dass ein Angreifer beliebigen Code ausführen kann.
...
**Was bewirkt das Update?**  
Das Update behebt die Sicherheitsanfälligkeit, indem geändert wird, wie Excel die Datei analysiert und einen Paletten-Datensatz überprüft, bevor die Daten an den zugewiesenen Puffer übergeben werden.
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2000 herunter](https://download.microsoft.com/download/6/0/0/600b3d06-df68-4789-8e88-e12f679d61d5/office2000-kb925524-v2-fullfile-enu.exe).
...
**Hinweis:** Administratoren, die für verwaltete Umgebungen zuständig sind, finden in einer Struktur im Office Admin Update Center umfangreiche Ressourcen für die Bereitstellung von Office-Updates. Suchen Sie auf dieser Website im Abschnitt **Update Resources** nach der Softwareversion, die Sie aktualisieren. Die [Dokumentation zu Windows Installer](https://msdn2.microsoft.com/en-us/library/aa367541.aspx) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2002 herunter](https://download.microsoft.com/download/07.02.06/2767578b-b40e-4a25-8ca1-2bdd03ca6945/officexp-kb925523-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
**Hinweis:** Administratoren, die für verwaltete Umgebungen zuständig sind, finden in einer Struktur im [Office Admin Update Center](https://www.microsoft.com/technet/prodtechnol/office/ork/default.mspx) umfangreiche Ressourcen für die Bereitstellung von Office-Updates. Suchen Sie auf der Homepage dieser Website im Abschnitt **Updatestrategien** nach der Softwareversion, die Sie aktualisieren. Die [Dokumentation zu Windows Installer](https://msdn2.microsoft.com/en-us/library/aa367541.aspx) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
...
-   Wenn Sie den Office Excel Viewer 2003 aktualisieren möchten, muss der Office Excel Viewer 2003 installiert sein. Bevor Sie dieses Update installieren, installieren Sie [Office Excel Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=c8378bf4-996c-4569-b547-75edbd03aaf0).

Weitere Informationen zum Ermitteln der auf dem Computer installierten Version von Office 2003 finden Sie im [Microsoft Knowledge Base-Artikel 821549](https://support.microsoft.com/kb/821549).

Weitere Informationen über die im Dialogfeld **Info** angezeigten Versionshinweise finden Sie im [Microsoft Knowledge Base-Artikel 328294](https://support.microsoft.com/kb/328294).
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2003](https://download.microsoft.com/download/f/d/4/fd440961-620a-4e16-a997-190dcf4e0376/office2003-kb925257-fullfile-enu.exe) bzw. das [Sicherheitsupdate für Excel 2003 Viewer](https://download.microsoft.com/download/1/9/e/19e98c21-86a6-4fa2-8228-f58de5c229a0/office2003-kb925525-fullfile-enu.exe) herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
2.  Öffnen Sie die Datei des **Microsoft Office 2004-Updates für Mac 11.3.3** auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.
3.  Doppelklicken Sie im Fenster des **Microsoft Office 2004-Updates für Mac 11.3.3** auf die Anwendung des **Microsoft Office 2004-Updates für Mac 11.3.3**, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.
...
Wird die Versionsnummer **11.3.3** angezeigt, wurde das Update erfolgreich installiert.
...
2.  Öffnen Sie die Datei des **Microsoft Office X-Updates für Mac 10.1.9** auf Ihrem Desktop. Dieser Schritt wurde eventuell bereits für Sie ausgeführt.
3.  Doppelklicken Sie im Fenster des **Microsoft Office X-Sicherheitsupdates für Mac 10.1.9** auf die Anwendung des **Microsoft Office X-Sicherheitsupdates für Mac 10.1.9**, um die Aktualisierung zu starten, und befolgen Sie die Anweisungen auf dem Bildschirm.
4.  Wenn die Installation erfolgreich abgeschlossen wurde, können Sie das Update-Installationsprogramm von Ihrer Festplatte entfernen. Weitere Informationen dazu, wie Sie den erfolgreichen Abschluss der Installation überprüfen können, finden Sie im Abschnitt „Überprüfen der Updateinstallation“. Um das Update-Installationsprogramm zu entfernen, ziehen Sie zuerst die Datei des **Microsoft Office X-Updates für Mac 10.1.9** in den Papierkorb. Ziehen Sie anschließend die heruntergeladene Datei in den Papierkorb.
...
Wird die Versionsnummer **10.1.9** angezeigt, wurde das Update erfolgreich installiert.
...
-   Jeff Gennari von [CERT](https://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - [CVE-2007-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0027)
-   Jie Ma von [Fortinet Security Research Team](https://www.fortinet.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - [CVE-2007-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0028)
-   [NSFocus Security Team](https://www.nsfocus.com) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund einer fehlerhaften Zeichenfolge - [CVE-2007-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)
-   Greg MacManus von [IDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - [CVE-2007-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0030)
-   Greg MacManus von [IDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften PALETTEN-Datensatzes - [CVE-2007-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0031)
...
-   V1.1 (12. Januar 2007): Die im Bulletin aufgeführten Vorsichtsmaßnahmen sowie der Abschnitt „Welches sind die bekannten Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können?“ unter „Häufig gestellte Fragen (FAQs) im Zusammenhang mit diesem Sicherheitsupdate“ wurden aktualisiert.
-   V2.0 (18. Januar 2007): Aktualisierung das Bulletins: Dieses Bulletin wurde erneut veröffentlicht, um Benutzern von Microsoft Excel 2000 noch einmal das Sicherheitsupdate anzubieten. Phonetische Informationen, die in Dateien eingebettet sind, die im ausführbaren Modus der koreanischen, chinesischen oder japanischen Version von Excel 2000 erstellt wurden, wurden durch das Sicherheitsupdate zuvor nicht richtig verarbeitet. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 931183](https://support.microsoft.com/kb/931183).
