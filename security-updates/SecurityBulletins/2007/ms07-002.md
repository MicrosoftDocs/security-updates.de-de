...
**Vorsichtsmaßnahmen:** Der [Microsoft Knowledge Base-Artikel 927198](http://support.microsoft.com/kb/927198) dokumentiert die derzeit bekannten Probleme, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 927198](http://support.microsoft.com/kb/927198).
...
-   Microsoft Office 2004 für Mac - [Update herunterladen (KB930402)](http://www.microsoft.com/mac/)
-   Microsoft Office X für Mac - [Update herunterladen (KB930403)](http://www.microsoft.com/mac/)
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------|----------------------|-----------------------------|-----------------------------|--------------------------------------------------|
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - [CVE-2007-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0027)    | Remotecodeausführung                   | Kritisch             | Hoch                 | Keine                       | Keine                       | Hoch                                             |
| Sicherheitsanfälligkeit in Microsoft Excel aufgrund eines fehlerhaften Datensatzes - [CVE-2007-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0028) | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund einer fehlerhaften Zeichenfolge - [CVE-2007-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)          | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - [CVE-2007-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)    | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Hoch                        | Hoch                                             |
| Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Palettendatensatzes - [CVE-2007-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0031)   | Remotecodeausführung                   | Kritisch             | Hoch                 | Hoch                        | Keine                       | Hoch                                             |
...
Dieses Bulletin wurde erneut veröffentlicht, um Benutzern von Microsoft Excel 2000 noch einmal das Sicherheitsupdate anzubieten. Phonetische Informationen, die in Dateien eingebettet sind, die im ausführbaren Modus der koreanischen, chinesischen oder japanischen Version von Excel 2000 erstellt wurden, wurden durch das Sicherheitsupdate zuvor nicht richtig verarbeitet. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 931183](http://support.microsoft.com/kb/931183).

**Welches sind die bekannten Probleme, die bei der Installation dieses Sicherheitsupdates auftreten können?**  
Der [Microsoft Knowledge Base-Artikel 927198](http://support.microsoft.com/kb/927198) dokumentiert die derzeit bekannten Probleme, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 927198](http://support.microsoft.com/kb/927198).

-   [Microsoft Knowledge Base-Artikel 931183:](http://support.microsoft.com/kb/931183) Excel 2000 öffnet einige Dateien nicht, nachdem Sicherheitsupdate 925524 installiert wurde, das in Microsoft Security Bulletin MS07-002 dokumentiert ist.
...
|---------------------------------------------------------------------------------------------|----------------------|----------------------|--------------------------------------------|--------------------------------------------------|
| [**MS06-059**](http://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-059.mspx) | Ersetzt              | Ersetzt              | Ersetzt                                    | Ersetzt                                          |
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2000 herunter](http://download.microsoft.com/download/6/0/0/600b3d06-df68-4789-8e88-e12f679d61d5/office2000-kb925524-v2-fullfile-enu.exe).
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2002 herunter](http://download.microsoft.com/download/07.02.06/2767578b-b40e-4a25-8ca1-2bdd03ca6945/officexp-kb925523-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
Weitere Informationen zum Ermitteln der auf dem Computer installierten Version von Office 2003 finden Sie im [Microsoft Knowledge Base-Artikel 821549](http://support.microsoft.com/kb/821549).
...
1.  [Laden Sie das Sicherheitsupdate für Excel 2003](http://download.microsoft.com/download/f/d/4/fd440961-620a-4e16-a997-190dcf4e0376/office2003-kb925257-fullfile-enu.exe) bzw. das [Sicherheitsupdate für Excel 2003 Viewer](http://download.microsoft.com/download/1/9/e/19e98c21-86a6-4fa2-8228-f58de5c229a0/office2003-kb925525-fullfile-enu.exe) herunter.
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   Jeff Gennari von [CERT](http://www.cert.org/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften IMDATA-Datensatzes - [CVE-2007-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0027)
-   Jie Ma von [Fortinet Security Research Team](http://www.fortinet.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Datensatzes - [CVE-2007-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0028)
-   [NSFocus Security Team](http://www.nsfocus.com) für den Hinweis auf die Sicherheitsanfälligkeit in Microsoft Excel aufgrund einer fehlerhaften Zeichenfolge - [CVE-2007-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0029)
-   Greg MacManus von [IDefense Labs](http://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften Spaltendatensatzes - [CVE-2007-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0030)
-   Greg MacManus von [IDefense Labs](http://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Excel aufgrund eines fehlerhaften PALETTEN-Datensatzes - [CVE-2007-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0031)
