...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten unter [CVE-2007-2218](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2218)
...
**Was ist SChannel?**  
Das SChannel-Sicherheitspaket (Secure Channel) ist ein SSP (Security Support Provider), der die Internetstandardauthentifizierungsprotokolle SSL (Secure Sockets Layer) und TLS (Transport Layer Security) implementiert. SChannel ist Teil des Sicherheitspakets, das einen Authentifizierungsdienst für sichere Kommunikation zwischen Client und Server bereitstellt. Weitere Informationen zu SChannel finden Sie auf der folgenden [MSDN-Website](https://msdn2.microsoft.com/en-us/library/ms678421.aspx).
...
Weitere Informationen zum Package Installer finden Sie auf der [Microsoft TechNet Website](https://www.microsoft.com/germany/technet/datenbank/articles/600338.mspx).
