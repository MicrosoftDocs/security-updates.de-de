...
-   Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=ce695e0e-938c-4fc6-a9a2-0eb9fc3e5512)
...
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|
| Sicherheitsanfälligkeit in der Windows-Bilderfassung – [CVE-2007-0210](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0210) | Erhöhung von Berechtigungen            | Hoch                      |
...
In Windows XP Service Pack 2 liegt eine Sicherheitsanfälligkeit des Typs Erhöhung von Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) in der Art vor, wie der Windows-Bilderfassungsdienst Anwendungen startet. Durch diese Sicherheitsanfälligkeit kann ein angemeldeter Angreifer vollständige Kontrolle über das System erlangen.
