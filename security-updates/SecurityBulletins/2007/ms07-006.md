...
-   Microsoft Windows XP Service Pack 2 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=f821b3a0-4e5a-4737-b9bf-1249f6683f4d)
-   Microsoft Windows XP Professional x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=75abff9b-c2b5-4151-b366-4be652882944&displaylang=en)
-   Microsoft Windows Server 2003 und Microsoft Windows Server 2003 Service Pack 1 – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=418acc52-0ebd-4623-81a7-5eacc21c3965)
-   Microsoft Windows Server 2003 für Itanium-basierte Systeme und Microsoft Windows Server 2003 mit SP1 für Itanium-basierte Systeme – [Update herunterladen](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=dc33a2fc-2d01-4577-b133-017493d1f278)
-   Microsoft Windows Server 2003 x64 Edition – [Update herunterladen](https://www.microsoft.com/download/details.aspx?familyid=c3e55066-b34e-485d-ac04-179f8e3a407a&displaylang=en)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------|---------------------|------------------------------------|
| Sicherheitsanfälligkeit in Windows Shell bezüglich Hardwareerkennung – [CVE-2007-0211](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0211) | Erhöhung von Berechtigungen            | Hoch                      | Hoch                | Hoch                               |
...
|---------------------------------------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-045**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) | Nicht anwendbar             | Ersetzt                   | Ersetzt             | Ersetzt                            |
...
In Windows Shell liegt eine Sicherheitsanfälligkeit bezüglich der Erhöhung von Berechtigungen ([Privilege Elevation](https://go.microsoft.com/fwlink/?linkid=21142)) aufgrund der Art vor, in der das Betriebssystem Erkennung und Registrierung neuer Hardware durchführt. Durch diese Sicherheitsanfälligkeit kann ein angemeldeter Angreifer vollständige Kontrolle über das System erlangen.
...
-   **Deaktivieren Sie die Shellhardwareerkennung**
    ...
    **Auswirkung der Problemumgehung:** Wenn Sie die **Shellhardwareerkennung** deaktivieren, können Sie u. U. den schnellen Benutzerwechsel ([Fast User Switching](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/fast_user_switching.mspx)) nicht verwenden. Daher wird diese Problemumgehung nur für Systeme empfohlen, auf denen diese Funktion nicht erforderlich ist.
