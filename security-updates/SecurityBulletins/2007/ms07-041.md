...
**Bekannte Probleme:** Im [Microsoft Knowledge Base-Artikel 939373](https://support.microsoft.com/kb/939373) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
| Windows XP Professional Service Pack 2 | [Microsoft Internet Information Services (IIS) 5.1](https://www.microsoft.com/download/details.aspx?displaylang=de&amp;familyid=fccbfe90-f838-47df-8310-352e2fb47132) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-4360](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360).
...
-   **Verwenden Sie URLScan 2.5**   
    Die Installation von [URLScan](https://www.microsoft.com/technet/security/tools/urlscan.mspx) trägt zum Schutz vor Angriffen bei, bei denen diese Sicherheitsanfälligkeit ausgenutzt wird.  
...
-   **Zum Schutz vor netzwerkbasierten Versuchen, diese Sicherheitsanfälligkeit auszunutzen, sollten Sie Port 80 (TCP) blockieren durch:**
    ...
    -   Windows-Firewall.  
    -   IPSec (Internet Protocol Security). Ausführliche Informationen zu IPSec und dem Anwenden von Filtern finden Sie im [Microsoft Knowledge Base-Artikel 313190](https://support.microsoft.com/kb/313190) und [Microsoft Knowledge Base-Artikel 813878](https://support.microsoft.com/kb/813878).
...
-   Jonathan Afek und Adi Sharabani von [Watchfire](https://www.watchfire.com/) für die Zusammenarbeit mit Microsoft und die Bereitstellung zusätzlicher Informationen zu der Sicherheitsanfälligkeit in IIS durch Speicheranforderung (CVE-2005-4360).
-   Peter Winter-Smith von [NGS Software](https://www.ngssoftware.com/) für die Zusammenarbeit mit Microsoft und die Bereitstellung zusätzlicher Informationen zur Sicherheitsanfälligkeit in IIS durch Speicheranforderung (CVE-2005-4360).
