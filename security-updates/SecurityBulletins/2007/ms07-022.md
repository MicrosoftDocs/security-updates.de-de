...
|------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| Sicherheitsanfälligkeit im Kernel durch Erhöhung lokaler Berechtigungen - [CVE-2007-1206](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) | Erhöhung von Berechtigungen            | Hoch                                  | Hoch                                | Hoch                          | Hoch                                         | Hoch                                         |
...
Weitere Informationen zu diesem Problem finden Sie im [Microsoft Knowledge Base-Artikel 931784](https://support.microsoft.com/kb/931784/). Im [Microsoft Knowledge Base-Artikel 931784](https://support.microsoft.com/kb/931784/)werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates auftreten können.
...
|---------------------------------------------------------------------------------------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| [**MS06-049**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-049.mspx) | Ersetzt                               | Nicht anwendbar                     | Nicht anwendbar               | Nicht anwendbar                              | Nicht anwendbar                              |
...
-   [eEye](https://www.eeye.com/)für den Hinweis auf die Sicherheitsanfälligkeit im Kernel durch Erhöhung lokaler Berechtigungen (CVE-2007-1206).

**Weitere Sicherheitsupdates:**

Updates für andere Sicherheitsrisiken sind unter den folgenden Adressen erhältlich:

-   Sicherheitsupdates sind im [Microsoft Download Center](https://www.microsoft.com/downloads/results.aspx?displaylang=de&freetext=sicherheitsupdate)verfügbar und können am einfachsten durch eine Suche nach dem Begriff „security\_patch“ ermittelt werden.
