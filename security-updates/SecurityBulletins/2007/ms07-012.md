...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 924667](https://support.microsoft.com/?kbid=924667) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 924667](https://support.microsoft.com/?kbid=924667).
...
|----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------------------|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|--------------------------------------------------|-----------------------------------|--------------------------------------------------|
| Sicherheitsanfälligkeit in MFC bezüglich Speicherbeschädigung – [CVE-2007-0025](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0025) | Remotecodeausführung                   | Hoch                                  | Hoch                                | Hoch                                                                                                                         | Hoch                              | Hoch                                             | Hoch                              | Hoch                                             |
...
-   [Microsoft Knowledge Base-Artikel 933273](https://support.microsoft.com/?kbid=933273): Die MFC-Quelldatei Oleui2.cpp wird nicht aktualisiert, wenn Sie das Sicherheitsupdate MS07-012 installieren.
-   [Microsoft Knowledge Base-Artikel 933339](https://support.microsoft.com/?kbid=933339): Die Datei Mfc42u.dll wird nicht aktualisiert, wenn Sie das Sicherheitsupdate MS07-012 installieren.
...
-   Kostya Kortchinsky von [Immunity, Inc.](https://www.immunityinc.com/) und Fabrice Desclaux von [EADS Common Research Center](https://www.eads.net/) für den Hinweis auf die Sicherheitsanfälligkeit in MFC bezüglich Speicherbeschädigung (CVE-2007-0025).
