...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 925938](https://support.microsoft.com/kb/925938) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 925938](https://support.microsoft.com/kb/925938).
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Outlook 2000 – [Update herunterladen (KB921593)](https://www.microsoft.com/download/details.aspx?familyid=97ce0b32-c6af-4c6c-abf1-838ed89062eb&displaylang=de)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Outlook 2002 – [Update herunterladen (KB921594)](https://www.microsoft.com/download/details.aspx?familyid=1d1991c5-3de3-4258-9120-058ffd62b4f5&displaylang=de)
-   Microsoft Office 2003 Service Pack 2
    -   Microsoft Outlook 2003 – [Update herunterladen (KB924085)](https://www.microsoft.com/download/details.aspx?familyid=9e4dd8ae-2564-4176-ac2e-e3760058cb56&displaylang=de)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|------------------------|------------------------|------------------------|
| Sicherheitsanfälligkeit im VEVENT-Wert von Microsoft Outlook – [CVE-2007-0033](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0033)                             | Remotecodeausführung                   | Keine                  | Hoch                   | Hoch                   |
| Sicherheitsanfälligkeit in Microsoft Outlook, die zu einem Denial-of-Service führen kann – [CVE-2006-1305](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1305) | DoS (Denial of Service)                | Mittel                 | Mittel                 | Mittel                 |
| Sicherheitsanfälligkeit in der erweiterten Suche von Microsoft Outlook – [CVE-2007-0034](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0034)                   | Remotecodeausführung                   | Kritisch               | Hoch                   | Hoch                   |
...
-   [Microsoft Knowledge Base-Artikel 925542:](https://support.microsoft.com/kb/925542) OSS-Dateien (Office Saved Searches) können in Outlook nicht geöffnet oder gespeichert werden, nachdem das Sicherheitsupdate vom 9. Januar 2007 (925542) installiert wurde.
-   [Microsoft Knowledge Base-Artikel 931270:](https://support.microsoft.com/kb/931270) You receive an error message "Microsoft Office Outlook has encountered a problem and needs to close. We are sorry for the inconvenience." when you use Microsoft CRM client for Microsoft Outlook (931270).
...
|---------------------------------------------------------------------------------------------|------------------------|------------------------|------------------------|
| [**MS06-003**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-003.mspx) | Nicht anwendbar        | Nicht anwendbar        | Ersetzt                |
...
Eine Sicherheitsanfälligkeit in Microsoft Outlook kann die Codeausführung von Remotestandorten aus ([Remote Code Execution](https://go.microsoft.com/fwlink/?linkid=21142)) ermöglichen. Ein Angreifer könnte diese Sicherheitsanfälligkeit ausnutzen, wenn Outlook eine OSS-Datei analysiert.
...
1.  [Laden Sie dieses Sicherheitsupdate für Outlook 2000 herunter](https://download.microsoft.com/download/6/b/8/6b8de04d-d33f-4659-abae-2bdb7b6a687e/office2000-kb921593-fullfile-enu.exe).
...
-   Office XP Service Pack 3 (SP3) muss installiert sein. Bevor Sie dieses Update installieren, installieren Sie [Office XP SP3](https://www.microsoft.com/download/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e&displaylang=de). Weitere Informationen zur Installation von Office XP SP3 finden Sie im [Microsoft Knowledge Base-Artikel 832671](https://support.microsoft.com/kb/832671). Außerdem müssen [Project 2002 Service Pack 1 (SP1)](https://www.microsoft.com/download/details.aspx?familyid=d64ea65b-9519-4061-9b3a-32af1a9bf888&displaylang=de) bzw. [Visio 2002 Service Pack 2 (SP2)](https://www.microsoft.com/download/details.aspx?familyid=00b9dfe4-ed08-4328-b355-4bc63d6267b2&displaylang=de) installiert sein.
...
1.  [Laden Sie das Sicherheitsupdate für Outlook 2002 herunter.](https://download.microsoft.com/download/08.07.05/785738cf-0899-4572-bf0b-c2c855efa749/officexp-kb921594-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
1.  [Laden Sie das Sicherheitsupdate für Office 2003 herunter.](https://download.microsoft.com/download/e/a/a/eaa3d1d8-ed6b-4568-bc28-bf6b71c6eacc/office2003-kb924085-fullfile-enu.exe)
...
-   Lurene Grenier von [Sourcefire](https://www.sourcefire.com) für den Hinweis auf die Sicherheitsanfälligkeit im VEVENT-Wert von Microsoft Outlook – [CVE-2007-0033](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0033).
-   Stuart Pearson von [Computer Terrorism](https://www.computerterrorism.com/) für den Hinweis auf die Sicherheitsanfälligkeit in der erweiterten Suche von Microsoft Outlook – [CVE-2007-0034](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0034).
