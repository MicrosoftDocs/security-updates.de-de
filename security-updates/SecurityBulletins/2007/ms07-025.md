...
**Vorsichtsmaßnahmen:** Im [Microsoft Knowledge Base-Artikel 934873](https://support.microsoft.com/?kbid=934873) werden die derzeit bekannten Probleme bei der Installation dieses Sicherheitsupdates beschrieben. Im Artikel werden auch Lösungen für diese Probleme empfohlen. Weitere Informationen finden Sie im [Microsoft Knowledge Base-Artikel 934873](https://support.microsoft.com/?kbid=934873).

**Getestete Software und Downloadpfade für das Update:**

**Betroffene Software:**

-   Microsoft Office 2000 Service Pack 3 – [Update herunterladen (KB934526)](https://www.microsoft.com/download/details.aspx?familyid=a693c271-4b94-4541-953a-0a2db4587b23&displaylang=de)
    -   Microsoft Excel 2000
    -   Microsoft FrontPage 2000
    -   Microsoft Publisher 2000
-   Microsoft Office XP Service Pack 3 – [Update herunterladen (KB934705)](https://www.microsoft.com/download/details.aspx?familyid=cb291ad9-348a-4c28-bec7-53d2f35d0b72&displaylang=de)
    -   Microsoft Excel 2002
    -   Microsoft FrontPage 2002
    -   Microsoft Publisher 2002
-   Microsoft Office 2003 Service Pack 2 – [Update herunterladen (KB934180)](https://www.microsoft.com/download/details.aspx?familyid=819857cc-3777-4e4a-9cc3-685fc079a254&displaylang=de)
    -   Microsoft Excel 2003
    -   Microsoft FrontPage 2003
    -   Microsoft Publisher 2003
    -   Microsoft Excel Viewer 2003
-   Microsoft Office 2007 – [Update herunterladen (KB934062)](https://www.microsoft.com/download/details.aspx?familyid=a3dc8e3f-90dd-4d0c-88b8-2ec88ff3a588&displaylang=de)
...
|----------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| Sicherheitsanfälligkeit in Zeichnungsobjekten – [CVE-2007-1747](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1747) | Remotecodeausführung                    | Kritisch                             | Hoch                               | Hoch                                 | Hoch                         | Hoch                          |
...
|---------------------------------------------------------------------------------------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| [**MS07-015**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-015.mspx) | Ersetzt                              | Ersetzt                            | Ersetzt                              | Nicht anwendbar              | Ersetzt                       |
...
Im Fall von SMS 2003 kann von SMS zum Auffinden von unter [Microsoft Updates](https://update.microsoft.com/microsoftupdate) erhältlichen Sicherheitsupdates und Updates, die von [Windows Server Update Services](https://www.microsoft.com/germany/technet/prodtechnol/windowsserver/wsus/default.mspx) unterstützt werden, das SMS 2003-Inventurprogramm für Microsoft-Updates verwendet werden. Weitere Informationen über das SMS 2003-Inventurprogramm für Microsoft Updates finden Sie auf der folgenden [Microsoft-Website](https://go.microsoft.com/fwlink/?linkid=50757). SMS 2003 kann auch das Microsoft Office-Inventurprogramm zur Erkennung der für Microsoft Office-Anwendungen erforderlichen Updates verwenden.
...
-   Weitere Informationen zum Ändern der Quelle für einen Clientcomputer von einem aktualisierten Administratorinstallationspunkt zu einer ursprünglichen Basislinienquelle in Office 2000 oder Service Pack 3 (SP3) finden Sie im [Microsoft Knowledge Base-Artikel 932889](https://support.microsoft.com/kb/932889/de).
...
Wir empfehlen, die Microsoft Office 2000-Clientupdates über die [Office Update-Website](https://office.microsoft.com/de-de/downloads/default.aspx) zu installieren. Die Office Update-Website erkennt Ihre individuelle Installation und fordert Sie auf, genau die Updates zu installieren, die für eine aktuelle Installation erforderlich sind.

Damit die [Office Update-Website](https://office.microsoft.com/de-de/downloads/default.aspx) Updates erkennen kann, die Sie auf Ihrem Computer installieren müssen, besuchen Sie die Office Update-Website und klicken Sie dann oben rechts auf der Webseite im Abschnitt „Updates jetzt herunterladen“ auf **Office Update**. Nachdem die Erkennung abgeschlossen ist, erhalten Sie eine Liste der empfohlenen Updates zur Bestätigung. Klicken Sie zum Abschließen des Vorgangs auf **Ich stimme zu. Installation beginnen**.
...
1.  [Laden Sie dieses Sicherheitsupdate für Office 2000 herunter](https://download.microsoft.com/download/7/0/8/70852c45-03a8-45f2-ac74-abbb42f2d21d/office2000-kb934526-fullfile-enu.exe).
...
1.  [Laden Sie dieses Sicherheitsupdate für Office XP herunter](https://download.microsoft.com/download/d/e/0/de06eeb7-3bbe-478d-88c5-2cf7345e93ad/officexp-kb934705-fullfile-enu.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
**Hinweis:** Administratoren, die für verwaltete Umgebungen zuständig sind, finden in einer Struktur im [Office Admin Update Center](https://www.microsoft.com/technet/prodtechnol/office/ork/default.mspx) umfangreiche Ressourcen für die Bereitstellung von Office-Updates. Suchen Sie auf der Homepage dieser Website im Abschnitt **Updatestrategien** nach der Softwareversion, die Sie aktualisieren. Die [Dokumentation zu Windows Installer](https://go.microsoft.com/fwlink/?linkid=21685) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Parametern.
...
-   Um Excel Viewer 2003 aktualisieren zu können, muss die neueste Version von Excel Viewer 2003 installiert werden. [Laden Sie den neuesten Excel Viewer 2003 herunter](https://www.microsoft.com/download/details.aspx?familyid=c8378bf4-996c-4569-b547-75edbd03aaf0&displaylang=en).
...
1.  [Laden Sie das Sicherheitsupdate für Office 2003 herunter.](https://download.microsoft.com/download/6/7/1/671fe678-8823-4477-97f2-e2701cf8ad3f/office2003-kb934180-fullfile-enu.exe)
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
Windows Installer 3.1 Redistributable (v2) im Microsoft Download Center. Weitere Informationen zu den Versionsinformationen, die im Dialogfeld **Info** angezeigt werden, finden Sie im [Microsoft Knowledge Base-Artikel 328294](https://support.microsoft.com/kb/328294).
...
1.  [Laden Sie das Sicherheitsupdate für das Office 2007 System herunter](https://download.microsoft.com/download/b/e/5/be5c2a49-ce23-4612-b46a-f4e189d72641/office2007-kb934062-fullfile-x86-glb.exe).
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.
3.  Klicken Sie auf **Speichern**.
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.
...
-   V1.2 (17. Mai 2007): Dieses Bulletin wurde aufgrund neuer Probleme mit dem Sicherheitsupdate überarbeitet, die im [Microsoft Knowledge Base-Artikel 934873](https://support.microsoft.com/?kbid=934873) beschrieben wurden.
