...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 933566](https://support.microsoft.com/kb/933566) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
<td style="border:1px solid black;">
[MS07-027](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-027.mspx)
</td>
</tr>
...
Im [Microsoft Knowledge Base-Artikel 933566](https://support.microsoft.com/kb/933566) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
Wenn Sie diese Sicherheitsanfälligkeit als Standardeintrag in der Liste der allgemeinen Sicherheitsanfälligkeiten anzeigen möchten, rufen Sie [CVE-2007-0218](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0218) auf.
...
Wenn Sie diese Sicherheitsanfälligkeit als Standardeintrag in der Liste der allgemeinen Sicherheitsanfälligkeiten anzeigen möchten, rufen Sie [CVE-2007-1750](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1750) auf.
...
Wenn Sie diese Sicherheitsanfälligkeit als Standardeintrag in der Liste der allgemeinen Sicherheitsanfälligkeiten anzeigen möchten, rufen Sie [CVE-2007-3027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3027) auf.
...
Wenn Sie diese Sicherheitsanfälligkeit als Standardeintrag in der Liste der allgemeinen Sicherheitsanfälligkeiten anzeigen möchten, rufen Sie [CVE-2007-1751](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1751) auf.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-1499](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1499).
...
Wenn Sie diese Sicherheitsanfälligkeit als Standardeintrag in der Liste der allgemeinen Sicherheitsanfälligkeiten anzeigen möchten, rufen Sie [CVE-2007-2222](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2222) auf.
...
**Was bewirkt das Update?**
Dieses Update setzt das [Kill Bit](https://support.microsoft.com/kb/240797) für eine Liste von Klassenkennungen (CLSIDs).
...
-   Einem anonymen Forscher in Zusammenarbeit mit [iDefense VCP](https://idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Instanziierung von COM-Objekten - CVE-2007-0218.  
-   Tom Cross von [ISS](https://www.iss.net/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit bei Instanziierung von COM-Objekten - CVE-2007-0218.  
-   Einem anonymen Forscher in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bei der Sprachpaketinstallation - CVE-2007-3027.  
-   Sam Thomas in Zusammenarbeit mit [TippingPoint](https://www.tippingpoint.com/) und der [Zero Day Initiative](https://www.zerodayinitiative.com/) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung aufgrund von Nichtinitialisierung - CVE-2007-1751.  
-   Will Dorman von [CERT/CC](https://www.cert.org/certcc.html) für den Hinweis auf die Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Sprachensteuerung - CVE-2007-2222.  
-   Cocoruder von [Fortinet Security Research](https://www.fortinet.com/) für die Zusammenarbeit mit Microsoft hinsichtlich der Sicherheitsanfälligkeit bezüglich Speicherbeschädigung bei Sprachensteuerung - CVE-2007-2222.
