...
**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 927051](https://support.microsoft.com/kb/927051) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|---------------------------------------------------|
|                                             | [Microsoft Visio 2002 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc1d0483-27e8-4541-b81d-4a47973bea30)                    | Remotecodeausführung           | Hoch                             | Keine                                             |
| Microsoft Office 2003                       | [Microsoft Visio 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c47f432e-8538-42fd-92c9-7e0f1d643e8e&amp;displaylang=de) | Remotecodeausführung           | Hoch                             | Keine                                             |
...
<th style="border:1px solid black;" >Sicherheitsanfälligkeit in Visio Version durch Speicherbeschädigung - CVE-2007-0934</th>
<th style="border:1px solid black;" >Sicherheitsanfälligkeit beim Verpacken von Visio-Dokumenten - CVE-2007-0936</th>
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten unter [CVE-2007-0934](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0934).
...
-   Verwenden Sie zum Öffnen und Anzeigen von Dateien Microsoft Visio Viewer 2003 oder Microsoft Visio Viewer 2007. Microsoft Visio Viewer 2003 und Microsoft Visio Viewer 2007 sind von diesem Problem nicht betroffen. Benutzer können [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=3fb3bd5c-fed1-46cf-bd53-da23635ab2df) und [Microsoft Visio Viewer 2007](https://www.microsoft.com/download/details.aspx?familyid=d88e4542-b174-4198-ae31-6884e9edd524&displaylang=en) im Microsoft Download Center herunterladen.  
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten unter [CVE-2007-0936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0936).
...
**Hinweis:** Administratoren, die für verwaltete Umgebungen zuständig sind, finden in einer Struktur im Office Admin Update Center umfangreiche Ressourcen für die Bereitstellung von Office-Updates. Suchen Sie auf dieser Website im Abschnitt **Update Resources** nach der Softwareversion, die Sie aktualisieren. Die [Dokumentation zu Windows Installer](https://go.microsoft.com/fwlink/?linkid=21685) enthält ebenfalls weitere Informationen zu den von Windows Installer unterstützten Setup-Switches.
...
Chris Ries von [Vigilant Minds](https://www.vigilantminds.com/) für den Hinweis auf die Sicherheitsanfälligkeit beim Packen von Visio-Dokumenten - (CVE-2007-0936).
