...
Dieses Sicherheitsupdate behebt auch die Sicherheitsanfälligkeit, die zuerst in der [Microsoft-Sicherheitsempfehlung 943521](https://www.microsoft.com/germany/technet/sicherheit/empfehlungen/943521.mspx) beschrieben wurde. Weitere Informationen finden Sie im Unterabschnitt „Häufig gestellte Fragen (FAQs)“ für den bestimmten Sicherheitsanfälligkeitseintrag unter dem nächsten Abschnitt „Sicherheitsanfälligkeitsinformationen“.

**Empfehlung.** Microsoft empfiehlt Benutzern die sofortige Installation des Updates.

**Bekannte Probleme.** Im [Microsoft Knowledge Base-Artikel 943460](https://support.microsoft.com/kb/943460) werden die derzeit bekannten Probleme dokumentiert, die durch die Installation dieses Sicherheitsupdates unter Umständen auftreten können. Im Artikel werden auch Lösungen für diese Probleme empfohlen.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=8ba1c2f9-1bde-4e97-b327-21259c5e5104)                                                                                             | Remotecodeausführung           | Kritisch                         | [MS06-045](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) |
| [Windows XP Professional x64 Edition und Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4ef7fdd7-8887-4c64-a70c-c6ae734d7c5f)                                           | Remotecodeausführung           | Kritisch                         | [MS06-045](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) |
| [Windows Server 2003 Service Pack 1 und Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=e5d8a866-2c1f-4035-8325-c1be61a75c3b)                                             | Remotecodeausführung           | Kritisch                         | [MS06-045](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) |
| [Windows Server 2003 x64 Edition und Windows 2003 Server x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=bf26da08-15b8-4d65-ba12-4cc74c7a1326)                                    | Remotecodeausführung           | Kritisch                         | [MS06-045](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) |
| [Windows Server 2003 mit SP1 für Itanium-basierte Systeme und Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=1c055f11-3273-4a4c-a33f-bf61ac9ec4c5) | Remotecodeausführung           | Kritisch                         | [MS06-045](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-045.mspx) |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896).
...
Ja. Zum Zeitpunkt der Erstveröffentlichung dieses Bulletins war diese Sicherheitsanfälligkeit öffentlich bekannt. Ihr wurde die Nummer für allgemeine Sicherheitsanfälligkeit [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896) zugewiesen. Diese Sicherheitsanfälligkeit wurde erstmals in der [Microsoft-Sicherheitsempfehlung 943521](https://technet.microsoft.com/security/advisory/943521) beschrieben.
...
Ja. Durch dieses Sicherheitsupdate wird die derzeit ausgenutzte Sicherheitsanfälligkeit behoben. Der beseitigten Sicherheitsanfälligkeit wurde die Nummer für allgemeine Sicherheitsfälligkeit [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896) zugewiesen.
...
-   Carsten H. Eiram von [Secunia](https://secunia.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit in der URI-Verarbeitung unter Windows (CVE-2007-3896).
-   Aviv Raff von [Finjan](https://www.finjan.com/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit in der URI-Verarbeitung unter Windows (CVE-2007-3896).
-   Petko Petkov von [GNUCITIZEN](https://www.gnucitizen.org/) für die Zusammenarbeit mit uns an der Sicherheitsanfälligkeit in der URI-Verarbeitung unter Windows (CVE-2007-3896).
