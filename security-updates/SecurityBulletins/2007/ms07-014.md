...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Word 2000 – [Update herunterladen (KB929139)](https://www.microsoft.com/download/details.aspx?familyid=f1e61e6a-be3d-4536-af76-a11d5ce67199&displaylang=de)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Word 2002 – [Update herunterladen (KB929061)](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d&displaylang=de)
-   Microsoft Office 2003 Service Pack 2
    -   Microsoft Word 2003 – [Update herunterladen (KB929057)](https://www.microsoft.com/download/details.aspx?familyid=882f8503-da72-43c9-b556-a002ec58f289&displaylang=de)
    -   Microsoft Word Viewer 2003 – [Update herunterladen (KB924883)](https://www.microsoft.com/download/details.aspx?familyid=fb59798b-afe2-4103-9991-cbdd7686f9ad&displaylang=de)
-   Microsoft Works Suite-Versionen:
    -   Microsoft Works Suite 2004 – [Update herunterladen (KB929061) (identisch mit Microsoft Word 2002-Update)](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d&displaylang=de)
    -   Microsoft Works Suite 2005 – [Update herunterladen (KB929061) (identisch mit Microsoft Word 2002-Update)](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d&displaylang=de)
    -   Microsoft Works Suite 2006 – [Update herunterladen (KB929061) (identisch mit Microsoft Word 2002-Update)](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d&displaylang=de)
-   Microsoft Office 2004 für Mac – [Update herunterladen (KB932185)](https://www.microsoft.com/mac/)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word aufgrund einer fehlerhaften Zeichenfolge – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5994">CVE-2006-5994</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word aufgrund fehlerhafter Datenstrukturen – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6456">CVE-2006-6456</a></td>
<td style="border:1px solid black;">Remotecodeausführung<br />
</td>
...
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word aufgrund einer Anzahl – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6561">CVE-2006-6561</a></td>
<td style="border:1px solid black;">Remotecodeausführung<br />
</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Hoch</td>
...
<tr class="even">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word-Makros – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0208">CVE-2007-0208</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word aufgrund fehlerhafter Zeichnungsobjekte –<a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0209">CVE-2007-0209</a></td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Hoch</td>
<td style="border:1px solid black;">Keine</td>
...
<tr class="even">
<td style="border:1px solid black;">Sicherheitsanfälligkeit in Word aufgrund einer fehlerhaften Funktion – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0515">CVE-CVE-2007-0515</a></td>
<td style="border:1px solid black;">Remotecodeausführung</td>
<td style="border:1px solid black;">Kritisch</td>
<td style="border:1px solid black;">Keine</td>
<td style="border:1px solid black;">Keine</td>
...
|---------------------------------------------------------------------------------------------|---------------------|---------------------|---------------------|-------------------------------|----------------------------|  
| [**MS06-060**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-060.mspx) | Ersetzt             | Ersetzt             | Ersetzt             | Ersetzt                       | Ersetzt                    |
...
-   Weitere Informationen zum Ändern der Quelle für einen Clientcomputer von einem aktualisierten Administratorinstallationspunkt zu einer ursprünglichen Basislinienquelle in Office 2000 oder Service Pack 3 (SP3) finden Sie im [Microsoft Knowledge Base-Artikel 932889](https://support.microsoft.com/kb/932889).  
-   Weitere Informationen zum Ändern der Quelle für einen Clientcomputer von einem aktualisierten Administratorinstallationspunkt zu einer ursprünglichen Basislinienquelle in Office XP oder Service Pack 3 (SP3) finden Sie im [Microsoft Knowledge Base-Artikel 922665](https://support.microsoft.com/kb/922665).  
-   Weitere Informationen zum Ändern der Quelle für einen Clientcomputer von einem aktualisierten Administratorinstallationspunkt zu einer ursprünglichen Basislinienquelle in Office 2003 oder Service Pack 2 (SP2) finden Sie im [Microsoft Knowledge Base-Artikel 902349](https://support.microsoft.com/kb/902349).
...
-   Verwenden Sie zum Öffnen und Anzeigen von Dateien Microsoft Word Viewer 2003. Microsoft Word Viewer 2003 ist von dem Problem nicht betroffen. Benutzer können [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf) im Microsoft Download Center herunterladen.
...
-   Öffnen und speichern Sie keine Microsoft Word-Dateien, die Sie von nicht vertrauenswürdigen Quellen oder unerwartet von vertrauenswürdigen Quellen erhalten. Diese Sicherheitsanfälligkeit kann ausgenutzt werden, wenn ein Benutzer eine Datei öffnet.  
-   Verwenden Sie zum Öffnen und Anzeigen von Dateien Word Viewer 2003. Microsoft Word Viewer 2003 ist von diesem Problem nicht betroffen. Benutzer können [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf) im Microsoft Download Center herunterladen.
...
-   Office 2000 Service Pack 3 (SP3) muss installiert sein. Installieren Sie vor diesem Update [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe). Weitere Informationen zum Installieren von Office 2000 SP3 finden Sie im [Microsoft Knowledge Base-Artikel 326585](https://support.microsoft.com/kb/326585).
...
1.  [Laden Sie dieses Sicherheitsupdate für Word 2000 herunter](https://download.microsoft.com/download/e/e/2/ee2c73dd-a33c-4d79-bd50-f772cccce765/office2000-kb929139-fullfile-enu.exe).  
...
1.  [Laden Sie dieses Sicherheitsupdate für Word 2002 herunter.](https://download.microsoft.com/download/d/0/9/d09d67ff-cba7-436e-88df-3db2327dee2a/officexp-kb929061-fullfile-enu.exe)  
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.  
3.  Klicken Sie auf **Speichern**.  
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.  
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.  
...
-   Zur Aktualisierung von Office 2003 muss Office 2003 Service Pack 1 installiert werden. Bevor Sie dieses Update installieren, installieren Sie [Office 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867&displaylang=de).  
-   Um Word Viewer 2003 aktualisieren zu können, muss die neueste Version von Word Viewer 2003 installiert werden. Laden Sie die [aktuelle Version von Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)herunter.
...
1.  Laden Sie das [Sicherheitsupdate für Word 2003](https://download.microsoft.com/download/4/a/0/4a0bcc02-9b89-458b-8629-ac9da6d1e470/office2003-kb929057-fullfile-enu.exe) bzw. [Word Viewer 2003](https://download.microsoft.com/download/0/d/7/0d7d95fa-12f1-4bb9-ba66-5fa99042e24a/office2003-kb924883-fullfile-enu.exe) herunter.  
2.  Klicken Sie auf **Das Programm speichern**, und klicken Sie dann auf **OK**.  
3.  Klicken Sie auf **Speichern**.  
4.  Navigieren Sie mithilfe von Windows Explorer zu dem Ordner, der die gespeicherte Datei enthält, und doppelklicken Sie auf die gespeicherte Datei.  
5.  Wenn Sie aufgefordert werden, das Update zu installieren, klicken Sie auf **Ja**.  
...
-   Shih-hao Weng vom [Information and Communication Security Technology Center](https://www.icst.org.tw/) für den Hinweis auf die Sicherheitsanfälligkeit in Word aufgrund einer fehlerhaften Zeichenfolge (CVE-2006-5994).  
-   Shih-hao Weng vom [Information and Communication Security Technology Center](https://www.icst.org.tw/) für den Hinweis auf die Sicherheitsanfälligkeit in Word aufgrund einer fehlerhaften Datenstruktur (CVE-2006-6456).  
