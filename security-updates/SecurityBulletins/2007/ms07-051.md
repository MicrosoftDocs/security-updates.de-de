...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------|-----------------------------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=de&familyid=7cd248ed-d154-4dce-89ef-ceefd2700965) | Remotecodeausführung           | Kritisch                         | [MS07-020](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-020.mspx) |
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040).
...
Microsoft Agent ist eine Komponente des Microsoft Windows-Betriebssystems, die interaktiv animierte Zeichen für Anleitungen an die Benutzer verwendet und so die Arbeit am und den Zugang zum Computer erleichtert. Weitere Informationen finden Sie auf der [Microsoft Agent-Website](https://www.microsoft.com/msagent/default.aspx).
...
-   Dem Vulnerability Research-Team von [Assurent Secure Technologies](https://www.assurent.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Agent bezüglich Remotecodeausführung – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   Yamata Li von [Palo Alto Networks](https://www.paloaltonetworks.com/) für den Hinweis auf die Sicherheitsanfälligkeit in Agent bezüglich Remotecodeausführung – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   Einer Person, die mit [iDefense VCP](https://labs.idefense.com/) zusammenarbeitet, aber anonym bleiben möchte, für den Hinweis auf die Sicherheitsanfälligkeit in Agent bezüglich Remotecodeausführung – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
