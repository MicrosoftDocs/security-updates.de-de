...
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|-------------------------------------|
| Sicherheitsanfälligkeit durch Speicherbeschädigung in UPnP – [CVE-2007-1204](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1204) | Remotecodeausführung                   | Kritisch                            |
...
**Voraussetzungen**  
Dieses Sicherheitsupdate erfordert Windows XP Service Pack 2 oder Windows XP Professional x64 Edition. Weitere Informationen zu den Bezugsquellen für das aktuelle Service Pack für Windows XP finden Sie im [Microsoft Knowledge Base-Artikel 322389](https://support.microsoft.com/kb/322389). Weitere Informationen zu den Bezugsquellen für das aktuelle Service Pack 2 für Windows XP Professional x64 Edition finden Sie unter folgendem Link zum [Download Center](https://www.microsoft.com/download/details.aspx?familyid=893fd6c0-6283-44c3-bb84-b2f0315b2ae6).
...
-   Greg MacManus von [iDefense Labs](https://labs.idefense.com/) für den Hinweis auf die Sicherheitsanfälligkeit durch Speicherbeschädigung in UPnP (CVE-2007-1204).
