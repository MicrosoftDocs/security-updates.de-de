...
<td style="border:1px solid black;">
2687441 in [MS12-060](https://go.microsoft.com/fwlink/?linkid=254386)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
2597986 in [MS12-060](https://go.microsoft.com/fwlink/?linkid=254386)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-1809](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1809).
...
<td style="border:1px solid black;">Das Update 2760272 für Microsoft Office 2013 RT ist über <a href="https://update.microsoft.com/windowsupdate/">Windows Update</a> verfügbar.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Neustartanforderung</strong></td>
<td style="border:1px solid black;">In einigen Fällen erfordert dieses Update keinen Neustart des Computers. Falls die erforderlichen Dateien bei der Installation des Updates gerade verwendet werden, müssen Sie allerdings einen Neustart durchführen. In diesem Fall wird eine Meldung angezeigt, die über den erforderlichen Neustart informiert.<br />
