...
<td style="border:1px solid black;">
2863856 in [MS14-022](https://go.microsoft.com/fwlink/?linkid=386285)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-2816](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-2816).
...
-   **Für SharePoint Instanzen, Beurteilen und ggf. Entfernen von Apps. Installieren Sie neue Apps nur von vertrauenswürdigen Quellen.**
    ...
    Weitere Informationen finden Sie unter [Entfernen einer App für SharePoint-Instanzen aus einer SharePoint 2013-Website](https://technet.microsoft.com/library/fp161233).
