...
<td style="border:1px solid black;">
GDR: 2977321 ersetzt 2716436 in [MS12-070](https://go.microsoft.com/fwlink/?linkid=263997)  
QFE: 2977322 ersetzt 2716435 in [MS12-070](https://go.microsoft.com/fwlink/?linkid=263997)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-1820](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1820).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-4061](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4061).
...
**Was ist T-SQL?**  
Transact-SQL (T-SQL) ist eine Sprache, mit der das SQL Server-Datenbankmodul abgefragt wird. Weitere Informationen finden Sie in [Transact-SQL Overview](https://technet.microsoft.com/en-us/library/aa260642(v=sql.80).aspx) (Englisch).
