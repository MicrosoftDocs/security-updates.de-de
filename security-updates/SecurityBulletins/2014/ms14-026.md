...
<td style="border:1px solid black;">
2901113 in [MS14-009](https://go.microsoft.com/fwlink/?linkid=386454)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
2901112 in [MS14-009](https://go.microsoft.com/fwlink/?linkid=386454)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[2]</sup>Die Sicherheitsupdates für Windows RT und Windows RT 8.1 werden über [Windows Update](https://update.microsoft.com/windowsupdate/) bereitgestellt.
...
Die Antwort auf diese Frage ist abhängig von dem Verteilungsweg, über den Endbenutzer Sicherheitsupdates beziehen. Endbenutzer, die Sicherheitsupdates von Windows Update oder aus dem Microsoft Update-Katalog beziehen, müssen zuerst das im April 2014 veröffentlichte Update 2919355 installieren, bevor sie das .NET Framework 3.5-Update (2931358) oder das .NET Framework 4.5.1-Update (2931366) wo zutreffend unter Windows 8.1, Windows Server 2012 R2 oder Windows RT 8.1 installieren können. Weitere Informationen zu dem vorausgesetzten Update finden Sie im [Microsoft Knowledge Base-Artikel 2919355](https://support.microsoft.com/kb/2919355). Für Endbenutzer jedoch, die Sicherheitsupdates auf anderem Wege beziehen, etwa über das Microsoft Download Center oder die Windows Server Update Services (WSUS), bestehen keine Voraussetzungen. Die Updates 2931358 und 2931366 können installiert werden, ungeachtet dessen, ob das Update 2919355 installiert wurde.
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-1806](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-cve-2014-1806).
...
-   **Aktivieren der Sicherheit beim Registrieren eines Kanals**
    ...
    Durch das Aktivieren der Sicherheit beim Registrieren eines Kanals können nur authentifizierte Clients mit dem anfälligen Server interagieren. Weitere Informationen finden Sie unter [Authentifizierung mit dem TCP-Channel](https://msdn.microsoft.com/library/59hafwyt).
...
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2958732">Microsoft Knowledge Base-Artikel 2958732</a>.</td>
</tr>
<tr class="odd">
...
Das Update 2931367 ist über <a href="https://update.microsoft.com/windowsupdate/">Windows Update</a> verfügbar.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
...
Das Update 2931366 ist über <a href="https://update.microsoft.com/windowsupdate/">Windows Update</a> verfügbar.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Neustartanforderung</strong></td>
