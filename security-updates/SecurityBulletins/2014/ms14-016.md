...
<td style="border:1px solid black;">
2626416 in [MS11-095](https://technet.microsoft.com/de-de/security/bulletin/ms11-095)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
2801109 in [MS13-032](https://go.microsoft.com/fwlink/?linkid=280660)
</td>
</tr>
<tr>
<td style="border:1px solid black;" colspan="4">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 mit SP2 für Itanium-basierte Systeme](https://www.microsoft.com/download/details.aspx?familyid=c079f55c-0046-4257-a45b-b6ac173c3e86)  
(Active Directory ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
2772930 in [MS13-032](https://go.microsoft.com/fwlink/?linkid=280660)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=50cfb145-6f71-4d7e-8598-4078c7b1ab30)  
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e55cd385-21da-4a13-b965-be75d8195768)  
(Active Directory-Domänendienste (AD DS) oder Active Directory Lightweight Directory Service (AD LDS) ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=04e3b3bd-e7e4-413b-893e-9324a00d2bd8)  
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für 32-Bit-Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=50cfb145-6f71-4d7e-8598-4078c7b1ab30) (Server Core-Installation)  
(Active Directory-Domänendienste (AD DS) oder Active Directory Lightweight Directory Service (AD LDS) ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 für x64-basierte Systeme Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e55cd385-21da-4a13-b965-be75d8195768) (Server Core-Installation)  
(Active Directory-Domänendienste (AD DS) oder Active Directory Lightweight Directory Service (AD LDS) ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 für x64-basierte Systeme Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=04e3b3bd-e7e4-413b-893e-9324a00d2bd8) (Server Core-Installation)  
(Rolle „Active Directory-Domänendienste (AD DS)“ ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=423a5216-7f79-4b52-9e08-ebb81d698d8b) (Server Core-Installation)  
(Active Directory ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=f2a11309-4764-4cc7-a415-88a0c447e0ed) (Server Core-Installation)  
(Active Directory ebenfalls installiert)  
(2923392)
</td>
<td style="border:1px solid black;">
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-0317](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0317).
...
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2933528$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2933528">Microsoft Knowledge Base-Artikel 2933528</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informationen zur Deinstallation</strong></td>
<td style="border:1px solid black;">Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2923392$\Spuninst.<br />
<br />
Verwenden Sie die Option <strong>Software</strong> in der Systemsteuerung oder das Dienstprogramm Spuninst.exe im Ordner %Windir%\\$NTUninstallKB2933528$\Spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2923392">Microsoft Knowledge Base-Artikel 2923392</a>.<br />
Siehe <a href="https://support.microsoft.com/kb/2933528">Microsoft Knowledge Base-Artikel 2933528</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Dateiinformationen</strong></td>
<td style="border:1px solid black;">Siehe <a href="https://support.microsoft.com/kb/2923392">Microsoft Knowledge Base-Artikel 2923392</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Überprüfung des Registrierungsschlüssels</strong></td>
