...
Ja. Dieses Update fügt den Strukturen, die von Entwicklern zum Erstellen von Tastatur- und Mauseingabe-Hooks auf niedriger Ebene verwendet werden, neue sicherheitsbezogene Kennzeichen hinzu. Ausführliche Informationen zu den Funktionsänderungen finden Sie unter [KBDLLHOOKSTRUCT structure](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx) und [MSLLHOOKSTRUCT structure](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx) (beide Englisch).
...
Informationen zum Anzeigen dieser Sicherheitsanfälligkeit als Standardeintrag in der Liste allgemeiner Sicherheitsanfälligkeiten finden Sie unter [CVE-2014-2781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-2781).
...
Das Update behebt die Sicherheitsanfälligkeit, indem korrigiert wird, wie einige Programme mit anderen Programmen unterschiedlicher Integritätsebene kommunizieren. Weitere ausführliche Informationen zu den Funktionsänderungen, die mit diesem Update implementiert wurden, finden Sie unter [KBDLLHOOKSTRUCT structure](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx) und [MSLLHOOKSTRUCT structure](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx) (beide Englisch).
