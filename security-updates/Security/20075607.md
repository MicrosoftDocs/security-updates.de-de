...
Standardmäßig klassifiziert Outlook eine Reihe von potenziell schädlichen Dateitypen (wie EXE, REG und VBS) als Ebene 1 und blockiert den Empfang von Dateien mit diesen Erweiterungen durch Benutzer. (Die vollständige Liste von [Anlagedateitypen, die von Outlook 2007 gesperrt werden](https://technet2.microsoft.com/office/en-us/library/bc667b4c-1645-42be-8dc0-af56dc11ef5b1033.mspx)  , finden Sie auf Microsoft TechNet.)
...
Weitere Informationen über Suite B finden Sie in den [Fakten zur NSA Suite-B-Kryptografie (in englischer Sprache)](https://www.nsa.gov/ia/industry/crypto_suite_b.cfm).
...
* Microsoft Office Online-Artikel „[Hinzufügen, Entfernen oder Anzeigen eines vertrauenswürdigen Herausgebers](https://office.microsoft.com/en-us/help/ha100341381033.aspx)  “.
* Knowledge Base-Artikel „[So wird's gemacht: Verwendung von Richtlinien für Softwareeinschränkung in Windows Server 2003](https://support.microsoft.com/kb/324036)  “.
* Microsoft TechNet-Artikel „[Schutz vor nicht autorisierter Software mit Richtlinien für Softwareeinschränkung](https://go.microsoft.com/fwlink/?linkid=98671)  “.
* Kapitel 6 „[Richtlinie für Softwareeinschränkungen auf Windows XP-Clients](https://www.microsoft.com/technet/security/prodtech/windowsxp/secwinxp/default.mspx)  “ im Windows XP-Sicherheitshandbuch im Microsoft TechNet.
...
Weitere Informationen über FIPS finden Sie in den [allgemeinen Informationen zu FIPS (möglicherweise in englischer Sprache)](https://www.itl.nist.gov/fipspubs/geninfo.htm).
...
Kürzlich durchgeführte Tests dieser Einstellung ergaben, dass sie nicht erwartungsgemäß funktionierte. Weitere Informationen finden Sie in diesem [Microsoft Knowledge Base-Artikel](https://go.microsoft.com/fwlink/?linkid=103514).
