...
Zum Bereitstellen von EC- oder SSLF-Sicherheitseinstellungen müssen Sie den [GPOAccelerator](https://go.microsoft.com/fwlink/?linkid=103569) herunterladen und ausführen. In Kapitel 4 des *Leitfadens zur Verwendung von GPOAccelerator* (möglicherweise in englischer Sprache) finden Sie eine schrittweise Anleitung zum Bereitstellen der Einstellungen für EC- und SSLF-Umgebungen.
...
[Melden Sie sich an, um über Updates und neue Versionen informiert zu werden](https://technet.microsoft.com/hi-in/solutionaccelerators/bb687756(en-us).aspx)
