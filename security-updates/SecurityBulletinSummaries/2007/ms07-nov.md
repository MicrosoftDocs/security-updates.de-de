...
Mit der Veröffentlichung der Bulletins für November 2007 ersetzt dieses Bulletin Summary die Bulletin Advance Notification, die erstmalig am 8. November 2007 veröffentlicht wurde. Weitere Informationen zum Bulletin Advance Notification-Service finden Sie unter [Microsoft Security Bulletin Advance Notification.](https://www.microsoft.com/germany/technet/sicherheit/bulletins/bulletinadvance.mspx)
...
Am Mittwoch, den 14. November 2007 um 11:00 Uhr pazifischer Zeit (USA & Kanada) führt Microsoft einen englischsprachigen Webcast durch, um Kundenfragen zu diesen Bulletins zu beantworten. [Registrieren Sie sich jetzt für das Security Bulletin-Webcast im November.](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032344694&eventcategory=4&culture=en-us&countrycode=us) Ab diesem Datum steht dieser Webcast auf Anfrage zur Verfügung. Weitere Informationen dazu finden Sie unter [Microsoft Security Bulletin Summarys und Webcasts.](https://technet.microsoft.com/security/bulletin/summary)
...
|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel des Bulletins**                    | [**Sicherheitsanfälligkeit bei der URI-Verarbeitung in Windows kann Remotecodeausführung ermöglichen (943460)**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-061.mspx)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
|--------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel des Bulletins**                    | [**Sicherheitsanfälligkeit in DNS kann Spoofing ermöglichen (941672)**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-062.mspx)                                                                                                                                                                                                                            |
...
<td style="border:1px solid black;">
[**MS07-061**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-061.mspx)
</td>
<td style="border:1px solid black;">
[**MS07-062**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms07-062.mspx)
</td>
</tr>
...
-   Sicherheitsupdates sind im [Microsoft Download Center](https://www.microsoft.com/downloads/results.aspx?displaylang=de&freetext=sicherheitsupdate) verfügbar Sie können am einfachsten durch eine Suche nach dem Begriff „sicherheitsupdate“ ermittelt werden.
...
-   Carsten H. Eiram von [Secunia](https://corporate.secunia.com/) für die Zusammenarbeit mit uns an einem in MS07-061 beschriebenen Problem.
-   Aviv Raff von [Finjan](https://www.finjan.com/) für die Zusammenarbeit mit uns an einem in MS07-061 beschriebenen Problem.
-   Petko Petkov von [GNUCITIZEN](https://www.gnucitizen.org/) für die Zusammenarbeit mit uns an einem in MS07-061 beschriebenen Problem.
-   Alla Berzroutchko von [Scanit](https://www.scanit.be/) für den Hinweis auf ein in MS07-062 beschriebenes Problem.
-   Amit Klein von [Trusteer](https://www.trusteer.com/) für den Hinweis auf ein in MS07-062 beschriebenes Problem.
