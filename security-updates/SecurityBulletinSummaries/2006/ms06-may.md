---
TOCTitle: 'MS06-MAI'
Title: Microsoft Security Bulletin Summary für Mai 2006
ms:assetid: 'ms06-mai'
ms:contentKeyID: 61225038
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms06-mai(v=Security.10)'
---
...
Veröffentlicht: Dienstag, 9. Mai 2006

**Version:** 1.0

Eine Endbenutzerfassung dieser Informationen finden Sie auf dem [Microsoft-Sicherheitsportal](https://www.microsoft.com/germany/sicherheit/).
...
| Kennung des Bulletins                      | Microsoft Security Bulletin MS06-019                                                                                                                                                               |
|--------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel des Bulletins**                    | [**Sicherheitsanfälligkeit in Microsoft Exchange kann Codeausführung von Remotestandorten aus ermöglichen (916803)**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-019.mspx) |
| **Kurzzusammenfassung**                    | In Microsoft Exchange liegen Sicherheitsanfälligkeiten vor, die die Codeausführung von Remotestandorten aus ermöglichen können.                                                                    |
...
| Kennung des Bulletins                      | Microsoft Security Bulletin MS06-020                                                                                                                                                                                  |
|--------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel des Bulletins**                    | [**Sicherheitsanfälligkeiten in Macromedia Flash Player von Adobe können Codeausführung von Remotestandorten aus ermöglichen (913433)**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-020.mspx) |
| **Kurzzusammenfassung**                    | In Macromedia Flash Player liegen Sicherheitsanfälligkeiten vor, die eine Codeausführung von Remotestandorten aus ermöglichen können.                                                                                 |
| **Bewertung des maximalen Schweregrads**   | [Kritisch](https://www.microsoft.com/germany/technet/datenbank/articles/527029.mspx)                                                                                                                                   |
| **Auswirkung der Sicherheitsanfälligkeit** | Codeausführung von Remotestandorten aus                                                                                                                                                                               |
...
| Kennung des Bulletins                      | Microsoft Security Bulletin MS06-018                                                                                                                                                                                                                                          |
|--------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel des Bulletins**                    | [**Sicherheitsanfälligkeit in Microsoft Distributed Transaction Coordinator kann zu einem DoS-Angriff (Denial-of-Service) führen (913580)**](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-018.mspx)                                                     |
| **Kurzzusammenfassung**                    | Bei der Sicherheitsanfälligkeit des Typs Denial-of-Service kann ein Angreifer eine speziell gestaltete Netzwerknachricht an ein betroffenes System senden.  Ein Angreifer könnte so bewirken, dass Microsoft Distributed Transaction Coordinator (MSDTC) nicht mehr reagiert. |
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-018.mspx"><strong>MS06-018</strong></a></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-019.mspx"><strong>MS06-019</strong></a></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-020.mspx"><strong>MS06-020</strong></a></td>
</tr>
<tr class="even">
...
-   [eEye Digital Security](https://www.eeye.com/html/) für den Hinweis auf eine in [MS06-018](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-018.mspx) beschriebene Sicherheitsanfälligkeit.  
-   Xiao Chen von [McAfee](https://www.mcafee.com) für den Hinweis auf eine in [MS06-018](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-018.mspx) beschriebene Sicherheitsanfälligkeit.  
-   Kai Zhang von [VenusTech](https://www.venustech.com.cn) für den Hinweis auf eine in [MS06-018](https://www.microsoft.com/germany/technet/sicherheit/bulletins/ms06-018.mspx) beschriebene Sicherheitsanfälligkeit.
