---
TOCTitle: 'MS04-JAN'
Title: Microsoft Security Bulletin Summary für Januar 2004
ms:assetid: 'ms04-jan'
ms:contentKeyID: 61225014
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms04-jan(v=Security.10)'
---

Security Bulletin Summary

Microsoft Security Bulletin Summary für Januar 2004
===================================================

Veröffentlicht: Dienstag, 13. Januar 2004

**Version:** 1.0

In diesem Bulletin Summary sind die im Januar 2004 veröffentlichten Security Bulletins aufgeführt.
...
Diese Zusammenfassung enthält Updates für entdeckte Sicherheitsanfälligkeiten in Microsoft Windows, Microsoft Exchange Server sowie Microsoft Internet Security and Acceleration Server. Diese Sicherheitsanfälligkeiten, unterteilt nach Schweregrad, sind:

**Kritisch**

[Microsoft Security Bulletin MS04-001 - Sicherheitsanfälligkeit in H.323-Filter von ISA Server 2000 kann Codeausführung von Remotestandorten aus ermöglichen (816458)](https://local/bulletin/ms04-001.mspx)
...
<td style="border:1px solid black;">13. Januar 2004</td>
</tr>
<tr class="even">
...
[Microsoft Security Bulletin MS04-003 - Pufferüberlauf in MDAC-Funktion kann Codeausführung ermöglichen (832483)](https://local/bulletin/ms04-003.mspx)
...
<tr class="odd">
<td style="border:1px solid black;">Betroffene Software</td>
<td style="border:1px solid black;">Microsoft Data Access Components 2.5 (in Microsoft Windows 2000 enthalten)
<div>
Microsoft Data Access Components 2.6 (in Microsoft SQL Server 2000 enthalten)  
</div>
<div>
Microsoft Data Access Components 2.7 (in Microsoft Windows XP enthalten)  
</div>
<div>
Microsoft Data Access Components 2.8 (in Microsoft Windows Server 2003 enthalten)  
</div>
<div>
Microsoft Data Access Components 2.8 (in Microsoft Windows Server 2003 64-Bit-Edition enthalten)
</div></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Auswirkung</td>
...
<tr class="odd">
<td style="border:1px solid black;">Letzte Überarbeitung</td>
<td style="border:1px solid black;">1. April 2004</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Versionsnummer</td>
...
[Microsoft Security Bulletin MS04-002 - Sicherheitsanfälligkeit in Exchange Server 2003 kann zur Erhöhung von Berechtigungen führen (832759)](https://local/bulletin/ms04-002.mspx)
  
|                      |                                |  
|----------------------|--------------------------------|  
| Betroffene Software  | Microsoft Exchange Server 2003 |  
| Auswirkung           | Erhöhung von Berechtigungen    |  
| Letzte Überarbeitung | 14. Januar 2004                |  
| Versionsnummer       | 1.1                            |
...
-   Dem [UK National Infrastructure Security Co-ordination Centre (NISCC)](https://www.niscc.gov.uk/) für den Hinweis auf das in MS04-001 beschriebene Problem.
...
-   V1.0 (13. Januar 2004): Bulletin Summary veröffentlicht.
