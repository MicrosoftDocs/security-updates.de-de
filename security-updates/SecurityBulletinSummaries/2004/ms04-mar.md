---
TOCTitle: 'MS04-MAR'
Title: Microsoft Security Bulletin Summary für März 2004
ms:assetid: 'ms04-mar'
ms:contentKeyID: 61225016
ms:mtpsurl: 'https://technet.microsoft.com/de-DE/library/ms04-mar(v=Security.10)'
---

Security Bulletin Summary

Microsoft Security Bulletin Summary für März 2004
=================================================

Veröffentlicht: Dienstag, 9. März 2004

**Version:** 1.0

In diesem Bulletin Summary sind die im März 2004 veröffentlichten Security Bulletins aufgeführt.
...
Diese Zusammenfassung enthält Updates für entdeckte Sicherheitsanfälligkeiten in Microsoft Windows, Microsoft Office und Microsoft MSN-Produkten. Diese Sicherheitsanfälligkeiten, unterteilt nach Schweregrad, sind:

**Kritisch**

[Microsoft Security Bulletin MS04-009 - Sicherheitsanfälligkeit in Outlook kann Remotecodeausführung ermöglichen (828040)](https://local/bulletin/ms04-009.mspx)
...
[Microsoft Security Bulletin MS04-008 - Sicherheitsanfälligkeit in Windows Media-Diensten kann zu DoS-Angriffen (Denial-of-Service) führen (832359)](https://local/bulletin/ms04-008.mspx)
  
|                      |                                                                                                                     |  
|----------------------|---------------------------------------------------------------------------------------------------------------------|  
| Betroffene Software  | Microsoft Windows 2000 Service Pack 2, Microsoft Windows 2000 Service Pack 3, Microsoft Windows 2000 Service Pack 4 |  
| Auswirkung           | DoS (Denial of Service)                                                                                             |  
| Letzte Überarbeitung | 9. März 2004                                                                                                        |  
| Versionsnummer       | 1.0                                                                                                                 |
  
[Microsoft Security Bulletin MS04-010 - Sicherheitsanfälligkeit in MSN Messenger kann zur Offenlegung von Informationen führen (838512)](https://local/bulletin/ms04-010.mspx)
...
-   [Qualys](https://www.qualys.com/) für den Hinweis auf das in MS04-008 beschriebene Problem.  
-   [IDefense](https://www.idefense.com/) und [Jouko Pynnönen](https://iki.fi/jouko) für den Hinweis auf das in MS04-009 beschriebene Problem.  
-   qFox und Mephisto für den Hinweis auf das in MS04-010 beschriebene Problem.
...
-   V1.0 (9. März 2004): Bulletin Summary veröffentlicht.
