...
ms:contentKeyID: 21669522
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Dd939870(v=WS.10)'
---
...
<br/><br/>Although the connection between Microsoft Update and WSUS requires ports 80 and 443 to be open, you can configure multiple WSUS servers to synchronize with a custom port.
