...
ms:contentKeyID: 18127593
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc708565(v=WS.10)'
---
...
> [!NOTE]  
> o not use WSUS to distribute updates to client computers that are not licensed for your organization. The WSUS license agreement specifically disallows this.
