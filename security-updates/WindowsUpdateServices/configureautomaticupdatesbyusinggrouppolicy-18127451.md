...
ms:contentKeyID: 18127451
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc720539(v=WS.10)'
---
...
| ![](images/Cc720539.note(WS.10).gif)Hinweis                                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720539.Important(WS.10).gif)Wichtig                                                                                                                                                                                                                                                                        |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
