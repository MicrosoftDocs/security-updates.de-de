...
ms:contentKeyID: 18127413
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc720498(v=WS.10)'
---
...
| ![](images/Cc720498.Important(WS.10).gif)Wichtig                                                                     |
|---------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720498.note(WS.10).gif)Hinweis                                                                                                          |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
