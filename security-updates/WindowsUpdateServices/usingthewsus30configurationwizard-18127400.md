...
ms:contentKeyID: 18127400
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)Hinweis                        |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)Wichtig  |
|--------------------------------------------------------------------------------|
