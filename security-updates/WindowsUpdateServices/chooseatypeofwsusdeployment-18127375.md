...
ms:contentKeyID: 18127375
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc720448(v=WS.10)'
---
...
| ![](images/Cc720448.note(WS.10).gif)Hinweis                                        |
|-----------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720448.Important(WS.10).gif)Wichtig                                                                                                                                                                                                                                                                                                                                             |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
