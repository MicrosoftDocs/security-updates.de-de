...
ms:contentKeyID: 18127470
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc720538(v=WS.10)'
---
...
| ![](images/Cc720538.Important(WS.10).gif)Wichtig                                                                                                                                                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720538.note(WS.10).gif)Hinweis                                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
