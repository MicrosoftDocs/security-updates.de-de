...
ms:contentKeyID: 18127587
ms:mtpsurl: 'https://technet.microsoft.com/de-de/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)Wichtig |
|-------------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)Hinweis                                                                                                                                                                                                                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
